...
The discipline of this chapter is simple: a cyclic substrate is allowed into
...
The concrete RoPE boundary surface is already checkable through
`python3 scripts/validate_circle_concrete_evidence_surface.py`. For this
chapter, that validator preserves the imported Circle RoPE receipt facts as
diagnostic structural evidence: Circle commit `63b0f511`,
...
The Lean hooks for this chapter live in `AsiStackProofs.CyclicMixers`. They
...
which claims can harden and which must remain research-only.
