...
The core claim remains an architectural argument.
The corresponding no-promotion record,
`evidence_transitions/v1_x_measured/rankfold_artifact_import_no_change.json`,
keeps the import at `argument` and blocks stronger claims until fresh
compression, clean or archived source state, decoder review, downstream
utility, fallback execution, and independent review exist.
...
keeps the replay at `argument` and blocks stronger claims until an enabled
