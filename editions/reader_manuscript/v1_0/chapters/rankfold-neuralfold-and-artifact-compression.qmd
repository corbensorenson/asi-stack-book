...
corrupted archive. That sounds small because it is small. The point is not to claim a
...
So the probe proves only replay discipline and a negative control. It does not
prove NeuralFold compression, compression advantage, RankFold codec correctness,
downstream utility, fallback execution, deployed compression behavior, or
