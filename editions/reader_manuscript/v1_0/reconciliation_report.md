...
Status: drafting; eleven curated reader chapters have first prose curation passes,
...
- Current graduation decision: keep drafting-only curated reader chapters for
  ...
  Human Intent, Security Kernel, Recursive Self-Improvement, Circle
  proof-carrying contracts, Executable Specifications, and Artifact Steward
  Agents while keeping generated reader source plus semantic overlays as the
  release baseline; see
  `docs/curated_reader_graduation_review.md`
- Chapter records: 11 drafting records
