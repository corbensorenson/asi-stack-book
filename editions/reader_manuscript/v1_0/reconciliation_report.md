...
Status: drafting; three curated reader chapters have first prose curation passes,
...
- Current graduation decision: keep drafting-only curated reader chapters for
  the opener, Efficient ASI, and Artifact Steward Agents while keeping generated
  reader source plus semantic overlays as the release baseline; see
  `docs/curated_reader_graduation_review.md`
- Chapter records: 3 drafting records
