...
Status: drafting; five curated reader chapters have first prose curation passes,
...
- Current graduation decision: keep drafting-only curated reader chapters for
  the opener, Efficient ASI, Human Intent, Recursive Self-Improvement, and
  Artifact Steward Agents while keeping generated reader source plus semantic
  overlays as the release baseline; see
  `docs/curated_reader_graduation_review.md`
- Chapter records: 5 drafting records
