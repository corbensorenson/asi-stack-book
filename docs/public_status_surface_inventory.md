...
| Tracked curated-reader and release manifests | explicit historical snapshot scope | Frozen derivative spines remain valid only for their named source commits and cannot override the active 84-chapter manifest. |
