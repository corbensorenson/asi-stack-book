...
| `costed-routing-residual-accounting-resource-discipline` | Costed routing, residual accounting, and resource discipline | selected-supporting | `resource-economics-and-token-budgets`; `fast-generation-architectures`; `readiness-gates-residual-escrow-and-quarantine` | `docs/costed_route_resource_slice.md`; `experiments/costed_route_resource_slice/results/2026-06-29-local.json`; `evidence_transitions/v1_0_measured/costed_route_resource_slice_synthetic_test_backed.json`; `docs/resource_workflow_trace.md`; `experiments/resource_workflow_trace/results/2026-07-01-local.json`; `docs/theseus_generation_mode_import_slice.md`; `docs/theseus_support_replay_probe.md`; `lean/AsiStackProofs/FastGenerationRefinement.lean`; `docs/readiness_residual_harness.md`; `docs/defended_contribution_prior_art_positioning.md` | Larger public trace now starts with deterministic workflow fixtures and Theseus support replay accounting; next blocker is externally reviewable or live workload quality review, scheduler logs, physical-feasibility review, and measured useful-speed/resource behavior; no economic or generation-speed overclaim; residual-governance comparator gap remains open. |
