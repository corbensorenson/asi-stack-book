...
| Governed consolidation | The 54-chapter shape may be over-split in places, but merges must preserve claims, sources, proofs, harnesses, handoffs, and reader paths. | `docs/chapter_consolidation_external_review_packet.md`; `docs/chapter_consolidation_full_review_packet.md`; `docs/chapter_consolidation_decision_review.md` |
...
6. Do the Part I consolidation destination drafts improve chapter depth and
   reader flow without losing source, proof, claim, harness, or handoff
   coverage?
7. Which review-ready non-pilot merge packages or fold dispositions should be
   executed, revised, deferred, or rejected before broad reader curation?
...
| Consolidation decision if reviewed | Execute, revise, defer, reject, or no opinion for each reviewed merge or fold package. |
