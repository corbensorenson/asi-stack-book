...
- Most source-to-claim mappings still need explicit claim-level mapping from the source notes before support states can be promoted; the first foundation cluster and the evidence-discipline core claim are mapped examples.
