...
Current scale: 50 chapter files, 78,260 chapter words, averaging 1,565 words per chapter.
...
- Most Lean proof targets remain planned or triaged as schema/process/research targets; 24 of 100 proof targets are currently marked implemented.
