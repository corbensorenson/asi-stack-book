...
- Appendix C now includes a generated source-note chapter-mapping column for the claim/evidence matrix. All 389 assigned source/chapter pairs have source notes, and 295 of those pairs are explicitly listed by stable chapter ID or exact chapter title in the corresponding source notes; remaining gaps are chapter-listing and exact claim-to-mechanism mapping work, not support-state promotions.
