...
Current scale: 51 chapter files, 82,539 chapter words, averaging 1,618 words per chapter.
...
- Appendix E now publishes a generated proof-target coverage summary from `proofs/proof_triage.json`: 102 proof targets are covered by triage, 46 are implemented formal-invariant Lean candidates, and 56 remain planned across schema, process, and research routes.
...
- Most Lean proof targets remain planned or triaged as schema/process/research targets; 46 of 102 proof targets are currently marked implemented.
