...
Current scale: 50 chapter files, 78,616 chapter words, averaging 1,572 words per chapter.
...
- Most Lean proof targets remain planned or triaged as schema/process/research targets; 30 of 100 proof targets are currently marked implemented.
