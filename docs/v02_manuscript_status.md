...
- Executable schema drafts now cover context adequacy records, semantic atoms, compression receipts, authority-use receipts, costed route records, authority transition records, failure boundary maps, intent contracts, constitutional predicates, agency rights checklists, value conflict records, and governance rights records, with valid example fixtures checked by `scripts/validate_protocol_examples.py`.
