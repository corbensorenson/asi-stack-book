...
Current scale: 50 chapter files, 77,436 chapter words, averaging 1,549 words per chapter.
...
- Most Lean proof targets remain planned or triaged as schema/process/research targets; 12 of 100 proof targets are currently marked implemented.
