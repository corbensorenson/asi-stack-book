...
- Generated and curated appendices exist for source matrix, claim/evidence matrix, protocol schemas, test specs, changelog, Corben-authored/supplied/local sources, external literature, lineage, release editions, and implementation horizons.
...
- Run `node scripts/validate_live_human_view_browser.js`.
