...
- `docs/proof_artifact_audit.md` records the current proof artifact traceability audit across all 321 proof targets: 295 implemented and 26 deliberately planned chapter targets.
