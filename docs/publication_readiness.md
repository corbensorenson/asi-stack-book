...
- `docs/proof_artifact_audit.md` records the current proof artifact traceability audit across all 333 proof targets: 302 implemented and 31 deliberately planned chapter targets.
