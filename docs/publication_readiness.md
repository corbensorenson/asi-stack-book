...
- All 51 chapters have v0.2 manuscript drafts generated from the source-of-truth manifest and kept at conservative support states.
...
- External literature queue is explicit in `docs/external_literature_queue.md`, including fast generation and decoding substrates, but not citation-normalized.
