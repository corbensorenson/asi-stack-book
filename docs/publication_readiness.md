...
- The post-v1.0.0 v1.x roadmap exists at `docs/v1_x_beyond_sota_roadmap.md`, separating future evidence depth, safety-critical Lean proof work, Project Theseus/Circle replay lanes, per-chapter evidence targets, curated human-reader prose, and artifact-release quality from the already tagged living-book release boundary.
