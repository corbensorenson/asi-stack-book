...
_Current canonical metrics (generated from machine records): **84 manifest chapters; 465 public-safe records; 84 chapter-core claims; 84/84 chapters externally positioned; 0 promoted core claims; 115/115 accepted transitions identity-resolved (25 direct, 61 subclaim, 29 proxy; 0 parent movements).**_
...
- `docs/proof_artifact_audit.md` records the current proof artifact traceability audit across all 329 proof targets: 303 implemented and 26 deliberately planned chapter targets.
