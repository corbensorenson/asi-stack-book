...
| Metric | Value |
|---|---:|
| Proof targets in manifest | 164 |
| Lean modules scanned | 54 |
| Theorem declarations classified | 856 |
| Direct/projection-style theorem declarations | 170 |
...
| `lean/AsiStackProofs/EvidenceStates.lean` | evidence-states-and-claim-discipline | 5 | 26 | 8 | 18 | 0 | mixed: preserve limitation prose and prioritize projection replacements |
