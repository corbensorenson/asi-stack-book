...
| Theorem declarations classified | 143 |
| Direct/projection-style theorem declarations | 112 |
| Derived/decomposed theorem declarations | 31 |
| Unknown or mixed theorem declarations | 0 |
| Safety-critical theorem declarations | 14 |
...
| `lean/AsiStackProofs/SelfImprovement.lean` | recursive-self-improvement-boundaries | 2 | 3 | 2 | 1 | 0 | v1-blocking: upgrade or keep explicitly classified as projection-only traceability |
| `lean/AsiStackProofs/ValueConflict.lean` | moral-uncertainty-and-value-conflict | 2 | 2 | 2 | 0 | 0 | v1-blocking: upgrade or keep explicitly classified as projection-only traceability |
