...
|---|---|---:|---|---|
| `lean/AsiStackProofs/Alignment.lean` | `chapters/constitutional-alignment-substrate.qmd` | 3 | yes | yes |
...
| `lean/AsiStackProofs/BenchmarkRatchets.lean` | benchmark-ratchets-and-anti-goodhart-evidence | 3 | 29 | 0 | 21 | 8 | manual review |
...
| `lean/AsiStackProofs/FailureRecoveryRefinement.lean` | failure-modes-of-ungoverned-intelligence | 1 | 44 | 4 | 29 | 11 | mixed: preserve limitation prose and prioritize projection replacements |
...
| `lean/AsiStackProofs/IntentContracts.lean` | unmapped | 0 | 20 | 0 | 20 | 0 | derived/decomposed by classifier |
| `lean/AsiStackProofs/IntentExecutionRefinement.lean` | intent-to-execution-contracts | 2 | 37 | 0 | 18 | 19 | manual review |
| `lean/AsiStackProofs/IntentResolutionRefinement.lean` | human-intent-as-a-formal-input | 5 | 36 | 1 | 20 | 15 | mixed: preserve limitation prose and prioritize projection replacements |
...
| `lean/AsiStackProofs/PlanForge.lean` | planning-as-a-control-layer | 2 | 18 | 2 | 10 | 6 | mixed: preserve limitation prose and prioritize projection replacements |
...
| `lean/AsiStackProofs/SecurityKernel.lean` | security-kernel-and-digital-scifs | 4 | 56 | 0 | 41 | 15 | manual review |
| `lean/AsiStackProofs/SelfImprovement.lean` | unmapped | 0 | 20 | 0 | 20 | 0 | derived/decomposed by classifier |
...
| `lean/AsiStackProofs/Alignment.lean` | `accepted_activation_uses_ratified_candidate_and_records_rollback` | derived_or_decomposed | yes | uses have, rcases, rw, simp, subst |
| `lean/AsiStackProofs/Alignment.lean` | `accepted_amendment_event_is_admissible` | derived_or_decomposed | yes | uses simp, split, unfold |
| `lean/AsiStackProofs/Alignment.lean` | `accepted_amendment_event_is_exact_advance` | derived_or_decomposed | yes | uses simp, split, unfold |
| `lean/AsiStackProofs/Alignment.lean` | `accepted_amendment_event_is_non_authorizing` | derived_or_decomposed | yes | uses cases, have, rcases, simp, subst |
| `lean/AsiStackProofs/Alignment.lean` | `accepted_amendment_event_never_erases_contestability_records` | derived_or_decomposed | yes | uses cases, rw, simp |
| `lean/AsiStackProofs/Alignment.lean` | `accepted_amendment_event_preserves_custody` | derived_or_decomposed | yes | uses cases, rw, simp |
| `lean/AsiStackProofs/Alignment.lean` | `accepted_amendment_rollback_preserves_dissent_and_adverse_record` | derived_or_decomposed | yes | uses rw, simp |
| `lean/AsiStackProofs/Alignment.lean` | `accepted_amendment_rollback_restores_exact_prior` | derived_or_decomposed | yes | uses have, rcases, rw, simp, subst |
| `lean/AsiStackProofs/Alignment.lean` | `accepted_appeal_preserves_dissent_and_adverse_record` | derived_or_decomposed | yes | uses have, rcases, rw, simp, subst |
| `lean/AsiStackProofs/Alignment.lean` | `accepted_appeal_resolution_preserves_adverse_record` | derived_or_decomposed | yes | uses have, rcases, rw, simp, subst |
...
| `lean/AsiStackProofs/Alignment.lean` | `accepted_migration_cannot_add_consent` | direct_or_projection | yes | only direct intro/exact/assumption/rfl-style steps detected |
| `lean/AsiStackProofs/Alignment.lean` | `accepted_migration_cannot_add_dignity` | direct_or_projection | yes | only direct intro/exact/assumption/rfl-style steps detected |
| `lean/AsiStackProofs/Alignment.lean` | `accepted_predicate_migration_is_admissible` | derived_or_decomposed | yes | uses simp, split, unfold |
| `lean/AsiStackProofs/Alignment.lean` | `accepted_predicate_migration_is_exact` | derived_or_decomposed | yes | uses simp, split, unfold |
| `lean/AsiStackProofs/Alignment.lean` | `accepted_predicate_migration_refines_prior` | derived_or_decomposed | yes | uses have, rw |
| `lean/AsiStackProofs/Alignment.lean` | `accepted_predicate_migration_stores_exact_rollback` | derived_or_decomposed | yes | uses rw |
| `lean/AsiStackProofs/Alignment.lean` | `accepted_ratification_requires_predicate_refinement` | derived_or_decomposed | yes | uses have, rcases, rw |
| `lean/AsiStackProofs/Alignment.lean` | `accepted_ratification_separates_all_three_roles` | derived_or_decomposed | yes | uses have, rcases, rw, subst |
| `lean/AsiStackProofs/Alignment.lean` | `accepted_review_separates_proposer_and_reviewer` | derived_or_decomposed | yes | uses have, rcases, rw, simp, subst |
...
| `lean/AsiStackProofs/Alignment.lean` | `activation_before_ratification_is_rejected` | unknown_or_mixed | yes | no recognized depth pattern |
| `lean/AsiStackProofs/Alignment.lean` | `activation_version_jump_is_rejected` | direct_or_projection | yes | only direct intro/exact/assumption/rfl-style steps detected |
| `lean/AsiStackProofs/Alignment.lean` | `amendment_run_never_erases_contestability_records` | derived_or_decomposed | yes | uses cases, have, induction, simp, subst |
| `lean/AsiStackProofs/Alignment.lean` | `amendment_run_preserves_custody_and_non_authority` | derived_or_decomposed | yes | uses cases, induction, rcases, simp, subst |
| `lean/AsiStackProofs/Alignment.lean` | `amendment_runs_compose` | derived_or_decomposed | yes | uses cases, induction, simp |
...
| `lean/AsiStackProofs/Alignment.lean` | `captured_appeal_review_is_rejected` | unknown_or_mixed | yes | no recognized depth pattern |
| `lean/AsiStackProofs/Alignment.lean` | `complete_amendment_trace_reaches_contestable_exact_rollback` | unknown_or_mixed | yes | no recognized depth pattern |
...
| `lean/AsiStackProofs/Alignment.lean` | `equal_predicate_counts_do_not_identify_predicate_sets` | unknown_or_mixed | yes | no recognized depth pattern |
...
| `lean/AsiStackProofs/Alignment.lean` | `no_predicate_count_decoder_recovers_both_collision_witnesses` | derived_or_decomposed | yes | uses apply, by_cases, calc, rcases, right |
| `lean/AsiStackProofs/Alignment.lean` | `outsider_appeal_is_rejected` | unknown_or_mixed | yes | no recognized depth pattern |
| `lean/AsiStackProofs/Alignment.lean` | `predicate_refinement_is_transitive` | derived_or_decomposed | yes | uses constructor |
...
| `lean/AsiStackProofs/Alignment.lean` | `predicate_widening_migration_is_rejected` | unknown_or_mixed | yes | no recognized depth pattern |
| `lean/AsiStackProofs/Alignment.lean` | `proposer_ratification_is_rejected` | unknown_or_mixed | yes | no recognized depth pattern |
...
| `lean/AsiStackProofs/Alignment.lean` | `reviewer_ratification_is_rejected` | unknown_or_mixed | yes | no recognized depth pattern |
| `lean/AsiStackProofs/Alignment.lean` | `rollback_before_appeal_is_upheld_is_rejected` | unknown_or_mixed | yes | no recognized depth pattern |
| `lean/AsiStackProofs/Alignment.lean` | `rollback_restores_exact_prior_predicate_set` | derived_or_decomposed | yes | uses unfold |
| `lean/AsiStackProofs/Alignment.lean` | `rolled_back_amendment_is_closed` | derived_or_decomposed | yes | uses cases, rcases, rw, simp, split, unfold |
...
| `lean/AsiStackProofs/Alignment.lean` | `self_reviewed_amendment_is_rejected` | unknown_or_mixed | yes | no recognized depth pattern |
...
| `lean/AsiStackProofs/Alignment.lean` | `widening_amendment_cannot_be_ratified` | unknown_or_mixed | yes | no recognized depth pattern |
...
| `lean/AsiStackProofs/ArtifactRealityRefinement.lean` | `admitted_event_is_rejected` | derived_or_decomposed | no | uses simp, split |
| `lean/AsiStackProofs/ArtifactRealityRefinement.lean` | `admitted_state_is_absorbing` | derived_or_decomposed | no | uses have, induction, simp |
...
| `lean/AsiStackProofs/ArtifactRealityRefinement.lean` | `rejected_event_preserves_exact_state` | derived_or_decomposed | no | uses simp |
| `lean/AsiStackProofs/ArtifactRealityRefinement.lean` | `run_events_cannot_assign_support_or_external_effect` | derived_or_decomposed | no | uses have, induction, simp |
| `lean/AsiStackProofs/ArtifactRealityRefinement.lean` | `run_events_compose` | derived_or_decomposed | no | uses induction, left, simp |
| `lean/AsiStackProofs/ArtifactRealityRefinement.lean` | `run_events_preserve_exact_identity` | derived_or_decomposed | no | uses induction |
...
| `lean/AsiStackProofs/BenchmarkRatchets.lean` | `accepted_ratchet_trace_accounts_for_every_event` | derived_or_decomposed | no | uses have, induction, omega, simp |
...
| `lean/AsiStackProofs/BenchmarkRatchets.lean` | `aggregate_pass_count_cannot_identify_promotion_admissibility` | unknown_or_mixed | no | no recognized depth pattern |
| `lean/AsiStackProofs/BenchmarkRatchets.lean` | `clean_promotion_trace_is_accepted` | unknown_or_mixed | no | no recognized depth pattern |
...
| `lean/AsiStackProofs/BenchmarkRatchets.lean` | `contaminated_quarantine_trace_is_accepted` | unknown_or_mixed | no | no recognized depth pattern |
...
| `lean/AsiStackProofs/BenchmarkRatchets.lean` | `no_exact_aggregate_pass_count_promotion_classifier` | derived_or_decomposed | no | uses have, rw |
| `lean/AsiStackProofs/BenchmarkRatchets.lean` | `quarantine_containment_survives_arbitrary_suffix` | derived_or_decomposed | no | uses induction |
| `lean/AsiStackProofs/BenchmarkRatchets.lean` | `quarantine_containment_survives_one_step` | derived_or_decomposed | no | uses cases, rcases, simp |
...
| `lean/AsiStackProofs/BenchmarkRatchets.lean` | `ratchet_custody_transitive` | derived_or_decomposed | no | uses left, rcases, right, simp |
| `lean/AsiStackProofs/BenchmarkRatchets.lean` | `ratchet_decision_accepted_bool_iff` | derived_or_decomposed | no | uses cases, constructor, have, simp |
...
| `lean/AsiStackProofs/BenchmarkRatchets.lean` | `ratchet_step_preserves_custody` | unknown_or_mixed | no | no recognized depth pattern |
...
| `lean/AsiStackProofs/BenchmarkRatchets.lean` | `ratchet_step_preserves_stage_coherence` | derived_or_decomposed | no | uses cases, split |
...
| `lean/AsiStackProofs/BenchmarkRatchets.lean` | `run_ratchet_lifecycle_preserves_custody` | derived_or_decomposed | no | uses induction, simp |
| `lean/AsiStackProofs/BenchmarkRatchets.lean` | `run_ratchet_lifecycle_preserves_stage_coherence` | derived_or_decomposed | no | uses induction |
...
| `lean/AsiStackProofs/BenchmarkRatchets.lean` | `saturated_promotion_trace_is_accepted` | unknown_or_mixed | no | no recognized depth pattern |
...
| `lean/AsiStackProofs/CoilAttentionMemory.lean` | `residue_collision_addresses_are_distinct` | unknown_or_mixed | no | no recognized depth pattern |
| `lean/AsiStackProofs/CoilAttentionMemory.lean` | `residue_only_projection_collides` | direct_or_projection | no | only direct intro/exact/assumption/rfl-style steps detected |
...
| `lean/AsiStackProofs/FailureRecoveryRefinement.lean` | `accepted_observation_cannot_assign_support_or_external_authority` | derived_or_decomposed | no | uses have |
| `lean/AsiStackProofs/FailureRecoveryRefinement.lean` | `accepted_observation_opens_residual_and_blocks_effects_and_promotion` | derived_or_decomposed | no | uses have, simp |
| `lean/AsiStackProofs/FailureRecoveryRefinement.lean` | `accepted_observation_preserves_incident_identity` | derived_or_decomposed | no | uses simp |
| `lean/AsiStackProofs/FailureRecoveryRefinement.lean` | `accepted_observation_records_exactly_one_incident_and_receipt` | derived_or_decomposed | no | uses have, simp |
| `lean/AsiStackProofs/FailureRecoveryRefinement.lean` | `accepted_observation_refines_recovery_detection` | derived_or_decomposed | no | uses have, rcases, simp |
| `lean/AsiStackProofs/FailureRecoveryRefinement.lean` | `accepted_observation_starts_from_valid_operating_state` | direct_or_projection | no | only direct intro/exact/assumption/rfl-style steps detected |
...
| `lean/AsiStackProofs/FailureRecoveryRefinement.lean` | `admitted_observation_requires_record_evidence_independence_and_boundary` | derived_or_decomposed | no | uses rcases |
...
| `lean/AsiStackProofs/FailureRecoveryRefinement.lean` | `authority_over_ceiling_cannot_admit_recovery` | unknown_or_mixed | no | no recognized depth pattern |
...
| `lean/AsiStackProofs/FailureRecoveryRefinement.lean` | `captured_detector_cannot_admit_recovery` | unknown_or_mixed | no | no recognized depth pattern |
...
| `lean/AsiStackProofs/FailureRecoveryRefinement.lean` | `complete_ordinary_observation_reaches_isolated_recovery` | unknown_or_mixed | no | no recognized depth pattern |
| `lean/AsiStackProofs/FailureRecoveryRefinement.lean` | `complete_recurrence_observation_admits_escalated_recovery` | unknown_or_mixed | no | no recognized depth pattern |
| `lean/AsiStackProofs/FailureRecoveryRefinement.lean` | `complete_severe_irreversible_observation_admits_escalated_recovery` | unknown_or_mixed | no | no recognized depth pattern |
...
| `lean/AsiStackProofs/FailureRecoveryRefinement.lean` | `missing_observation_receipt_requests_evidence` | unknown_or_mixed | no | no recognized depth pattern |
...
| `lean/AsiStackProofs/FailureRecoveryRefinement.lean` | `open_escape_without_quarantine_cannot_admit_recovery` | unknown_or_mixed | no | no recognized depth pattern |
...
| `lean/AsiStackProofs/FailureRecoveryRefinement.lean` | `recurrence_marker_substitution_cannot_admit_recovery` | unknown_or_mixed | no | no recognized depth pattern |
...
| `lean/AsiStackProofs/FailureRecoveryRefinement.lean` | `rejected_observation_preserves_exact_state` | derived_or_decomposed | no | uses simp |
...
| `lean/AsiStackProofs/FailureRecoveryRefinement.lean` | `unclassified_observation_preserves_unmapped_residual` | unknown_or_mixed | no | no recognized depth pattern |
...
| `lean/AsiStackProofs/IntentResolutionRefinement.lean` | `affected_party_change_changes_lossless_lowering` | derived_or_decomposed | no | uses have, simp |
...
| `lean/AsiStackProofs/IntentResolutionRefinement.lean` | `complete_resolution_transport_is_injective` | derived_or_decomposed | no | uses calc, left, right |
| `lean/AsiStackProofs/IntentResolutionRefinement.lean` | `complete_resolution_transport_preserves_route` | derived_or_decomposed | no | uses rw, unfold |
| `lean/AsiStackProofs/IntentResolutionRefinement.lean` | `complete_resolution_transport_round_trips` | derived_or_decomposed | no | uses cases |
...
| `lean/AsiStackProofs/IntentResolutionRefinement.lean` | `lossless_lowering_is_injective` | derived_or_decomposed | no | uses cases, left, right, simp |
...
| `lean/AsiStackProofs/IntentResolutionRefinement.lean` | `no_thin_decoder_recovers_both_colliding_intents` | derived_or_decomposed | no | uses apply, by_cases, calc, rcases, right |
| `lean/AsiStackProofs/IntentResolutionRefinement.lean` | `no_thin_resolution_router_recovers_both_conflict_routes` | derived_or_decomposed | no | uses apply, by_cases, calc, have, right |
| `lean/AsiStackProofs/IntentResolutionRefinement.lean` | `privacy_change_changes_lossless_lowering` | derived_or_decomposed | no | uses have, simp |
...
| `lean/AsiStackProofs/IntentResolutionRefinement.lean` | `thin_lowering_has_distinct_intent_collision` | unknown_or_mixed | no | no recognized depth pattern |
| `lean/AsiStackProofs/IntentResolutionRefinement.lean` | `thin_resolution_transport_has_non_goal_conflict_collision` | unknown_or_mixed | no | no recognized depth pattern |
| `lean/AsiStackProofs/IntentResolutionRefinement.lean` | `thin_resolution_transport_has_reversibility_collision` | unknown_or_mixed | no | no recognized depth pattern |
...
| `lean/AsiStackProofs/LearnedObjectiveIntegrity.lean` | `apply_event_handoff_count_monotone` | derived_or_decomposed | no | uses by_cases, simp |
| `lean/AsiStackProofs/LearnedObjectiveIntegrity.lean` | `apply_event_invalidation_count_monotone` | derived_or_decomposed | no | uses by_cases, simp |
| `lean/AsiStackProofs/LearnedObjectiveIntegrity.lean` | `apply_event_preserves_full_identity` | derived_or_decomposed | no | uses by_cases, simp |
...
| `lean/AsiStackProofs/LearnedObjectiveIntegrity.lean` | `canonical_integrity_initial_state_is_invariant` | direct_or_projection | no | only direct intro/exact/assumption/rfl-style steps detected |
| `lean/AsiStackProofs/LearnedObjectiveIntegrity.lean` | `canonical_integrity_run_reaches_exact_invalidated_state` | unknown_or_mixed | no | no recognized depth pattern |
...
| `lean/AsiStackProofs/LearnedObjectiveIntegrity.lean` | `integrity_accepted_step_adds_exact_receipt` | derived_or_decomposed | no | uses rw |
| `lean/AsiStackProofs/LearnedObjectiveIntegrity.lean` | `integrity_accepted_step_advances_stage` | derived_or_decomposed | no | uses rw, simp |
| `lean/AsiStackProofs/LearnedObjectiveIntegrity.lean` | `integrity_accepted_step_applies_event` | derived_or_decomposed | no | uses simp, split, unfold |
| `lean/AsiStackProofs/LearnedObjectiveIntegrity.lean` | `integrity_accepted_step_is_accepted` | derived_or_decomposed | no | uses simp, split, unfold |
| `lean/AsiStackProofs/LearnedObjectiveIntegrity.lean` | `integrity_accepted_step_preserves_full_identity` | derived_or_decomposed | no | uses rw |
| `lean/AsiStackProofs/LearnedObjectiveIntegrity.lean` | `integrity_accepted_step_preserves_invariant` | derived_or_decomposed | no | uses have, rw |
| `lean/AsiStackProofs/LearnedObjectiveIntegrity.lean` | `integrity_accepted_step_preserves_non_authority` | derived_or_decomposed | no | uses have, rw |
| `lean/AsiStackProofs/LearnedObjectiveIntegrity.lean` | `integrity_run_accounts_exact_receipts` | derived_or_decomposed | no | uses calc, cases, have, induction, omega, rw, simp, subst |
| `lean/AsiStackProofs/LearnedObjectiveIntegrity.lean` | `integrity_run_composes_across_event_batches` | derived_or_decomposed | no | uses cases, induction, simp |
| `lean/AsiStackProofs/LearnedObjectiveIntegrity.lean` | `integrity_run_handoff_count_monotone` | derived_or_decomposed | no | uses cases, have, induction, rw, simp, subst |
| `lean/AsiStackProofs/LearnedObjectiveIntegrity.lean` | `integrity_run_invalidation_count_monotone` | derived_or_decomposed | no | uses cases, have, induction, rw, simp, subst |
| `lean/AsiStackProofs/LearnedObjectiveIntegrity.lean` | `integrity_run_preserves_full_identity` | derived_or_decomposed | no | uses cases, have, induction, simp, subst |
| `lean/AsiStackProofs/LearnedObjectiveIntegrity.lean` | `integrity_run_preserves_invariant` | derived_or_decomposed | no | uses cases, have, induction, simp, subst |
| `lean/AsiStackProofs/LearnedObjectiveIntegrity.lean` | `integrity_successful_run_has_accepted_trace` | derived_or_decomposed | no | uses cases, have, induction, rw, simp |
| `lean/AsiStackProofs/LearnedObjectiveIntegrity.lean` | `invalidated_integrity_state_accepts_no_event` | derived_or_decomposed | no | uses by_cases, simp |
...
| `lean/AsiStackProofs/ModelWeightCustody.lean` | `accepted_weight_custody_event_preserves_descendant_key_inventory` | derived_or_decomposed | no | uses cases, have, simp, subst |
...
| `lean/AsiStackProofs/ModelWeightCustody.lean` | `complete_weight_custody_prefix_reaches_exact_observed_state` | unknown_or_mixed | no | no recognized depth pattern |
...
| `lean/AsiStackProofs/ModelWeightCustody.lean` | `erased_weight_custody_state_has_no_nonempty_run` | derived_or_decomposed | no | uses have, simp |
| `lean/AsiStackProofs/ModelWeightCustody.lean` | `erased_weight_custody_state_rejects_every_event` | derived_or_decomposed | no | uses cases, rcases, simp |
...
| `lean/AsiStackProofs/ModelWeightCustody.lean` | `no_exact_descendant_key_revocation_classifier_from_count_only` | derived_or_decomposed | no | uses have, rw |
| `lean/AsiStackProofs/ModelWeightCustody.lean` | `rejected_weight_custody_event_preserves_exact_state` | derived_or_decomposed | no | uses simp |
...
| `lean/AsiStackProofs/ModelWeightCustody.lean` | `successful_weight_custody_run_has_valid_trace` | derived_or_decomposed | no | uses cases, induction, simp |
...
| `lean/AsiStackProofs/ModelWeightCustody.lean` | `weight_custody_duplicate_descendant_key_inventory_is_rejected` | unknown_or_mixed | no | no recognized depth pattern |
...
| `lean/AsiStackProofs/ModelWeightCustody.lean` | `weight_custody_exact_inventory_separates_count_collision` | unknown_or_mixed | no | no recognized depth pattern |
...
| `lean/AsiStackProofs/ModelWeightCustody.lean` | `weight_custody_revocation_count_summary_collides` | unknown_or_mixed | no | no recognized depth pattern |
| `lean/AsiStackProofs/ModelWeightCustody.lean` | `weight_custody_run_preserves_descendant_key_inventory` | derived_or_decomposed | no | uses cases, have, induction, simp, subst |
...
| `lean/AsiStackProofs/ModelWeightCustody.lean` | `weight_custody_same_count_descendant_key_substitution_is_rejected` | unknown_or_mixed | no | no recognized depth pattern |
...
| `lean/AsiStackProofs/PlanForge.lean` | `complete_plan_graph_transport_is_injective` | derived_or_decomposed | no | uses calc, left, right |
| `lean/AsiStackProofs/PlanForge.lean` | `complete_plan_graph_transport_preserves_admission` | derived_or_decomposed | no | uses rw |
| `lean/AsiStackProofs/PlanForge.lean` | `complete_plan_graph_transport_round_trips` | derived_or_decomposed | no | uses cases |
| `lean/AsiStackProofs/PlanForge.lean` | `dependency_precedence_blocks_self_dependency` | derived_or_decomposed | no | uses rw, unfold |
| `lean/AsiStackProofs/PlanForge.lean` | `diamond_plan_graph_has_reachable_join` | derived_or_decomposed | no | uses simp |
| `lean/AsiStackProofs/PlanForge.lean` | `diamond_plan_graph_is_verified` | unknown_or_mixed | no | no recognized depth pattern |
...
| `lean/AsiStackProofs/PlanForge.lean` | `no_thin_plan_graph_classifier_recovers_both_decisions` | derived_or_decomposed | no | uses apply, by_cases, calc, have, right |
| `lean/AsiStackProofs/PlanForge.lean` | `out_of_bounds_graph_is_rejected` | unknown_or_mixed | no | no recognized depth pattern |
| `lean/AsiStackProofs/PlanForge.lean` | `reverse_dependency_graph_is_rejected` | unknown_or_mixed | no | no recognized depth pattern |
| `lean/AsiStackProofs/PlanForge.lean` | `self_dependency_graph_is_rejected` | unknown_or_mixed | no | no recognized depth pattern |
| `lean/AsiStackProofs/PlanForge.lean` | `thin_plan_graph_summary_has_admission_collision` | unknown_or_mixed | no | contains sorry/admit marker |
| `lean/AsiStackProofs/PlanForge.lean` | `verified_plan_graph_dependency_paths_strictly_increase` | derived_or_decomposed | no | uses induction |
| `lean/AsiStackProofs/PlanForge.lean` | `verified_plan_graph_excludes_dependency_cycles` | direct_or_projection | no | only direct intro/exact/assumption/rfl-style steps detected |
| `lean/AsiStackProofs/PlanForge.lean` | `verified_plan_graph_member_edge_is_bounded_and_ordered` | derived_or_decomposed | no | uses have, simp |
| `lean/AsiStackProofs/PlanForge.lean` | `verified_plan_graph_projects_to_legacy_dispatchable` | derived_or_decomposed | no | uses constructor |
| `lean/AsiStackProofs/PlanForge.lean` | `verified_plan_graph_routes_to_admission` | unknown_or_mixed | no | contains sorry/admit marker |
| `lean/AsiStackProofs/Planning.lean` | `accepted_graph_bound_admission_projects_to_legacy_dispatchable` | derived_or_decomposed | no | uses have |
| `lean/AsiStackProofs/Planning.lean` | `accepted_graph_bound_plan_admission_preserves_both_models` | derived_or_decomposed | no | uses rcases, simp, split, unfold |
...
| `lean/AsiStackProofs/Planning.lean` | `diamond_graph_bound_admission_reaches_admitted_state` | unknown_or_mixed | no | no recognized depth pattern |
...
| `lean/AsiStackProofs/Planning.lean` | `mismatched_graph_artifact_admission_is_rejected` | unknown_or_mixed | no | no recognized depth pattern |
...
| `lean/AsiStackProofs/Planning.lean` | `self_dependent_graph_bound_admission_is_rejected` | unknown_or_mixed | no | no recognized depth pattern |
...
| `lean/AsiStackProofs/PrivacyInformationFlow.lean` | `accepted_activation_requires_rights_disposition` | derived_or_decomposed | no | uses cases, have, simp |
| `lean/AsiStackProofs/PrivacyInformationFlow.lean` | `accepted_deletion_records_only_known_copy_disposition` | derived_or_decomposed | no | uses cases, have, rcases, simp, subst |
...
| `lean/AsiStackProofs/PrivacyInformationFlow.lean` | `accepted_revocation_zeros_information_authority` | derived_or_decomposed | no | uses have, simp, subst |
...
| `lean/AsiStackProofs/ProofCarryingContracts.lean` | `contract_transport_custody_transitive` | derived_or_decomposed | no | uses rcases, unfold |
...
| `lean/AsiStackProofs/ProofCarryingContracts.lean` | `contract_transport_step_preserves_custody` | direct_or_projection | no | only direct intro/exact/assumption/rfl-style steps detected |
...
| `lean/AsiStackProofs/ProofCarryingContracts.lean` | `contract_transport_step_preserves_invariant` | derived_or_decomposed | no | uses cases, simp, split |
...
| `lean/AsiStackProofs/ProofCarryingContracts.lean` | `independent_lineage_availability_survives_arbitrary_suffix` | derived_or_decomposed | no | uses induction |
| `lean/AsiStackProofs/ProofCarryingContracts.lean` | `independent_lineage_availability_survives_one_step` | derived_or_decomposed | no | uses cases, rcases, simp, split |
...
| `lean/AsiStackProofs/ProofCarryingContracts.lean` | `revoked_root_excludes_descendant_use_after_any_suffix` | derived_or_decomposed | no | uses have, simp |
...
| `lean/AsiStackProofs/ProofCarryingContracts.lean` | `root_lineage_containment_survives_arbitrary_suffix` | derived_or_decomposed | no | uses induction |
| `lean/AsiStackProofs/ProofCarryingContracts.lean` | `root_lineage_containment_survives_one_step` | derived_or_decomposed | no | uses cases, rcases, simp, split |
...
| `lean/AsiStackProofs/ProofCarryingContracts.lean` | `run_contract_transport_preserves_custody` | derived_or_decomposed | no | uses induction, simp |
| `lean/AsiStackProofs/ProofCarryingContracts.lean` | `run_contract_transport_preserves_invariant` | derived_or_decomposed | no | uses induction |
...
| `lean/AsiStackProofs/Replacement.lean` | `accepted_replacement_step_preserves_failure_containment` | derived_or_decomposed | no | uses cases, have, rcases, simp, subst |
...
| `lean/AsiStackProofs/Replacement.lean` | `accepted_replacement_step_preserves_state_invariant` | derived_or_decomposed | no | uses cases, have, rcases, simp, subst |
...
| `lean/AsiStackProofs/Replacement.lean` | `clean_replacement_run_satisfies_exact_commit_objective` | derived_or_decomposed | no | uses constructor |
...
| `lean/AsiStackProofs/Replacement.lean` | `failed_replacement_run_satisfies_exact_recovery_objective` | derived_or_decomposed | no | uses constructor |
...
| `lean/AsiStackProofs/Replacement.lean` | `replacement_initial_state_satisfies_invariant` | unknown_or_mixed | no | no recognized depth pattern |
...
| `lean/AsiStackProofs/Replacement.lean` | `successful_replacement_run_preserves_failure_containment` | derived_or_decomposed | no | uses cases, have, induction, simp, subst |
...
| `lean/AsiStackProofs/Replacement.lean` | `successful_replacement_run_preserves_state_invariant` | derived_or_decomposed | no | uses cases, have, induction, simp, subst |
...
| `lean/AsiStackProofs/Replacement.lean` | `successful_run_from_failed_monitor_cannot_activate_default` | derived_or_decomposed | no | uses have, simp |
...
| `lean/AsiStackProofs/SecurityKernel.lean` | `accepted_authority_transaction_event_preserves_descendant_inventory` | derived_or_decomposed | no | uses cases, have, simp, subst |
...
| `lean/AsiStackProofs/SecurityKernel.lean` | `authority_transaction_duplicate_descendant_inventory_is_rejected` | unknown_or_mixed | no | no recognized depth pattern |
| `lean/AsiStackProofs/SecurityKernel.lean` | `authority_transaction_exact_inventory_separates_count_collision` | unknown_or_mixed | no | no recognized depth pattern |
...
| `lean/AsiStackProofs/SecurityKernel.lean` | `authority_transaction_revocation_count_summary_collides` | unknown_or_mixed | no | no recognized depth pattern |
...
| `lean/AsiStackProofs/SecurityKernel.lean` | `authority_transaction_run_preserves_descendant_inventory` | derived_or_decomposed | no | uses cases, have, induction, simp, subst |
...
| `lean/AsiStackProofs/SecurityKernel.lean` | `authority_transaction_same_count_descendant_substitution_is_rejected` | unknown_or_mixed | no | no recognized depth pattern |
...
| `lean/AsiStackProofs/SecurityKernel.lean` | `complete_authority_transaction_prefix_reaches_exact_committed_state` | unknown_or_mixed | no | no recognized depth pattern |
...
| `lean/AsiStackProofs/SecurityKernel.lean` | `no_exact_revocation_admission_classifier_from_count_only` | derived_or_decomposed | no | uses have, rw |
| `lean/AsiStackProofs/SecurityKernel.lean` | `prompt_injection_records_leak_residual` | derived_or_decomposed | no | uses simp, unfold |
| `lean/AsiStackProofs/SecurityKernel.lean` | `rejected_authority_transaction_event_preserves_exact_state` | derived_or_decomposed | no | uses simp |
...
| `lean/AsiStackProofs/SecurityKernel.lean` | `revoked_authority_transaction_state_has_no_nonempty_run` | derived_or_decomposed | no | uses have, simp |
| `lean/AsiStackProofs/SecurityKernel.lean` | `revoked_authority_transaction_state_rejects_every_event` | derived_or_decomposed | no | uses cases, rcases, simp |
...
| `lean/AsiStackProofs/SecurityKernel.lean` | `successful_authority_transaction_run_has_valid_trace` | derived_or_decomposed | no | uses cases, induction, simp |
...
| `lean/AsiStackProofs/ValueConflict.lean` | `accepted_affected_party_appeal_has_recorded_standing` | derived_or_decomposed | yes | uses have, rcases, rw, simp, subst |
...
| `lean/AsiStackProofs/ValueConflict.lean` | `accepted_contestable_issue_rechecks_profile_and_bounds` | derived_or_decomposed | yes | uses have, rcases, rw, subst |
| `lean/AsiStackProofs/ValueConflict.lean` | `accepted_contestable_lease_event_is_admissible` | derived_or_decomposed | yes | uses simp, split, unfold |
| `lean/AsiStackProofs/ValueConflict.lean` | `accepted_contestable_lease_event_is_exact_advance` | derived_or_decomposed | yes | uses simp, split, unfold |
| `lean/AsiStackProofs/ValueConflict.lean` | `accepted_contestable_lease_event_is_non_authorizing` | derived_or_decomposed | yes | uses cases, have, rcases, simp, subst |
| `lean/AsiStackProofs/ValueConflict.lean` | `accepted_contestable_lease_event_never_widens_authority` | derived_or_decomposed | yes | uses cases, have, rcases, simp, subst |
| `lean/AsiStackProofs/ValueConflict.lean` | `accepted_contestable_lease_event_preserves_profile_custody` | derived_or_decomposed | yes | uses cases, have, simp, subst |
| `lean/AsiStackProofs/ValueConflict.lean` | `accepted_contestable_review_requires_complete_profile_and_separation` | derived_or_decomposed | yes | uses have, rcases, rw, subst |
...
| `lean/AsiStackProofs/ValueConflict.lean` | `accepted_profiled_lease_preserves_exact_stakeholder_and_dissent_custody` | derived_or_decomposed | yes | uses contradiction, have, simp, split, subst, unfold |
| `lean/AsiStackProofs/ValueConflict.lean` | `accepted_profiled_lease_request_is_admissible` | derived_or_decomposed | yes | uses simp, split, unfold |
...
| `lean/AsiStackProofs/ValueConflict.lean` | `accepted_sustained_appeal_has_independent_custody_and_adverse_record` | derived_or_decomposed | yes | uses have, rcases, rw, simp, subst |
...
| `lean/AsiStackProofs/ValueConflict.lean` | `aggregate_collision_has_equal_support_count` | unknown_or_mixed | yes | no recognized depth pattern |
| `lean/AsiStackProofs/ValueConflict.lean` | `aggregate_collision_profiles_are_distinct` | unknown_or_mixed | yes | no recognized depth pattern |
| `lean/AsiStackProofs/ValueConflict.lean` | `aggregate_equivalent_dissent_substitution_is_rejected` | unknown_or_mixed | yes | no recognized depth pattern |
...
| `lean/AsiStackProofs/ValueConflict.lean` | `complete_contestable_lease_trace_reaches_exact_expiry` | unknown_or_mixed | yes | no recognized depth pattern |
...
| `lean/AsiStackProofs/ValueConflict.lean` | `contestable_action_authority_request_is_rejected` | unknown_or_mixed | yes | no recognized depth pattern |
| `lean/AsiStackProofs/ValueConflict.lean` | `contestable_appeal_authority_widening_is_rejected` | unknown_or_mixed | yes | no recognized depth pattern |
| `lean/AsiStackProofs/ValueConflict.lean` | `contestable_appellant_self_review_is_rejected` | unknown_or_mixed | yes | no recognized depth pattern |
| `lean/AsiStackProofs/ValueConflict.lean` | `contestable_captured_appeal_review_is_rejected` | unknown_or_mixed | yes | no recognized depth pattern |
| `lean/AsiStackProofs/ValueConflict.lean` | `contestable_dissent_substitution_is_rejected` | unknown_or_mixed | yes | no recognized depth pattern |
| `lean/AsiStackProofs/ValueConflict.lean` | `contestable_forged_self_reviewed_state_is_rejected` | unknown_or_mixed | yes | no recognized depth pattern |
| `lean/AsiStackProofs/ValueConflict.lean` | `contestable_lease_run_preserves_profile_non_authority_narrowing_and_history` | derived_or_decomposed | yes | uses cases, have, induction, rcases, simp, subst |
| `lean/AsiStackProofs/ValueConflict.lean` | `contestable_lease_runs_compose` | derived_or_decomposed | yes | uses cases, induction, simp |
| `lean/AsiStackProofs/ValueConflict.lean` | `contestable_moral_settlement_request_is_rejected` | unknown_or_mixed | yes | no recognized depth pattern |
| `lean/AsiStackProofs/ValueConflict.lean` | `contestable_open_appeal_expiry_is_rejected` | unknown_or_mixed | yes | no recognized depth pattern |
| `lean/AsiStackProofs/ValueConflict.lean` | `contestable_outsider_appeal_is_rejected` | unknown_or_mixed | yes | no recognized depth pattern |
| `lean/AsiStackProofs/ValueConflict.lean` | `contestable_scalar_equivalent_profile_substitution_is_rejected` | unknown_or_mixed | yes | no recognized depth pattern |
| `lean/AsiStackProofs/ValueConflict.lean` | `contestable_support_count_substitution_is_rejected` | unknown_or_mixed | yes | no recognized depth pattern |
| `lean/AsiStackProofs/ValueConflict.lean` | `contestable_unrecorded_standing_appeal_is_rejected` | unknown_or_mixed | yes | no recognized depth pattern |
| `lean/AsiStackProofs/ValueConflict.lean` | `expired_contestable_lease_is_terminal` | derived_or_decomposed | yes | uses cases, simp, unfold |
...
| `lean/AsiStackProofs/ValueConflict.lean` | `missing_stakeholder_standing_is_rejected_even_with_matching_count` | direct_or_projection | yes | only direct intro/exact/assumption/rfl-style steps detected |
...
| `lean/AsiStackProofs/ValueConflict.lean` | `no_scalar_decoder_recovers_every_stakeholder_profile` | derived_or_decomposed | yes | uses apply, have, left, right, rw |
| `lean/AsiStackProofs/ValueConflict.lean` | `open_contestable_appeal_cannot_expire` | derived_or_decomposed | yes | uses simp, unfold |
| `lean/AsiStackProofs/ValueConflict.lean` | `scalar_support_count_is_not_injective` | derived_or_decomposed | yes | uses apply |
...
| `lean/AsiStackProofs/ValueConflict.lean` | `valid_profiled_lease_issues_exact_receipt` | unknown_or_mixed | yes | no recognized depth pattern |
...
| `lean/AsiStackProofs/ValueConflict.lean` | `value_lease_revisit_without_trigger_is_rejected` | direct_or_projection | yes | only direct intro/exact/assumption/rfl-style steps detected |
...
- lean/AsiStackProofs/Alignment.lean has 3 direct/projection-style theorem(s) and must remain explicitly scoped.
