...
| Metric | Value |
|---|---:|
| Proof targets in manifest | 195 |
| Lean modules scanned | 54 |
| Theorem declarations classified | 986 |
| Direct/projection-style theorem declarations | 183 |
| Derived/decomposed theorem declarations | 799 |
...
| `lean/AsiStackProofs/ArtifactGraph.lean` | artifact-graphs-audit-logs-and-replay | 6 | 36 | 2 | 34 | 0 | mixed: preserve limitation prose and prioritize projection replacements |
