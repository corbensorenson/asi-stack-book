...
| `docs/reader_format_dry_run.md` | Local Phase 8 HTML/EPUB/DOCX reader-format dry-run summary, artifact snapshot paths, review status, and non-release boundary. | tracked |
