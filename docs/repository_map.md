...
| `appendices/` | Generated and curated appendices: source matrix, glossary, claims, schemas, tests, changelog, Corben's sources/papers/local projects, external sources and third-party literature, author-intent lineage, release editions, and implementation horizons. | tracked |
