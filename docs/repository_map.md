...
| `docs/evidence_transition_pilot.md` | Phase 3 evidence-transition summary, recording twenty-six no-change support-state decisions plus the separate bounded registry-runner transition. | tracked |
| `docs/first_measured_replayed_slice.md` | First accepted measured/replayed slice: a narrow `synthetic-test-backed` repository-infrastructure transition for the Phase 5 harness registry runner, with non-claims. | tracked |
...
| `evidence_transitions/v1_0_measured/` | Accepted bounded measured/replayed evidence-transition records; currently limited to the Phase 5 registry-runner infrastructure claim. | tracked |
