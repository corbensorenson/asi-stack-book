...
| Governed visual edition | `visual_edition/` | Track Manim scene source, visual grammar, storyboards, narration, reviewed captions, descriptive transcripts, thumbnails, manifests, the canonical YouTube channel contract, the generated 84-chapter publication/revision ledger, and exact render/platform receipts. Keep rendered video, narration audio, partial frames, and Manim caches in ignored `build/`; YouTube owns published binaries. |
