...
| `docs/per_chapter_evidence_plan.md` | 45-chapter evidence-lane backlog for selecting a small high-payoff v1.x execution set without triggering another shallow breadth sweep. | tracked |
| `docs/v1_x_active_evidence_cycle.md` | Active v1.x evidence-cycle ledger naming the seven selected high-payoff lanes, the thirty-eight planned-only lanes, and the no-chapter-core-promotion boundary. | tracked |
...
| `docs/chapter_external_grounding_status.md` | Generated 45-chapter status ledger tying each chapter to source-noted external comparators, explicit exceptions, and Corben/local sources to mine before broad literature search. | tracked |
...
| `docs/reader_chapter_review_matrix.md` | Generated public summary of the manifest-synced 45-chapter human-reader review queue, overlay dispositions, and release blockers. | tracked |
...
| `docs/core_claim_transition_coverage.md` | Generated Phase 3 coverage report proving all 45 chapter core claims have either an accepted transition record or an accepted no-promotion decision. | tracked |
...
| `scripts/validate_chapter_consolidation_sequence.py` | Validator for the full governed consolidation sequence, public-surface references, no-promotion boundary, and current 45-chapter manifest after executed merges and folds. | tracked |
