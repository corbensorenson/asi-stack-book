...
| `appendices/` | Generated and curated appendices: source matrix, glossary, claims, schemas, tests, changelog, Corben-authored/supplied/local sources, external literature, author-intent lineage, release editions, and implementation horizons. | tracked |
