...
| `docs/evidence_transition_pilot.md` | Phase 3 evidence-transition pilot summary, recording twenty no-change support-state decisions and their blockers. | tracked |
