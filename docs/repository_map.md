...
- Edit `editions/reader_manuscript/v1_0/manifest.json`, `editions/reader_manuscript/v1_0/curation_contract.json`, `editions/reader_manuscript/v1_0/artifact_inspection_manifest.json`, `editions/reader_manuscript/v1_0/pdf_probe_manifest.json`, or `editions/reader_manuscript/v1_0/companion_note_routing.json` only when reader-manuscript status, curated-source policy, artifact-inspection evidence, PDF probe evidence, or companion-note routing changes, then run `python3 scripts/validate_reader_manuscript_manifest.py`, `python3 scripts/validate_reader_artifact_inspection_manifest.py`, and `python3 scripts/validate_reader_pdf_probe_manifest.py` as applicable.
