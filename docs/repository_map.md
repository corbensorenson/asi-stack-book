...
| `appendices/` | Generated and curated appendices: source matrix, glossary, claims, schemas, tests, changelog, the Corben source corpus, external literature, author-intent lineage, release editions, and implementation horizons. | tracked |
