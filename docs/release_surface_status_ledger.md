...
- `docs/reader_audio_script_probe_manifest.md` records 49 audio-script workspace files and routes 10 draft key-figure spoken summaries into the generated audio companion workspace; target artifact states remain audio-embedded-epub: target_not_generated, m4b: target_not_generated, mp3: target_not_generated.
