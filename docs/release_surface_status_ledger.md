...
- `docs/curated_reader_format_artifact_probe.md` records the tracked curated-reader structural probe: 49 HTML files, 52 EPUB XHTML entries, 61 DOCX PNG media entries, 0 DOCX SVG media entries, and 505 PDF pages. Its repaired-package EPUB audit checks 52 XHTML entries, 49 packaged content XHTML entries, and 0 unresolved internal hrefs, with repaired artifact SHA `2828f90c6a4298118b8b3af0508d01783aaa84c28558401f7fbc32af28cb9b1a`. Its repaired-package DOCX audit checks 17354 paragraphs, 286 relationships, and 0 raw .qmd relationship targets, with repaired artifact SHA `bd1db6539c998bbf8f8a10921ded35e889aaf57ce0f8d56874172d5ef41cd1e6`. Its all-page PDF raster audit checks 505 pages, 0 blank pages, 0 low-ink pages, and 0 near-edge pages. It preserves release blockers.
