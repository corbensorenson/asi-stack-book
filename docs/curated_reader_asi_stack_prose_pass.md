...
- Reworked the opening into a clearer first encounter with the book's core
  object: ASI as a governed stack rather than a single model.
- Replaced the generated reader baseline's stale external-baseline exception
  language with the live chapter's current comparator boundary: MRKL systems,
  LLM-agent surveys, cognitive-architecture lineage, and layered robot-control
  work are positioning comparators, not validation.
...
| Check | Result |
|---|---|
| Core claim meaning preserved | Pass. The curated draft keeps the governed-stack-over-monolith claim. |
