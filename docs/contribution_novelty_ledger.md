...
| Pattern language for governed cognition | `pattern_local_delta_partially_integrated_not_novelty_proven` | `ext_model_cards_2019`; `ext_datasheets_datasets_2021`; `ext_factsheets_ai_services_2019`; `ext_nist_ai_rmf_1_0_2023`; `ext_frontier_ai_regulation_2023` | Turns authority ceilings, claim movement, belief continuity, artifact reality, effect leases, routability, evidence receipts, residual custody, and rollback into a reusable systems pattern instead of separate reporting practices; the opener now names it, Integrated Reference Architecture applies it at trace scale, Living Book Methodology applies it to book changes, and the first control-boundary slice assigns local deltas to six non-owner chapters. | Continue the broader inline local-delta pass through remaining non-owner planning, context, routing, compression, and self-improvement chapters; no standalone audit report by default. |
