...
| Pattern language for governed cognition | `needs_delta_audit` | `ext_model_cards_2019`; `ext_datasheets_datasets_2021`; `ext_factsheets_ai_services_2019`; `ext_nist_ai_rmf_1_0_2023`; `ext_frontier_ai_regulation_2023` | Turns claim movement, authority, artifacts, receipts, and rollback into a reusable systems pattern instead of separate reporting practices. | Inline chapter pattern-delta pass through existing chapter prose, outline, and ledger rows; no standalone audit report by default. |
