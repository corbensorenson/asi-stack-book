...
| Record-reality gap | `randomized_artifact_attestation_backed_not_open_world` | `ext_proof_carrying_code_1997`; `ext_ai_safety_debate_2018`; `ext_llm_as_judge_mt_bench_2023`; `ext_model_evaluation_extreme_risks_2023`; `ext_nist_zero_trust_architecture_2020` | Treats receipt faithfulness and the epistemic trusted computing base as first-class architecture problems: records must correspond to reality, and verifier trust must bottom out in named roots rather than ambient confidence. Current bounded backing state: `repository_receipt_audit_backed_not_open_world`, `repository_receipt_challenge_backed_not_open_world`, `live_artifact_attestation_backed_not_open_world`, and `randomized_artifact_attestation_backed_not_open_world`. The first bounded receipt fixture exists at `experiments/receipt_faithfulness/results/2026-07-03-local.json`, the first repository receipt audit exists at `experiments/receipt_repository_audit/results/2026-07-03-local.json`, the deterministic repository challenge exists at `experiments/receipt_repository_audit/results/2026-07-04-challenge.json`, the local live artifact attestation probe exists at `experiments/artifact_live_attestation/results/2026-07-04-local.json`, the deterministic pseudo-random multi-artifact audit exists at `experiments/artifact_randomized_attestation/results/2026-07-04-local.json`, the first bounded epistemic trusted computing base fixture exists at `experiments/epistemic_tcb/results/2026-07-03-local.json`, and the 2026-07-04 Artifact Graphs owner-section pass now states the record-reality objection, bounded answer, weakening condition, and no-deployed-faithfulness boundary in live and curated reader prose. | Deployed or externally reviewable attestation/audit, verifier-quality evidence, trust-base storage/replay evidence, or a randomized/external challenge outside this local repository; no standalone chapter unless later evidence makes the owner section duplicative or too narrow; explicit boundary that current fixtures, repository audit, deterministic challenge, live artifact attestation probe, randomized artifact attestation audit, and owner-section prose do not prove open-world receipt faithfulness, verifier correctness, external project truth, deployed attestation behavior, or deployed trust-base behavior. |
