...
epistemic trusted computing base fixtures plus an Artifact Graphs owner-section
treatment in both live and curated reader prose, but still needs live or
externally reviewable attestation, audit, trust-base storage/replay, and
verifier-quality evidence before the book can claim a complete answer to record
or verifier-trust laundering.
