...
pushed, built, and deployed ancestral
...
4. **Book slot — W3:** freeze the then-current 61-chapter baseline, centralize shared method
...
6. **Book slot — R16-B:** build and validate the combined then-current 61-chapter
