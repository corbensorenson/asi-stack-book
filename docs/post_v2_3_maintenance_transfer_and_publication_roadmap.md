...
`proofs/proof_semantic_depth_overlay.json` classifies 1,515 live theorem
declarations across 118 theorem-bearing modules and maps them to 72 active
semantic-owner chapters. The 296 added declarations are bound to the
...
The live semantic-depth distribution is 26 P0 record-shape results, 760 P1
finite-route results, 106 P2 reachability/nonvacuity results, 379 P3
...
1,460 retain, zero retire as narrow projection, zero pending scope-language
rewrites, and zero stronger-model actions remaining. All 1,460 rows have
...
the later 241 theorems are additive consumer-owned formal expansion, not
