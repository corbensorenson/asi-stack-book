...
EM0 and EM1 are complete. The first EM2 package is also complete as a
no-cutover method-detail pilot: Resource Economics now composes Fast Generation
and Governed Deliberation as separately owned allocation offers, while Compact
Generative Systems composes RankFold/NeuralFold as a separately owned technical
method family. All three child routes, local claims, sources, proofs, tests,
evidence ceilings, and URLs remain intact. The remaining twelve publication
nests, Improvement/Stewardship package, and semantic-merge candidate are open.
EM3 drafting has begun in the separately maintained Human Reader source:
Unit 23, Generative Compression and Cognitive Resource Economics, is at 5,508
visible words inside its 5,500-7,500 target. The other 25 units remain openly
`not_started`; target length is not editorial approval or release.
...
| Editorial product migration and independent human narrative — active book packet | `P7.1-EM-87-identity-56-reference-26-unit-editorial-migration` | EM0 and EM1 are complete. The first EM2 package composes the two method-detail nests plus Governed Deliberation into Resource Economics and Compact Generative Systems while retaining three stable technical routes, local ownership, support ceilings, and URLs. EM3 Unit 23 is independently authored at 5,508 words inside its target; 25 units remain not started. The exact 54+2/15+2+1/7/5/1 split and 26 owner routes remain validated; no public cutover or release occurred. | Continue EM2–EM4 with the remaining twelve publication nests, Improvement/Stewardship package, one gated semantic-merge candidate, and 25 independent Human Reader units. Preserve major conclusions and every technical identity without reproducing local status administration. Defer the primer and major release formats until content freeze. |
...
| M7 — Editorial product migration, independent narrative, and derivative disposition | in progress; EM0-EM1 complete | Preserve `reader-2026-07-18`, the 84-chapter virtual derivative, and the current 22-unit candidate as immutable historical receipts while maintaining all 87 research identities. EM0 manifest-derived count truth and EM1 exact metadata-first 54+2/15+2+1/7/5/1 disposition are complete with a generated no-cutover preview. Complete EM2-EM4: evidence-preserving publication nests, method-detail nests, one gated semantic merge candidate, redirects, and an independently maintained 26-unit, 131,000-180,000-word human manuscript with conclusion/claim crosswalk; retain the fifteen-minute utility route, three runnable task recipes, optional-depth marking, and unit-level use/avoid/conclusion-change guidance. Defer the primer and full EPUB/PDF/DOCX/audio build until major-version content freeze. P7.3 remains separately owned and cannot substitute for or block narrative completion. |
