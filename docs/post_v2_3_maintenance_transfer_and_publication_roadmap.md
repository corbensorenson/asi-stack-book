...
EM0 and EM1 are complete. Three EM2 packages are complete without public
...
owner. All eight nested routes retain local claims, sources, proofs, tests,
evidence ceilings, IDs, and URLs. Seven ordinary publication nests, the
two-owner Improvement/Stewardship package, and the semantic-merge candidate
remain open. EM3 drafting has three maintained Human Reader units at target
length: Unit 4 is 5,650 words, Unit 5 is 5,553, and Unit 23 is 5,508, for
16,711 visible words. The other 23 units remain openly `not_started`; target length is not
...
| Editorial product migration and independent human narrative — active book packet | `P7.1-EM-87-identity-56-reference-26-unit-editorial-migration` | EM0 and EM1 are complete. Three no-cutover EM2 packages compose eight technical-detail routes into six primary owners while preserving stable routes, local ownership, support ceilings, and URLs. EM3 Units 4, 5, and 23 are independently authored at 5,650, 5,553, and 5,508 words inside their targets; 23 units remain not started. The exact 54+2/15+2+1/7/5/1 split and 26 owner routes remain validated; no public cutover or release occurred. | Continue EM2–EM4 with seven ordinary publication nests, the two-owner Improvement/Stewardship package, one gated semantic-merge candidate, and 23 independent Human Reader units. Preserve major conclusions and every technical identity without reproducing local status administration. Defer the primer and major release formats until content freeze. |
...
| M7 — Editorial product migration, independent narrative, and derivative disposition | in progress; EM0-EM1 and three EM2 packages complete | Preserve `reader-2026-07-18`, the 84-chapter virtual derivative, and the current 22-unit candidate as immutable historical receipts while maintaining all 87 research identities. EM0 manifest-derived count truth, EM1 exact metadata-first 54+2/15+2+1/7/5/1 disposition, three no-cutover EM2 composition packages, and three target-length EM3 units are complete. Finish EM2-EM4: the remaining publication nests, one gated semantic merge candidate, redirects, and an independently maintained 26-unit, 131,000-180,000-word human manuscript with conclusion/claim crosswalk; retain the fifteen-minute utility route, three runnable task recipes, optional-depth marking, and unit-level use/avoid/conclusion-change guidance. Defer the primer and full EPUB/PDF/DOCX/audio build until major-version content freeze. P7.3 remains separately owned and cannot substitute for or block narrative completion. |
