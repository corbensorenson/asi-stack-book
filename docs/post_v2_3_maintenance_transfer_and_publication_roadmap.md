...
| Editorial product migration and independent human narrative — active book packet | `P7.1-EM-87-identity-56-reference-26-unit-editorial-migration` | EM0 and EM1 are complete: active narrative products use manifest-derived count language, all 87 owners carry canonical role/parent/legacy-route metadata, the exact 54+2/15+2+1/7/5/1 split and 26 owner routes are validated, and the generated preview changes no prose, support, release, or public route. The historical 22-unit candidate remains current custody pending cutover. | Continue with EM2–EM4: compose 15 publication nests and two method-detail nests without transferring technical ownership or support, execute the one semantic merge candidate only after its full gate, and write the 120,000–180,000-word 26-unit human source around one continuing repository-change trace. Preserve major conclusions and every technical identity without reproducing local status administration. Defer the primer and major release formats until content freeze. |
