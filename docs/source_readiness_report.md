...
|---|---|---:|---:|---|---|
| `viea` | Verified Intent-to-Execution Architecture | `cached_existing` | 211471 | sources/raw/google_docs/viea.txt |  |
| `scf` | Stable Capability Fields | `cached_existing` | 215254 | sources/raw/google_docs/scf.txt |  |
| `planforge` | PlanForge | `cached_existing` | 49857 | sources/raw/google_docs/planforge.txt |  |
...
| `benchmaxxing` | Benchmaxxing: The Performance Ratchet | `cached_existing` | 51787 | sources/raw/google_docs/benchmaxxing.txt |  |
| `cgs` | Compact Generative Systems | `cached_existing` | 60191 | sources/raw/google_docs/cgs.txt |  |
| `rgs` | Ratcheting Generative Systems | `cached_existing` | 58010 | sources/raw/google_docs/rgs.txt |  |
| `rankfold_neuralfold` | RankFold + NeuralFold | `cached_existing` | 108056 | sources/raw/google_docs/rankfold_neuralfold.txt |  |
| `rankfold_compressor` | rankFold compressor | `cached_existing` | 185058 | sources/raw/google_docs/rankfold_compressor.txt |  |
| `bbvca_v9` | BBVCA_v9_final_public_release | `cached_existing` | 71278 | sources/raw/google_docs/bbvca_v9.txt |  |
| `bbvca_main` | Big Bang Volumetric Compression Architecture | `cached_existing` | 416925 | sources/raw/google_docs/bbvca_main.txt |  |
...
| `aletheia` | Aletheia Foundry | `cached_existing` | 91713 | sources/raw/google_docs/aletheia.txt |  |
| `context_engineer` | Context Engineer / Manhattan Protocol | `cached_existing` | 18556 | sources/raw/google_docs/context_engineer.txt |  |
| `black_hole_context_manager` | Black Hole Context Manager | `cached_existing` | 19880 | sources/raw/google_docs/black_hole_context_manager.txt |  |
| `ladon_manhattan` | Ladon & The Manhattan Protocol | `cached_existing` | 8945 | sources/raw/google_docs/ladon_manhattan.txt |  |
