...
| `lean/AsiStackProofs/Alignment.lean` | 2 | 73 | 0 | 38 | 10 |
...
| `lean/AsiStackProofs/BenchmarkRatchets.lean` | 3 | 29 | 0 | 19 | 5 |
...
| `lean/AsiStackProofs/CognitiveCompilationRefinement.lean` | 3 | 33 | 0 | 23 | 2 |
| `lean/AsiStackProofs/CoilAttentionMemory.lean` | 3 | 34 | 0 | 19 | 6 |
...
| `lean/AsiStackProofs/CompactGenerationRefinement.lean` | 9 | 35 | 0 | 15 | 4 |
...
| `lean/AsiStackProofs/ContextTransactionRefinement.lean` | 4 | 35 | 0 | 21 | 2 |
| `lean/AsiStackProofs/Corrigibility.lean` | 1 | 24 | 0 | 17 | 4 |
| `lean/AsiStackProofs/CyclicMixers.lean` | 2 | 23 | 0 | 15 | 6 |
...
| `lean/AsiStackProofs/EmbodiedPhysicalSafety.lean` | 1 | 41 | 0 | 26 | 5 |
...
| `lean/AsiStackProofs/FailureRecoveryRefinement.lean` | 1 | 44 | 0 | 19 | 5 |
...
| `lean/AsiStackProofs/HiveLifecycleRefinement.lean` | 6 | 31 | 0 | 14 | 4 |
| `lean/AsiStackProofs/HumanAICognitiveSovereignty.lean` | 1 | 48 | 0 | 30 | 8 |
| `lean/AsiStackProofs/HumanAIOrganizations.lean` | 1 | 62 | 0 | 30 | 9 |
...
| `lean/AsiStackProofs/LearnedObjectiveIntegrity.lean` | 2 | 34 | 0 | 20 | 6 |
| `lean/AsiStackProofs/LearningTheoryForecastReview.lean` | 1 | 38 | 0 | 29 | 8 |
| `lean/AsiStackProofs/LivingBook.lean` | 4 | 39 | 0 | 22 | 9 |
| `lean/AsiStackProofs/MilitaryInteractionReview.lean` | 1 | 24 | 0 | 31 | 3 |
| `lean/AsiStackProofs/ModelWeightCustody.lean` | 8 | 45 | 0 | 20 | 4 |
| `lean/AsiStackProofs/MultiAgentDynamics.lean` | 1 | 38 | 0 | 25 | 3 |
| `lean/AsiStackProofs/ObjectiveLeaseGovernance.lean` | 1 | 27 | 0 | 31 | 7 |
| `lean/AsiStackProofs/ObservationTrust.lean` | 2 | 32 | 0 | 25 | 6 |
...
| `lean/AsiStackProofs/PrivacyInformationFlow.lean` | 2 | 38 | 0 | 21 | 4 |
...
| `lean/AsiStackProofs/Replacement.lean` | 6 | 60 | 0 | 25 | 9 |
...
| `lean/AsiStackProofs/SecurityKernel.lean` | 4 | 56 | 0 | 24 | 6 |
...
| `lean/AsiStackProofs/StackBoundaries.lean` | 3 | 34 | 0 | 22 | 8 |
| `lean/AsiStackProofs/SupplyChainIntegrity.lean` | 6 | 34 | 0 | 19 | 4 |
...
| `moral-uncertainty-and-value-conflict` | 8 | 8 | 0 | 0 |
...
| `lean:authority.lifecycle.admission_route` | `system-boundaries-and-authority` | `AsiStackProofs.AuthorityEffectRefinement` | triage ok; module ok; chapter tag ok; limitation ok |
| `lean:authority.revocation.trace_surface_bridge` | `system-boundaries-and-authority` | `AsiStackProofs.AuthorityEffectRefinement` | triage ok; module ok; chapter tag ok; limitation ok |
...
| `lean:societal-resilience-and-misuse-defense.admission_boundary` | `societal-resilience-and-misuse-defense` | `AsiStackProofs.SocietalResilienceReview` | triage ok; module ok; chapter tag ok; limitation ok |
...
| `lean:coil_memory.versioned_freshness_and_recurrence.lifecycle` | `coil-attention-cyclic-memory-and-recurrence-contracts` | `AsiStackProofs.CoilAttentionMemory` | triage ok; module ok; chapter tag ok; limitation ok |
