...
| Metric | Value |
|---|---:|
| Proof targets audited | 190 |
| Manifest status counts | {"implemented": 190} |
| Triage class counts | {"formal-invariant": 190} |
...
| `lean/AsiStackProofs/ArtifactGraph.lean` | 6 | 36 | 14 | 7 |
...
|---|---:|---:|---:|---:|
| `artifact-graphs-audit-logs-and-replay` | 6 | 6 | 0 | 0 |
