...
|---|---:|---:|---:|---:|
| `lean/AsiStackProofs/Alignment.lean` | 2 | 2 | 2 | 2 |
...
| `lean/AsiStackProofs/Corrigibility.lean` | 2 | 2 | 2 | 2 |
| `lean/AsiStackProofs/CyclicMixers.lean` | 2 | 2 | 2 | 2 |
| `lean/AsiStackProofs/Efficiency.lean` | 2 | 2 | 3 | 2 |
| `lean/AsiStackProofs/EvidenceStates.lean` | 2 | 4 | 3 | 1 |
...
| `lean/AsiStackProofs/GovernanceRights.lean` | 2 | 2 | 2 | 2 |
| `lean/AsiStackProofs/IntentContracts.lean` | 2 | 2 | 2 | 2 |
| `lean/AsiStackProofs/IntentToExecution.lean` | 2 | 2 | 2 | 2 |
| `lean/AsiStackProofs/LivingBook.lean` | 2 | 2 | 2 | 2 |
| `lean/AsiStackProofs/MoECOTRuntime.lean` | 2 | 2 | 2 | 2 |
| `lean/AsiStackProofs/PersonalComputeHives.lean` | 4 | 4 | 4 | 4 |
| `lean/AsiStackProofs/PlanForge.lean` | 2 | 4 | 4 | 3 |
| `lean/AsiStackProofs/Planning.lean` | 2 | 2 | 3 | 2 |
| `lean/AsiStackProofs/PolicyOptimization.lean` | 2 | 2 | 2 | 2 |
| `lean/AsiStackProofs/ProceduralMemory.lean` | 2 | 2 | 2 | 2 |
| `lean/AsiStackProofs/ProofCarryingClaims.lean` | 2 | 2 | 2 | 2 |
...
| `lean/AsiStackProofs/ReferenceArchitecture.lean` | 2 | 2 | 2 | 2 |
| `lean/AsiStackProofs/Replacement.lean` | 2 | 2 | 2 | 1 |
...
| `lean/AsiStackProofs/ValueConflict.lean` | 2 | 2 | 2 | 2 |
...
| `capability-replacement-and-rollback` | 2 | 2 | 0 | 0 |
...
| `planning-as-a-control-layer` | 2 | 2 | 0 | 0 |
...
| `lean:command.semantic_interface.operational_invariant` | `command-contracts-and-semantic-interfaces` | `AsiStackProofs.CommandContracts` | triage ok; module ok; chapter tag ok; limitation ok |
| `lean:command.semantic_interface.failure_blocks_promotion` | `command-contracts-and-semantic-interfaces` | `AsiStackProofs.CommandContracts` | triage ok; module ok; chapter tag ok; limitation ok |
...
| `lean:planforge.dag.operational_invariant` | `planforge-dags-and-intelligence-arbitrage` | `AsiStackProofs.PlanForge` | triage ok; module ok; chapter tag ok; limitation ok |
| `lean:planforge.dag.failure_blocks_promotion` | `planforge-dags-and-intelligence-arbitrage` | `AsiStackProofs.PlanForge` | triage ok; module ok; chapter tag ok; limitation ok |
...
| `lean:tribunal.review.operational_invariant` | `unified-adaptive-tribunal-and-adversarial-review` | `AsiStackProofs.Tribunal` | triage ok; module ok; chapter tag ok; limitation ok |
| `lean:tribunal.review.failure_blocks_promotion` | `unified-adaptive-tribunal-and-adversarial-review` | `AsiStackProofs.Tribunal` | triage ok; module ok; chapter tag ok; limitation ok |
