...
| Metric | Value |
|---|---:|
| Proof targets audited | 177 |
| Manifest status counts | {"implemented": 177} |
| Triage class counts | {"formal-invariant": 177} |
...
| `lean/AsiStackProofs/RuntimeAdapters.lean` | 4 | 40 | 10 | 7 |
...
| `lean/AsiStackProofs/TheseusReference.lean` | 3 | 11 | 8 | 6 |
...
| `runtime-adapters-tool-permissions-and-human-approval` | 4 | 4 | 0 | 0 |
