...
| Metric | Value |
|---|---:|
| Proof targets audited | 172 |
| Manifest status counts | {"implemented": 172} |
| Triage class counts | {"formal-invariant": 172} |
...
| `capability-replacement-and-rollback` | 4 | 4 | 0 | 0 |
...
| `planning-as-a-control-layer` | 6 | 6 | 0 | 0 |
