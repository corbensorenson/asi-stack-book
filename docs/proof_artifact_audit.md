...
| Metric | Value |
|---|---:|
| Proof targets audited | 199 |
| Manifest status counts | {"implemented": 199} |
| Triage class counts | {"formal-invariant": 199} |
...
| `lean/AsiStackProofs/ArtifactGraph.lean` | 9 | 42 | 21 | 11 |
...
|---|---:|---:|---:|---:|
| `artifact-graphs-audit-logs-and-replay` | 9 | 9 | 0 | 0 |
