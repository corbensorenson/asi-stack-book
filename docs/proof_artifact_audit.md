...
| Metric | Value |
|---|---:|
| Proof targets audited | 196 |
| Manifest status counts | {"implemented": 196} |
| Triage class counts | {"formal-invariant": 196} |
...
| `lean/AsiStackProofs/ArtifactGraph.lean` | 7 | 37 | 16 | 8 |
...
|---|---:|---:|---:|---:|
| `artifact-graphs-audit-logs-and-replay` | 7 | 7 | 0 | 0 |
