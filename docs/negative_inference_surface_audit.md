# Negative-Inference Surface Audit

Date: 2026-07-17

This current-prose audit covers 100 reader-facing
surfaces, including all 80 live chapters. It
...
- Accepted historical transition ceilings: 1 N0, 15 N1,
  74 N2, 0 N3, 0 N4, and 0 N5.
- Forbidden overbroad current phrases: 0.
- Missing named rehabilitation boundaries: 0.
- Live chapters that use `blocked_after_full_attempt` without also calling the
  ...
  0.
- Broad negative inferences retained: 0.
- Chapter-core refutations retained: 0.
