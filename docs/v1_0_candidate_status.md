...
| Manuscript scale | 54 chapter files; 178,178 chapter words excluding YAML front matter; 185,677 raw chapter-file words including metadata and live scaffolding | Local word-count check on `chapters/*.qmd` |
