...
| Manuscript scale | 44 chapter files; 207,661 chapter words excluding YAML front matter; 218,086 raw chapter-file words including metadata and live scaffolding | Local word-count check on `chapters/*.qmd` |
