...
| Manuscript scale | 54 chapter files; 169,288 chapter words excluding YAML front matter; 176,787 raw chapter-file words including metadata and live scaffolding | Local word-count check on `chapters/*.qmd` |
