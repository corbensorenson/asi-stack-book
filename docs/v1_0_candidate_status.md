...
| Manuscript scale | 44 chapter files; 205,471 chapter words excluding YAML front matter; 215,474 raw chapter-file words including metadata and live scaffolding | Local word-count check on `chapters/*.qmd` |
