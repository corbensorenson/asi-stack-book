...
| Manuscript scale | 54 chapter files; 174,703 chapter words excluding YAML front matter; 182,202 raw chapter-file words including metadata and live scaffolding | Local word-count check on `chapters/*.qmd` |
