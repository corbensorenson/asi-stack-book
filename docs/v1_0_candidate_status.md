...
| Manuscript scale | 44 chapter files; 204,949 chapter words excluding YAML front matter; 214,952 raw chapter-file words including metadata and live scaffolding | Local word-count check on `chapters/*.qmd` |
