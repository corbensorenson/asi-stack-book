...
| Manuscript scale | 54 chapter files; 184,407 chapter words excluding YAML front matter; 191,996 raw chapter-file words including metadata and live scaffolding | Local word-count check on `chapters/*.qmd` |
