...
| Manuscript scale | 54 chapter files; 184,042 chapter words excluding YAML front matter; 191,541 raw chapter-file words including metadata and live scaffolding | Local word-count check on `chapters/*.qmd` |
