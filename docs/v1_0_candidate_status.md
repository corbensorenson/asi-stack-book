...
| Manuscript scale | 54 chapter files; 177,122 chapter words excluding YAML front matter; 184,621 raw chapter-file words including metadata and live scaffolding | Local word-count check on `chapters/*.qmd` |
