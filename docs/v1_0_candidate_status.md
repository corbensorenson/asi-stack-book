...
| Manuscript scale | 44 chapter files; 206,051 chapter words excluding YAML front matter; 216,090 raw chapter-file words including metadata and live scaffolding | Local word-count check on `chapters/*.qmd` |
