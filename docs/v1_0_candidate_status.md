...
| Manuscript scale | 54 chapter files; 180,536 chapter words excluding YAML front matter; 188,035 raw chapter-file words including metadata and live scaffolding | Local word-count check on `chapters/*.qmd` |
