...
| Manuscript scale | 44 chapter files; 206,873 chapter words excluding YAML front matter; 217,133 raw chapter-file words including metadata and live scaffolding | Local word-count check on `chapters/*.qmd` |
