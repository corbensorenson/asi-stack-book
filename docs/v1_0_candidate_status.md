...
| Manuscript scale | 54 chapter files; 183,951 chapter words excluding YAML front matter; 191,450 raw chapter-file words including metadata and live scaffolding | Local word-count check on `chapters/*.qmd` |
