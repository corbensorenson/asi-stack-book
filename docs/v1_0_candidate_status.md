...
| Manuscript scale | 54 chapter files; 182,335 chapter words excluding YAML front matter; 189,834 raw chapter-file words including metadata and live scaffolding | Local word-count check on `chapters/*.qmd` |
...
| Chapter handoffs | All 30 Part I and Part II chapters now end with manifest-driven `Handoff` sections that name the next manifest chapter title and avoid numbered chapter references; Parts III and IV remain ratchet targets | `python3 scripts/validate_chapter_handoffs.py` |
