...
| Manuscript scale | 54 chapter files; 170,371 chapter words excluding YAML front matter; 177,870 raw chapter-file words including metadata and live scaffolding | Local word-count check on `chapters/*.qmd` |
