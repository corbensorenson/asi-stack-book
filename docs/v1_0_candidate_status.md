...
| Manuscript scale | 44 chapter files; 204,755 chapter words excluding YAML front matter; 214,758 raw chapter-file words including metadata and live scaffolding | Local word-count check on `chapters/*.qmd` |
