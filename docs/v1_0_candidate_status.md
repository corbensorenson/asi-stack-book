...
| Manuscript scale | 54 chapter files; 181,397 chapter words excluding YAML front matter; 188,896 raw chapter-file words including metadata and live scaffolding | Local word-count check on `chapters/*.qmd` |
...
| Chapter handoffs | All 14 Part I foundation chapters now end with manifest-driven `Handoff` sections that name the next manifest chapter title and avoid numbered chapter references; later parts remain a ratchet target | `python3 scripts/validate_chapter_handoffs.py` |
