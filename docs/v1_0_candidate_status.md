...
| Manuscript scale | 54 chapter files; 183,228 chapter words excluding YAML front matter; 190,727 raw chapter-file words including metadata and live scaffolding | Local word-count check on `chapters/*.qmd` |
...
| Chapter handoffs | All 45 Part I, Part II, and Part III chapters now end with manifest-driven `Handoff` sections that name the next manifest chapter title and avoid numbered chapter references; Part IV remains a ratchet target | `python3 scripts/validate_chapter_handoffs.py` |
