...
| Manuscript scale | 54 chapter files; 168,402 chapter words excluding YAML front matter; 175,901 raw chapter-file words including metadata and live scaffolding | Local word-count check on `chapters/*.qmd` |
