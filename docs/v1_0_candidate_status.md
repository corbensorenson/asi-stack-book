...
| Manuscript scale | 44 chapter files; 205,184 chapter words excluding YAML front matter; 215,187 raw chapter-file words including metadata and live scaffolding | Local word-count check on `chapters/*.qmd` |
