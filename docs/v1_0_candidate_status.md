...
| Manuscript scale | 54 chapter files; 178,304 chapter words excluding YAML front matter; 185,803 raw chapter-file words including metadata and live scaffolding | Local word-count check on `chapters/*.qmd` |
