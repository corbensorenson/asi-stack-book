...
| Manuscript scale | 54 chapter files; 179,542 chapter words excluding YAML front matter; 187,041 raw chapter-file words including metadata and live scaffolding | Local word-count check on `chapters/*.qmd` |
