...
| Manuscript scale | 54 chapter files; 183,943 chapter words excluding YAML front matter; 191,442 raw chapter-file words including metadata and live scaffolding | Local word-count check on `chapters/*.qmd` |
