...
| Manuscript scale | 54 chapter files; 169,812 chapter words excluding YAML front matter; 177,311 raw chapter-file words including metadata and live scaffolding | Local word-count check on `chapters/*.qmd` |
...
| Visual coverage | Every chapter has at least one substantive Mermaid diagram with enough named states, edges, and labeled transitions to explain a mechanism; landing page has a generated visual asset | `python3 scripts/validate_visual_coverage.py` |
