...
| Manuscript scale | 54 chapter files; 177,792 chapter words excluding YAML front matter; 185,291 raw chapter-file words including metadata and live scaffolding | Local word-count check on `chapters/*.qmd` |
