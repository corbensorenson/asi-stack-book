...
| Manuscript scale | 54 chapter files; 175,501 chapter words excluding YAML front matter; 183,000 raw chapter-file words including metadata and live scaffolding | Local word-count check on `chapters/*.qmd` |
