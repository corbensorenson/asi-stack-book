...
| Manuscript scale | 54 chapter files; 178,246 chapter words excluding YAML front matter; 185,745 raw chapter-file words including metadata and live scaffolding | Local word-count check on `chapters/*.qmd` |
