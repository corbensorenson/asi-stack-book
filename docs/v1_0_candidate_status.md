...
| Manuscript scale | 44 chapter files; 208,104 chapter words excluding YAML front matter; 218,575 raw chapter-file words including metadata and live scaffolding | Local word-count check on `chapters/*.qmd` |
