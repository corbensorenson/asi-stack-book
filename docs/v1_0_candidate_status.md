...
| Manuscript scale | 54 chapter files; 175,156 chapter words excluding YAML front matter; 182,655 raw chapter-file words including metadata and live scaffolding | Local word-count check on `chapters/*.qmd` |
