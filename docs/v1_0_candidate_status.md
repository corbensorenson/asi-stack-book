...
| Manuscript scale | 44 chapter files; 207,226 chapter words excluding YAML front matter; 217,601 raw chapter-file words including metadata and live scaffolding | Local word-count check on `chapters/*.qmd` |
