...
| Manuscript scale | 54 chapter files; 169,601 chapter words excluding YAML front matter; 177,100 raw chapter-file words including metadata and live scaffolding | Local word-count check on `chapters/*.qmd` |
