...
| Manuscript scale | 54 chapter files; 168,558 chapter words excluding YAML front matter; 176,057 raw chapter-file words including metadata and live scaffolding | Local word-count check on `chapters/*.qmd` |
