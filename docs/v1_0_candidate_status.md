...
| Manuscript scale | 54 chapter files; 169,102 chapter words excluding YAML front matter; 176,601 raw chapter-file words including metadata and live scaffolding | Local word-count check on `chapters/*.qmd` |
...
| Source appendix ownership | Appendix G is reserved for Corben/source-corpus records; Appendix H is reserved for records marked `external_literature` | `python3 scripts/validate_source_appendices.py` |
