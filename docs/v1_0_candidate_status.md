...
| Manuscript scale | 54 chapter files; 176,794 chapter words excluding YAML front matter; 184,293 raw chapter-file words including metadata and live scaffolding | Local word-count check on `chapters/*.qmd` |
