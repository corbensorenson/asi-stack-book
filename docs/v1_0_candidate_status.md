...
| Manuscript scale | 54 chapter files; 183,915 chapter words excluding YAML front matter; 191,414 raw chapter-file words including metadata and live scaffolding | Local word-count check on `chapters/*.qmd` |
