...
| Moral Uncertainty, Value Conflict, and Contestable Governance | 59 | 0 | 0 | `evidence_quality/claim_dossiers/moral-uncertainty-and-value-conflict.md` |
...
| Fast Generation Architectures | 76 | 0 | 0 | `evidence_quality/claim_dossiers/fast-generation-architectures.md` |
...
| Capability Thresholds and Deployment Commitments | 79 | 0 | 0 | `evidence_quality/claim_dossiers/capability-thresholds-and-deployment-commitments.md` |
| Adversarial Evaluation, Sandbagging, and Training-Time Deception | 79 | 0 | 0 | `evidence_quality/claim_dossiers/adversarial-evaluation-sandbagging-and-training-time-deception.md` |
