...
- `docs/resource_workload_quality_probe.md` records 3 local route candidates, 5 samples per route for the selected route, selected route `route://selected-scoped-workflow-trace-validator`, and 85.032 percent observed selected-vs-baseline elapsed reduction for the scoped local task.
