...
|---|---|---|---|
| `asi-is-a-stack-not-a-model` | pass | bounded in insufficiency section | complete packet surface |
...
| `fast-generation-architectures` | pass | bounded in insufficiency section | complete packet surface |
...
| `prototype-roadmap` | pass | bounded in insufficiency section | complete packet surface |
