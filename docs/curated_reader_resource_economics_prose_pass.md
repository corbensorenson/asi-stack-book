...
Live source file: `chapters/resource-economics-and-token-budgets.qmd`

## Reader Promise

This pass should let a human reader understand why efficiency is not credible
until protected costs, verification tax, human review, displaced work, and
residual burden have been counted.

The reader throughline is:

> saved what, for whom, and after which hidden costs are counted?
...
- Preserved the minimum viable implementation and beyond-state-of-the-art
  endpoint without implying a scheduler, economics result, serving result,
...
- This pass does not claim TokenMana simulations, PlanForge scheduler
