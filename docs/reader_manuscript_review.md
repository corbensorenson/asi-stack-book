...
The current matrix records 54 manifest-aligned chapter rows: 46 `reviewed`
...
`docs/reader_part_iii_iv_proof_bridge_full_review_pass.md`, with 8 `spot_checked`
