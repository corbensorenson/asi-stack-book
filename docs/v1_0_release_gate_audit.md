...
| 3 | First measured/replayed result gate | satisfied for bounded synthetic-test-backed slices | `docs/first_measured_replayed_slice.md`; `docs/costed_route_resource_slice.md`; `evidence_transitions/v1_0_measured/phase5_harness_runner_synthetic_test_backed.json`; `evidence_transitions/v1_0_measured/costed_route_resource_slice_synthetic_test_backed.json` | These transitions support only `living-book-methodology.phase5_harness_registry_runner` and `resource-economics.costed_route_budget_slice`, not chapter core claims or deployed capability. |
