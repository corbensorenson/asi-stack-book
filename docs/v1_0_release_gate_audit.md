...
| 2 | Claim-state gate | satisfied for v1.0 coverage | `docs/core_claim_transition_coverage.md`; `claim_decisions/v1_0_core_claim_no_promotion.json`; `docs/evidence_transition_pilot.md`; `python3 scripts/validate_core_claim_decisions.py`; `python3 scripts/validate_evidence_transitions.py` | All 46 chapter core claims remain at `argument`; no chapter core claim can move without a new accepted transition. |
