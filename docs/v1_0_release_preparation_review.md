...
- Reader overlay validation now passes with 14 active operations and 14 applied
...
- Reader edition check passed for 54 chapters and 59 files; 275 live-only
  sections would be removed, 60 reader scaffold terms would be humanized, and 14
...
- The v1.0 reader overlay set now has opening-chapter, Personal Compute Hives,
  Command Contracts, Policy Optimization, Artifact Steward Agents, and Semantic
  Representation operations. They are reader-only semantic deltas, not a
  reviewed reader release.
