...
claim that any human-edition artifact is ready for publication.
...
- Reader overlay validation passed with 0 active operations and 0 applied
  operations.
- Reader edition check passed for 54 chapters and 59 files; 275 live-only
  sections would be removed, 60 reader scaffold terms would be humanized, and 0
...
- The v1.0 reader overlay manifest currently has zero active operations.
