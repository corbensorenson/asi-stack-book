...
- The matrix currently records 54 chapter rows, 41 `spot_checked` rows from existing representative reader-review notes plus the first Part I and Part II review passes, 13 `not_started` rows, 20 chapters with active reader overlays, 22 no-immediate-action decisions, 3 companion-note candidates, and 1 curated-manuscript candidate.
