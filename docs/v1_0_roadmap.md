...
- The matrix currently records 54 chapter rows, 22 `spot_checked` rows from existing representative reader-review notes, 32 `not_started` rows, 20 chapters with active reader overlays, 3 companion-note candidates, and 1 curated-manuscript candidate.
