...
finishing public-site accessibility and ledger cleanup, preserving proof-depth
honesty and protocol source-of-truth checks, and recording final release
metadata only when the tag or archive facts actually exist.
