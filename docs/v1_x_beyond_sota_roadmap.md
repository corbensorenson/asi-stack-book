...
- `ValueConflict` now has a second v1.x depth increment: three additional
  ...
  authority narrowing.
- The generated proof-depth report records 326 theorem declarations, 205
...
- `docs/proof_depth_classification.md` records 326 theorem declarations, 205
