...
- `ValueConflict` now has a second v1.x depth increment: three additional
  ...
  authority narrowing.
- The generated proof-depth report records 314 theorem declarations, 199
...
- `docs/proof_depth_classification.md` records 314 theorem declarations, 199
