...
- The next reader task is not another review report. All 44 active manifest
  ...
  foundations-and-control, Part II entry/context/verification/execution, and
  the first eight Part III arcs have 32 records reconciled for prose meaning,
  the other 12 records remain drafting, and
