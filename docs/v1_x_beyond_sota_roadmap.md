...
- `python3 scripts/validate_chapter_review_burndown.py` passes and proves that
  ...
  dated blocker.
- `python3 scripts/validate_proof_depth.py` now classifies 1,439 theorem
  declarations, including 942 derived/decomposed declarations, 193 direct or
  projection-style declarations, and 304 unknown/mixed declarations. The counts are stronger than the older
