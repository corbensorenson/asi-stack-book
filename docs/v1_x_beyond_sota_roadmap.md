...
- `ValueConflict` now has a second v1.x depth increment: three additional
  ...
  authority narrowing.
- The generated proof-depth report records 320 theorem declarations, 202
...
- `docs/proof_depth_classification.md` records 320 theorem declarations, 202
  derived/decomposed theorem declarations, and 118 direct/projection-style
