...
- The ten draft key figures are now embedded/adapted into the curated reader
  ...
  approval, or reader release approval. Remaining work is visual figure polish,
  real e-reader/app/PDF-layout review,
...
- Ten draft key-figure assets tied to the reader handoff contract now exist and
  ...
  `scripts/validate_reader_key_figure_format_probe.py`, and source-level
  visual identity checked by `scripts/validate_reader_visual_identity.py` with
  ...
  polish, format-specific inspection, and release review still need to happen before any approved
...
- Test 2: one blocked curated-reader release-candidate record now exists beyond
  ...
  edition release record; source-level visual identity review now exists with
  10 key figures, 54 combined colors, 5 non-neutral color families, and
  minimum text contrast 5.19, but visual identity remains blocked on manual
  aesthetic judgment, real e-reader/application review, final figure-artifact
  approval, and reader release approval.
