...
- The next reader task is not another review report. All 44 active manifest
  ...
  III, and the Part IV evidence/governance arc have 39 records reconciled for
  prose meaning, the remaining 5 Part IV synthesis/implementation records
  remain drafting, and
