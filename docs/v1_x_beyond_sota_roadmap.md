...
- Ten draft key-figure assets tied to the reader handoff contract now exist and
  ...
  `docs/reader_key_figure_pdf_layout_review.md`. They remain
  ...
  polish, real e-reader/app/DOCX inspection, manual page-by-page PDF/PDF-viewer
  review, and release review still need to happen before any approved
