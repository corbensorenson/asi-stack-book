...
- The ten draft key figures are now embedded/adapted into the curated reader
  ...
  approval, or reader release approval. Remaining work is raster/rendered
  visual inspection, visual figure polish, real e-reader/app/PDF-layout review,
  audio-specific inspection, and release review before any human-review-ready
  figure-artifact claim.
...
- Ten draft key-figure assets tied to the reader handoff contract now exist and
  ...
  standard deviation, and 116 minimum quantized colors. The results are
  ...
  `docs/reader_key_figure_raster_review.md`. They remain
  ...
  polish, real e-reader/app/PDF/DOCX inspection, and release review still need
  to happen before any approved
...
- Test 2: one blocked curated-reader release-candidate record now exists beyond
  ...
  5.19, but visual identity remains blocked on raster/rendered visual
