...
- `ValueConflict` now has a second v1.x depth increment: three additional
  ...
  authority narrowing.
- The generated proof-depth report records 329 theorem declarations, 208
...
- `docs/proof_depth_classification.md` records 329 theorem declarations, 208
