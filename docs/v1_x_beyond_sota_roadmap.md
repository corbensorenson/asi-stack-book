...
- `ValueConflict` now has a second v1.x depth increment: three additional
  ...
  authority narrowing.
- The generated proof-depth report records 308 theorem declarations, 193
...
- `docs/proof_depth_classification.md` records 308 theorem declarations, 193
