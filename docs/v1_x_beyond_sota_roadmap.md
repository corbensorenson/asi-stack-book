...
- `ValueConflict` now has a second v1.x depth increment: three additional
  ...
  authority narrowing.
- The generated proof-depth report records 352 theorem declarations, 231
...
- `docs/proof_depth_classification.md` records 352 theorem declarations, 231
