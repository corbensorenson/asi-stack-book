...
- `docs/reader_keyboard_navigation_review.md`,
  ...
  duplicate-ID hits. These are automated Chromium checks only; manual
...
- Test 2: one blocked curated-reader release-candidate record now exists beyond
  ...
  keyboard-only review, screen-reader review, WCAG conformance review,
  audiobook review, and reader release approval. Automated Chromium
  ...
  failures, and 0 duplicate-ID hits, but it does not clear manual
  keyboard-only review, screen-reader review, WCAG conformance review,
  e-reader review, audiobook review, or reader release approval.
