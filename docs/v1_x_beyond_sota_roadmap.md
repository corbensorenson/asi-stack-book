...
- `ValueConflict` now has a second v1.x depth increment: three additional
  ...
  authority narrowing.
- The generated proof-depth report records 300 theorem declarations, 185
...
- `docs/proof_depth_classification.md` records 300 theorem declarations, 185
