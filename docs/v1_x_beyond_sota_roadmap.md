...
- The ten draft key figures are now embedded/adapted into the curated reader
  ...
  manual page-by-page PDF review, audio-specific inspection, and
...
- `docs/curated_reader_format_artifact_probe.md` and
  ...
  to a 504-page tagged PDF, checks 1,026,949 extracted text characters,
  ...
  manual PDF page-by-page reading-flow/layout review or an explicit release decision,
...
- Test 2: one blocked curated-reader release-candidate record now exists beyond
  ...
  records 2 nonblank viewer screenshots and 4.434% changed pixels after scroll.
  PDF remains probe-level until real manual page-by-page PDF reading-flow/layout
  review and an edition release record exist; audio now has
