...
- `ValueConflict` now has a second v1.x depth increment: three additional
  ...
  authority narrowing.
- The generated proof-depth report records 287 theorem declarations, 172
...
- `docs/proof_depth_classification.md` records 287 theorem declarations, 172
