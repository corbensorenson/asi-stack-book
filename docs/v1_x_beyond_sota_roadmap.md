...
- `ValueConflict` now has a second v1.x depth increment: three additional
  ...
  authority narrowing.
- The generated proof-depth report records 476 theorem declarations, 355
...
- `docs/proof_depth_classification.md` records 476 theorem declarations, 355
