...
| `capability-replacement-and-rollback` | Deployment/MLOps prior art is lightly anchored despite strong canary/rollback prose. | Source-note and name progressive delivery, canary, blue-green, feature-flag, model-rollout, and regression-gating comparators; regenerate Appendix H and preserve rollback transaction boundaries before implying any live deployment or model-rollout validation. |
...
| `routing-heads-and-specialist-cores` | Strong chapter with remaining planned tests. | Finish planned routing tests with authority/readiness/residual non-claims, including negative controls for unready specialists and authority-widening routes; avoid turning route-quality fixtures into learned-router claims. |
