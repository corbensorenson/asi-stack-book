...
- `ValueConflict` now has a second v1.x depth increment: three additional
  ...
  authority narrowing.
- The generated proof-depth report records 291 theorem declarations, 176
...
- `docs/proof_depth_classification.md` records 291 theorem declarations, 176
