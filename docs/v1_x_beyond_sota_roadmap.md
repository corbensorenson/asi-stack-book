...
- `ValueConflict` now has a second v1.x depth increment: three additional
  ...
  authority narrowing.
- The generated proof-depth report records 495 theorem declarations, 374
...
- `docs/proof_depth_classification.md` records 495 theorem declarations, 374
