...
- `ValueConflict` now has a second v1.x depth increment: three additional
  ...
  authority narrowing.
- The generated proof-depth report records 514 theorem declarations, 393
...
- `docs/proof_depth_classification.md` records 514 theorem declarations, 393
