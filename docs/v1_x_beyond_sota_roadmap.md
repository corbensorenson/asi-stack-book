...
- Ten draft key-figure assets tied to the reader handoff contract now exist and
  ...
  marker contrast ratio 3.96, and minimum SVG text size 15 px. The results are
  ...
  `docs/reader_visual_identity_review.md`. They remain
  `draft_not_release_reviewed` with no new
  support-state, enforcement, security, proof, test, external-review, or
  artifact-release effect. Current blocker: raster/rendered visual inspection,
  manual aesthetic judgment, figure polish, format-specific inspection, and
  release review still need to happen before any approved
