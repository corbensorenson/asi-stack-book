...
- `ValueConflict` now has a second v1.x depth increment: three additional
  ...
  authority narrowing.
- The generated proof-depth report records 298 theorem declarations, 183
...
- `docs/proof_depth_classification.md` records 298 theorem declarations, 183
