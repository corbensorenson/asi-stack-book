...
Quarto site, and thirteen narrow non-core evidence transitions. The current v1.x
...
- source-to-chapter and claim-source mappings are complete for the current
  manifest;
- thirteen narrow non-core evidence transitions are recorded;
