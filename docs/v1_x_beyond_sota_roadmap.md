...
- `ValueConflict` now has a second v1.x depth increment: three additional
  ...
  authority narrowing.
- The generated proof-depth report records 347 theorem declarations, 226
...
- `docs/proof_depth_classification.md` records 347 theorem declarations, 226
