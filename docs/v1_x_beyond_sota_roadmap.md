...
- `ValueConflict` now has a second v1.x depth increment: three additional
  ...
  authority narrowing.
- The generated proof-depth report records 585 theorem declarations, 464
  derived/decomposed declarations, 86 safety-critical declarations, and 10
...
- `docs/proof_depth_classification.md` records 585 theorem declarations, 464
