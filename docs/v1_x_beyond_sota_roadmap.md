...
- `ValueConflict` now has a second v1.x depth increment: three additional
  ...
  authority narrowing.
- The generated proof-depth report records 448 theorem declarations, 327
...
- `docs/proof_depth_classification.md` records 448 theorem declarations, 327
