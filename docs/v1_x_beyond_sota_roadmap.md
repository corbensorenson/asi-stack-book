...
- `python3 scripts/validate_chapter_review_burndown.py` passes and proves that
  ...
  dated blocker.
- `python3 scripts/validate_proof_depth.py` now classifies 2,004 theorem
  declarations, including 1,175 derived/decomposed declarations, 404 direct or
  projection-style declarations, and 425 unknown/mixed declarations. The counts are stronger than the older
