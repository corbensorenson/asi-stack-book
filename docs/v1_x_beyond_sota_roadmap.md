...
- `ValueConflict` now has a second v1.x depth increment: three additional
  ...
  authority narrowing.
- The generated proof-depth report records 356 theorem declarations, 235
...
- `docs/proof_depth_classification.md` records 356 theorem declarations, 235
