...
- `ValueConflict` now has a second v1.x depth increment: three additional
  ...
  authority narrowing.
- The generated proof-depth report records 343 theorem declarations, 222
...
- `docs/proof_depth_classification.md` records 343 theorem declarations, 222
