...
- The ten draft key figures are now embedded/adapted into the curated reader
  ...
  Remaining work is visual figure polish, real e-reader/app/PDF-layout review,
...
- Ten draft key-figure assets tied to the reader handoff contract now exist and
  ...
  `scripts/validate_reader_key_figure_format_probe.py`, and recorded in
  `docs/reader_key_figure_artifact_review.md` plus
  `docs/reader_key_figure_format_probe.md`. They remain
