...
- `python3 scripts/validate_chapter_review_burndown.py` passes and proves that
  ...
  dated blocker.
- `python3 scripts/validate_proof_depth.py` now classifies 2,027 theorem
  declarations, including 1,182 derived/decomposed declarations, 405 direct or
  projection-style declarations, and 440 unknown/mixed declarations. The counts are stronger than the older
