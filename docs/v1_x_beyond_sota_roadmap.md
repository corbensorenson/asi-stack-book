...
- The next reader task is not another review report. All 44 active manifest
  chapters now have tracked curated reader files; the opener is reconciled for
  prose meaning, the other 43 records remain drafting, and
