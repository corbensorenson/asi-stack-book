...
- `python3 scripts/validate_chapter_review_burndown.py` passes and proves that
  ...
  dated blocker.
- `python3 scripts/validate_proof_depth.py` now classifies 1,332 theorem
  declarations, including 865 derived/decomposed declarations, 183 direct or
  projection-style declarations, and 284 unknown/mixed declarations. The counts are stronger than the older
