...
| Evidence and source matrices | Appendices, source notes, schemas, release records, test specs, proof manifest, Corben-authored/supplied/local sources, external literature, and changelog. | Kept for live/research; reader releases keep selected human-useful appendices such as glossary, Corben-authored/supplied/local sources, and external literature. |
