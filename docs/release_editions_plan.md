...
- `editions/reader_manuscript/v1_0/manifest.json` records the curated reader-manuscript path, its graduation criteria, allowed prose divergence, blocked evidence divergence, generated-reader baseline, reconciliation requirement, and current `drafting` status with drafting-only curated chapter records for `asi-is-a-stack-not-a-model`, `the-efficient-asi-hypothesis`, `system-boundaries-and-authority`, `failure-modes-of-ungoverned-intelligence`, `evidence-states-and-claim-discipline`, `human-intent-as-a-formal-input`, `security-kernel-and-digital-scifs`, `stable-capability-fields`, `capability-replacement-and-rollback`, `readiness-gates-residual-escrow-and-quarantine`, `context-transactions-snapshots-mounts-and-taint`, `verification-bandwidth-and-context-adequacy`, `claim-ledgers-and-belief-revision`, `labor-os-and-typed-jobs`, `artifact-graphs-audit-logs-and-replay`, `runtime-adapters-tool-permissions-and-human-approval`, `procedural-memory-and-cognitive-loop-closure`, `benchmark-ratchets-and-anti-goodhart-evidence`, `policy-optimization-and-learning-from-feedback`, `integrated-reference-architecture`, `project-theseus-as-report-first-implementation-reference`, `prototype-roadmap`, `living-book-methodology`, `open-research-agenda-and-bibliography-plan`, `mathematical-and-search-substrates`, `coil-attention-cyclic-memory-and-recurrence-contracts`, `coilra-multicoil-rope-and-cyclic-mixers`, `recursive-self-improvement-boundaries`, `circle-calculus-and-proof-carrying-ai-contracts`, `executable-specifications-and-lean-proof-envelope`, and `artifact-steward-agents-and-living-project-governance`. `docs/curated_reader_asi_stack_prose_pass.md`, `docs/curated_reader_efficient_asi_prose_pass.md`, `docs/curated_reader_system_boundaries_prose_pass.md`, `docs/curated_reader_failure_modes_prose_pass.md`, `docs/curated_reader_evidence_states_prose_pass.md`, `docs/curated_reader_human_intent_prose_pass.md`, `docs/curated_reader_security_kernel_prose_pass.md`, `docs/curated_reader_stable_capability_fields_prose_pass.md`, `docs/curated_reader_capability_replacement_prose_pass.md`, `docs/curated_reader_readiness_gates_prose_pass.md`, `docs/curated_reader_context_transactions_prose_pass.md`, `docs/curated_reader_verification_bandwidth_prose_pass.md`, `docs/curated_reader_claim_ledgers_prose_pass.md`, `docs/curated_reader_labor_os_prose_pass.md`, `docs/curated_reader_artifact_graphs_prose_pass.md`, `docs/curated_reader_runtime_adapters_prose_pass.md`, `docs/curated_reader_procedural_memory_prose_pass.md`, `docs/curated_reader_benchmark_ratchets_prose_pass.md`, `docs/curated_reader_policy_optimization_prose_pass.md`, `docs/curated_reader_integrated_reference_prose_pass.md`, `docs/curated_reader_project_theseus_prose_pass.md`, `docs/curated_reader_prototype_roadmap_prose_pass.md`, `docs/curated_reader_living_book_methodology_prose_pass.md`, `docs/curated_reader_open_research_agenda_prose_pass.md`, `docs/curated_reader_mathematical_search_substrates_prose_pass.md`, `docs/curated_reader_coil_attention_memory_prose_pass.md`, `docs/curated_reader_coilra_cyclic_mixers_prose_pass.md`, `docs/curated_reader_recursive_self_improvement_prose_pass.md`, `docs/curated_reader_circle_contracts_prose_pass.md`, `docs/curated_reader_executable_specs_prose_pass.md`, and `docs/curated_reader_artifact_steward_prose_pass.md` record the first prose curation passes. `editions/reader_manuscript/v1_0/reconciliation_report.md` records the drafting chapters and keeps release blockers active until reconciliation, format review, and an edition release record exist.
...
facts: 51 generated script files, preserved implementation horizons, 8 table
treatment notes, 54 Mermaid diagram notes, 1 image note, and MP3/M4B/
