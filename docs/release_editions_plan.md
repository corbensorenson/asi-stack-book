...
- `release_records/2026-07-05-v1-curated-reader-blocked-d81d505a.json` and `scripts/validate_curated_reader_blocked_release_record.py` record the current curated reader manuscript as a blocked partial release candidate, naming exact local HTML/EPUB/DOCX/PDF/e-reader/audio blockers without approving or publishing artifacts.
