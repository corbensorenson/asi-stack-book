...
- `editions/reader_manuscript/v1_0/manifest.json` records the curated reader-manuscript path, its graduation criteria, allowed prose divergence, blocked evidence divergence, generated-reader baseline, reconciliation requirement, and current `drafting` status with one drafting-only curated chapter record for `artifact-steward-agents-and-living-project-governance`. `docs/curated_reader_artifact_steward_prose_pass.md` records the first prose curation pass. `editions/reader_manuscript/v1_0/reconciliation_report.md` records the drafting chapter and keeps release blockers active until reconciliation, format review, and an edition release record exist.
