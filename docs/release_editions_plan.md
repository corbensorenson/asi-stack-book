...
| Evidence and source matrices | Appendices, source notes, schemas, release records, test specs, proof manifest, Corben source corpus, external literature, and changelog. | Kept for live/research; reader releases keep selected human-useful appendices such as glossary, Corben's source corpus, and external literature. |
