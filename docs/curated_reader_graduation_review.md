...
- Curated chapter records: 5 drafting records and 39 reconciled records; see `editions/reader_manuscript/v1_0/manifest.json` and `editions/reader_manuscript/v1_0/reconciliation_report.md` for the current chapter-level list. Earlier curated records include
...
- This review records forty-four curated reader chapter files for future prose
  editing, with five drafting records and thirty-nine reconciled prose records;
