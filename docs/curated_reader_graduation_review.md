...
- Curated chapter records: 40 drafting records and 4 reconciled records; see `editions/reader_manuscript/v1_0/manifest.json` and `editions/reader_manuscript/v1_0/reconciliation_report.md` for the current chapter-level list. Earlier curated records include
...
- This review records forty-four curated reader chapter files for future prose
  editing, with forty drafting records and four reconciled prose records;
