...
- Curated chapter records: 0 drafting records and 44 reconciled records; see `editions/reader_manuscript/v1_0/manifest.json` and `editions/reader_manuscript/v1_0/reconciliation_report.md` for the current chapter-level list. Earlier curated records include
...
- This review records forty-four curated reader chapter files for future prose
  editing, with zero drafting records and forty-four reconciled prose records;
