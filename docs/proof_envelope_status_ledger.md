...
The current adequacy review classifies 167 adequate finite-record invariant, 89 useful but too narrow, 16 needs richer state-machine or review semantics, 33 needs executable tests first, 17 needs empirical or baseline tests first, and 2 research-agenda until artifact import. These classes route follow-through work; they do not change theorem status or chapter support states.
