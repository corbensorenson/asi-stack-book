...
The current adequacy review classifies 252 adequate finite-record invariant, 60 useful but too narrow, 0 needs richer state-machine or review semantics, 3 needs executable tests first, 15 needs empirical or baseline tests first, and 0 research-agenda until artifact import. These classes route follow-through work; they do not change theorem status or chapter support states.

| Adequacy class | Targets |
|---|---:|
| adequate finite-record invariant | 252 |
| useful but too narrow | 60 |
| needs richer state-machine or review semantics | 0 |
