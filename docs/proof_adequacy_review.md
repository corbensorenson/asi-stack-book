...
| useful but too narrow | 32 | The predicate is a useful guard, but the chapter needs state-machine, trace, integration, empirical, or benchmark tests before the proof can support the larger boundary. |
...
proof shape, not semantic adequacy. The current baseline is 174 theorem
declarations: 115 direct/projection-style, 59 derived/decomposed, and 0
