...
| useful but too narrow | 33 | The predicate is a useful guard, but the chapter needs state-machine, trace, integration, empirical, or benchmark tests before the proof can support the larger boundary. |
...
proof shape, not semantic adequacy. The current baseline is 179 theorem
declarations: 115 direct/projection-style, 64 derived/decomposed, and 0
