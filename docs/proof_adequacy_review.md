...
proof shape, not semantic adequacy. The current baseline is 146 theorem
declarations: 112 direct/projection-style, 34 derived/decomposed, and 0
unknown or mixed. The v1.0 safety-critical modules now contain 17 theorem
declarations: 10 remain direct/projection-style; all five safety-critical
modules have at least one derived/decomposed finite-record theorem, and
