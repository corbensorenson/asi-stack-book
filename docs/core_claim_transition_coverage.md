...
| Accepted explicit no-promotion decisions | 22 |
...
| `context-transactions-snapshots-mounts-and-taint.core` | Context Transactions, Snapshots, Mounts, and Taint | `argument_only` | no memory-store runtime; finite deletion-closure fixture/proof coverage only; no deployed deletion-closure, side-channel, or branch-isolation review |
