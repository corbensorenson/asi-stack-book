...
| Metric | Count |
|---|---:|
| Manifest chapter core claims | 66 |
| Accepted core evidence-transition records | 22 |
| Accepted explicit no-promotion decisions | 44 |
...
| `embodied-agency-real-time-control-and-physical-safety.core` | Embodied Agency, Real-Time Control, and Physical Safety | `argument_only` | no local controller or physical plant campaign has run; no fallback, independent stop, stabilization, compensation, or irreversible effect has been observed; source-reported robotics and conditional control theory do not establish plant-specific safety |
...
| `human-ai-organizations-delegation-and-accountability.core` | Human-AI Organizations, Delegation, and Accountability | `argument_only` | no local human-participant or longitudinal organizational study has run; no succession, dissolution, appeal, remedy, or accountability intervention has been tested; field and formal source results are setting-bound and do not validate this organizational contract |
...
| `inner-alignment-mesa-optimization-and-learned-objective-integrity.core` | Inner Alignment, Mesa-Optimization, and Learned-Objective Integrity | `argument_only` | no local learned-objective or conditional-policy campaign has run; no independent method family or evaluator has reproduced an objective-integrity result; behavioral compliance cannot identify an objective and the planned formal target remains unimplemented |
...
| `multi-agent-dynamics-collective-intelligence-and-systemic-risk.core` | Multi-Agent Dynamics, Collective Intelligence, and Systemic Risk | `argument_only` | no local multi-agent population campaign has run; no independent evaluator has calibrated collusion, effective diversity, systemic risk, or human-influence measures; pairwise protocol validity and source taxonomies do not establish population-level outcomes |
...
| `perception-sensor-fusion-and-observation-trust.core` | Perception, Sensor Fusion, and Observation Trust | `argument_only` | no local sensor stream, fusion mechanism, corruption suite, or active-observation policy has been evaluated; no independent calibration or attack assessment exists; shared representation and source-reported robotics performance do not establish observation trust |
...
| `privacy-data-rights-and-information-flow-governance.core` | Privacy, Data Rights, and Information-Flow Governance | `argument_only` | natural campaign unexecuted; no local privacy mechanism or strong attack result; no legal applicability or compliance determination; no independent reproduction or transfer |
