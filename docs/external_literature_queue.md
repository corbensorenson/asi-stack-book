...
| Policy optimization and learning from feedback | Ground PPO/RLHF, GRPO/RLVR, DPO-style preference optimization, verifier rewards, reward hacking, reasoning-budget RL, and control-policy RL for planners, routers, VCM, execution, and generation modes. | Create citation-normalized source records and source notes before promoting any reward, training, or model-quality claim. |
