...
claim label. The semantic queue retires 270 inherited prose-candidate IDs,
adjudicates 713 domain-specific replacements against existing owned atoms,
preserves all 4,061 structured atoms, and leaves zero pending prose candidates.
