...
The raw-QMD diagnostic is also retained (1,921 to 905). Its widest families are generated source and P7 evidence reconciliation packets with explicit generator owners; they are
...
claim label. The semantic queue retires 262 inherited prose-candidate IDs,
adjudicates 694 domain-specific replacements against existing owned atoms,
