...
The raw-QMD diagnostic is also retained (1,921 to 932). Its widest families are generated source and P7 evidence reconciliation packets with explicit generator owners; they are
...
claim label. The semantic queue retires 248 inherited prose-candidate IDs,
adjudicates 629 domain-specific replacements against existing owned atoms,
preserves all 4,059 structured atoms, and leaves zero pending prose candidates.
