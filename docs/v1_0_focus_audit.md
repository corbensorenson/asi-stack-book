...
| Chapter body words | 171,553 | The book is already full-length; the main risk is not shortness. |
| Raw chapter-file words | 179,340 | Live scaffolding adds useful AI/research overhead beyond the reader spine. |
...
| Test appendix rows | 329 | Appendix E now records 329 generated chapter-level rows plus a separate repository-level check section. |
...
- That all 128 finite-record Lean targets are the best formalization of the intended chapter boundaries.
