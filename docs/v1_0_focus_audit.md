...
| Lean proof targets | 112 implemented finite-record targets | Traceability is complete; the initial proof adequacy review is recorded, and Authority plus Planning have first follow-through envelopes. Most targets still need stronger semantics, executable tests, empirical baselines, or imported artifacts before they can carry broader claims. |
