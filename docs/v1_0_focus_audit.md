...
| Chapter body words | 168,950 | The book is already full-length; the main risk is not shortness. |
| Raw chapter-file words | 176,537 | Live scaffolding adds useful AI/research overhead beyond the reader spine. |
...
| Test appendix rows | 296 | Appendix E now records 296 generated chapter-level rows plus a separate repository-level check section. |
