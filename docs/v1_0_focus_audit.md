...
| Chapter body words | 172,696 | The book is already full-length; the main risk is not shortness. |
| Raw chapter-file words | 180,598 | Live scaffolding adds useful AI/research overhead beyond the reader spine. |
...
- That all 136 finite-record Lean targets are the best formalization of the intended chapter boundaries.
