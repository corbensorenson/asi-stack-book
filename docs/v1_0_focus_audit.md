...
| Chapter body words | 172,754 | The book is already full-length; the main risk is not shortness. |
| Raw chapter-file words | 180,656 | Live scaffolding adds useful AI/research overhead beyond the reader spine. |
...
| Test appendix rows | 337 | Appendix E now records 337 generated chapter-level rows plus a separate repository-level check section. |
