...
| Chapter body words | 171,717 | The book is already full-length; the main risk is not shortness. |
| Raw chapter-file words | 179,548 | Live scaffolding adds useful AI/research overhead beyond the reader spine. |
...
| Test appendix rows | 330 | Appendix E now records 330 generated chapter-level rows plus a separate repository-level check section. |
...
- That all 129 finite-record Lean targets are the best formalization of the intended chapter boundaries.
