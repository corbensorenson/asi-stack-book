...
| Chapter body words | 168,298 | The book is already full-length; the main risk is not shortness. |
| Raw chapter-file words | 175,808 | Live scaffolding adds useful AI/research overhead beyond the reader spine. |
...
| Test appendix rows | 276 | Appendix E now records 276 generated chapter-level rows plus a separate repository-level check section. |
