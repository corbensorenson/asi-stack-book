...
| Chapter body words | 172,548 | The book is already full-length; the main risk is not shortness. |
| Raw chapter-file words | 180,450 | Live scaffolding adds useful AI/research overhead beyond the reader spine. |
...
| Test appendix rows | 336 | Appendix E now records 336 generated chapter-level rows plus a separate repository-level check section. |
...
- That all 135 finite-record Lean targets are the best formalization of the intended chapter boundaries.
