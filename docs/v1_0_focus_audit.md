...
| Chapter body words | 169,158 | The book is already full-length; the main risk is not shortness. |
| Raw chapter-file words | 176,761 | Live scaffolding adds useful AI/research overhead beyond the reader spine. |
...
| Test appendix rows | 305 | Appendix E now records 305 generated chapter-level rows plus a separate repository-level check section. |
