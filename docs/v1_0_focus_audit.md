...
| Test appendix rows | 324 | Appendix E now records 324 generated chapter-level rows plus a separate repository-level check section. |
...
- That all 123 finite-record Lean targets are the best formalization of the intended chapter boundaries.
