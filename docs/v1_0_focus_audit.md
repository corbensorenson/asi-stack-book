...
| Chapter body words | 169,989 | The book is already full-length; the main risk is not shortness. |
| Raw chapter-file words | 177,657 | Live scaffolding adds useful AI/research overhead beyond the reader spine. |
...
| Test appendix rows | 317 | Appendix E now records 317 generated chapter-level rows plus a separate repository-level check section. |
