...
| Chapter body words | 171,088 | The book is already full-length; the main risk is not shortness. |
| Raw chapter-file words | 178,849 | Live scaffolding adds useful AI/research overhead beyond the reader spine. |
...
| Test appendix rows | 326 | Appendix E now records 326 generated chapter-level rows plus a separate repository-level check section. |
...
- That all 125 finite-record Lean targets are the best formalization of the intended chapter boundaries.
