...
| Chapter body words | 172,433 | The book is already full-length; the main risk is not shortness. |
| Raw chapter-file words | 180,335 | Live scaffolding adds useful AI/research overhead beyond the reader spine. |
...
| Test appendix rows | 335 | Appendix E now records 335 generated chapter-level rows plus a separate repository-level check section. |
...
- That all 134 finite-record Lean targets are the best formalization of the intended chapter boundaries.
