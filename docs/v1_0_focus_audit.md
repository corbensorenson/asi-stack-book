...
3. Continue manual inspection of the local HTML, EPUB, DOCX, and PDF snapshots
   ...
   behavior, starting with a broader PDF source-card and appendix layout review.
...
6. Manual reader release dry-run inspection of the actual local HTML/EPUB/DOCX/PDF snapshots, including source-appendix card behavior in PDF.
