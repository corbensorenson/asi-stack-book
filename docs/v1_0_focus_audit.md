...
| Chapter body words | 169,609 | The book is already full-length; the main risk is not shortness. |
| Raw chapter-file words | 177,241 | Live scaffolding adds useful AI/research overhead beyond the reader spine. |
...
- That all 122 finite-record Lean targets are the best formalization of the intended chapter boundaries.
