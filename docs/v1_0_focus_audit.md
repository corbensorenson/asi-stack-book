...
| Chapter body words | 166,346 | The book is already full-length; the main risk is not shortness. |
| Raw chapter-file words | 173,677 | Live scaffolding adds useful AI/research overhead beyond the reader spine. |
...
| Lean proof targets | 122 implemented finite-record targets | Traceability is complete; the proof adequacy review is recorded, Stack Boundaries, Artifact Compression, Human Intent, Command Contracts, Cognitive Compilation, Virtual Context ABI, Verification Bandwidth, Labor OS, Stable Capability Fields, Capability Replacement, Security Kernel, Self-Improvement, Authority, Planning, Claim Ledger, and Proof-Carrying Claims now have finite record-envelope follow-through; Proof-Carrying Claims also has negative-case theorems for missing verifier artifact refs and negative verifier results attempting scoped updates. Personal Compute Hives has negative-case theorems for missing bound approval and missing federation-lease boundaries. Runtime Adapters has a synthetic permission harness plus finite negative-case theorems for missing parent-job permission and unrejected high-impact calls without approval. Artifact Graphs has a synthetic replay/audit consistency harness feeding the adequacy review, Procedural Memory has a synthetic loop-qualification harness feeding the adequacy review, Routing Heads has a synthetic route-lease harness feeding the adequacy review, Fast Generation has deterministic baseline-accounting fixtures that still do not replace model baselines, Resource Economics has paired resource-budget accounting, deterministic budget-ledger coverage, capacity-smoothing toy traces, and a bounded synthetic costed-route/resource-budget selector slice, and Circle has one bounded external rope receipt replay. These remain too narrow for intent parsing, command parsing, deployed dispatch, deployed target lowering, localized repair, deployed resolver behavior, summary fidelity, measured verification bandwidth, contradiction-rate behavior, deployed lifecycle enforcement, deployed job runtime, deployed replacement execution, deployed security-kernel enforcement, safe recursive self-improvement, scheduler behavior, real load, serving, proof-contract transport, model-quality, transfer, or economic claims. Most targets still need stronger semantics, executable tests, empirical baselines, or imported artifacts before they can carry broader claims. |
