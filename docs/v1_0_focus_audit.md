...
| Chapter body words | 168,499 | The book is already full-length; the main risk is not shortness. |
| Raw chapter-file words | 176,043 | Live scaffolding adds useful AI/research overhead beyond the reader spine. |
...
| Test appendix rows | 281 | Appendix E now records 281 generated chapter-level rows plus a separate repository-level check section. |
