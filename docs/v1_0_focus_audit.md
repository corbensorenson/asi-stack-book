...
| Chapter body words | 172,039 | The book is already full-length; the main risk is not shortness. |
| Raw chapter-file words | 179,927 | Live scaffolding adds useful AI/research overhead beyond the reader spine. |
...
| Test appendix rows | 332 | Appendix E now records 332 generated chapter-level rows plus a separate repository-level check section. |
...
- That all 131 finite-record Lean targets are the best formalization of the intended chapter boundaries.
