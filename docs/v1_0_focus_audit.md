...
| P0 | Test/prototype execution | 71 schemas and 70 fixtures validate record shape. | 196 Appendix E rows remain planned/not run. | First executable test harnesses with command, environment, result, and non-claim boundaries. |
