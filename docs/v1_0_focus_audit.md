...
| Chapter body words | 170,423 | The book is already full-length; the main risk is not shortness. |
| Raw chapter-file words | 178,119 | Live scaffolding adds useful AI/research overhead beyond the reader spine. |
...
| Test appendix rows | 325 | Appendix E now records 325 generated chapter-level rows plus a separate repository-level check section. |
...
- That all 124 finite-record Lean targets are the best formalization of the intended chapter boundaries.
