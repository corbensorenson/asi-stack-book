...
| Chapter body words | 168,069 | The book is already full-length; the main risk is not shortness. |
| Raw chapter-file words | 175,554 | Live scaffolding adds useful AI/research overhead beyond the reader spine. |
...
| Test appendix rows | 244 | Appendix E now records 244 generated chapter-level rows plus a separate repository-level check section. |
