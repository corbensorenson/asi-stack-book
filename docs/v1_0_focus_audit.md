...
| Chapter body words | 169,368 | The book is already full-length; the main risk is not shortness. |
| Raw chapter-file words | 177,000 | Live scaffolding adds useful AI/research overhead beyond the reader spine. |
...
| Test appendix rows | 312 | Appendix E now records 312 generated chapter-level rows plus a separate repository-level check section. |
