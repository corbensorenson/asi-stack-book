...
| Chapter body words | 171,883 | The book is already full-length; the main risk is not shortness. |
| Raw chapter-file words | 179,755 | Live scaffolding adds useful AI/research overhead beyond the reader spine. |
...
| Test appendix rows | 331 | Appendix E now records 331 generated chapter-level rows plus a separate repository-level check section. |
...
- That all 130 finite-record Lean targets are the best formalization of the intended chapter boundaries.
