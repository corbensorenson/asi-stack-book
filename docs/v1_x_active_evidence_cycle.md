...
cycle selects seven high-payoff lanes and leaves the other forty-seven chapter
...
| No-sweep rule | No 54-lane fixture sweep is claimed or implied. |
...
|---|---|---|---|---|---|---|
| `evidence-states-and-claim-discipline` | executed-narrow | Claim/evidence ledgers and explicit no-promotion decisions | `docs/non_core_evidence_ledger.md`; `docs/core_claim_transition_coverage.md`; `claim_decisions/v1_0_core_claim_no_promotion.json` | No-promotion decisions and support-state transition validators reject unsupported promotion. | No chapter core promotion; core claim remains `argument`. | External review and prior-art comparison before stronger methodology claims. |
...
| `resource-economics-and-token-budgets` | executed-narrow | Costed-route/resource-budget synthetic slice | `docs/costed_route_resource_slice.md`; `experiments/costed_route_resource_slice/results/2026-06-29-local.json`; `evidence_transitions/v1_0_measured/costed_route_resource_slice_synthetic_test_backed.json` | Cheaper failed route is rejected; adequate overkill baseline remains eligible. | Non-core `resource-economics.costed_route_budget_slice` is `synthetic-test-backed`; chapter core remains `argument`. | Larger public trace with workload quality and displaced-cost accounting. |
...
| `living-book-methodology` | executed-narrow | Phase 5 harness registry runner plus release-control validators | `docs/phase5_harness_runner.md`; `experiments/phase5_harness_registry.json`; `evidence_transitions/v1_0_measured/phase5_harness_runner_synthetic_test_backed.json` | Registry guard checks command, doc, fixture-count, result, Appendix E, public-status, and non-claim wiring. | Non-core `living-book-methodology.phase5_harness_registry_runner` is `synthetic-test-backed`; chapter core remains `argument`. | External review and no-ledger-sprawl prior-art comparison. |
