...
| `military-ai-autonomous-weapons-and-strategic-stability` | 4 | 4 | 4 | 4 | 0 | argument | passage review required before source-derived promotion |
| `evidence-states-and-claim-discipline` | 17 | 16 | 17 | 17 | 16 | argument | passage review required before source-derived promotion |
| `scalable-oversight-and-adversarial-ai-control` | 8 | 8 | 8 | 8 | 8 | argument | eligible for support review |
| `human-intent-as-a-formal-input` | 9 | 8 | 9 | 9 | 8 | argument | passage review required before source-derived promotion |
| `human-factors-and-meaningful-control-in-oversight` | 10 | 10 | 10 | 10 | 10 | argument | eligible for support review |
| `human-ai-communication-persuasion-and-epistemic-security` | 6 | 3 | 6 | 6 | 0 | argument | passage review required before source-derived promotion |
| `constitutional-alignment-substrate` | 14 | 14 | 14 | 14 | 14 | argument | eligible for support review |
| `inner-alignment-mesa-optimization-and-learned-objective-integrity` | 6 | 6 | 6 | 6 | 6 | argument | eligible for support review |
...
| `stable-capability-fields` | 12 | 10 | 12 | 12 | 10 | argument | passage review required before source-derived promotion |
...
| `confidential-and-verifiable-ai-computation` | 3 | 3 | 3 | 3 | 0 | argument | passage review required before source-derived promotion |
...
| `recursive-self-improvement-boundaries` | 20 | 16 | 20 | 20 | 16 | argument | passage review required before source-derived promotion |
| `open-ended-improvement-engines` | 9 | 8 | 9 | 9 | 8 | argument | passage review required before source-derived promotion |
...
| `human-ai-organizations-delegation-and-accountability` | 10 | 7 | 10 | 10 | 7 | argument | passage review required before source-derived promotion |
...
| `artifact-graphs-audit-logs-and-replay` | 25 | 22 | 25 | 25 | 22 | argument | passage review required before source-derived promotion |
| `runtime-adapters-tool-permissions-and-human-approval` | 31 | 28 | 31 | 31 | 28 | argument | passage review required before source-derived promotion |
| `embodied-agency-real-time-control-and-physical-safety` | 9 | 9 | 9 | 9 | 9 | argument | eligible for support review |
| `inter-stack-protocols-identity-and-economic-exchange` | 12 | 11 | 12 | 12 | 11 | argument | passage review required before source-derived promotion |
| `multi-agent-dynamics-collective-intelligence-and-systemic-risk` | 7 | 6 | 7 | 7 | 6 | argument | passage review required before source-derived promotion |
| `procedural-memory-and-cognitive-loop-closure` | 30 | 24 | 30 | 30 | 24 | argument | passage review required before source-derived promotion |
| `routing-heads-and-specialist-cores` | 25 | 20 | 25 | 25 | 20 | argument | passage review required before source-derived promotion |
| `replaceable-cognitive-substrates-beyond-transformer-monoculture` | 53 | 42 | 53 | 53 | 42 | argument | passage review required before source-derived promotion |
...
| `governed-model-training-distributed-optimization-and-scaling` | 33 | 31 | 33 | 33 | 31 | argument | passage review required before source-derived promotion |
| `learning-compute-topology-and-adaptive-process-architecture` | 6 | 6 | 6 | 6 | 6 | argument | eligible for support review |
| `learning-theory-generalization-and-scaling-science` | 14 | 12 | 14 | 14 | 4 | argument | passage review required before source-derived promotion |
| `readiness-gates-residual-escrow-and-quarantine` | 24 | 21 | 24 | 24 | 21 | argument | passage review required before source-derived promotion |
...
| `rankfold-neuralfold-and-artifact-compression` | 8 | 7 | 8 | 8 | 7 | argument | passage review required before source-derived promotion |
| `resource-economics-and-token-budgets` | 49 | 24 | 49 | 49 | 24 | argument | passage review required before source-derived promotion |
...
| `executable-specifications-and-lean-proof-envelope` | 15 | 14 | 15 | 15 | 14 | argument | passage review required before source-derived promotion |
| `benchmark-ratchets-and-anti-goodhart-evidence` | 49 | 38 | 49 | 49 | 38 | argument | passage review required before source-derived promotion |
...
| `adversarial-evaluation-sandbagging-and-training-time-deception` | 12 | 11 | 12 | 12 | 11 | argument | passage review required before source-derived promotion |
...
| `governed-operations-incident-command-and-graceful-degradation` | 12 | 11 | 12 | 12 | 11 | argument | passage review required before source-derived promotion |
| `adjudicated-persistence-and-the-adaptive-commit-boundary` | 10 | 10 | 10 | 10 | 10 | argument | eligible for support review |
...
| `open-research-agenda-and-bibliography-plan` | 31 | 29 | 31 | 31 | 29 | argument | passage review required before source-derived promotion |
...
|---|---:|---|
| `talos` | 29 | yes |
| `deterministic_capability_compilation` | 29 | yes |
| `viea` | 27 | yes |
| `platonic_world_model` | 24 | yes |
| `moecot` | 22 | yes |
| `benchmaxxing` | 20 | yes |
| `scf` | 18 | yes |
| `rmi` | 18 | yes |
...
| `cca_project` | 16 | yes |
| `adjudicated_persistence` | 16 | yes |
| `spinoza` | 15 | yes |
| `corbens_best_model_possible_project` | 14 | yes |
| `vcm_public` | 14 | yes |
| `coherence_exchange` | 14 | yes |
| `assurance_shift_learning` | 14 | yes |
| `cognitive_loop_closure` | 14 | yes |
...
| `planforge` | 11 | yes |
| `learning_compute_topology` | 11 | yes |
| `regret_engine` | 11 | yes |
| `genesiscode` | 10 | yes |
| `verification_bandwidth` | 10 | yes |
| `theseus_operator_os` | 10 | yes |
| `relational_dimension_compiler` | 10 | yes |
...
| `forward_transfer_program_synthesis` | 8 | yes |
...
| `ext_international_ai_safety_report_2026` | 5 | yes |
| `uat` | 5 | yes |
| `ext_w3c_prov_o_2013` | 5 | yes |
| `software_magic_grimoire` | 5 | yes |
| `ext_airllm_2023` | 5 | yes |
| `ext_hf_accelerate_big_model_inference_2026` | 5 | yes |
| `ext_llm_in_flash_2024` | 5 | yes |
...
| `ext_eggroll_hyperscale_es_2026` | 5 | yes |
| `aletheia` | 4 | yes |
...
| `ext_llama_cpp_memory_mapping_2026` | 4 | yes |
...
| `ext_powerinfer_2024` | 4 | yes |
| `ext_atsinfer_2026` | 4 | yes |
| `ext_openai_es_2017` | 4 | yes |
| `bugbrain` | 4 | yes |
...
| `road_to_agi` | 4 | yes |
| `bbvca_v9` | 3 | yes |
| `ext_goal_misgeneralization_2022` | 3 | yes |
| `ext_learned_optimization_risks_2019` | 3 | yes |
| `ext_unlearning_benchmarks_weak_2024` | 3 | yes |
| `ext_cultural_alignment_llms_2024` | 3 | yes |
| `ext_corrigibility_2015` | 3 | yes |
| `ext_emergent_misalignment_reward_hacking_2025` | 3 | yes |
| `ext_flexible_hardware_enabled_guarantees_2025` | 3 | yes |
...
| `ext_bourtoule_machine_unlearning_2021` | 3 | yes |
| `ext_openai_prompt_caching_docs_2026` | 3 | yes |
| `ext_anthropic_prompt_caching_docs_2026` | 3 | yes |
| `ext_gemini_context_caching_docs_2026` | 3 | yes |
| `ext_vllm_automatic_prefix_caching_2026` | 3 | yes |
...
| `ext_scaling_laws_neural_language_models_2020` | 2 | yes |
| `field_of_god` | 2 | yes |
| `ext_optimal_policies_power_2019` | 2 | yes |
| `ext_gradual_disempowerment_2025` | 2 | yes |
| `ext_model_evaluation_extreme_risks_2023` | 2 | yes |
| `ext_openai_preparedness_framework_2025` | 2 | yes |
| `ext_openai_worst_case_open_weight_risks_2025` | 2 | yes |
| `ext_aisi_misuse_safeguards_safety_case_2026` | 2 | yes |
| `ext_anthropic_responsible_scaling_policy_3_4_2026` | 2 | yes |
| `ext_icrc_autonomous_weapons_ihl_2025` | 2 | yes |
| `ext_weak_to_strong_generalization_2023` | 2 | yes |
| `ext_ai_safety_debate_2018` | 2 | yes |
| `ext_monitorbench_2026` | 2 | yes |
| `ext_conversational_persuasion_gpt4_2025` | 2 | yes |
| `ext_anthropic_model_persuasiveness_2024` | 2 | yes |
| `ext_commercial_persuasion_ai_2026` | 2 | yes |
| `ext_cooperative_inverse_rl_2016` | 2 | yes |
...
| `ext_multilingual_evaluation_state_2026` | 2 | yes |
| `ethica_mechanica` | 2 | yes |
| `ext_collective_constitutional_ai_2024` | 2 | yes |
| `ext_off_switch_game_2016` | 2 | yes |
| `ext_legal_alignment_2026` | 2 | yes |
| `ext_sleeper_agents_2024` | 2 | yes |
| `ext_contestable_ai_design_2022` | 2 | yes |
| `ext_eu_article_50_transparency_guidelines_2026` | 2 | yes |
| `ext_eu_ai_civil_liability_2025` | 2 | yes |
| `ext_nist_incident_response_2025` | 2 | yes |
| `ext_nist_pqc_standards_2024` | 2 | yes |
| `ext_carlini_training_data_extraction_2021` | 2 | yes |
| `ext_adversarial_sensor_fusion_2022` | 2 | yes |
| `theseus_synthetic_data_curation` | 2 | yes |
| `ext_nist_privacy_enhancing_cryptography_2026` | 2 | yes |
| `ext_who_neurotechnology_landscape_2025` | 2 | yes |
| `ext_ietf_rats_architecture_2023` | 2 | yes |
| `ext_rand_model_weight_security_2024` | 2 | yes |
| `ext_provable_model_weight_release_2025` | 2 | yes |
| `ext_proof_of_learning_2021` | 2 | yes |
| `ext_c2pa_specification_2_3_2025` | 2 | yes |
| `ext_voyager_2023` | 2 | yes |
| `ext_gemini_robotics_2025` | 2 | yes |
...
| `ext_titans_2025` | 2 | yes |
| `ext_gpqa_2023` | 2 | yes |
| `ext_lean4_theorem_proving` | 2 | yes |
| `ext_generative_ai_at_work_2025` | 2 | yes |
...
| `ext_scaling_dllms_2026` | 2 | yes |
| `ext_neuromorphic_computing_scale_2025` | 2 | yes |
| `ext_photonic_neuromorphic_2024` | 2 | yes |
| `ext_quantum_ml_shadows_2024` | 2 | yes |
| `ext_megatron_distributed_training_2021` | 2 | yes |
| `ext_gspmd_2021` | 2 | yes |
| `ext_curriculum_learning_2009` | 2 | yes |
| `ext_akash_docs_2026` | 2 | yes |
| `ext_golem_docs_2025` | 2 | yes |
| `ext_github_self_hosted_runners_docs` | 2 | yes |
| `ext_vattention_2025` | 2 | yes |
| `ext_infinigen_2024` | 2 | yes |
| `ext_specache_2025` | 2 | yes |
| `ext_specoffload_2025` | 2 | yes |
| `ext_sglang_radixattention_2024` | 2 | yes |
| `ext_prompt_cache_2024` | 2 | yes |
| `ext_mooncake_2025` | 2 | yes |
...
| `ext_chinchilla_compute_optimal_2022` | 1 | yes |
| `ext_emergent_abilities_2022` | 1 | yes |
| `ext_emergence_mirage_2023` | 1 | yes |
| `ext_concrete_ai_safety_2016` | 1 | yes |
| `ext_goodhart_variants_2018` | 1 | yes |
| `ext_aisi_frontier_ai_trends_2025` | 1 | yes |
| `ext_sipri_military_ai_nuclear_escalation_2025` | 1 | yes |
...
| `ext_taking_ai_welfare_seriously_2024` | 1 | yes |
| `ext_un_global_digital_compact_2024` | 1 | yes |
| `ext_council_europe_ai_convention_2024` | 1 | yes |
...
| `ext_nist_adversarial_ml_2024` | 1 | yes |
...
| `ext_replibench_2025` | 1 | yes |
| `ext_multimodal_machine_learning_taxonomy_2019` | 1 | yes |
| `ext_imagebind_2023` | 1 | yes |
| `ext_3d_detection_corruptions_2023` | 1 | yes |
| `ext_world_models_2018` | 1 | yes |
| `ext_dreamer_v3_2025` | 1 | yes |
| `ext_toward_causal_representation_learning_2021` | 1 | yes |
| `ext_causal_calculus_1995` | 1 | yes |
...
| `ext_ilo_genai_jobs_index_2025` | 1 | yes |
| `spinoza_composer` | 1 | yes |
| `ext_foundation_robotics_physical_risk_2025` | 1 | yes |
| `ext_control_barrier_functions_2019` | 1 | yes |
| `ext_simplex_architecture_1998` | 1 | yes |
| `ext_safe_reinforcement_learning_survey_2015` | 1 | yes |
| `ext_ai_simulation_digital_twins_2025` | 1 | yes |
...
| `ext_multi_agent_risks_2025` | 1 | yes |
| `ext_cooperative_ai_foundations_2023` | 1 | yes |
| `ext_functional_decision_theory_2017` | 1 | yes |
...
| `ext_organoid_intelligence_2023` | 1 | yes |
...
| `ext_emergent_abilities_llms_2022` | 1 | yes |
| `ext_emergent_abilities_mirage_2023` | 1 | yes |
| `ext_no_free_lunch_inductive_bias_2024` | 1 | yes |
...
| `the-efficient-asi-hypothesis.core` | `the-efficient-asi-hypothesis` | `ext_scaling_laws_neural_language_models_2020` | mapped | note present | chapter listed | passage-reviewed |
...
| `dangerous-capability-domains-and-misuse-uplift.core` | `dangerous-capability-domains-and-misuse-uplift` | `ext_model_evaluation_extreme_risks_2023` | mapped | note present | chapter listed | not passage-reviewed |
| `dangerous-capability-domains-and-misuse-uplift.core` | `dangerous-capability-domains-and-misuse-uplift` | `ext_openai_preparedness_framework_2025` | mapped | note present | chapter listed | not passage-reviewed |
| `dangerous-capability-domains-and-misuse-uplift.core` | `dangerous-capability-domains-and-misuse-uplift` | `ext_singapore_consensus_2026` | mapped | note present | chapter listed | not passage-reviewed |
| `dangerous-capability-domains-and-misuse-uplift.core` | `dangerous-capability-domains-and-misuse-uplift` | `ext_international_ai_safety_report_2026` | mapped | note present | chapter listed | not passage-reviewed |
| `dangerous-capability-domains-and-misuse-uplift.core` | `dangerous-capability-domains-and-misuse-uplift` | `ext_openai_worst_case_open_weight_risks_2025` | mapped | note present | chapter listed | not passage-reviewed |
...
| `military-ai-autonomous-weapons-and-strategic-stability.core` | `military-ai-autonomous-weapons-and-strategic-stability` | `ext_icrc_autonomous_weapons_ihl_2025` | mapped | note present | chapter listed | not passage-reviewed |
| `military-ai-autonomous-weapons-and-strategic-stability.core` | `military-ai-autonomous-weapons-and-strategic-stability` | `ext_sipri_military_ai_nuclear_escalation_2025` | mapped | note present | chapter listed | not passage-reviewed |
| `military-ai-autonomous-weapons-and-strategic-stability.core` | `military-ai-autonomous-weapons-and-strategic-stability` | `ext_singapore_consensus_2026` | mapped | note present | chapter listed | not passage-reviewed |
| `military-ai-autonomous-weapons-and-strategic-stability.core` | `military-ai-autonomous-weapons-and-strategic-stability` | `ext_international_ai_safety_report_2026` | mapped | note present | chapter listed | not passage-reviewed |
...
| `evidence-states-and-claim-discipline.core` | `evidence-states-and-claim-discipline` | `assurance_shift_learning` | mapped | note present | chapter listed | passage-reviewed |
| `evidence-states-and-claim-discipline.core` | `evidence-states-and-claim-discipline` | `adjudicated_persistence` | mapped | note present | chapter listed | passage-reviewed |
...
| `human-intent-as-a-formal-input.core` | `human-intent-as-a-formal-input` | `ext_cultural_alignment_llms_2024` | unmapped | note present | chapter listed | not passage-reviewed |
...
| `human-ai-communication-persuasion-and-epistemic-security.core` | `human-ai-communication-persuasion-and-epistemic-security` | `talos` | unmapped | note present | chapter listed | not passage-reviewed |
| `human-ai-communication-persuasion-and-epistemic-security.core` | `human-ai-communication-persuasion-and-epistemic-security` | `ext_conversational_persuasion_gpt4_2025` | mapped | note present | chapter listed | not passage-reviewed |
| `human-ai-communication-persuasion-and-epistemic-security.core` | `human-ai-communication-persuasion-and-epistemic-security` | `ext_anthropic_model_persuasiveness_2024` | mapped | note present | chapter listed | not passage-reviewed |
| `human-ai-communication-persuasion-and-epistemic-security.core` | `human-ai-communication-persuasion-and-epistemic-security` | `ext_commercial_persuasion_ai_2026` | mapped | note present | chapter listed | not passage-reviewed |
| `human-ai-communication-persuasion-and-epistemic-security.core` | `human-ai-communication-persuasion-and-epistemic-security` | `ext_cultural_alignment_llms_2024` | unmapped | note present | chapter listed | not passage-reviewed |
| `human-ai-communication-persuasion-and-epistemic-security.core` | `human-ai-communication-persuasion-and-epistemic-security` | `ext_multilingual_evaluation_state_2026` | unmapped | note present | chapter listed | not passage-reviewed |
...
| `constitutional-alignment-substrate.core` | `constitutional-alignment-substrate` | `ext_legal_alignment_2026` | mapped | note present | chapter listed | passage-reviewed |
| `inner-alignment-mesa-optimization-and-learned-objective-integrity.core` | `inner-alignment-mesa-optimization-and-learned-objective-integrity` | `ext_learned_optimization_risks_2019` | mapped | note present | chapter listed | passage-reviewed |
| `inner-alignment-mesa-optimization-and-learned-objective-integrity.core` | `inner-alignment-mesa-optimization-and-learned-objective-integrity` | `ext_goal_misgeneralization_2022` | mapped | note present | chapter listed | passage-reviewed |
| `inner-alignment-mesa-optimization-and-learned-objective-integrity.core` | `inner-alignment-mesa-optimization-and-learned-objective-integrity` | `ext_sleeper_agents_2024` | mapped | note present | chapter listed | passage-reviewed |
| `inner-alignment-mesa-optimization-and-learned-objective-integrity.core` | `inner-alignment-mesa-optimization-and-learned-objective-integrity` | `ext_emergent_misalignment_reward_hacking_2025` | mapped | note present | chapter listed | passage-reviewed |
| `inner-alignment-mesa-optimization-and-learned-objective-integrity.core` | `inner-alignment-mesa-optimization-and-learned-objective-integrity` | `ext_optimal_policies_power_2019` | mapped | note present | chapter listed | passage-reviewed |
| `inner-alignment-mesa-optimization-and-learned-objective-integrity.core` | `inner-alignment-mesa-optimization-and-learned-objective-integrity` | `alignment_field` | mapped | note present | chapter listed | passage-reviewed |
...
| `moral-uncertainty-and-value-conflict.core` | `moral-uncertainty-and-value-conflict` | `ext_taking_ai_welfare_seriously_2024` | mapped | note present | chapter listed | passage-reviewed |
| `governed-objective-formation-value-learning-and-goal-integrity.core` | `governed-objective-formation-value-learning-and-goal-integrity` | `alignment_field` | unmapped | note present | chapter listed | not passage-reviewed |
| `governed-objective-formation-value-learning-and-goal-integrity.core` | `governed-objective-formation-value-learning-and-goal-integrity` | `ext_cooperative_inverse_rl_2016` | mapped | note present | chapter listed | not passage-reviewed |
| `governed-objective-formation-value-learning-and-goal-integrity.core` | `governed-objective-formation-value-learning-and-goal-integrity` | `ext_goal_misgeneralization_2022` | mapped | note present | chapter listed | not passage-reviewed |
| `governed-objective-formation-value-learning-and-goal-integrity.core` | `governed-objective-formation-value-learning-and-goal-integrity` | `ext_learned_optimization_risks_2019` | mapped | note present | chapter listed | not passage-reviewed |
| `governed-objective-formation-value-learning-and-goal-integrity.core` | `governed-objective-formation-value-learning-and-goal-integrity` | `ext_emergent_misalignment_reward_hacking_2025` | mapped | note present | chapter listed | not passage-reviewed |
| `institutions-international-coordination-and-public-legitimacy.core` | `institutions-international-coordination-and-public-legitimacy` | `coherence_exchange` | unmapped | note present | chapter listed | not passage-reviewed |
| `institutions-international-coordination-and-public-legitimacy.core` | `institutions-international-coordination-and-public-legitimacy` | `ext_un_global_digital_compact_2024` | mapped | note present | chapter listed | not passage-reviewed |
| `institutions-international-coordination-and-public-legitimacy.core` | `institutions-international-coordination-and-public-legitimacy` | `ext_council_europe_ai_convention_2024` | mapped | note present | chapter listed | not passage-reviewed |
| `institutions-international-coordination-and-public-legitimacy.core` | `institutions-international-coordination-and-public-legitimacy` | `ext_flexible_hardware_enabled_guarantees_2025` | mapped | note present | chapter listed | passage-reviewed |
| `institutions-international-coordination-and-public-legitimacy.core` | `institutions-international-coordination-and-public-legitimacy` | `ext_legal_alignment_2026` | mapped | note present | chapter listed | passage-reviewed |
| `institutions-international-coordination-and-public-legitimacy.core` | `institutions-international-coordination-and-public-legitimacy` | `ext_eu_article_50_transparency_guidelines_2026` | mapped | note present | chapter listed | passage-reviewed |
| `institutions-international-coordination-and-public-legitimacy.core` | `institutions-international-coordination-and-public-legitimacy` | `ext_oecd_ai_infrastructure_competition_2025` | unmapped | note present | chapter listed | not passage-reviewed |
| `institutions-international-coordination-and-public-legitimacy.core` | `institutions-international-coordination-and-public-legitimacy` | `ext_eu_ai_civil_liability_2025` | unmapped | note present | chapter listed | not passage-reviewed |
| `institutions-international-coordination-and-public-legitimacy.core` | `institutions-international-coordination-and-public-legitimacy` | `ext_icrc_autonomous_weapons_ihl_2025` | unmapped | note present | chapter listed | not passage-reviewed |
| `societal-resilience-and-misuse-defense.core` | `societal-resilience-and-misuse-defense` | `ext_nist_incident_response_2025` | mapped | note present | chapter listed | not passage-reviewed |
...
| `stable-capability-fields.core` | `stable-capability-fields` | `assurance_shift_learning` | mapped | note present | chapter listed | passage-reviewed |
| `stable-capability-fields.core` | `stable-capability-fields` | `adjudicated_persistence` | mapped | note present | chapter listed | passage-reviewed |
...
| `security-kernel-and-digital-scifs.core` | `security-kernel-and-digital-scifs` | `ext_nist_pqc_standards_2024` | unmapped | note present | chapter listed | not passage-reviewed |
| `adversarial-machine-learning-and-model-attack-surface.core` | `adversarial-machine-learning-and-model-attack-surface` | `deterministic_capability_compilation` | unmapped | note present | chapter listed | not passage-reviewed |
| `adversarial-machine-learning-and-model-attack-surface.core` | `adversarial-machine-learning-and-model-attack-surface` | `ext_nist_adversarial_ml_2024` | mapped | note present | chapter listed | not passage-reviewed |
| `adversarial-machine-learning-and-model-attack-surface.core` | `adversarial-machine-learning-and-model-attack-surface` | `ext_sleeper_agents_2024` | mapped | note present | chapter listed | not passage-reviewed |
| `adversarial-machine-learning-and-model-attack-surface.core` | `adversarial-machine-learning-and-model-attack-surface` | `ext_carlini_training_data_extraction_2021` | mapped | note present | chapter listed | not passage-reviewed |
| `adversarial-machine-learning-and-model-attack-surface.core` | `adversarial-machine-learning-and-model-attack-surface` | `ext_adversarial_sensor_fusion_2022` | mapped | note present | chapter listed | not passage-reviewed |
| `adversarial-machine-learning-and-model-attack-surface.core` | `adversarial-machine-learning-and-model-attack-surface` | `ext_reluplex_2017` | mapped | note present | chapter listed | passage-reviewed |
...
| `privacy-data-rights-and-information-flow-governance.core` | `privacy-data-rights-and-information-flow-governance` | `ext_nist_privacy_enhancing_cryptography_2026` | unmapped | note present | chapter listed | not passage-reviewed |
| `privacy-data-rights-and-information-flow-governance.core` | `privacy-data-rights-and-information-flow-governance` | `ext_who_neurotechnology_landscape_2025` | unmapped | note present | chapter listed | not passage-reviewed |
| `confidential-and-verifiable-ai-computation.core` | `confidential-and-verifiable-ai-computation` | `ext_nist_privacy_enhancing_cryptography_2026` | mapped | note present | chapter listed | not passage-reviewed |
| `confidential-and-verifiable-ai-computation.core` | `confidential-and-verifiable-ai-computation` | `ext_zkllm_2024` | mapped | note present | chapter listed | not passage-reviewed |
| `confidential-and-verifiable-ai-computation.core` | `confidential-and-verifiable-ai-computation` | `ext_ietf_rats_architecture_2023` | mapped | note present | chapter listed | not passage-reviewed |
...
| `model-weight-custody-and-hardware-roots-of-trust.core` | `model-weight-custody-and-hardware-roots-of-trust` | `ext_airllm_2023` | unmapped | note present | chapter listed | not passage-reviewed |
...
| `model-weight-custody-and-hardware-roots-of-trust.core` | `model-weight-custody-and-hardware-roots-of-trust` | `ext_flexible_hardware_enabled_guarantees_2025` | mapped | note present | chapter listed | passage-reviewed |
| `model-weight-custody-and-hardware-roots-of-trust.core` | `model-weight-custody-and-hardware-roots-of-trust` | `ext_nist_pqc_standards_2024` | unmapped | note present | chapter listed | not passage-reviewed |
| `open-weight-release-and-post-release-control.core` | `open-weight-release-and-post-release-control` | `ext_provable_model_weight_release_2025` | mapped | note present | chapter listed | not passage-reviewed |
| `open-weight-release-and-post-release-control.core` | `open-weight-release-and-post-release-control` | `ext_rand_model_weight_security_2024` | mapped | note present | chapter listed | not passage-reviewed |
| `open-weight-release-and-post-release-control.core` | `open-weight-release-and-post-release-control` | `ext_singapore_consensus_2026` | mapped | note present | chapter listed | not passage-reviewed |
...
| `ai-supply-chain-integrity-and-lifecycle-provenance.core` | `ai-supply-chain-integrity-and-lifecycle-provenance` | `ext_proof_of_learning_2021` | mapped | note present | chapter listed | passage-reviewed |
| `ai-supply-chain-integrity-and-lifecycle-provenance.core` | `ai-supply-chain-integrity-and-lifecycle-provenance` | `ext_c2pa_specification_2_3_2025` | mapped | note present | chapter listed | passage-reviewed |
...
| `recursive-self-improvement-boundaries.core` | `recursive-self-improvement-boundaries` | `adjudicated_persistence` | mapped | note present | chapter listed | passage-reviewed |
| `recursive-self-improvement-boundaries.core` | `recursive-self-improvement-boundaries` | `forward_transfer_program_synthesis` | mapped | note present | chapter listed | passage-reviewed |
| `open-ended-improvement-engines.core` | `open-ended-improvement-engines` | `learning_compute_topology` | unmapped | note present | chapter listed | not passage-reviewed |
...
| `autonomous-replication-proliferation-and-containment.core` | `autonomous-replication-proliferation-and-containment` | `deterministic_capability_compilation` | unmapped | note present | chapter listed | not passage-reviewed |
| `autonomous-replication-proliferation-and-containment.core` | `autonomous-replication-proliferation-and-containment` | `ext_replibench_2025` | mapped | note present | chapter listed | not passage-reviewed |
...
| `perception-sensor-fusion-and-observation-trust.core` | `perception-sensor-fusion-and-observation-trust` | `ext_multimodal_machine_learning_taxonomy_2019` | mapped | note present | chapter listed | passage-reviewed |
| `perception-sensor-fusion-and-observation-trust.core` | `perception-sensor-fusion-and-observation-trust` | `ext_imagebind_2023` | mapped | note present | chapter listed | passage-reviewed |
| `perception-sensor-fusion-and-observation-trust.core` | `perception-sensor-fusion-and-observation-trust` | `ext_3d_detection_corruptions_2023` | mapped | note present | chapter listed | passage-reviewed |
| `perception-sensor-fusion-and-observation-trust.core` | `perception-sensor-fusion-and-observation-trust` | `ext_adversarial_sensor_fusion_2022` | mapped | note present | chapter listed | passage-reviewed |
| `perception-sensor-fusion-and-observation-trust.core` | `perception-sensor-fusion-and-observation-trust` | `ext_gemini_robotics_2025` | mapped | note present | chapter listed | passage-reviewed |
| `perception-sensor-fusion-and-observation-trust.core` | `perception-sensor-fusion-and-observation-trust` | `platonic_world_model` | mapped | note present | chapter listed | passage-reviewed |
...
| `planning-as-a-control-layer.core` | `planning-as-a-control-layer` | `regret_engine` | unmapped | note present | chapter listed | not passage-reviewed |
...
| `virtual-context-abi.core` | `virtual-context-abi` | `ext_pagedattention_vllm_2023` | unmapped | note present | chapter listed | not passage-reviewed |
...
| `durable-semantic-memory-and-knowledge-lattices.core` | `durable-semantic-memory-and-knowledge-lattices` | `treellm` | mapped | note present | chapter listed | passage-reviewed |
| `durable-semantic-memory-and-knowledge-lattices.core` | `durable-semantic-memory-and-knowledge-lattices` | `portia_synapse` | mapped | note present | chapter listed | passage-reviewed |
...
| `durable-semantic-memory-and-knowledge-lattices.core` | `durable-semantic-memory-and-knowledge-lattices` | `ext_titans_2025` | mapped | note present | chapter listed | not passage-reviewed |
| `durable-semantic-memory-and-knowledge-lattices.core` | `durable-semantic-memory-and-knowledge-lattices` | `ext_hermes_agent_2026` | mapped | note present | chapter listed | passage-reviewed |
| `durable-semantic-memory-and-knowledge-lattices.core` | `durable-semantic-memory-and-knowledge-lattices` | `adjudicated_persistence` | mapped | note present | chapter listed | passage-reviewed |
...
| `context-transactions-snapshots-mounts-and-taint.core` | `context-transactions-snapshots-mounts-and-taint` | `ext_openai_prompt_caching_docs_2026` | unmapped | note present | chapter listed | not passage-reviewed |
| `context-transactions-snapshots-mounts-and-taint.core` | `context-transactions-snapshots-mounts-and-taint` | `ext_anthropic_prompt_caching_docs_2026` | unmapped | note present | chapter listed | not passage-reviewed |
| `context-transactions-snapshots-mounts-and-taint.core` | `context-transactions-snapshots-mounts-and-taint` | `ext_gemini_context_caching_docs_2026` | unmapped | note present | chapter listed | not passage-reviewed |
| `context-transactions-snapshots-mounts-and-taint.core` | `context-transactions-snapshots-mounts-and-taint` | `ext_vllm_automatic_prefix_caching_2026` | unmapped | note present | chapter listed | not passage-reviewed |
| `context-transactions-snapshots-mounts-and-taint.core` | `context-transactions-snapshots-mounts-and-taint` | `ext_azure_llm_semantic_cache_2026` | unmapped | note present | chapter listed | not passage-reviewed |
...
| `claim-ledgers-and-belief-revision.core` | `claim-ledgers-and-belief-revision` | `regret_engine` | unmapped | note present | chapter listed | not passage-reviewed |
...
| `human-ai-organizations-delegation-and-accountability.core` | `human-ai-organizations-delegation-and-accountability` | `ext_generative_ai_at_work_2025` | mapped | note present | chapter listed | passage-reviewed |
| `human-ai-organizations-delegation-and-accountability.core` | `human-ai-organizations-delegation-and-accountability` | `ext_constructive_interdependence_human_ai_2026` | mapped | note present | chapter listed | passage-reviewed |
| `human-ai-organizations-delegation-and-accountability.core` | `human-ai-organizations-delegation-and-accountability` | `talos` | mapped | note present | chapter listed | passage-reviewed |
| `human-ai-organizations-delegation-and-accountability.core` | `human-ai-organizations-delegation-and-accountability` | `ext_human_ai_team_meta_analysis_2024` | unmapped | note present | chapter listed | not passage-reviewed |
| `human-ai-organizations-delegation-and-accountability.core` | `human-ai-organizations-delegation-and-accountability` | `ext_human_ai_feedback_loops_2025` | unmapped | note present | chapter listed | not passage-reviewed |
| `human-ai-organizations-delegation-and-accountability.core` | `human-ai-organizations-delegation-and-accountability` | `ext_eu_ai_civil_liability_2025` | unmapped | note present | chapter listed | not passage-reviewed |
| `human-ai-organizations-delegation-and-accountability.core` | `human-ai-organizations-delegation-and-accountability` | `adjudicated_persistence` | mapped | note present | chapter listed | passage-reviewed |
| `human-ai-symbiosis-neurotechnology-and-cognitive-sovereignty.core` | `human-ai-symbiosis-neurotechnology-and-cognitive-sovereignty` | `ext_human_ai_team_meta_analysis_2024` | mapped | note present | chapter listed | not passage-reviewed |
| `human-ai-symbiosis-neurotechnology-and-cognitive-sovereignty.core` | `human-ai-symbiosis-neurotechnology-and-cognitive-sovereignty` | `ext_human_ai_feedback_loops_2025` | mapped | note present | chapter listed | not passage-reviewed |
| `human-ai-symbiosis-neurotechnology-and-cognitive-sovereignty.core` | `human-ai-symbiosis-neurotechnology-and-cognitive-sovereignty` | `ext_oecd_neuro_ai_convergence_2025` | mapped | note present | chapter listed | not passage-reviewed |
| `human-ai-symbiosis-neurotechnology-and-cognitive-sovereignty.core` | `human-ai-symbiosis-neurotechnology-and-cognitive-sovereignty` | `ext_who_neurotechnology_landscape_2025` | mapped | note present | chapter listed | not passage-reviewed |
| `ai-deployment-transition-distribution-and-human-agency.core` | `ai-deployment-transition-distribution-and-human-agency` | `coherence_exchange` | unmapped | note present | chapter listed | not passage-reviewed |
| `ai-deployment-transition-distribution-and-human-agency.core` | `ai-deployment-transition-distribution-and-human-agency` | `ext_generative_ai_at_work_2025` | mapped | note present | chapter listed | not passage-reviewed |
| `ai-deployment-transition-distribution-and-human-agency.core` | `ai-deployment-transition-distribution-and-human-agency` | `ext_ilo_genai_jobs_index_2025` | mapped | note present | chapter listed | not passage-reviewed |
| `ai-deployment-transition-distribution-and-human-agency.core` | `ai-deployment-transition-distribution-and-human-agency` | `ext_oecd_ai_infrastructure_competition_2025` | unmapped | note present | chapter listed | not passage-reviewed |
...
| `artifact-graphs-audit-logs-and-replay.core` | `artifact-graphs-audit-logs-and-replay` | `regret_engine` | unmapped | note present | chapter listed | not passage-reviewed |
| `artifact-graphs-audit-logs-and-replay.core` | `artifact-graphs-audit-logs-and-replay` | `ext_openclaw_agent_runtime_2026` | mapped | note present | chapter listed | passage-reviewed |
| `artifact-graphs-audit-logs-and-replay.core` | `artifact-graphs-audit-logs-and-replay` | `assurance_shift_learning` | mapped | note present | chapter listed | passage-reviewed |
| `artifact-graphs-audit-logs-and-replay.core` | `artifact-graphs-audit-logs-and-replay` | `adjudicated_persistence` | mapped | note present | chapter listed | passage-reviewed |
...
| `runtime-adapters-tool-permissions-and-human-approval.core` | `runtime-adapters-tool-permissions-and-human-approval` | `ext_elizaos_agent_runtime_2026` | mapped | note present | chapter listed | passage-reviewed |
| `runtime-adapters-tool-permissions-and-human-approval.core` | `runtime-adapters-tool-permissions-and-human-approval` | `ext_hermes_agent_2026` | mapped | note present | chapter listed | passage-reviewed |
| `runtime-adapters-tool-permissions-and-human-approval.core` | `runtime-adapters-tool-permissions-and-human-approval` | `ext_openclaw_agent_runtime_2026` | mapped | note present | chapter listed | passage-reviewed |
...
| `embodied-agency-real-time-control-and-physical-safety.core` | `embodied-agency-real-time-control-and-physical-safety` | `ext_simplex_architecture_1998` | mapped | note present | chapter listed | passage-reviewed |
| `embodied-agency-real-time-control-and-physical-safety.core` | `embodied-agency-real-time-control-and-physical-safety` | `ext_safe_reinforcement_learning_survey_2015` | mapped | note present | chapter listed | passage-reviewed |
| `embodied-agency-real-time-control-and-physical-safety.core` | `embodied-agency-real-time-control-and-physical-safety` | `ext_ai_simulation_digital_twins_2025` | mapped | note present | chapter listed | passage-reviewed |
| `embodied-agency-real-time-control-and-physical-safety.core` | `embodied-agency-real-time-control-and-physical-safety` | `viea` | mapped | note present | chapter listed | passage-reviewed |
...
| `inter-stack-protocols-identity-and-economic-exchange.core` | `inter-stack-protocols-identity-and-economic-exchange` | `ext_openclaw_agent_runtime_2026` | mapped | note present | chapter listed | passage-reviewed |
| `multi-agent-dynamics-collective-intelligence-and-systemic-risk.core` | `multi-agent-dynamics-collective-intelligence-and-systemic-risk` | `learning_compute_topology` | unmapped | note present | chapter listed | not passage-reviewed |
| `multi-agent-dynamics-collective-intelligence-and-systemic-risk.core` | `multi-agent-dynamics-collective-intelligence-and-systemic-risk` | `ext_multi_agent_risks_2025` | mapped | note present | chapter listed | passage-reviewed |
| `multi-agent-dynamics-collective-intelligence-and-systemic-risk.core` | `multi-agent-dynamics-collective-intelligence-and-systemic-risk` | `ext_cooperative_ai_foundations_2023` | mapped | note present | chapter listed | passage-reviewed |
| `multi-agent-dynamics-collective-intelligence-and-systemic-risk.core` | `multi-agent-dynamics-collective-intelligence-and-systemic-risk` | `ext_gradual_disempowerment_2025` | mapped | note present | chapter listed | passage-reviewed |
| `multi-agent-dynamics-collective-intelligence-and-systemic-risk.core` | `multi-agent-dynamics-collective-intelligence-and-systemic-risk` | `ext_constructive_interdependence_human_ai_2026` | mapped | note present | chapter listed | passage-reviewed |
| `multi-agent-dynamics-collective-intelligence-and-systemic-risk.core` | `multi-agent-dynamics-collective-intelligence-and-systemic-risk` | `ext_functional_decision_theory_2017` | mapped | note present | chapter listed | passage-reviewed |
| `multi-agent-dynamics-collective-intelligence-and-systemic-risk.core` | `multi-agent-dynamics-collective-intelligence-and-systemic-risk` | `coherence_exchange` | mapped | note present | chapter listed | passage-reviewed |
...
| `procedural-memory-and-cognitive-loop-closure.core` | `procedural-memory-and-cognitive-loop-closure` | `regret_engine` | unmapped | note present | chapter listed | not passage-reviewed |
| `procedural-memory-and-cognitive-loop-closure.core` | `procedural-memory-and-cognitive-loop-closure` | `ext_hermes_agent_2026` | mapped | note present | chapter listed | passage-reviewed |
| `procedural-memory-and-cognitive-loop-closure.core` | `procedural-memory-and-cognitive-loop-closure` | `ext_openclaw_agent_runtime_2026` | mapped | note present | chapter listed | passage-reviewed |
| `procedural-memory-and-cognitive-loop-closure.core` | `procedural-memory-and-cognitive-loop-closure` | `assurance_shift_learning` | mapped | note present | chapter listed | passage-reviewed |
| `procedural-memory-and-cognitive-loop-closure.core` | `procedural-memory-and-cognitive-loop-closure` | `adjudicated_persistence` | mapped | note present | chapter listed | passage-reviewed |
| `procedural-memory-and-cognitive-loop-closure.core` | `procedural-memory-and-cognitive-loop-closure` | `forward_transfer_program_synthesis` | mapped | note present | chapter listed | passage-reviewed |
| `routing-heads-and-specialist-cores.core` | `routing-heads-and-specialist-cores` | `learning_compute_topology` | unmapped | note present | chapter listed | not passage-reviewed |
...
| `replaceable-cognitive-substrates-beyond-transformer-monoculture.core` | `replaceable-cognitive-substrates-beyond-transformer-monoculture` | `learning_compute_topology` | unmapped | note present | chapter listed | not passage-reviewed |
...
| `replaceable-cognitive-substrates-beyond-transformer-monoculture.core` | `replaceable-cognitive-substrates-beyond-transformer-monoculture` | `relational_dimension_compiler` | mapped | note present | chapter listed | passage-reviewed |
| `replaceable-cognitive-substrates-beyond-transformer-monoculture.core` | `replaceable-cognitive-substrates-beyond-transformer-monoculture` | `ext_llm_in_flash_2024` | unmapped | note present | chapter listed | not passage-reviewed |
| `replaceable-cognitive-substrates-beyond-transformer-monoculture.core` | `replaceable-cognitive-substrates-beyond-transformer-monoculture` | `ext_powerinfer_2024` | unmapped | note present | chapter listed | not passage-reviewed |
| `replaceable-cognitive-substrates-beyond-transformer-monoculture.core` | `replaceable-cognitive-substrates-beyond-transformer-monoculture` | `ext_atsinfer_2026` | unmapped | note present | chapter listed | not passage-reviewed |
| `replaceable-cognitive-substrates-beyond-transformer-monoculture.core` | `replaceable-cognitive-substrates-beyond-transformer-monoculture` | `ext_test_time_training_2020` | mapped | note present | chapter listed | passage-reviewed |
| `replaceable-cognitive-substrates-beyond-transformer-monoculture.core` | `replaceable-cognitive-substrates-beyond-transformer-monoculture` | `ext_llada_2025` | mapped | note present | chapter listed | passage-reviewed |
| `replaceable-cognitive-substrates-beyond-transformer-monoculture.core` | `replaceable-cognitive-substrates-beyond-transformer-monoculture` | `ext_scaling_dllms_2026` | mapped | note present | chapter listed | passage-reviewed |
| `replaceable-cognitive-substrates-beyond-transformer-monoculture.core` | `replaceable-cognitive-substrates-beyond-transformer-monoculture` | `ext_neuromorphic_computing_scale_2025` | unmapped | note present | chapter listed | not passage-reviewed |
...
| `replaceable-cognitive-substrates-beyond-transformer-monoculture.core` | `replaceable-cognitive-substrates-beyond-transformer-monoculture` | `ext_eggroll_hyperscale_es_2026` | mapped | note present | chapter listed | passage-reviewed |
| `replaceable-cognitive-substrates-beyond-transformer-monoculture.core` | `replaceable-cognitive-substrates-beyond-transformer-monoculture` | `ext_mezo_2023` | mapped | note present | chapter listed | passage-reviewed |
| `replaceable-cognitive-substrates-beyond-transformer-monoculture.core` | `replaceable-cognitive-substrates-beyond-transformer-monoculture` | `ext_forward_forward_2022` | mapped | note present | chapter listed | passage-reviewed |
...
| `governed-model-training-distributed-optimization-and-scaling.core` | `governed-model-training-distributed-optimization-and-scaling` | `learning_compute_topology` | unmapped | note present | chapter listed | not passage-reviewed |
...
| `governed-model-training-distributed-optimization-and-scaling.core` | `governed-model-training-distributed-optimization-and-scaling` | `ext_eggroll_hyperscale_es_2026` | mapped | note present | chapter listed | passage-reviewed |
| `governed-model-training-distributed-optimization-and-scaling.core` | `governed-model-training-distributed-optimization-and-scaling` | `ext_openai_es_2017` | mapped | note present | chapter listed | passage-reviewed |
| `governed-model-training-distributed-optimization-and-scaling.core` | `governed-model-training-distributed-optimization-and-scaling` | `ext_mezo_2023` | mapped | note present | chapter listed | passage-reviewed |
| `governed-model-training-distributed-optimization-and-scaling.core` | `governed-model-training-distributed-optimization-and-scaling` | `ext_forward_forward_2022` | mapped | note present | chapter listed | passage-reviewed |
| `learning-compute-topology-and-adaptive-process-architecture.core` | `learning-compute-topology-and-adaptive-process-architecture` | `learning_compute_topology` | mapped | note present | chapter listed | passage-reviewed |
| `learning-compute-topology-and-adaptive-process-architecture.core` | `learning-compute-topology-and-adaptive-process-architecture` | `ext_megatron_distributed_training_2021` | mapped | note present | chapter listed | passage-reviewed |
| `learning-compute-topology-and-adaptive-process-architecture.core` | `learning-compute-topology-and-adaptive-process-architecture` | `ext_gspmd_2021` | mapped | note present | chapter listed | passage-reviewed |
| `learning-compute-topology-and-adaptive-process-architecture.core` | `learning-compute-topology-and-adaptive-process-architecture` | `ext_pbt_2017` | mapped | note present | chapter listed | passage-reviewed |
| `learning-compute-topology-and-adaptive-process-architecture.core` | `learning-compute-topology-and-adaptive-process-architecture` | `ext_openai_es_2017` | mapped | note present | chapter listed | passage-reviewed |
| `learning-compute-topology-and-adaptive-process-architecture.core` | `learning-compute-topology-and-adaptive-process-architecture` | `assurance_shift_learning` | mapped | note present | chapter listed | passage-reviewed |
...
| `learning-theory-generalization-and-scaling-science.core` | `learning-theory-generalization-and-scaling-science` | `ext_deep_double_descent_2020` | mapped | note present | chapter listed | not passage-reviewed |
| `learning-theory-generalization-and-scaling-science.core` | `learning-theory-generalization-and-scaling-science` | `ext_emergent_abilities_llms_2022` | mapped | note present | chapter listed | not passage-reviewed |
...
| `learning-theory-generalization-and-scaling-science.core` | `learning-theory-generalization-and-scaling-science` | `ext_eggroll_hyperscale_es_2026` | mapped | note present | chapter listed | passage-reviewed |
| `learning-theory-generalization-and-scaling-science.core` | `learning-theory-generalization-and-scaling-science` | `ext_forward_forward_2022` | mapped | note present | chapter listed | passage-reviewed |
| `learning-theory-generalization-and-scaling-science.core` | `learning-theory-generalization-and-scaling-science` | `forward_transfer_program_synthesis` | mapped | note present | chapter listed | passage-reviewed |
...
| `readiness-gates-residual-escrow-and-quarantine.core` | `readiness-gates-residual-escrow-and-quarantine` | `regret_engine` | unmapped | note present | chapter listed | not passage-reviewed |
| `readiness-gates-residual-escrow-and-quarantine.core` | `readiness-gates-residual-escrow-and-quarantine` | `assurance_shift_learning` | mapped | note present | chapter listed | passage-reviewed |
| `readiness-gates-residual-escrow-and-quarantine.core` | `readiness-gates-residual-escrow-and-quarantine` | `adjudicated_persistence` | mapped | note present | chapter listed | passage-reviewed |
...
| `personal-compute-hives-and-federated-edge-intelligence.core` | `personal-compute-hives-and-federated-edge-intelligence` | `ext_airllm_2023` | unmapped | note present | chapter listed | not passage-reviewed |
| `personal-compute-hives-and-federated-edge-intelligence.core` | `personal-compute-hives-and-federated-edge-intelligence` | `ext_deepspeed_inference_2022` | unmapped | note present | chapter listed | not passage-reviewed |
| `personal-compute-hives-and-federated-edge-intelligence.core` | `personal-compute-hives-and-federated-edge-intelligence` | `ext_flexgen_2023` | unmapped | note present | chapter listed | not passage-reviewed |
| `personal-compute-hives-and-federated-edge-intelligence.core` | `personal-compute-hives-and-federated-edge-intelligence` | `ext_hf_accelerate_big_model_inference_2026` | unmapped | note present | chapter listed | not passage-reviewed |
| `personal-compute-hives-and-federated-edge-intelligence.core` | `personal-compute-hives-and-federated-edge-intelligence` | `ext_llama_cpp_memory_mapping_2026` | unmapped | note present | chapter listed | not passage-reviewed |
| `personal-compute-hives-and-federated-edge-intelligence.core` | `personal-compute-hives-and-federated-edge-intelligence` | `ext_llm_in_flash_2024` | unmapped | note present | chapter listed | not passage-reviewed |
| `personal-compute-hives-and-federated-edge-intelligence.core` | `personal-compute-hives-and-federated-edge-intelligence` | `ext_powerinfer_2024` | unmapped | note present | chapter listed | not passage-reviewed |
| `personal-compute-hives-and-federated-edge-intelligence.core` | `personal-compute-hives-and-federated-edge-intelligence` | `ext_atsinfer_2026` | unmapped | note present | chapter listed | not passage-reviewed |
...
| `fast-generation-architectures.core` | `fast-generation-architectures` | `ext_airllm_2023` | unmapped | note present | chapter listed | not passage-reviewed |
| `fast-generation-architectures.core` | `fast-generation-architectures` | `ext_deepspeed_inference_2022` | unmapped | note present | chapter listed | not passage-reviewed |
| `fast-generation-architectures.core` | `fast-generation-architectures` | `ext_flexgen_2023` | unmapped | note present | chapter listed | not passage-reviewed |
| `fast-generation-architectures.core` | `fast-generation-architectures` | `ext_hf_accelerate_big_model_inference_2026` | unmapped | note present | chapter listed | not passage-reviewed |
| `fast-generation-architectures.core` | `fast-generation-architectures` | `ext_llama_cpp_memory_mapping_2026` | unmapped | note present | chapter listed | not passage-reviewed |
| `fast-generation-architectures.core` | `fast-generation-architectures` | `ext_llm_in_flash_2024` | unmapped | note present | chapter listed | not passage-reviewed |
| `fast-generation-architectures.core` | `fast-generation-architectures` | `ext_powerinfer_2024` | unmapped | note present | chapter listed | not passage-reviewed |
| `fast-generation-architectures.core` | `fast-generation-architectures` | `ext_vattention_2025` | unmapped | note present | chapter listed | not passage-reviewed |
| `fast-generation-architectures.core` | `fast-generation-architectures` | `ext_infinigen_2024` | unmapped | note present | chapter listed | not passage-reviewed |
| `fast-generation-architectures.core` | `fast-generation-architectures` | `ext_specache_2025` | unmapped | note present | chapter listed | not passage-reviewed |
| `fast-generation-architectures.core` | `fast-generation-architectures` | `ext_specoffload_2025` | unmapped | note present | chapter listed | not passage-reviewed |
| `fast-generation-architectures.core` | `fast-generation-architectures` | `ext_atsinfer_2026` | unmapped | note present | chapter listed | not passage-reviewed |
| `fast-generation-architectures.core` | `fast-generation-architectures` | `ext_openai_prompt_caching_docs_2026` | unmapped | note present | chapter listed | not passage-reviewed |
| `fast-generation-architectures.core` | `fast-generation-architectures` | `ext_anthropic_prompt_caching_docs_2026` | unmapped | note present | chapter listed | not passage-reviewed |
| `fast-generation-architectures.core` | `fast-generation-architectures` | `ext_gemini_context_caching_docs_2026` | unmapped | note present | chapter listed | not passage-reviewed |
| `fast-generation-architectures.core` | `fast-generation-architectures` | `ext_vllm_automatic_prefix_caching_2026` | unmapped | note present | chapter listed | not passage-reviewed |
| `fast-generation-architectures.core` | `fast-generation-architectures` | `ext_sglang_radixattention_2024` | unmapped | note present | chapter listed | not passage-reviewed |
| `fast-generation-architectures.core` | `fast-generation-architectures` | `ext_prompt_cache_2024` | unmapped | note present | chapter listed | not passage-reviewed |
...
| `governed-deliberation-and-test-time-scaling.core` | `governed-deliberation-and-test-time-scaling` | `portia_synapse` | mapped | note present | chapter listed | passage-reviewed |
| `governed-deliberation-and-test-time-scaling.core` | `governed-deliberation-and-test-time-scaling` | `spider_synapse` | mapped | note present | chapter listed | passage-reviewed |
...
| `rankfold-neuralfold-and-artifact-compression.core` | `rankfold-neuralfold-and-artifact-compression` | `forward_transfer_program_synthesis` | mapped | note present | chapter listed | passage-reviewed |
| `resource-economics-and-token-budgets.core` | `resource-economics-and-token-budgets` | `learning_compute_topology` | unmapped | note present | chapter listed | not passage-reviewed |
...
| `resource-economics-and-token-budgets.core` | `resource-economics-and-token-budgets` | `ext_eggroll_hyperscale_es_2026` | mapped | note present | chapter listed | passage-reviewed |
| `resource-economics-and-token-budgets.core` | `resource-economics-and-token-budgets` | `ext_openai_es_2017` | mapped | note present | chapter listed | passage-reviewed |
| `resource-economics-and-token-budgets.core` | `resource-economics-and-token-budgets` | `ext_mezo_2023` | mapped | note present | chapter listed | passage-reviewed |
...
| `resource-economics-and-token-budgets.core` | `resource-economics-and-token-budgets` | `relational_dimension_compiler` | mapped | note present | chapter listed | passage-reviewed |
| `resource-economics-and-token-budgets.core` | `resource-economics-and-token-budgets` | `ext_airllm_2023` | unmapped | note present | chapter listed | not passage-reviewed |
| `resource-economics-and-token-budgets.core` | `resource-economics-and-token-budgets` | `ext_deepspeed_inference_2022` | unmapped | note present | chapter listed | not passage-reviewed |
| `resource-economics-and-token-budgets.core` | `resource-economics-and-token-budgets` | `ext_flexgen_2023` | unmapped | note present | chapter listed | not passage-reviewed |
| `resource-economics-and-token-budgets.core` | `resource-economics-and-token-budgets` | `ext_hf_accelerate_big_model_inference_2026` | unmapped | note present | chapter listed | not passage-reviewed |
| `resource-economics-and-token-budgets.core` | `resource-economics-and-token-budgets` | `ext_llama_cpp_memory_mapping_2026` | unmapped | note present | chapter listed | not passage-reviewed |
| `resource-economics-and-token-budgets.core` | `resource-economics-and-token-budgets` | `ext_llm_in_flash_2024` | unmapped | note present | chapter listed | not passage-reviewed |
| `resource-economics-and-token-budgets.core` | `resource-economics-and-token-budgets` | `ext_powerinfer_2024` | unmapped | note present | chapter listed | not passage-reviewed |
| `resource-economics-and-token-budgets.core` | `resource-economics-and-token-budgets` | `ext_vattention_2025` | unmapped | note present | chapter listed | not passage-reviewed |
| `resource-economics-and-token-budgets.core` | `resource-economics-and-token-budgets` | `ext_infinigen_2024` | unmapped | note present | chapter listed | not passage-reviewed |
| `resource-economics-and-token-budgets.core` | `resource-economics-and-token-budgets` | `ext_specache_2025` | unmapped | note present | chapter listed | not passage-reviewed |
| `resource-economics-and-token-budgets.core` | `resource-economics-and-token-budgets` | `ext_specoffload_2025` | unmapped | note present | chapter listed | not passage-reviewed |
| `resource-economics-and-token-budgets.core` | `resource-economics-and-token-budgets` | `ext_atsinfer_2026` | unmapped | note present | chapter listed | not passage-reviewed |
| `resource-economics-and-token-budgets.core` | `resource-economics-and-token-budgets` | `ext_openai_prompt_caching_docs_2026` | unmapped | note present | chapter listed | not passage-reviewed |
| `resource-economics-and-token-budgets.core` | `resource-economics-and-token-budgets` | `ext_anthropic_prompt_caching_docs_2026` | unmapped | note present | chapter listed | not passage-reviewed |
| `resource-economics-and-token-budgets.core` | `resource-economics-and-token-budgets` | `ext_gemini_context_caching_docs_2026` | unmapped | note present | chapter listed | not passage-reviewed |
| `resource-economics-and-token-budgets.core` | `resource-economics-and-token-budgets` | `ext_vllm_automatic_prefix_caching_2026` | unmapped | note present | chapter listed | not passage-reviewed |
| `resource-economics-and-token-budgets.core` | `resource-economics-and-token-budgets` | `ext_sglang_radixattention_2024` | unmapped | note present | chapter listed | not passage-reviewed |
| `resource-economics-and-token-budgets.core` | `resource-economics-and-token-budgets` | `ext_prompt_cache_2024` | unmapped | note present | chapter listed | not passage-reviewed |
...
| `resource-economics-and-token-budgets.core` | `resource-economics-and-token-budgets` | `assurance_shift_learning` | mapped | note present | chapter listed | passage-reviewed |
| `resource-economics-and-token-budgets.core` | `resource-economics-and-token-budgets` | `adjudicated_persistence` | mapped | note present | chapter listed | passage-reviewed |
| `resource-economics-and-token-budgets.core` | `resource-economics-and-token-budgets` | `forward_transfer_program_synthesis` | mapped | note present | chapter listed | passage-reviewed |
...
| `physical-compute-infrastructure-energy-and-environmental-constraints.core` | `physical-compute-infrastructure-energy-and-environmental-constraints` | `ext_flexible_hardware_enabled_guarantees_2025` | mapped | note present | chapter listed | passage-reviewed |
| `physical-compute-infrastructure-energy-and-environmental-constraints.core` | `physical-compute-infrastructure-energy-and-environmental-constraints` | `ext_neuromorphic_computing_scale_2025` | unmapped | note present | chapter listed | not passage-reviewed |
| `physical-compute-infrastructure-energy-and-environmental-constraints.core` | `physical-compute-infrastructure-energy-and-environmental-constraints` | `ext_photonic_neuromorphic_2024` | unmapped | note present | chapter listed | not passage-reviewed |
| `physical-compute-infrastructure-energy-and-environmental-constraints.core` | `physical-compute-infrastructure-energy-and-environmental-constraints` | `ext_quantum_ml_shadows_2024` | unmapped | note present | chapter listed | not passage-reviewed |
| `physical-compute-infrastructure-energy-and-environmental-constraints.core` | `physical-compute-infrastructure-energy-and-environmental-constraints` | `ext_oecd_ai_infrastructure_competition_2025` | unmapped | note present | chapter listed | not passage-reviewed |
...
| `executable-specifications-and-lean-proof-envelope.core` | `executable-specifications-and-lean-proof-envelope` | `ext_reluplex_2017` | mapped | note present | chapter listed | passage-reviewed |
| `executable-specifications-and-lean-proof-envelope.core` | `executable-specifications-and-lean-proof-envelope` | `forward_transfer_program_synthesis` | mapped | note present | chapter listed | passage-reviewed |
...
| `benchmark-ratchets-and-anti-goodhart-evidence.core` | `benchmark-ratchets-and-anti-goodhart-evidence` | `relational_dimension_compiler` | mapped | note present | chapter listed | passage-reviewed |
| `benchmark-ratchets-and-anti-goodhart-evidence.core` | `benchmark-ratchets-and-anti-goodhart-evidence` | `ext_cultural_alignment_llms_2024` | unmapped | note present | chapter listed | not passage-reviewed |
...
| `benchmark-ratchets-and-anti-goodhart-evidence.core` | `benchmark-ratchets-and-anti-goodhart-evidence` | `regret_engine` | unmapped | note present | chapter listed | not passage-reviewed |
| `benchmark-ratchets-and-anti-goodhart-evidence.core` | `benchmark-ratchets-and-anti-goodhart-evidence` | `ext_elizaos_agent_runtime_2026` | mapped | note present | chapter listed | passage-reviewed |
| `benchmark-ratchets-and-anti-goodhart-evidence.core` | `benchmark-ratchets-and-anti-goodhart-evidence` | `assurance_shift_learning` | mapped | note present | chapter listed | passage-reviewed |
| `benchmark-ratchets-and-anti-goodhart-evidence.core` | `benchmark-ratchets-and-anti-goodhart-evidence` | `adjudicated_persistence` | mapped | note present | chapter listed | passage-reviewed |
| `benchmark-ratchets-and-anti-goodhart-evidence.core` | `benchmark-ratchets-and-anti-goodhart-evidence` | `forward_transfer_program_synthesis` | mapped | note present | chapter listed | passage-reviewed |
...
| `adversarial-evaluation-sandbagging-and-training-time-deception.core` | `adversarial-evaluation-sandbagging-and-training-time-deception` | `learning_compute_topology` | unmapped | note present | chapter listed | not passage-reviewed |
...
| `adversarial-evaluation-sandbagging-and-training-time-deception.core` | `adversarial-evaluation-sandbagging-and-training-time-deception` | `assurance_shift_learning` | mapped | note present | chapter listed | passage-reviewed |
...
| `governed-operations-incident-command-and-graceful-degradation.core` | `governed-operations-incident-command-and-graceful-degradation` | `regret_engine` | unmapped | note present | chapter listed | not passage-reviewed |
| `governed-operations-incident-command-and-graceful-degradation.core` | `governed-operations-incident-command-and-graceful-degradation` | `assurance_shift_learning` | mapped | note present | chapter listed | passage-reviewed |
| `governed-operations-incident-command-and-graceful-degradation.core` | `governed-operations-incident-command-and-graceful-degradation` | `adjudicated_persistence` | mapped | note present | chapter listed | passage-reviewed |
| `adjudicated-persistence-and-the-adaptive-commit-boundary.core` | `adjudicated-persistence-and-the-adaptive-commit-boundary` | `adjudicated_persistence` | mapped | note present | chapter listed | passage-reviewed |
| `adjudicated-persistence-and-the-adaptive-commit-boundary.core` | `adjudicated-persistence-and-the-adaptive-commit-boundary` | `assurance_shift_learning` | mapped | note present | chapter listed | passage-reviewed |
| `adjudicated-persistence-and-the-adaptive-commit-boundary.core` | `adjudicated-persistence-and-the-adaptive-commit-boundary` | `regret_engine` | mapped | note present | chapter listed | passage-reviewed |
| `adjudicated-persistence-and-the-adaptive-commit-boundary.core` | `adjudicated-persistence-and-the-adaptive-commit-boundary` | `cognitive_loop_closure` | mapped | note present | chapter listed | passage-reviewed |
| `adjudicated-persistence-and-the-adaptive-commit-boundary.core` | `adjudicated-persistence-and-the-adaptive-commit-boundary` | `deterministic_capability_compilation` | mapped | note present | chapter listed | passage-reviewed |
| `adjudicated-persistence-and-the-adaptive-commit-boundary.core` | `adjudicated-persistence-and-the-adaptive-commit-boundary` | `platonic_world_model` | mapped | note present | chapter listed | passage-reviewed |
| `adjudicated-persistence-and-the-adaptive-commit-boundary.core` | `adjudicated-persistence-and-the-adaptive-commit-boundary` | `viea` | mapped | note present | chapter listed | passage-reviewed |
| `adjudicated-persistence-and-the-adaptive-commit-boundary.core` | `adjudicated-persistence-and-the-adaptive-commit-boundary` | `talos` | mapped | note present | chapter listed | passage-reviewed |
| `adjudicated-persistence-and-the-adaptive-commit-boundary.core` | `adjudicated-persistence-and-the-adaptive-commit-boundary` | `ext_bourtoule_machine_unlearning_2021` | mapped | note present | chapter listed | passage-reviewed |
| `adjudicated-persistence-and-the-adaptive-commit-boundary.core` | `adjudicated-persistence-and-the-adaptive-commit-boundary` | `forward_transfer_program_synthesis` | mapped | note present | chapter listed | passage-reviewed |
| `policy-optimization-and-learning-from-feedback.core` | `policy-optimization-and-learning-from-feedback` | `learning_compute_topology` | unmapped | note present | chapter listed | not passage-reviewed |
...
| `policy-optimization-and-learning-from-feedback.core` | `policy-optimization-and-learning-from-feedback` | `portia_synapse` | mapped | note present | chapter listed | passage-reviewed |
| `policy-optimization-and-learning-from-feedback.core` | `policy-optimization-and-learning-from-feedback` | `spider_synapse` | mapped | note present | chapter listed | passage-reviewed |
| `policy-optimization-and-learning-from-feedback.core` | `policy-optimization-and-learning-from-feedback` | `regret_engine` | unmapped | note present | chapter listed | not passage-reviewed |
| `policy-optimization-and-learning-from-feedback.core` | `policy-optimization-and-learning-from-feedback` | `ext_eggroll_hyperscale_es_2026` | mapped | note present | chapter listed | passage-reviewed |
| `policy-optimization-and-learning-from-feedback.core` | `policy-optimization-and-learning-from-feedback` | `ext_openai_es_2017` | mapped | note present | chapter listed | passage-reviewed |
| `policy-optimization-and-learning-from-feedback.core` | `policy-optimization-and-learning-from-feedback` | `assurance_shift_learning` | mapped | note present | chapter listed | passage-reviewed |
| `policy-optimization-and-learning-from-feedback.core` | `policy-optimization-and-learning-from-feedback` | `adjudicated_persistence` | mapped | note present | chapter listed | passage-reviewed |
| `data-engines-continual-learning-and-unlearning.core` | `data-engines-continual-learning-and-unlearning` | `learning_compute_topology` | unmapped | note present | chapter listed | not passage-reviewed |
...
| `data-engines-continual-learning-and-unlearning.core` | `data-engines-continual-learning-and-unlearning` | `ext_influence_functions_2017` | mapped | note present | chapter listed | passage-reviewed |
| `data-engines-continual-learning-and-unlearning.core` | `data-engines-continual-learning-and-unlearning` | `ext_curriculum_learning_2009` | mapped | note present | chapter listed | passage-reviewed |
| `data-engines-continual-learning-and-unlearning.core` | `data-engines-continual-learning-and-unlearning` | `regret_engine` | unmapped | note present | chapter listed | not passage-reviewed |
| `data-engines-continual-learning-and-unlearning.core` | `data-engines-continual-learning-and-unlearning` | `assurance_shift_learning` | mapped | note present | chapter listed | passage-reviewed |
...
| `integrated-reference-architecture.core` | `integrated-reference-architecture` | `relational_dimension_compiler` | mapped | note present | chapter listed | passage-reviewed |
| `integrated-reference-architecture.core` | `integrated-reference-architecture` | `regret_engine` | unmapped | note present | chapter listed | not passage-reviewed |
| `integrated-reference-architecture.core` | `integrated-reference-architecture` | `assurance_shift_learning` | mapped | note present | chapter listed | passage-reviewed |
| `integrated-reference-architecture.core` | `integrated-reference-architecture` | `adjudicated_persistence` | mapped | note present | chapter listed | passage-reviewed |
...
| `open-research-agenda-and-bibliography-plan.core` | `open-research-agenda-and-bibliography-plan` | `relational_dimension_compiler` | mapped | note present | chapter listed | passage-reviewed |
