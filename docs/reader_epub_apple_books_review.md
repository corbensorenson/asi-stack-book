...
- Apple Books opened the rebuilt repaired local EPUB digest into a reader window titled The ASI Stack.
- The Reader Edition Baseline page rendered without the earlier XML error banner.
- Chapter 1 rendered after table-of-contents navigation and exposed body text, the ASI Stack control-plane figure, and descriptive alt text in the Apple Books accessibility tree.
