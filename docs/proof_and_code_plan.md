...
- schema validators for context packets, typed jobs, SCF records, context ABI records, context adequacy records, context transaction records, semantic atoms, semantic page certificates, compression receipts, authority-use receipts, costed route records, authority transition records, failure boundary maps, intent contracts, command contracts, intent-to-execution traces, plan graphs, PlanForge DAGs, constitutional predicates, agency rights checklists, value conflict records, governance rights records, replacement transactions, and self-improvement transitions,
