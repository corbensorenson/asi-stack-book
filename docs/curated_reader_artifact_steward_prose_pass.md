...
This pass turns the initialized generated reader baseline into a first
...
- Compressed repeated project-object, autonomy, treasury, federation, and
  failure-mode explanations into a steadier book-chapter flow.
- Preserved the Mermaid steward-loop diagram while simplifying the surrounding
  explanation.
- Preserved the exact core-claim meaning and the reader-facing evidence
