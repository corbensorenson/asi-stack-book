...
A human reader should leave this chapter understanding that a plausible route
or promising capability is not automatically ready for ordinary use. Readiness
is the layer that turns evidence into scoped permission, keeps unresolved
failures in residual escrow, and uses quarantine to preserve diagnostic value
without leaving failed routes live.

## Scope

This pass turns the initialized generated reader baseline for Readiness Gates,
Residual Escrow, and Quarantine into a first booklike curated reader draft. It
