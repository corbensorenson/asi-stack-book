...
| Demotion/refutation path needs a live example | Evidence-laundering prevention is most convincing when it rejects a tempting false promotion. | Add a no-promotion or demotion case study that survives validation and reviewer inspection. |
