...
| Plan-execution contract harness | `python3 scripts/validate_plan_execution_contracts.py` | 2 valid, 8 expected-invalid | `experiments/plan_execution_contracts/results/2026-07-01-local.md` |
