...
| Resource budget ledger harness | `python3 scripts/validate_resource_budget_ledgers.py` | 5 valid, 6 expected-invalid | `experiments/resource_budget_ledgers/results/2026-07-01-local.md` |
