...
| Security kernel harness | `python3 scripts/validate_security_kernel.py` | 3 valid, 8 expected-invalid | `experiments/security_kernel/results/2026-07-01-local.md` |
...
| Capability replacement harness | `python3 scripts/validate_capability_replacement.py` | 5 valid, 9 expected-invalid | `experiments/capability_replacement/results/2026-07-01-local.md` |
| Self-improvement boundary harness | `python3 scripts/validate_self_improvement_boundaries.py` | 3 valid, 10 expected-invalid | `experiments/self_improvement_boundaries/results/2026-07-02-local.md` |
| Plan-execution contract harness | `python3 scripts/validate_plan_execution_contracts.py` | 3 valid, 10 expected-invalid | `experiments/plan_execution_contracts/results/2026-07-02-local.md` |
...
| Resource budget ledger harness | `python3 scripts/validate_resource_budget_ledgers.py` | 6 valid, 7 expected-invalid | `experiments/resource_budget_ledgers/results/2026-07-01-local.md` |
| Reference trace harness | `python3 scripts/validate_reference_trace.py` | 2 valid, 6 expected-invalid | `experiments/reference_trace/results/2026-06-30-local.md` |
| Capacity smoothing toy harness | `python3 scripts/validate_capacity_smoothing.py` | 3 valid, 6 expected-invalid | `experiments/capacity_smoothing/results/2026-07-01-local.md` |
