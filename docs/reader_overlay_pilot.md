...
The following reader-continuity pass added one active operation under `editions/reader_overlays/v1_0/chapters/evidence-states-and-claim-discipline.json`:
...
The following reader-continuity pass added one active operation under `editions/reader_overlays/v1_0/chapters/generate-verify-repair-compression.json`:
