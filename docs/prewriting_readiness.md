...
- Chapter claims now have exact source-note mappings in Appendix C, but only 67 of the 461 current claim-source mappings have recorded passage-level review.
