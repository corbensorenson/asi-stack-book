...
- Chapter claims now have exact source-note mappings in Appendix C, but only 5 of the 458 current claim-source mappings have recorded passage-level review.
