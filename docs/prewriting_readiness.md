...
- Chapter claims now have exact source-note mappings in Appendix C, but only 52 of the 461 current claim-source mappings have recorded passage-level review.
