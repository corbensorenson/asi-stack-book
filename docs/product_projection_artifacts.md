...
chapter has one canonical core-claim reference, reader
...
contracts, canonical selection order, scenario continuity, 23 cumulative
...
meaning-preservation, figure, accessibility, and final-format checks remain
open.
...
23-unit narrative, a missing strongest objection, out-of-order selection,
