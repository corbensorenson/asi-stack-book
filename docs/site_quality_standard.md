...
- Reader-only major-version prose deltas must live in the tracked semantic overlay source under `editions/reader_overlays/`, not in generated reader manuscripts or generated delta reports. `reader_delta_report.md` is reviewed to understand the derivation, operation digests, and generated before/after excerpts; it is regenerated after overlay or canonical-source edits and is not an editable patch file.
