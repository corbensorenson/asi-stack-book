...
- Reader-visible causal transitions should name the actual layer, record, or authority change rather than relying on generic explanation scaffolding. `scripts/validate_repeated_prose.py` rejects `This is why`.
