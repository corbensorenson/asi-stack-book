...
- Implemented proof-backed lowering boundary: `AsiStackProofs.IntentResolutionRefinement` proves that a thin four-field command projection has a distinct-intent collision and no decoder can recover both witnesses, while the modeled full ten-field projection is injective. The independent consumer reconstructs collisions for all six omitted fields and rejects changes to all ten full fields. This proves representational information loss and preservation only for the modeled fields, not language understanding, semantic adequacy, authority, consent, or deployed lowering.
...
- Implemented generated audit: `docs/proof_depth_classification.md` records proof-depth classification. Current proof-depth snapshot: 330 proof targets, 130 Lean modules, 2822 theorem declarations, 1760 derived/decomposed, 432 direct/projection, 630 unknown/mixed, and 2/2 safety-critical chapter classifications present.
