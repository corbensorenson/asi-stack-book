...
- Current minimum: two public record schemas, 3-valid/5-invalid constitutional
  ...
  effect-admission consumer under five manifest targets. This is bounded
...
- Implemented Lean follow-through: `AsiStackProofs.Alignment` includes the finite missing-field admission router plus a versioned proposal lifecycle. Fifteen additional theorems prove accepted-step admissibility and exact advancement, constitutional identity/scope/proposer/ceiling custody, zero support/effect assignment, independent review before activation, conflict residualization, return to the recorded rollback version, arbitrary-run preservation, exact batch composition, one complete review-to-rollback witness, and five rejecting substitutions. These authored semantics do not establish moral correctness, deployed alignment, rights usability, reviewer competence, effect-complete rollback, consent quality, support-state promotion, or runtime policy behavior.
