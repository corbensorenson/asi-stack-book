...
Result record: `experiments/routing_decision_lease/results/2026-06-30-local.md`

Result summary: Routing decision lease harness passed: 3 valid fixture(s), 6 expected-invalid fixture(s).
...
required capability, satisfy readiness, stay under the authority ceiling, and
choose a least-authority eligible specialist. It requires overprivileged
specialists to be rejected with non-selection evidence, missing-readiness or
blocked routes to preserve fallback/residual paths, expired leases to stop
selected routing, and source-only MoECOT packets to keep replay gaps and
promotion blockers visible.
