...
```text
Resource budget ledger harness passed: 5 valid fixture(s), 5 expected-invalid fixture(s).
```
...
escalation, protected overhead, displaced costs, review-capacity hoarding,
