...
3. Read `appendices/G_corben_source_corpus.qmd` when drafting from Corben's source corpus or local project records; read `appendices/H_external_sources.qmd` when drafting external-literature or third-party citation context by other authors.
