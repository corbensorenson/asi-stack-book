...
3. Read `appendices/G_bibliography.qmd` when drafting Corben/source-corpus references; read `appendices/H_external_literature.qmd` when drafting external-literature or third-party citation context.
