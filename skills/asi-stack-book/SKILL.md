...
3. Read `appendices/G_corben_source_corpus.qmd` when drafting Corben-authored, Corben-supplied, or local project source references; read `appendices/H_external_sources.qmd` when drafting external-literature or third-party citation context.
