...
|---|---|
| Source ID | `tokenmana` |
| Source class | `author_mechanism_and_human_outcomes_family` |
| Library class | `research_paper` |
| Manuscript date | 2026-07-31 |
| Inventory updated | 2026-07-31 |
| Exact published-source SHA-256 | `03460d7bb87822d9792cad12828633418e744674d5baa0aa0c33307ff43e758d` |
| Exact published-source bytes | 60,285 |
| Exact source text | [Download/view the tracked Markdown source](source/tokenmana.md) |
| Book's source note | [Read the bounded mining note](https://github.com/corbensorenson/asi-stack-book/blob/main/sources/source_notes/tokenmana.md) |
...
[Planning as a Control Layer: DAGs and Intelligence Arbitrage](../chapters/planning-as-a-control-layer.html), [Inter-Stack Protocols, Identity, and Economic Exchange](../chapters/inter-stack-protocols-identity-and-economic-exchange.html), [Personal Compute Hives and Federated Edge Intelligence](../chapters/personal-compute-hives-and-federated-edge-intelligence.html), [Fast Generation Architectures](../chapters/fast-generation-architectures.html), [Resource Economics and Token Budgets](../chapters/resource-economics-and-token-budgets.html), [Physical Compute Infrastructure, Energy, and Environmental Constraints](../chapters/physical-compute-infrastructure-energy-and-environmental-constraints.html), [Benchmark Ratchets and Anti-Goodhart Evidence](../chapters/benchmark-ratchets-and-anti-goodhart-evidence.html), [Policy Optimization and Learning from Feedback](../chapters/policy-optimization-and-learning-from-feedback.html), [Artifact Steward Agents and Living Project Governance](../chapters/artifact-steward-agents-and-living-project-governance.html)
