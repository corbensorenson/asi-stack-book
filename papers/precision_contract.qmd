...
| Inventory updated | 2026-07-24 |
| Exact published-source SHA-256 | `c8c5eeedf72f5fad4132d9916971f1c1853c74f01fc4a6bab9ad8c0700b39ac7` |
| Exact published-source bytes | 116,585 |
| Exact source text | [Download/view the tracked Markdown source](source/precision_contract.md) |
| Book's source note | [Read the bounded mining note](https://github.com/corbensorenson/asi-stack-book/blob/main/sources/source_notes/precision_contract.md) |
...
[The Efficient ASI Hypothesis](../chapters/the-efficient-asi-hypothesis.html), [Model-Weight Custody and Hardware Roots of Trust](../chapters/model-weight-custody-and-hardware-roots-of-trust.html), [Open-Weight Release and Post-Release Control](../chapters/open-weight-release-and-post-release-control.html), [Readiness Gates, Residual Escrow, and Quarantine](../chapters/readiness-gates-residual-escrow-and-quarantine.html), [Compact Generative Systems: Generate, Verify, Repair, and Residual Honesty](../chapters/compact-generative-systems-and-residual-honesty.html), [Fast Generation Architectures](../chapters/fast-generation-architectures.html), [RankFold, NeuralFold, and Artifact Compression](../chapters/rankfold-neuralfold-and-artifact-compression.html), [Resource Economics and Token Budgets](../chapters/resource-economics-and-token-budgets.html), [Executable Specifications and Lean Proof Envelope](../chapters/executable-specifications-and-lean-proof-envelope.html)
...
1.  Introduction<br>
2.  Why a universal per-weight upper bound is ill-posed<br>
3.  Prior work and the novelty boundary<br>
4.  Formal framework<br>
5.  The precision contract<br>
6.  The Functional Precision Compiler<br>
7.  Progressive executable precision<br>
8.  Verification, certification, and assurance bits<br>
9.  Experimental and falsification program<br>
10. Implications for advanced AI systems<br>
11. Limitations and open problems<br>
12. Conclusion<br>
    Appendices A–D<br>
    References
...
**Proposition 2 — Monotonicity in tolerance.**<br>
