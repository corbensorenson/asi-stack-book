---
title: "Virtual_Context_Memory_v1"
...
| Exact published-source SHA-256 | `832a96c700074246b537b4f97c5a3611d676eed9f1a9d1f0b68057e980a9de8a` |
| Exact published-source bytes | 235,401 |
| Exact source text | [Download/view the tracked Markdown source](source/vcm_public.md) |
| Book's source note | [Read the bounded mining note](https://github.com/corbensorenson/asi-stack-book/blob/main/sources/source_notes/vcm_public.md) |
...
[Failure Modes of Ungoverned Intelligence](../chapters/failure-modes-of-ungoverned-intelligence.html), [The Virtual Context ABI: Typed Pages, Cells, and Certificates](../chapters/virtual-context-abi.html), [Durable Semantic Memory and Knowledge Lattices](../chapters/durable-semantic-memory-and-knowledge-lattices.html), [Context Transactions, Snapshots, Mounts, and Taint](../chapters/context-transactions-snapshots-mounts-and-taint.html), [Verification Bandwidth and Context Adequacy](../chapters/verification-bandwidth-and-context-adequacy.html), [Inter-Stack Protocols, Identity, and Economic Exchange](../chapters/inter-stack-protocols-identity-and-economic-exchange.html), [Personal Compute Hives and Federated Edge Intelligence](../chapters/personal-compute-hives-and-federated-edge-intelligence.html), [Fast Generation Architectures](../chapters/fast-generation-architectures.html), [Coil Attention, Cyclic Memory, and Recurrence Contracts](../chapters/coil-attention-cyclic-memory-and-recurrence-contracts.html), [Policy Optimization and Learning from Feedback](../chapters/policy-optimization-and-learning-from-feedback.html), [Artifact Steward Agents and Living Project Governance](../chapters/artifact-steward-agents-and-living-project-governance.html), [Integrated Reference Architecture](../chapters/integrated-reference-architecture.html), [Prototype Roadmap](../chapters/prototype-roadmap.html), [Open Research Agenda and Bibliography Plan](../chapters/open-research-agenda-and-bibliography-plan.html)
...
A Governed Protocol for Compiled Working Context
Corben Sorenson
Public Release v1 - June 2026
Abstract
Long-horizon language-model agents need more than larger context windows or higher-recall retrieval. They need a dependable control plane between durable memory, active context, evidence, behavioral authority, privacy, and runtime state. This paper presents Virtual Context Memory (VCM), a protocol in which the model-visible prompt is compiled as a bounded working set over a larger, versioned semantic address space. VCM separates semantic identity, immutable content versions, task-relative representations, use-specific validation, and physical materialization. It derives role-indexed obligations; admits mandatory context through joint constrained selection; distinguishes adequacy from admission and feasibility from optimizer quality; and treats evidence, behavioral permission, processing exposure, output influence, and action authorization as different relations. The public-v1 Core is deliberately small. Predictive staging, rich packet grammars, native runtime caches, multi-principal exchange, human review, and causal influence inference remain optional. The affirmative claim is control-plane correctness and observability, not superior model accuracy. A synthetic governance study shows that the Core prevents modeled cross-layer failures more reliably than typed and point-hardened compilers under the study’s assumptions. Those results are conditional on activated faults and oracle source-authority labels; they do not estimate real-world fault prevalence. A small model-facing pilot fails to establish a reliable packet-format ranking and is treated as uninformative. VCM v1 contributes a governed semantic-memory protocol, explicit failure boundaries, executable conformance artifacts, and a falsifiable external-validation agenda.
Keywords - language-model agents; agent memory; semantic paging; context compiler; provenance; capability security; context governance.
Protocol and systems-design paper with executable conformance and bounded mechanism studies. No result in this paper establishes superiority on frozen pretrained language models, natural agent histories, or complete neighboring systems. Related-work survey frozen on 19 June 2026.
1. Introduction
A language-model agent may work with a person, codebase, organization, or environment for months while the model can attend to only a bounded token sequence during one inference step. Larger windows, retrieval-augmented generation, recursive summarization, persistent stores, and cache reuse increase reach. They do not by themselves create a reliable memory system.
Durable history is heterogeneous. It contains policy, goals, constraints, decisions, corrections, evidence, quotations, preferences, tool results, stale facts, hostile instructions embedded in data, private material, rejected alternatives, and model-generated inferences. Treating these items as interchangeable text creates failures that are not well described as retrieval error.
Three boundary failures motivate VCM:
1. Discovery and contract failure. The system never discovers a required correction, or it assigns a weak use contract to an operation that actually requires exact quotation, current evidence, independent review, or live authorization.
2. Admission and authority failure. A locally cheap summary makes the mandatory set globally infeasible; hostile quoted text is promoted into behavior; or unresolved evidence is counted as sufficient.
3. Lifecycle and release failure. A source update leaves a stale synthesis or cache entry resident; revoked access is replayed; or sensitive material is prefetched, retained, or disclosed under an obsolete purpose.
VCM addresses these failures by treating the context window as a compiled working cache, not as the totality of memory. The larger memory space is logical and versioned. It can contain compact routing views, source-bound evidence, exact spans, conflict bundles, policy records, and physical materializations. A task-specific compiler selects what becomes model-visible, in which role, and under which evidence and authorization conditions.
The operating-systems analogy is useful but limited. Conventional virtual memory maps exact byte pages. Semantic memory is meaning-dependent, variably sized, often lossy, and capable of changing control flow. A summary cannot be “decompressed” into facts that it omitted. Exact recovery is possible only from retained exact bytes or an authoritative source. Otherwise the system must materialize a task-appropriate view under an explicit use contract.
The context window is a cache, not the agent’s memory. Working context should be compiled, not accumulated.
1.1 Claim, evidence, and boundary
What VCM v1 claims
* Mandatory obligations can be made explicit, authenticated, and auditable before optional context is admitted.
* Evidence cannot silently become behavioral or action authority through retrieval, compression, repetition, or cache reuse.
* Uncertainty, timeout, stale state, revocation, and proven infeasibility can produce different machine-readable outcomes.
* A packet can record what was admitted, why, under which snapshot, and with which unresolved risks.
What the current evidence supports
* One reference implementation can enforce the declared protocol rules on synthetic and annotated cases.
* Cross-layer checks prevent modeled governance faults that isolated point fixes miss.
* Some semantic heuristics remain low-recall, and richer packet grammar has not shown general model-facing benefit.
What remains unproved
* End-to-end superiority on frozen pretrained models and natural histories.
* Reliable open-world discovery, contract synthesis, or semantic validation.
* Lower total cost than a simpler typed-memory-plus-compiler design.
1.2 Contributions
The public-v1 release contributes five things.
1. A minimal governed semantic-memory Core. The Core contains identity and versioning, source and authority binding, role-indexed obligations, authenticated stabilization, adequacy and admission states, joint protected compilation, snapshot coherence, and auditable release decisions.
2. A precise cross-layer model. VCM distinguishes object, version, representation, validation, packet, and materialization; separates control, evidence, quotation, data, and action uses; and separates processing exposure from output influence.
3. Typed non-success. The protocol distinguishes semantic inadequacy from deferral, proven infeasibility from unknown feasibility, and feasible solutions from optimizer quality. A timeout cannot become a false UNSAFE_FIT.
4. A concrete protocol and conformance boundary. A companion specification defines signed envelopes, operation schemas, registries, packet profiles, exact-byte handling, invalidation commitments, collection, and mandatory tests.
5. Bounded evidence with an explicit non-result. Mechanism studies test selected protocol properties. A small packet-learnability pilot does not establish a reliable model-format ranking and is retained as an uninformative non-replication.
The novelty claim is compositional and falsifiable. Semantic paging, context compilation, provenance, evidence escalation, information-flow labels, transactions, predictive loading, and runtime-cache management all have substantial prior art. VCM claims that their interaction benefits from an explicit protocol with auditable failure states. A simpler design that matches its governance properties, model behavior, interoperability, and cost should replace or narrow the full protocol.
1.3 Scope and non-claims
VCM does not claim an infinite architectural context window, lossless semantic compression, complete open-world discovery, perfect contract synthesis, reliable model obedience to packet labels, universal erasure from trained weights or uncontrolled copies, or safe composition of arbitrary KV-cache blocks.
The deterministic kernel enforces declared labels and policies. It cannot make fallible semantic judgments correct. Authenticated stabilization is sound only if source identity and source authority were bound correctly at ingestion. The model is not trusted to enforce access control or authorize external actions.
 Figure 1. VCM public v1 at a glance. The safety-critical Core governs identity, obligations, adequacy, admission, coherence, and audit. Prediction, rich packet grammar, native caches, multi-principal exchange, and human review are optional.

Figure 1. VCM public v1 at a glance. The safety-critical Core governs identity, obligations, adequacy, admission, coherence, and audit. Prediction, rich packet grammar, native caches, multi-principal exchange, and human review are optional.
2. VCM in Brief
A VCM deployment has four planes.
* The ledger plane stores semantic objects, immutable content versions, claims, source bindings, relations, validations, capabilities, retention state, and materializations.
* The judgment plane performs fallible segmentation, discovery, contract derivation, semantic coverage assessment, contradiction analysis, and validation.
* The kernel plane resolves authenticated obligations, checks authorization, pins snapshots, invokes a joint solver, filters fault details, signs protocol messages, and enforces coherence rules.
* The model plane receives a compiled packet and produces text or proposed actions. External effects pass through a separate live authorization gate.
The read path is:
request
  -> provisional role-indexed contract
  <-> authenticated discovery and contract stabilization
  -> version and representation resolution
  -> adequacy judgment
  -> admission decision
  -> joint protected compilation
  -> optional admission under the same feasibility predicate
  -> model-specific serialization
  -> generation, verification, and live action authorization
  -> ledger update, invalidation, or collection
2.1 Why the Core is deliberately small
The public release does not make every useful mechanism mandatory. The negative packet-format result is one reason, but the stronger reason is systems parsimony: only features required for the stated governance contract belong in Core.
Table 1. Core and optional features.
Element
	Status
	Governance purpose
	Stable object, version, representation, validation, packet, and materialization identities
	Core
	Prevents a summary or cache entry from silently becoming “the memory.”
	Authenticated source and authority binding
	Core
	Prevents retrieved content from creating its own priority or permission.
	Role-indexed obligations
	Core
	Separates control, evidence, quotation, data, and action uses.
	Bounded authenticated stabilization
	Core
	Prevents false obligations from accumulating without bound.
	Adequacy separated from admission
	Core
	Prevents deferred or unknown evidence from counting as satisfied.
	Joint protected compilation with typed feasibility
	Core
	Prevents silent mandatory-state loss and false infeasibility claims.
	Snapshot, revocation, and invalidation coherence
	Core
	Prevents stale or formerly authorized material from being reused.
	Audit records and redacted fault views
	Core
	Makes denial and omission explainable without leaking sealed state.
	Rich model-packet grammar
	Optional
	May help or harm utilization depending on the model and provider API.
	Predictive staging
	Optional
	Can hide latency but creates exposure and pollution risk.
	Native token or KV materializations
	Optional
	Can reduce prefill only under strict runtime compatibility.
	Multi-principal exchange
	Optional
	Needed for collaborative deployments, not every agent.
	Human review
	Optional
	Needed where policy requires accountable escalation.
	Fine-grained causal influence inference
	Experimental
	May reduce over-taint, but current methods are incomplete.
	2.2 Core invariants
Table 2. Core invariants.
ID
	Invariant
	Required consequence
	I1
	Identity classes remain distinct.
	A derivative never inherits source status by convenience.
	I2
	Every hard obligation has a source, authority, role, scope, and contract version.
	Untrusted content cannot self-promote.
	I3
	Control, evidence, quotation, data, and action are different uses.
	Evidence can support a claim without authorizing behavior.
	I4
	Adequacy and admission are separate.
	UNKNOWN cannot become final admission.
	I5
	Only verified infeasibility yields UNSAFE_FIT.
	Timeout yields FEASIBILITY_UNKNOWN.
	I6
	Optional context is tested with the protected set.
	Non-additive constraints remain valid.
	I7
	Sensitive release follows processing exposure unless exclusion is mechanical.
	Missing attribution cannot silently declassify input.
	I8
	Dynamic coherence state is not stored as immutable object content.
	Byte-identical stale state is not reused under new policy or authorization.
	I9
	Planner output is an untrusted performance hint.
	Planning cannot grant access, truth, or authority.
	I10
	Retention, prefetch, and evaluation use decision-time information only.
	Future-answer leakage cannot inflate value estimates.
	The principal outcomes are:
AdequacyResult  = SATISFIED | UNSATISFIED | UNKNOWN
AdmissionStatus = FINAL | PROVISIONAL | DEFERRED | REJECTED
Feasibility     = FEASIBLE | PROVEN_INFEASIBLE | FEASIBILITY_UNKNOWN
Optimality      = PROVEN_OPTIMAL | BOUNDED_GAP | BEST_EFFORT | NOT_APPLICABLE
CompileOutcome  = READY_PACKET | PROVISIONAL_PACKET | ASK | ABSTAIN | DENY |
                  UNSAFE_FIT | FEASIBILITY_UNKNOWN | RETRY
3. Running Example: Project Atlas
Project Atlas is a designed diagnostic trace, not a representative workload. It contains:
* a final paper objective;
* an explicit rejection of an MVP-first framing for this project;
* an external document containing a hostile imperative inside quoted evidence;
* a source that later changes version;
* a switch to another project and back;
* a later request for an exact quotation;
* an untrusted source that falsely claims a human review is mandatory.
A flat transcript exposes all events at once. Similarity retrieval may find the hostile imperative and miss the rejected prototype. A rolling summary may retain “user dislikes prototypes” while losing the narrow project scope. A long context can still contain stale and contradictory versions.
VCM instead stores separate objects and representations:
* an active project goal;
* a scoped rejection record;
* an evidence page whose imperative remains data;
* a source-version relation and invalidation edge;
* a project root that can be mounted or unmounted;
* an exact source span for quotation.
The false review demand is placed in the exploratory queue. It cannot create a protected obligation because its source lacks authority. If later corroborated by authenticated policy, it can be promoted through a new contract revision. This is the core distinction between investigating a claim and granting the claim authority over compilation.
 Figure 2. Project Atlas. The clean path preserves a scoped decision and current evidence; the adversarial branch tests self-promotion, hostile quoted text, and stale-state invalidation.

Figure 2. Project Atlas. The clean path preserves a scoped decision and current evidence; the adversarial branch tests self-promotion, hostile quoted text, and stale-state invalidation.
4. Related Work and Novelty Boundary
Long-context models and benchmarks show that larger windows help but do not guarantee usable attention or distractor resistance [1], [2], [3], [4]. RAG and active retrieval extend access to external information [5], [6], [7], [8]. Prompt-compression methods reduce active tokens but do not by themselves preserve role, authority, exactness, or future-query sufficiency [9], [10], [11], [12].
Persistent-agent memory systems make durable state and tiered memory practical [13], [14], [15], [16], [17]. ClawVM develops harness-managed virtual memory with typed pages and observable faults [18]. RAMPART treats context assembly as programmable compilation [19]. Tiered evidence systems, provenance-grounded memories, lineage protocols, and portable memory packages address complementary parts of the problem [20], [21], [22], [23], [24].
Runtime systems manage tokens, prefixes, and KV memory efficiently [25], [26], [27], [28], [29], [30], [31], [32], [33]. VCM treats those forms as disposable materializations beneath a semantic coherence boundary.
Classical systems work supplies much of the vocabulary: working sets and replacement [34], [35], capabilities and protection [36], [37], provenance and materialized-view maintenance [38], [39], [40], [41], information flow and policy combination [42], [43], [44], [45], and convergence and abstract interpretation [46], [47]. VCM applies these distinctions to semantic state whose discovery and validation are probabilistic.
Table 3. Composition-specific litmus tests.
Failure
	Why one isolated component is insufficient
	VCM contract involved
	A cheap summary is reused for an exact quotation.
	Retrieval found the right object, but the representation is inadequate for the use.
	Use contract, adequacy, exact-byte descriptor, semantic fault.
	Hostile quoted text becomes behavioral instruction after summarization.
	Provenance alone does not constrain role or effect.
	Role-indexed obligations, authority non-escalation, action gate.
	A source update leaves a compatible-looking cached prefix resident.
	Cache identity alone does not encode current validation or policy.
	Materialization coherence key and read-time invalidation.
	A planner prefetches a sealed page.
	Prediction alone cannot enforce purpose or capability.
	Authorization before staging and non-model-visible residency.
	Point fixes pass isolated checks but fail a combined check-use race.
	Authorization, invalidation, admission, and release must be bound to one decision.
	Snapshot-bound compilation and live release check.
	The residual claim is precise: VCM does not invent each mechanism. It defines one auditable protocol for composing them without allowing one layer’s optimization to violate another layer’s correctness contract.
5. Semantic Model and Governance Core
5.1 Identity: object, version, representation, validation, packet, materialization
VCM separates six identities.
* ObjectID: stable governable semantic identity.
* VersionID: immutable content and source ancestry at one transaction time.
* RepresentationID: a task-relative view of one or more versions.
* ValidationID: a content-addressed assessment of one representation for one obligation under one snapshot, policy view, authorization view, and time.
* PacketID: the logical admitted set before provider-specific adaptation.
* MaterializationID: a physical rendering such as messages, tokens, a prefix entry, or runtime state.
An immutable ObjectVersion contains content and ancestry, not current policy, authorization, validation, serialization, or runtime state. Those dynamic fields belong to contextual records and coherence commitments. This prevents a revocation or serializer upgrade from masquerading as a change in semantic content.
A source content descriptor binds media type, byte length, and raw-byte hash. Normalized model-facing text is separate from exact source bytes. Exact quotation depends on the descriptor and source boundaries, not on a normalized JSON string.
 Figure 3. Identity and state. Semantic validity, physical residency, task admission, and retention are orthogonal.

Figure 3. Identity and state. Semantic validity, physical residency, task admission, and retention are orthogonal.
5.2 Role-indexed operation contracts
One global permission such as “behavioral” cannot describe a packet containing user instructions, external evidence, exact quotation, ordinary data, and a proposed action. VCM therefore defines five obligation roles:
* CONTROL - may shape model behavior within scope;
* EVIDENCE - may support claims but not grant behavioral permission;
* QUOTATION - must preserve exact or contextual wording as data;
* DATA - may be observed but not obeyed;
* ACTION - requires live out-of-band authorization for an external effect.
Each obligation records source, source authority, purpose, scope, exactness, coverage, freshness, valid time, support, disclosure, audience, review, allowed effects, confidence, and provisional permission.
Contract strengthening is a partial order, not a scalar “fidelity” ladder. Required coverage, permitted disclosure, exactness, freshness, review, support, audience, and effects have separate comparison rules. Some representations are incomparable: a current synthesis and a historical byte-exact quotation answer different questions.
5.3 Adequacy and admission
Adequacy asks whether a representation supports a use:
SATISFIED | UNSATISFIED | UNKNOWN
Admission asks whether the representation may enter the current packet:
FINAL | PROVISIONAL | DEFERRED | REJECTED
The mapping is strict:
* SATISFIED -> FINAL;
* UNKNOWN -> PROVISIONAL only when explicitly authorized with expiry, permitted effects, verification action, and failure behavior;
* UNKNOWN -> DEFERRED otherwise;
* UNSATISFIED -> REJECTED.
This distinction matters because a plan to validate later is not evidence now.
5.4 Authenticated stabilization
Discovery and contract synthesis revise each other. A discovered conflict can require stronger evidence. A quotation request can require exact context. Conversely, malicious content can falsely claim urgency, sensitivity, or mandatory review.
VCM uses bounded authenticated stabilization:
start with the authenticated minimum contract
repeat under round, work, depth, and principal quotas:
  discover candidate addresses and relations
  classify candidate obligations by source and authority
  promote only authenticated or independently validated hard obligations
  retain uncertain untrusted claims as expiring exploratory questions
  apply only authorized retractions and supersessions
  stop at a stable fingerprint, cycle, or declared limit
A lower-precedence principal cannot retract a higher-precedence privacy restriction, legal hold, or policy constraint merely because the retraction is signed.
The protocol exposes a convergence-latency-availability tradeoff. Tight limits reduce denial-of-service risk but can force CONVERGENCE_LIMIT before the obligation set stabilizes. High-impact deployments should ask, decompose, or abstain rather than pretend the result is complete.
 Figure 4. Authenticated stabilization. Untrusted discoveries may create exploratory questions; only authorized sources or validated risk triggers can create protected obligations.

Figure 4. Authenticated stabilization. Untrusted discoveries may create exploratory questions; only authorized sources or validated risk triggers can create protected obligations.
5.5 Evidence, exposure, influence, and authority
VCM separates:
* declared dependency;
* processing exposure;
* mechanically proven influence;
* intervention-supported influence;
* mechanical exclusion.
Processing exposure and output influence are different privacy questions. Once confidential content is sent to a model provider, it has been exposed to that processing environment even if the final answer does not depend on it. High-sensitivity release therefore follows exposure unless deterministic isolation establishes a narrower dependency set.
Behavioral authority follows authenticated control dependencies. Evidential support follows evidence dependencies. Action authority is checked live. Repetition, summarization, corroboration, and cache reuse cannot create permission.
 Figure 5. Roles, evidence, authority, and exposure. The control plane keeps factual support, processing exposure, behavioral authority, and action permission separate.

Figure 5. Roles, evidence, authority, and exposure. The control plane keeps factual support, processing exposure, behavioral authority, and action permission separate.
6. Compiled Working Context and Virtual Residency
6.1 Representation graph and semantic materialization
A semantic object can have several views:
* a short handle for routing;
* a scoped decision capsule;
* a structured synthesis;
* an evidence map;
* an exact source span;
* a contradiction bundle;
* a provider-specific message sequence;
* a compatible runtime materialization.
These views form a graph, not a single compression ladder. The “best” representation depends on the operation contract. A summary can be ideal for planning and invalid for quotation. An exact excerpt can preserve bytes while omitting contextual qualifiers.
VCM therefore distinguishes:
* exact decoding from a retained lossless encoding;
* semantic materialization from sources and transforms;
* fluent expansion, which is not evidence of omitted truth.
6.2 Protected-set derivation and joint compilation
The kernel derives the protected set from stabilized obligations, current policy, task state, corrections, active decisions, conflicts, evidence requirements, and current authorization. Untrusted content cannot pin itself.
Representation choice is a set problem. Costs can share sources, conflict, trigger review, or interact with privacy and provider limits. The compiler therefore evaluates candidate bundles jointly rather than selecting the cheapest view independently for each obligation.
The feasibility result is separate from optimizer quality:
Feasibility = FEASIBLE | PROVEN_INFEASIBLE | FEASIBILITY_UNKNOWN
Optimality  = PROVEN_OPTIMAL | BOUNDED_GAP | BEST_EFFORT | NOT_APPLICABLE
A feasible best-effort packet still satisfies all hard constraints. An unsatisfied hard constraint is never “approximately feasible.” PROVEN_INFEASIBLE requires a verifiable proof profile and unsatisfiable core. Timeout and incomplete search return FEASIBILITY_UNKNOWN.
Optional context is tested with the full protected set under the same resource predicate. Dropping optional items does not make a packet provisional.
6.3 Compile outcomes and semantic faults
...
FEASIBILITY_UNKNOWN
RETRY
A structured result may also carry a fault code and a next action such as VALIDATE, REVIEW, DECOMPOSE, REMATERIALIZE, or REAUTHORIZE. Outcomes and recovery actions are different types.
The semantic-fault cascade is intentionally cheap first:
1. deterministic metadata and coherence checks;
2. contract comparison and cached validation;
3. targeted evidence or exact-source materialization;
4. answer-time verification, clarification, review, or abstention.
A semantic fault is not a hardware exception. It may require an expensive judgment call. VCM’s contribution is to make the fault explicit and staged, not to make semantic uncertainty free.
 Figure 6. Protected compilation and fault outcomes. Protected obligations are admitted before optional context. Only proven infeasibility yields UNSAFE_FIT; unresolved search yields FEASIBILITY_UNKNOWN.

Figure 6. Protected compilation and fault outcomes. Protected obligations are admitted before optional context. Only proven infeasibility yields UNSAFE_FIT; unresolved search yields FEASIBILITY_UNKNOWN.
6.4 Model-packet profiles
Core requires only SimpleTyped/1.0. Four richer profiles are optional:
* NativeRoles/1.0;
* TaggedText/1.0;
* StructuredInput/1.0;
* ToolEnvelope/1.0.
Each profile commits the logical packet, actual provider request, serialized text, role mapping, tool schema, truncation, and tokenizer/runtime state where applicable.
Packet labels do not force model behavior. The small neural pilot provides no reliable evidence that a richer VCM grammar is better than a compact typed compiler. Model-packet profiles therefore remain adaptation layers, not the primary safety claim.
6.5 Predictive staging and hot-swappable context
VCM can maintain a much larger effective working context than the active window by keeping stable addresses and compact routing views resident while task-relevant pages remain in storage, compressed memory, or staged buffers.
A planner may forecast likely future needs and request prefetch. That request is an untrusted performance hint. Authorization precedes staging, and staging remains outside model-visible context until promotion.
A context switch changes mounted roots, pinned snapshot, and resident working set. It does not replay the entire history. This supports fast movement among projects or roles while retaining provenance and recovery paths.
Prediction can reduce page-fault latency when demand is predictable. It can also waste compute, expose private data, and pollute cache. A deployment must report prefetch regret and use only information available at decision time.
6.6 Native runtime materializations
Tokens, prefixes, and KV state are optional physical forms, not semantic truth. A runtime key binds packet or representation identity to current validation, contract, policy, authorization, serializer, tokenizer, model, runtime, and tool-schema state.
Independent KV blocks are generally not composable under ordinary causal-transformer semantics. When compatibility is uncertain, the correct fallback is re-prefill from an authorized serialized packet.
7. Lifecycle, Recovery, and Collection
7.1 Core versus Transactions
Core requires immutable versions, pinned read snapshots, current coherence commitments, and revocation checks. It can consume those services from an external ledger.
The optional Transactions feature owns commit, merge, branching, alias publication, invalidation origination, and deletion closure. When enabled, writes use immutable commits and expected-parent conflict detection. This separation allows a minimal read/release kernel without pretending that distributed write semantics are optional for deployments that actually perform multi-step writes.
7.2 Race-free invalidation
A source, policy, authorization, contract, validation, serializer, or runtime change advances a dependency epoch or equivalent commitment. Reads validate parent versions and commitments before release. A mismatch returns STALE_OR_DIRTY even if asynchronous closure traversal has not reached every descendant.
This closes the common race in which a stale derivative remains apparently valid between the root update and background invalidation.
7.3 Garbage collection and deletion
A long-running ledger cannot retain every packet, validation, staging event, and runtime form forever. Collection preserves live roots, active snapshots, legal holds, unresolved decisions, retained evidence, and required audit commitments. Short-lived packets and runtime materializations expire aggressively. Older validations can be compacted into signed commitments when policy permits.
Deletion returns a residue report. VCM claims tracked closure over governed derivatives and caches, not universal erasure from recipients, external backups, provider logs, or trained weights.
 Figure 7. Lifecycle and collection. Immutable semantic ancestry is separated from dynamic validation, admission, residency, and retention state.

Figure 7. Lifecycle and collection. Immutable semantic ancestry is separated from dynamic validation, admission, residency, and retention state.
7.4 Recovery from judgment-plane failure
The kernel can detect declared uncertainty, missing validation, stale state, unauthorized use, and inconsistent commitments. It cannot detect every confident misclassification.
Recovery may therefore include:
* conservative defaults for high-impact uses;
* independent source-exact checks;
* human review;
* task decomposition;
* output buffering and verification;
* post-incident invalidation and correction.
The protocol relocates fallible judgments behind explicit boundaries. It does not eliminate them.
8. Wire Protocol, Registries, and Conformance
The companion specification defines canonical signed envelopes, audience binding, replay protection, downgrade resistance, version and feature negotiation, stable outcomes, and redacted fault views. It also separates normalized model-facing text from exact-byte descriptors.
The public-v1 operation registry includes Core operations for mounting, contract derivation, discovery, resolution, validation, coherence checks, compilation, serialization, and authorized explanation. Optional feature registries add governance, transactions, predictive residency, native runtime binding, multi-principal exchange, and human review.
Networked messages use authenticated version negotiation. Content-bearing idempotent reads recheck current release authority before returning a cached result. Unknown critical fields fail closed. Public faults can conceal whether an object is absent, sealed, or unauthorized.
The reference suite is constructive evidence for one implementation. Interoperability requires a second implementation, cross-language canonicalization, mutation testing, fuzzing, and signed positive and negative vectors.
 Figure 8. Protocol boundary. Signed service messages, the logical packet, the provider adapter, and the actual model-visible request are separately committed.

Figure 8. Protocol boundary. Signed service messages, the logical packet, the provider adapter, and the actual model-visible request are separately committed.
9. Threat Model
The trusted computing base contains the deterministic kernel, cryptographic verification, policy-combining engine, coherence machinery, and selected storage primitives. The trusted judgment base is larger and fallible: classifiers, contract synthesis, discovery, semantic validation, contradiction analysis, and human review.
VCM considers malicious retrieved documents, mistaken or malicious principals within granted authority, compromised external agents, planner manipulation, cross-principal probing, replay, downgrade, stale-cache reuse, poisoned semantic labels, and storage tampering.
It does not protect against a fully malicious governance root, trusted signing keys controlled by an attacker, undisclosed copies outside the system, or a model provider that violates its processing contract.
Planner staging requests are untrusted. Authorization checks precede staging and promotion. Fault details are filtered into internal, authorized-caller, and public views. Timing and access-pattern leakage remain deployment-specific risks.
10. Evidence and Results
10.1 Evidence boundary
The current studies use synthetic or annotated semantics. They test control-plane mechanics, solver behavior, influence heuristics, collection policy, and packet learnability. They do not establish that automatic discovery and contract synthesis are correct on natural histories. They do not establish end-to-end advantage over a released neighboring system or measure full production cost.
The evidence ladder is:
1. specification;
2. single-implementation conformance;
3. mechanism isolation;
4. controlled model learnability;
5. external validity with frozen pretrained models and natural traces.
This release reaches Levels 1-4. Level 4 is a non-replication treated as uninformative, not a performance win.
10.2 Governance fault-injection study
The study activates one of seven modeled fault families on every trial: authority laundering, replay after revocation, stale derivative reuse, self-promoting obligations, deletion-residue leakage, timeout misclassified as infeasibility, and a combined authorization/invalidation check-use race.
Critical scope statement: results are conditional on activated faults under oracle source-authority labels unless label error is explicitly injected. They do not estimate real-world fault prevalence.
Across 20 paired seeds and 10,000 activated-fault trials per seed, the mean severity-weighted unsafe-outcome rates are:
Policy
	Unsafe rate
	Typed compiler
	77.51%
	Point-hardened typed compiler
	3.29%
	VCM Core
	0.44%
	On the combined check-use race, the unsafe rates are 44.60%, 15.87%, and 0% respectively. This is the narrowest and most informative finding: local fixes can pass isolated checks yet fail when authorization, invalidation, admission, and release are not bound to one decision.
The study assumes correct authority labels. At 5% source-authority label error, the VCM result rises to 2.00%. The kernel faithfully enforcing a wrong label is a remaining unsafe path. The study therefore supports a conditional control-plane claim, not a claim that the semantic front end is solved.
10.3 Other mechanism evidence
Authenticated stabilization sharply reduces false protected obligations but trades some recall for precision and availability. The correct metric is severity-weighted dangerous false negatives, not average recall alone.
A bounded joint-solver study demonstrates why timeout must remain FEASIBILITY_UNKNOWN: at the largest tested size, most runs return a feasible but not proven-optimal packet or remain unknown; none proves infeasibility.
An intervention-based influence pilot reaches moderate precision but low recall. It supports conservative privacy propagation and does not validate general causal attribution or declassification.
A synthetic 100,000-event ledger study shows that one bounded collection policy can reduce retained record count substantially. It does not establish long-term task-resumption quality or audit sufficiency.
The public release’s conformance suite covers record separation, contract roles, adequacy and admission, exact-byte descriptors, disclosure comparison, authorized retraction, feasibility status, compile outcomes, packet escaping, canonicalization, signatures, replay, downgrade, revocation, invalidation, and deletion residue. Passing tests demonstrate internal conformance, not independent interoperability.
10.4 Model-facing pilot: non-replication treated as uninformative
An earlier internal draft reported a favorable result for a tiny from-scratch model. A stronger eight-seed study does not reproduce that advantage. Accuracy remains near floor, five of eight paired seeds tie between the strong typed composite and full VCM, and paired tests do not support a reliable ranking.
The defensible conclusion is:
The pilot does not establish that the fuller VCM packet grammar is better or worse than a strong typed compiler for real pretrained models.
The experiment measures closed-vocabulary learnability in a small model trained on every packet policy. It does not test zero-shot use by an instruction-tuned model, natural histories, or free-form generation. It is retained to prevent a favorable earlier pilot from being selectively reported.
 Figure 9. Evidence summary. The governance study supports a conditional control-plane claim under modeled faults and oracle labels. The neural pilot supplies no reliable packet-format ranking.

Figure 9. Evidence summary. The governance study supports a conditional control-plane claim under modeled faults and oracle labels. The neural pilot supplies no reliable packet-format ranking.
11. External Validation and Falsification
The decisive next experiment should freeze the public-v1 protocol before trace annotation. It should use:
* at least two frozen instruction-tuned model families;
* natural or independently authored long-horizon traces;
* free-form outputs;
* matched source material and token budgets;
* a strong typed-memory-plus-compiler baseline;
* at least one released close-neighbor implementation or harness;
* stage-wise error attribution and full operational cost.
The minimum useful study should compare simple typed compilation and VCM Core using identical admitted content. It should separately measure:
* discovery recall;
* contract understatement;
* adequacy false positives and false negatives;
* mandatory-state admission;
* severe governance failures;
* model compliance;
* evidence fidelity;
* stale-state use;
* review burden;
* latency, storage, and developer cost.
A decisive positive result requires both materially fewer severe failures at matched task quality and overhead low enough that a simpler compiler cannot obtain the same result more cheaply.
VCM should be narrowed or rejected if:
* a simpler typed compiler matches its governance properties at lower cost;
* semantic-front-end error dominates deterministic control benefits;
* packet structure does not help frozen models;
* joint compilation is too slow at realistic scale;
* metadata and review overhead exceed the value of prevented failures;
* independent implementations cannot interoperate.
12. Discussion
12.1 Why virtual context remains useful without a packet-format win
The packet pilot does not invalidate the systems problem. An agent can still benefit from durable addresses, exact-source escalation, scoped preferences, negative memory, authenticated obligation sources, stale-state invalidation, and explicit infeasibility even if the final model-facing serialization is simple.
The protocol’s strongest near-term value is governed context allocation: making release decisions inspectable and binding them to one snapshot and authorization view.
12.2 From retrieval to residency
RAG asks what text resembles the query. VCM asks what state should be resident, in which representation, for which use, under which proof and authority constraints, for how long.
This is a shift from retrieval to residency. The agent need not carry its history as a transcript. It maintains an addressable memory space and compiles the current working set.
12.3 Complexity discipline
VCM is intentionally modular. A single-principal black-box deployment can implement the Core with SimpleTyped/1.0, an ordinary database, a vector and graph index, source-exact retrieval, a bounded solver, and live authorization checks. It does not need native KV integration, predictive staging, causal influence inference, or multi-agent transactions.
Every optional feature must justify its cost independently.
13. Limitations
VCM depends on semantic judgments it cannot make deterministic. Source typing, discovery, contract synthesis, validation, and contradiction analysis can fail confidently. The kernel makes those judgments governable; it does not make them correct.
Open-world discovery remains incomplete. A relevant object that is neither retrieved nor structurally exposed may produce no fault.
Joint selection is computationally hard. Real deployments need bounded search, warm starts, decomposition, or domain-specific solvers, and must preserve FEASIBILITY_UNKNOWN when proof is unavailable.
Processing exposure can be broader than measured output influence. Fine-grained declassification remains difficult.
Tracked deletion does not erase the universe. Runtime compatibility does not establish truth. Packet labels do not guarantee model obedience. Predictive staging may be net harmful in reactive workloads. Multi-principal policy reconciliation remains a substantial distributed-systems problem.
14. Conclusion
Virtual Context Memory public v1 specifies a governed semantic address space and a compiler that constructs a bounded working set from it. Its Core is deliberately small: authenticated obligations, role-indexed contracts, explicit adequacy and admission, joint protected compilation, snapshot and revocation coherence, and auditable outcomes.
The central thesis is not that an agent should remember everything. It is that the system should make explicit what deserves to become active context, in which form, under whose authority, with what evidence, and with what recovery path when the answer is uncertain.
The current evidence supports a conditional control-plane claim under synthetic and annotated conditions. It does not establish end-to-end superiority. The protocol is precise enough for that stronger claim to be tested - including the possibility that a simpler system wins.
Appendix A. Core Record Summary
The companion schemas are normative. This summary is explanatory.
SemanticObject
  object_id, principal_or_namespace, object_type,
  claim_boundaries, retention_policy, sensitivity_default

ObjectVersion
  version_id, object_id, parent_version_ids[], transaction_time,
  source_bindings[], content_descriptor, claim_manifest_hash?

Representation
  representation_id, source_version_ids[], transform_id, class,
  content_hash, attestation_bundle_id, declared_dependencies[]

ValidationRecord
  representation_id, obligation_id, snapshot_id, policy_view_hash,
  authorization_view_hash, validator_identity, validator_profile,
  evidence_set[], source_set_hash, adequacy_result,
  independence_evidence?, issued_at, expires_at, revocation_state

ValidationID
  hash(canonical complete ValidationRecord)

OperationContract
  contract_id, revision, purpose, principal, audience, operation_class,
  snapshot_id, policy_view_hash, authorization_view_hash,
  obligations[], uncertainty_policy, resource_envelope, safe_fallbacks[]

AdmissionRecord
  obligation_id, validation_id, admission_status, permitted_effects,
  required_verification_action?, expiry?, failure_behavior

ContextPacket
  packet_id, contract_version, snapshot_id, protected_entries[],
  optional_entries[], unresolved_items[], logical_packet_hash

Materialization
  packet_or_representation_id, validation_state_commitment,
  contract_version, policy_view_hash, authorization_view_hash,
  snapshot_id, serializer_version, packet_profile,
  provider_adapter_version, model_runtime_fingerprint,
  tokenizer_and_role_layout, tool_schema_version,
  provider_request_hash, serialized_text_hash,
  tokenization_hash?, runtime_materialization_hash?, expiry
Appendix B. Core Outcome Summary
Adequacy:
  SATISFIED | UNSATISFIED | UNKNOWN
...
Feasibility:
  FEASIBLE | PROVEN_INFEASIBLE | FEASIBILITY_UNKNOWN

Optimality:
  PROVEN_OPTIMAL | BOUNDED_GAP | BEST_EFFORT | NOT_APPLICABLE

Compilation:
  READY_PACKET | PROVISIONAL_PACKET | ASK | ABSTAIN | DENY |
  UNSAFE_FIT | FEASIBILITY_UNKNOWN | RETRY

Lifecycle:
  VALIDATED | STALE_OR_DIRTY | INVALID | PURGED
Appendix C. Artifact and Release Record
The public-v1 package contains the paper, companion specification, editable sources, X-ready article text, figures, JSON schemas, registries, positive and negative protocol vectors, reference code, tests, study scripts, raw results, an environment record, licenses, a release manifest, and SHA-256 checksums.
The release identifier, registry-set hash, and bundle-root hash are recorded in RELEASE_MANIFEST.json. A repository URL or DOI is added only after an immutable public deposit exists.
References
[1] N. F. Liu et al., “Lost in the middle: How language models use long contexts,” Transactions of the Association for Computational Linguistics, vol. 12, pp. 157–173, 2024, doi: 10.1162/tacl_a_00638.
[2] C.-P. Hsieh et al., “RULER: What’s the real context size of your long-context language models?” arXiv preprint arXiv:2404.06654, 2024, doi: 10.48550/arXiv.2404.06654.
[3] Y. Bai et al., “LongBench v2: Towards deeper understanding and reasoning on realistic long-context multitasks,” in Proceedings of the 63rd annual meeting of the association for computational linguistics, 2025, pp. 3639–3664. doi: 10.48550/arXiv.2412.15204.
[4] Y. Du et al., “Context length alone hurts LLM performance despite perfect retrieval,” in Findings of the association for computational linguistics: EMNLP 2025, 2025, pp. 23281–23298. doi: 10.18653/v1/2025.findings-emnlp.1264.
[5] P. Lewis et al., “Retrieval-augmented generation for knowledge-intensive NLP tasks,” in Advances in neural information processing systems, 2020, pp. 9459–9474.
[6] Z. Jiang et al., “Active retrieval augmented generation,” arXiv preprint arXiv:2305.06983, 2023, doi: 10.48550/arXiv.2305.06983.
[7] A. Asai, Z. Wu, Y. Wang, A. Sil, and H. Hajishirzi, “Self-RAG: Learning to retrieve, generate, and critique through self-reflection,” arXiv preprint arXiv:2310.11511, 2023, doi: 10.48550/arXiv.2310.11511.
[8] H. Trivedi, N. Balasubramanian, T. Khot, and A. Sabharwal, “Interleaving retrieval with chain-of-thought reasoning for knowledge-intensive multi-step questions,” arXiv preprint arXiv:2212.10509, 2022, doi: 10.48550/arXiv.2212.10509.
[9] H. Jiang, Q. Wu, C.-Y. Lin, Y. Yang, and L. Qiu, “LLMLingua: Compressing prompts for accelerated inference of large language models,” in Proceedings of the 2023 conference on empirical methods in natural language processing, 2023, pp. 13358–13376. doi: 10.18653/v1/2023.emnlp-main.825.
[10] H. Jiang et al., “LongLLMLingua: Accelerating and enhancing LLMs in long context scenarios via prompt compression,” arXiv preprint arXiv:2310.06839, 2023, doi: 10.48550/arXiv.2310.06839.
[11] J. Mu, X. L. Li, and N. Goodman, “Learning to compress prompts with gist tokens,” arXiv preprint arXiv:2304.08467, 2023, doi: 10.48550/arXiv.2304.08467.
[12] F. Xu, W. Shi, and E. Choi, “RECOMP: Improving retrieval-augmented LMs with compression and selective augmentation,” in The twelfth international conference on learning representations, 2024. doi: 10.48550/arXiv.2310.04408.
[13] C. Packer et al., “MemGPT: Towards LLMs as operating systems,” arXiv preprint arXiv:2310.08560, 2023, doi: 10.48550/arXiv.2310.08560.
[14] P. Chhikara, D. Khant, S. Aryan, T. Singh, and D. Yadav, “Mem0: Building production-ready AI agents with scalable long-term memory,” arXiv preprint arXiv:2504.19413, 2025, doi: 10.48550/arXiv.2504.19413.
[15] W. Xu, Z. Liang, K. Mei, H. Gao, J. Tan, and Y. Zhang, “A-MEM: Agentic memory for LLM agents,” arXiv preprint arXiv:2502.12110, 2025, doi: 10.48550/arXiv.2502.12110.
[16] Z. Li et al., “MemOS: A memory OS for AI system,” arXiv preprint arXiv:2507.03724, 2025, doi: 10.48550/arXiv.2507.03724.
[17] J. Liu et al., “SimpleMem: Efficient lifelong memory for LLM agents,” arXiv preprint arXiv:2601.02553, 2026, doi: 10.48550/arXiv.2601.02553.
[18] M. Rafique and L. Bindschaedler, “ClawVM: Harness-managed virtual memory for stateful tool-using LLM agents,” in Proceedings of the sixth european workshop on machine learning and systems (EuroMLSys ’26), 2026, pp. 1–12. doi: 10.1145/3805621.3807648.
[19] N. Tomczak, “RAMPART: Registry-based agentic memory with priority-aware runtime transformation,” arXiv preprint arXiv:2606.04628, 2026, doi: 10.48550/arXiv.2606.04628.
[20] Q. Zhu, S. Chen, R. Yu, Z. Wu, and B. Wang, “From lossy to verified: A provenance-aware tiered memory for agents,” arXiv preprint arXiv:2602.17913, 2026, doi: 10.48550/arXiv.2602.17913.
[21] Z. Jin, B. Wang, J. Li, R. Xu, and M. Zhang, “Mitigating provenance-role collapse in long-term agents via typed memory representation,” arXiv preprint arXiv:2605.25869, 2026, doi: 10.48550/arXiv.2605.25869.
[22] C. Ouyang and R. Hou, “MemLineage: Lineage-guided enforcement for LLM agent memory,” arXiv preprint arXiv:2605.14421, 2026, doi: 10.48550/arXiv.2605.14421.
[23] R. Joshi, “Eywa: Provenance-grounded long-term memory for AI agents,” arXiv preprint arXiv:2605.30771, 2026, doi: 10.48550/arXiv.2605.30771.
[24] S. K. Ravindran, “Portable agent memory: A protocol for cryptographically-verified memory transfer across heterogeneous AI agents,” arXiv preprint arXiv:2605.11032, 2026, doi: 10.48550/arXiv.2605.11032.
[25] W. Kwon et al., “Efficient memory management for large language model serving with PagedAttention,” in Proceedings of the 29th ACM symposium on operating systems principles, 2023, pp. 611–626. doi: 10.1145/3600006.3613165.
[26] R. Prabhu, A. Nayak, J. Mohan, R. Ramjee, and A. Panwar, “vAttention: Dynamic memory management for serving LLMs without PagedAttention,” arXiv preprint arXiv:2405.04437, 2024, doi: 10.48550/arXiv.2405.04437.
[27] L. Zheng et al., “SGLang: Efficient execution of structured language model programs,” in Advances in neural information processing systems, 2024. doi: 10.48550/arXiv.2312.07104.
[28] Z. Pan et al., “KVFlow: Efficient prefix caching for accelerating LLM-based multi-agent workflows,” in Advances in neural information processing systems, 2025. doi: 10.48550/arXiv.2507.07400.
[29] Z. Zhang et al., “H2O: Heavy-hitter oracle for efficient generative inference of large language models,” arXiv preprint arXiv:2306.14048, 2023, doi: 10.48550/arXiv.2306.14048.
[30] G. Xiao, Y. Tian, B. Chen, S. Han, and M. Lewis, “Efficient streaming language models with attention sinks,” arXiv preprint arXiv:2309.17453, 2023, doi: 10.48550/arXiv.2309.17453.
[31] Z. Bian, F. Wu, Z. Li, T. Ma, and Y. Zhuo, “TokenCake: A KV-cache-centric serving framework for LLM-based multi-agent applications,” arXiv preprint arXiv:2510.18586, 2025, doi: 10.48550/arXiv.2510.18586.
[32] H. Zheng et al., “Efficient serving for dynamic agent workflows with prediction-based KV-cache management,” arXiv preprint arXiv:2605.06472, 2026, doi: 10.48550/arXiv.2605.06472.
[33] S. Yu et al., “Pythia: Exploiting workflow predictability for efficient agent-native LLM serving,” arXiv preprint arXiv:2604.25899, 2026, doi: 10.48550/arXiv.2604.25899.
[34] P. J. Denning, “The working set model for program behavior,” Communications of the ACM, vol. 11, no. 5, pp. 323–333, 1968, doi: 10.1145/363095.363141.
[35] L. A. Bélády, “A study of replacement algorithms for a virtual-storage computer,” IBM Systems Journal, vol. 5, no. 2, pp. 78–101, 1966, doi: 10.1147/sj.52.0078.
[36] J. B. Dennis and E. C. Van Horn, “Programming semantics for multiprogrammed computations,” Communications of the ACM, vol. 9, no. 3, pp. 143–155, 1966, doi: 10.1145/365230.365252.
[37] J. H. Saltzer and M. D. Schroeder, “The protection of information in computer systems,” Proceedings of the IEEE, vol. 63, no. 9, pp. 1278–1308, 1975, doi: 10.1109/PROC.1975.9939.
[38] P. Buneman, S. Khanna, and W.-C. Tan, “Why and where: A characterization of data provenance,” in Database theory - ICDT 2001, in Lecture notes in computer science, vol. 1973. Springer, 2001, pp. 316–330. doi: 10.1007/3-540-44503-X_20.
[39] J. Cheney, L. Chiticariu, and W.-C. Tan, “Provenance in databases: Why, how, and where,” Foundations and Trends in Databases, vol. 1, no. 4, pp. 379–474, 2009, doi: 10.1561/1900000006.
[40] T. J. Green, G. Karvounarakis, and V. Tannen, “Provenance semirings,” in Proceedings of the 26th ACM SIGMOD-SIGACT-SIGART symposium on principles of database systems, 2007, pp. 31–40. doi: 10.1145/1265530.1265535.
[41] A. Gupta and I. S. Mumick, “Maintenance of materialized views: Problems, techniques, and applications,” IEEE Data Engineering Bulletin, vol. 18, no. 2, pp. 3–18, 1995.
[42] D. E. Denning, “A lattice model of secure information flow,” Communications of the ACM, vol. 19, no. 5, pp. 236–243, 1976, doi: 10.1145/360051.360056.
[43] A. Sabelfeld and A. C. Myers, “Language-based information-flow security,” IEEE Journal on Selected Areas in Communications, vol. 21, no. 1, pp. 5–19, 2003, doi: 10.1109/JSAC.2002.806121.
[44] A. C. Myers and B. Liskov, “Protecting privacy using the decentralized label model,” ACM Transactions on Software Engineering and Methodology, vol. 9, no. 4, pp. 410–442, 2000, doi: 10.1145/363516.363526.
[45] OASIS, “eXtensible access control markup language (XACML) version 3.0 plus errata 01,” OASIS Open, 2017.
[46] G. A. Kildall, “A unified approach to global program optimization,” in Proceedings of the 1st ACM SIGACT-SIGPLAN symposium on principles of programming languages, 1973, pp. 194–206. doi: 10.1145/512927.512945.
[47] P. Cousot and R. Cousot, “Abstract interpretation: A unified lattice model for static analysis of programs by construction or approximation of fixpoints,” in Proceedings of the 4th ACM SIGACT-SIGPLAN symposium on principles of programming languages, 1977, pp. 238–252. doi: 10.1145/512950.512973.
denser
Virtual Context Memory
An Evidence-Carrying, Planner-Guided Context Compiler for Long-Horizon Language-Model Agents
Corben Sorenson
Version .1 - June 2026
Abstract
...
A durable interaction history is not a bag of interchangeable tokens. It contains hard constraints, current task state, decisions, corrections, evidence, user preferences, procedures, temporary assumptions, rejected designs, tool outputs, stale facts, quoted malicious instructions, and conversational residue. A flat transcript gives these objects similar structural status. Top-k retrieval privileges lexical or embedding similarity over behavioral importance. A rolling summary can collapse distinct source roles and silently lose negation, scope, or decision force. A large native window can hold more material, yet long-context benchmarks continue to show position sensitivity, distractor interference, and degradation from supplying more context than a task requires [1], [2], [3], [4]. Capacity and usable context are therefore related but not equivalent.
...
VCM is not the first work to compare LLM context with virtual memory. MemGPT introduced virtual-context management; recent systems have developed demand paging, learned page control, minimum-fidelity typed pages, provenance-linked summary-to-raw escalation, typed memory representations, lineage enforcement, programmable context compilation, workflow-aware prefetch, and model-runtime cache management [5], [6], [7], [8], [9], [10], [11], [12], [13]. A broader model-native architecture has also identified the need for a context compiler while emphasizing that semantic context management is intrinsically lossier than byte-addressed virtual memory [14].
...
Let an agent operate over interaction steps . At step , it receives a task state , environment state , current user request , policy set , and access to a durable memory substrate . The underlying model accepts at most  active tokens and may additionally use bounded host, accelerator, prefix, latent, or KV-cache resources.
...
Long-context models can process far more tokens than early transformer systems, but nominal length does not imply reliable use. “Lost in the Middle” demonstrated position-dependent access to relevant information [1]. RULER and LongBench v2 evaluate more demanding long-context behaviors than simple needle retrieval [2], [3]. Performance can degrade even under perfect retrieval as excess supplied context burdens reasoning [4]. Native context growth remains valuable, especially for phases requiring simultaneous comparison, but it does not by itself provide typing, provenance, retention policy, contradiction handling, or lifecycle governance.
3.2 Retrieval and active retrieval
Retrieval-augmented generation externalizes documents and retrieves passages at inference time [15]. FLARE, Self-RAG, and IRCoT make retrieval conditional on generation or intermediate reasoning [16], [17], [18]. Predictive Prefetching for RAG forecasts when and what to retrieve so that external I/O can overlap generation [19]. These systems establish that context access can be dynamic and, in some settings, anticipatory.
...
Generative Agents combined observations, reflection, and planning in a persistent memory stream [20]. MemGPT, MemoryOS, and MemOS use operating-system-inspired memory abstractions [5], [21], [22]. Mem0, A-MEM, SimpleMem, and Agentic Memory address scalable storage, linked notes, lifelong memory, or learned memory operations [23], [24], [25], [26]. HiAgent, MemAgent, and ByteRover explore hierarchical working memory, learned recurrent memory, and LLM-curated context trees [27], [28], [29].
Recent systems sharpen the substrate itself. Contextual Memory Virtualisation represents accumulated session state as a versioned DAG with snapshot, branch, and structurally lossless trimming operations [30]. The View-oriented Conversation Compiler parses agent traces into a typed intermediate representation and emits lossless, user-facing, and adaptive views [31]. MemMachine keeps complete episodes as ground truth and expands retrieved nuclei with surrounding context rather than relying primarily on lossy write-time extraction [32]. Portable Agent Memory defines a provenance-verified serialization and re-hydration protocol spanning episodic, semantic, procedural, working, and identity memory across heterogeneous agent runtimes [33]. These approaches support VCM’s insistence that compact views remain anchored to richer records and that durable memory should outlive a particular model or vendor. Portable Agent Memory focuses on interchange; VCM focuses on the live residency, compilation, fault, and coherence contract after memory is mounted.
Architectural complexity is not automatically an advantage. ENGRAM reports strong long-horizon results with three typed memory classes and straightforward dense retrieval, while the Deterministic Memory Framework removes model calls from memory preparation and uses source-linked deterministic scoring [34], [35]. They are important counterexamples to maximalist memory stacks: VCM is justified only if its additional contracts improve fidelity, latency, governance, or total cost beyond well-engineered simple systems.
Recent surveys likewise argue that modern agent memory cannot be captured by a simple short-term/long-term split and must be analyzed across representation, function, dynamics, evaluation, and trustworthiness [36]. These systems motivate durable, structured, and adaptive memory. VCM’s additional claim is that persistent memory requires a portable semantic/runtime contract: stable identity, representation eligibility, protected compilation, snapshot consistency, fault semantics, capability-scoped mounts, causal invalidation, and explicit runtime-cache coherence.
3.4 Semantic paging and harness-enforced residency
The Missing Memory Hierarchy develops demand paging for production context windows and reports the importance of working-set control and thrashing behavior [6]. Neural Paging formalizes a Context Paging Problem and learns a controller intended to approximate future-aware replacement under stated assumptions [7]. ClawVM is an especially close neighbor: it places typed pages, minimum-fidelity invariants, multi-resolution representations, lifecycle-aware writeback, deterministic prompt assembly, and an offline fault oracle in the agent harness [8].
RAMPART treats context assembly as an explicit programmable compile step over named, addressable in-RAM blocks, with promotion, gating, write, eviction, rollback, provenance tags, authorship controls, and position-sensitive placement [12]. It is a particularly close demonstration that compilation policy and structural placement matter independently of retrieval quality.
...
TierMem identifies the write-before-query barrier: a summary is created before the future query reveals which omitted detail matters. It uses provenance-linked summary and raw-log tiers with query-time sufficiency routing [9]. MemIR combats provenance-role collapse through typed grounded atoms and claim-centered projection [10]. MemLineage attaches cryptographic provenance and derivation lineage to memory and gates sensitive actions based on ancestry [11].
Structured execution records and multi-agent memory protocols expose adjacent requirements. The Agent Execution Record model represents intent, observations, inferences, versioned plans, evidence chains, and delegation authority as queryable operational artifacts [37]. The Mesh Memory Protocol emphasizes per-field admission and signal-level lineage so that agents can distinguish independent support from recycled echoes [38]. VCM can store either schema as typed event or semantic pages, but it does not claim that hidden chain-of-thought can be reconstructed from checkpoints; only explicitly captured operational state enters the ledger.
...
LLMLingua, LongLLMLingua, gist tokens, and RECOMP reduce the amount of text supplied at inference [39], [40], [41], [42]. Active Context Compression lets an agent invoke compression as part of its own control loop [43]. These methods demonstrate useful compression but also expose a central limitation: a compact form optimized for one use can be unsafe for another.
...
PagedAttention, vAttention, SGLang’s RadixAttention, KVFlow, H2O, and StreamingLLM manage physical inference state, prefix reuse, or KV retention [44], [45], [46], [47], [48], [49]. SpeContext overlaps sparse-context/KV retrieval with model computation, while Pythia exploits multi-agent workflow predictability for serving decisions [13], [50]. PBKV predicts dynamic workflow invocations to guide conservative KV eviction and prefetch, and TokenCake uses application graphs and function-call events for predictive upload, offload, and critical-path reservation [51], [52]. Leyline exposes policy-directed KV edit primitives for agentic traces, and fail-closed ResidentClaim lowering distinguishes generic cache controls from a runtime’s accepted obligation to make a specific future materialization reusable [53], [54].
...
Memory injection, experience poisoning, and memory-control-flow attacks show that persistent memory is a durable attack surface [55], [56], [57], [58]. A recent lifecycle survey organizes memory risk across write, store, retrieve, execute, share, and forget/rollback phases and argues for verifiable memory governance [59]. MemGate treats memory search itself as a trust boundary and gates semantically related but contextually unsafe memories before they reach the backbone model [60]. OP-Bench examines over-personalization, STALE tests invalid memories, and MemPrivacy studies privacy-preserving personalized memory [61], [62], [63].
...
Table 1. Primary emphasis of close architectural neighbors. The comparison is intentionally conservative and should be updated as these rapidly evolving systems mature.
System family
	Typed / minimum-fidelity state
	Query-time evidence escalation
	Plan-guided non-visible staging
	Snapshot / invalidation contract
	Authority and capability enforcement
	Semantic-to-runtime cache binding
	MemGPT / memory OS systems
	Partial
	Partial
	Limited
	System-dependent
	...
	Limited
	CMV / VCC / MemMachine
	Structured or source-preserving views
	Source replay or exact trace pointers
	Limited
	Core in CMV; trace-centered in VCC
	Limited
	Outside primary scope
	RAMPART
	Named addressable blocks and compiled placement
	No dedicated evidence escalation
	No; in-RAM pre-compilation
	Session-local rollback
	Block ownership and authorship flags
	Outside primary scope
	Portable Agent Memory
	Typed portable memory package
	Source/provenance verification
	Re-hydration rather than plan prefetch
	Transfer manifest and Merkle-DAG
	Capability-scoped transfer
	Model-agnostic interchange
	ENGRAM / DMF
	Lightweight typed or deterministic records
	Source-linked retrieval
	No
	Limited
	Limited
	Outside scope
	Pichay / Neural Paging
	Paging-centered
	Limited
	Learned or demand-centered
	Limited
	Limited
	Limited
	ClawVM
	Core
	Minimum-fidelity fallback
	Limited
	Lifecycle writeback; single-session emphasis
	Harness policy
	Outside primary scope
	TierMem
	Summary/raw tiers
	...
	Outside scope
	MemIR / MemLineage
	Core provenance roles
	Claim/lineage-centered
	No
	Lineage-centered
	Core for sensitive use
	Outside scope
	Pythia / PBKV / TokenCake / SpeContext
	Runtime objects
	No
	Core at serving/KV layer
	Runtime keyed
	...
	Vision-level
	VCM
	Core, typed pages and protected minimum set
	Core, use-contract faults
	Core, staged from explicit plans
	Core, task snapshots and causal invalidation
	Core, authority non-escalation and capabilities
	Core, disposable keyed materializations
...
A context cell is an atomic typed assertion or event unit: “decision  was accepted at time ,” “source  supports claim ,” “the user stated preference  within scope ,” or “branch  was rejected for reason .” Cells are smaller than arbitrary text chunks so that source role, authority, temporal validity, and contradiction can be preserved independently.
...
Let  be the address,  the page type,  the authoritative payload,  the relation graph,  the temporal-validity state,  the capability policy,  the behavioral, evidential, and action-authority ceilings, and  the available representations. Current action authorization is never inferred from memory alone; it is intersected with live capabilities at execution time.
4.3 Representation graph, not a linear ladder
A page can have several useful representations:
Table 2. Representations are specialized and only partially ordered. Exact excerpts can dominate a synthesis for quotation while providing less global coverage; a runtime cache can be faster while carrying no additional epistemic authority.
Representation
	Optimized for
	Principal limitation
	Typical authority
	Handle / manifest
	Addressing, routing, dependency planning
	Almost no substantive content
	Index metadata
	Routing capsule
	Fast page selection and prefetch
	Coarse, omission-heavy
	Derived cue only
	Structured synthesis
	Broad semantic coverage at low token cost
	Lossy and model-generated
	Derived interpretation
	Evidence bundle
	Claim-to-source reasoning and careful synthesis
	May omit unrelated source content
	Source-bound derivative
	Exact excerpts
	Quotation, code, numbers, disputed wording
	Narrow local coverage
	Extractive source evidence
	Raw event or document view
	Audit and re-derivation
	Expensive; may still contain untrusted assertions
	Authoritative record, not necessarily true claim
	Runtime materialization
	Fast repeated inference
	Model-, tokenizer-, prefix-, policy-, and snapshot-specific
	Disposable cache only
	 Figure 1. A semantic page has a stable identity but multiple task-relative representations and dynamic physical residencies.

Figure 1. A semantic page has a stable identity but multiple task-relative representations and dynamic physical residencies.
For a requested operation, define a use contract

where  is the query or operation family,  the required semantic coverage,  the exactness and evidence obligation,  and  the required and permitted authority bounds,  the freshness condition,  the purpose and capability policy, and  the deadline. Authority is use-specific rather than scalar: at minimum, VCM distinguishes behavioral influence, evidential use, and action authorization. A representation certificate  declares corresponding guarantees, limits, cost, and lineage. A representation is eligible only if

meaning that, under snapshot , it satisfies the contract, is authorized, is not invalidated, and remains within every authority ceiling. The representation space is therefore a directed graph with task-relative dominance, not a universal scalar level.
...
Proposition 1 — No universal strict summary. Let  be a finite set of possible source states and  a representation function with . Then there exist  such that . For any query language capable of distinguishing  from , there exists a query  for which no procedure that sees only  can answer correctly on both sources.
Proof. By the pigeonhole principle, two source states map to the same representation. Choose a query whose correct answer differs between those states. A decoder receiving the same representation must return the same output distribution for both, so it cannot be correct on both with certainty.
The proposition is intentionally modest, but it blocks an important category error: a summary written before the future query cannot promise arbitrary future sufficiency. This formalizes the write-before-query barrier identified by provenance-tiered memory [9].
...
For anticipated query family , a derived representation  is -sufficient when

where  is the authoritative source,  the downstream answer or decision procedure, and  a task-relevant loss. This is an empirical contract, not an ontological guarantee. Query distributions can shift, and high-stakes uses can require exact source escalation regardless of average loss.
...
A retention policy at time  must be measurable with respect to the information then available. If  is the observable history, an online decision has the form

not a function of an unseen future request, gold answer, or oracle dependency label. Future outcomes may train  offline, but the evaluation must replay the policy from a decision-time snapshot. Recent work on multi-factor value and observability-safe retention shows why this matters: scoring “goal relevance” against the held-out question evaluates retrieval with answer-side information, not realistic forgetting [64], [65]. VCM therefore treats observability as part of the memory-policy interface, not merely an experimental detail.
...
Let  denote the authority vector of representation ,  its source set, and  the partial order of an implementation-defined authority lattice. A conforming transformation satisfies
...
At step , let  be the authorized protected minimum set: applicable policy, the current request and objective, hard constraints issued by a principal with sufficient authority, latest relevant corrections, unresolved commitments, procedures required for imminent authorized actions, and evidence obligations for planned claims. Membership in  is a governance decision, not a label that page content can assign to itself. Let  denote active-token cost. Safe compilation first checks

where  is the cheapest eligible representation for the mandatory use. If the inequality fails, the compiler returns UNSAFE-FIT. Valid responses include requesting a larger context budget, switching models, decomposing the task, postponing an action, narrowing scope, or asking the user. Silently omitting a mandatory page is not a legal optimization. Conversely, blindly pinning every instruction-like span would permit protected-lane denial of service. VCM therefore authenticates issuers, resolves precedence and scope, rate-limits low-trust writes, deduplicates equivalent obligations, and surfaces unresolved mandatory conflicts. Untrusted or merely retrieved content cannot self-pin.
After admitting , the compiler chooses optional page representations  under token, latency, accelerator-memory, privacy-exposure, and attention-interference budgets:

where  enforces eligibility, capability, snapshot, dependency, conflict, and authority constraints. Let  be token, latency, host-memory, accelerator-memory, privacy-exposure, and interference cost, and  the corresponding budget vector; every feasible packet satisfies

The objective is not generally additive. Pages can be complements through dependencies, substitutes through redundancy, or jointly harmful through interference. The problem is therefore a multiple-choice, dependency-constrained packing problem related to the deterministic prompt assembly used by ClawVM [8]. Exact solution is generally unnecessary and often intractable; implementations can use protected lanes, greedy marginal bids with interaction updates, constrained learned value estimates, branch-and-bound for small sets, or online admission control, provided the hard invariants remain external to the learned scorer.
...
where  is materialization latency and  the page deadline. A dormant archive does not count as effective context merely because it exists.
...
VCM separates memory into three planes: a data plane that stores authoritative and derived state, a control plane that predicts and manages context demand, and a governance plane that decides whether and how memory may influence the agent. Their shared interface is the Virtual Context ABI: address resolution, mounting, use-contract evaluation, staging, promotion, faulting, snapshotting, commit, invalidation, and unmounting. Figure 2 shows the full architecture.
 Figure 2. End-to-end Virtual Context Memory architecture.
...
Table 3. Representative semantic-page taxonomy and default lifecycle rules.
Page type
	Required fields
	Default residency / retention rule
	Typical faults
	Policy / hard constraint
	issuer, precedence, scope, validity
	Pinned while applicable; never merged into ordinary summary
	version, conflict, capability
	Task state
	objective, status, dependencies, owner
	Resident while task is active; checkpoint on switch
	dependency, freshness
	Decision
	choice, alternatives, rationale, status
	Preserve until superseded; retrieve by task and consequence
	rationale, supersession
	Correction
	corrected claim, prior version, evidence
	High failure-prevention value; invalidates descendants
	contradiction, exactness
	Evidence
	source, claim map, trust, timestamp
	Load to claim-required fidelity; retain provenance
	exactness, freshness
	Scoped preference
	subject, scope, confidence, counterexamples
	Retain only with bounded scope and review policy
	scope, consent, validity
	Procedure
	preconditions, steps, permissions, version
	Materialize exactly for execution; do not paraphrase critical steps silently
	version, authorization
	Episodic event
	actors, time, event, uncertainty
	Compress by default; retain raw source pointer
	temporal, identity
	Open question / commitment
	owner, due state, dependencies
	Protected while unresolved
	status, dependency
	Rejected / obsolete branch
	proposal, reason, scope, status
	Retrieve to prevent repetition, not as active recommendation
	scope, supersession
	Tool output / external text
	tool/source identity, role, trust
	Data-only unless separately authorized; often quarantined
	integrity, taint
	Runtime cache page
	model, tokenizer, prefix, snapshot
	Disposable; invalidated aggressively
	compatibility
...
Candidates are retrieved through multiple channels rather than one similarity search: semantic relevance, task dependency, decision history, constraint match, correction and contradiction, temporal validity, evidence need, procedural precondition, rejection memory, and predicted future use. The compiler computes dependency closure, surfaces unresolved conflicts instead of merging them, chooses the least costly sufficient representation, labels provenance role, and packs the final packet under budget.
 Figure 3. The context compiler uses protected lanes and promotion gates rather than a single similarity ranking.
...
The physical policy follows a semantic working-set model inspired by classical virtual-memory research [66]. Replacement may use learned predictors, but it is constrained by protected classes and correctness requirements. Belady’s optimal policy is unattainable online because future references are unknown [67]; VCM partially reduces this uncertainty by using the task plan as a demand forecast.
...
For a scoped preference, the certificate may say that the user explicitly requested exhaustive treatment for research-architecture discussions, that this does not imply a general preference for verbosity, and that later contradictory statements should trigger review. For a decision, it may preserve the rejected alternatives and rationale. For evidence, it may distinguish an author’s claim from an independently verified fact.
 Figure 4. Evidence-carrying lineage preserves an auditable path from working context to authoritative sources.
...
For candidate page  over horizon , let  be the probability that the page will be required,  the latency avoided by early loading,  the resource cost,  the expected cost of occupying cache or influencing selection, and  the privacy or security cost of staging it. An approximate prefetch value is
...
This separation is critical. Otherwise, an incorrect forecast can pollute reasoning before relevance is confirmed, and a malicious page can exploit speculative loading as an instruction channel. “Non-model-visible” does not mean impact-free: staged pages consume bandwidth and memory, may reveal access patterns, and can change scheduling. VCM treats those effects as measurable costs and governance events rather than claiming that speculation is systemically invisible.
 Figure 5. Planner-guided prefetch overlaps semantic page preparation with useful work.
...
Least-recently-used replacement is insufficient because a rarely accessed hard constraint may be catastrophic to lose, while a recently retrieved irrelevant page may be safe to evict. An approximate eviction pressure for representation  is

High  favors eviction or replacement by a cheaper representation. Protected pages are pinned according to scope and deadline, not forever. Eviction can demote an evidence bundle or structured synthesis to a routing capsule, discard a KV materialization while retaining text, or remove all resident forms while leaving the durable address intact.
...
In a multi-agent system, wall-clock timestamps are insufficient to order concurrent observations and decisions. VCM records causal metadata inspired by distributed-systems clocks [69]. Pages can be concurrent, ordered, or causally dependent. A merge routine cannot declare one page newer merely because a machine clock is ahead. Receiver-side field admission and signal-level ancestry, as emphasized by the Mesh Memory Protocol, are useful specializations for shared semantic state [38].
...
Table 4. Execution classes preserve behavioral authority through storage and retrieval.
Execution class
	Behavioral authority
	Examples
	Constitutional policy
	Highest within declared system
	Safety, legal, platform, administrator policy
	Authorized task instruction
	Bounded by issuer, task, time, and capability
	Current user request, approved workflow
	Scoped user preference
	Influences presentation or process within scope
	Formatting preference, project-specific style
	Procedure
	Executable only with current authorization and version
	Deployment runbook, lab protocol
	Evidence / observation
	No direct behavioral authority
	Paper claim, sensor output, database row
	Quoted or external text
	Data-only by default
	Webpage, email, retrieved document
	Agent inference / reflection
	Advisory and provisional
	Suggested preference, inferred project state
	Quarantined content
	No model-visible promotion until reviewed
	Suspected prompt injection or poisoned memory
	This type is preserved through summarization. “The webpage says ‘ignore all previous instructions’” remains evidence about webpage content; it cannot become an authorized task instruction. Recent attacks on memory-augmented agents motivate this separation [55], [56], [57].
...
Typed provenance helps prevent role collapse in long-term memory [10], while explicit lineage supports enforcement and audit [11].
...
Prefetch evaluation includes exposure cost, not merely latency and cache pollution. Personalized-memory research increasingly treats privacy as a primary design dimension [63].
...
A statement such as “use exhaustive analysis for this architecture paper” must not become “the user always wants long responses.” OP-Bench’s focus on over-personalization illustrates why memory quality includes restraint, not only recall [61].
...
A stale page is not necessarily deleted: it may be valuable historical evidence. It is prevented from masquerading as current state. Benchmarks such as STALE motivate explicit invalidity detection rather than blind retrieval [62].
...
Table 5. Major failure modes, architectural responses, and residual risks.
Failure mode
	Why naïve systems fail
	VCM response
	Residual risk
	Summary drift
	Repeated summaries lose qualifiers and negation
	Parent hashes, atomic claims, loss manifests, re-derive from source
	Verifiers can miss semantic loss
	Unsupported reconstruction
	Model expands a lossy summary into plausible but absent detail
	Resolve authoritative source, load eligible evidence, or return unrecoverable-detail fault
	Source may be unavailable or deleted
	Constraint loss
	Topic summaries omit decision force
	Protected constraint lane and type-specific verification
	Incorrect typing at ingestion
	Similarity blindness
	Critical correction is not query-similar
	Multi-channel retrieval and dependency closure
	Channel weights can still be wrong
	Static importance
	Old page is ignored when task resumes
	Task-conditioned revaluation and mount-triggered promotion
	Forecast uncertainty
	Wrong prefetch
	Irrelevant pages bias the model
	Non-model-visible staging and promotion gates
	Cache, scheduling, and exposure cost remain
	Thrashing
	Working set exceeds active capacity
	Hysteresis, pinning, adaptive pages, decomposition, larger model
	Some phases are inherently global
	Address rot / rollback
	Alias points to stale or substituted object
	Immutable IDs, content hashes, signed alias history
	Key compromise
	Contradictory pages
	Retriever merges incompatible claims
	Conflict graph, snapshot semantics, explicit adjudication
	Model may still mishandle conflict
	Stale memory
	Accurate history is used as current fact
	Validity intervals and temporal faults
	Verification source can be wrong
	Over-personalization
	Temporary preference becomes identity
	Scope, evidence, exceptions, expiry, user control
	Subtle social inference remains hard
	Memory poisoning
	Malicious text becomes durable steering
	Execution classes, taint, quarantine, capability checks
	Novel attacks and classifier evasion
	Self-reinforcing false memory
	Agent-generated claim is later treated as evidence
	Provisional status and source-role separation
	Correlated verifier models
	Privacy leakage by prefetch
	Sensitive page is loaded unnecessarily
	Purpose-aware encrypted staging, no-prefetch policies
	Metadata can reveal existence
	Cross-user cache leak
	Runtime cache reused under wrong identity
	Principal/policy/snapshot cache keys and partitioning
	Infrastructure bugs
	Incomplete deletion
	Embeddings or caches retain deleted data
	Graph-based deletion closure and cryptographic erasure
	Backups and trained weights
	Plan manipulation
	Attacker steers prefetch through task graph
	Plan provenance, resource caps, taint, purpose validation
	Adversarial but valid-looking plans
	Oversized page
	One semantic page consumes budget
	Adaptive splitting and view-specific representations
	Loss of cross-page relations
	Excessively small pages
	Fault overhead dominates
	Co-access clustering and huge pages
	Dynamic granularity cost
	Learned-policy opacity
	Optimizer trades safety for benchmark gain
	Hard invariants, audit logs, interpretable features, safe fallback
	Performance gap versus unconstrained policy
	Mandatory-set overflow
	Required policy, constraints, and evidence do not fit
	Emit UNSAFE-FIT; increase budget, switch model, narrow or decompose task
	Some tasks remain infeasible
	Protected-lane denial of service
	Untrusted content declares itself mandatory or floods obligations
	Authority-check mandatory admission, deduplicate, quota, resolve precedence, and reject self-pinning
	Compromised trusted issuer or policy conflict
	Authority escalation
	Derived or repeated content gains behavioral force
	External authority lattice and non-escalation checks
	Incorrect source classification
	Importance starvation
	Low-retrieval pages never resurface
	Mount-time revaluation and bounded exploration budget
	Exploration adds cost
	Role-label bypass
	Model ignores textual provenance labels
	External tool authorization, capability checks, and native masks where available
	Black-box models remain weaker
...
A full deployment comprises the following services or trusted modules. Its record layer can interoperate with portable memory packages and structured execution records rather than requiring a proprietary archive format [33], [37]:
...
When a stable set of pages is repeatedly compiled in the same role order, VCM can create a canonical prefix object and reuse its runtime state through mechanisms such as paged KV blocks or radix-prefix caches [44], [46]. Workflow predictions can initiate prefix or KV transfer before a model call, extending ideas in KVFlow and Pythia [13], [47].
...
VCM-Runtime additionally distinguishes an advisory cache hint from an accepted resident-materialization claim. A conformant claim binds a unique claim identity; source, representation, model, principal, policy, and ordered-prefix keys; a materialization predicate; a deadline or reuse horizon; and ordered outcomes such as READY, EVICTED, INVALIDATED, or RESTORE_FAILED. The runtime must either satisfy the accepted predicate or return a claim-scoped fail-closed outcome before the caller relies on reuse. Generic priority, time-to-live, offload, or routing controls are useful substrates, but they do not by themselves accept this responsibility [54]. Policy-directed span edits such as Leyline can serve as lower-level mechanisms when their position-correction and lifecycle semantics are included in the claim descriptor [53].
...
6. simple typed or deterministic systems such as ENGRAM and DMF, plus a source-preserving episodic baseline modeled on MemMachine [32], [34], [35];
7. persistent agent-memory systems such as MemGPT, Mem0, A-MEM, MemoryOS, MemOS, or comparable reproducible implementations;
8. learned memory-operation policies such as Agentic Memory, multi-factor value models, and observability-safe retention [64], [65];
...
10. programmable context registries and compilers such as RAMPART [12];
11. provenance-tiered and typed systems such as TierMem and MemIR;
12. hierarchical, trace-compiled, portable, or agent-native memory systems such as ByteRover, CMV, VCC, and Portable Agent Memory where reproducible [33];
13. prompt-compression systems such as LongLLMLingua or RECOMP;
14. predictive retrieval and prefix/KV-aware serving systems such as Predictive Prefetching, Pythia, PBKV, TokenCake, directive-based interfaces, and fail-closed resident claims for the latency and runtime tracks [13], [19], [51], [52];
...
Use and extend LongMemEval, LoCoMo, and related memory benchmarks [71], [72]. Add project-specific preferences, corrections, commitments, and superseded facts. Measure whether the agent recalls not merely an answer but the current valid state and appropriate interaction policy.
Track B: Incremental agent tasks
Use MemoryAgentBench, MemoryArena, MemBench, and MemGym-style interactions that require memory updates across dependent sessions and realistic tool environments [73], [74], [75], [76]. Add tool state, rejected plans, branching tasks, coding and research artifacts, computer-use traces, and delayed consequences. Report memory-isolated scores when the benchmark permits separation from base reasoning and tool competence.
...
Table 6. Core VCM-Bench metric groups.
Dimension
	Metrics
	Task quality
	success rate, calibrated judge score, tool-action correctness, long-form factual precision
	Mandatory state
	survival at use point, unsafe-fit rate, silent-omission rate, protected-lane completeness
	Continuity
	decision continuity, correction application, commitment completion, rejection recall, context-switch recovery
	Context efficiency
	active tokens, context value density, quality per token, bytes and tokens moved
	Paging
	fault rate by class, recovery success, p50/p95 latency, deadline miss rate
	Prediction
	prefetch precision/recall, calibration, useful lead time, cancellation cost, prefetch regret
	Interference
	optional-page displacement, irrelevant-context quality loss, wrong-project contamination
	Residency
	working-set size, eviction regret, re-fault rate, thrash index, page-granularity efficiency
	Derivation
	atomic claim coverage, negation/scope preservation, query-relative sufficiency, summary drift
	Observability
	future-information leakage rate, blind retention utility, oracle gap, delayed-utility regret, resurfacing recall
	Evidence and authority
	source-span or source-region accuracy, evidence coverage, unsupported claims, correct exactness faults, authority-escalation rate
	Temporal reasoning
	stale-memory use, supersession accuracy, revalidation precision and latency
	Security
	attack success rate, poisoned-page promotion, control-flow influence, unauthorized tool justification
	Privacy
	excess pages accessed, sensitive bytes staged, access-pattern leakage, unauthorized exposure, purge latency
	Consistency
	mixed-version errors, read-your-writes failures, stale-cache use, merge-conflict loss
	Runtime
	prefill time, accepted-claim success/failure, KV hit rate, HBM/DRAM/SSD traffic, throughput, energy, cost per successful task
	Complexity
	offline build time, index/verification maintenance, storage amplification, configuration surface, failure-recovery labor, reproducibility
...
[3] Y. Bai et al., “LongBench v2: Towards deeper understanding and reasoning on realistic long-context multitasks,” in Proceedings of the 63rd annual meeting of the association for computational linguistics, 2025, pp. 3639–3664. doi: 10.48550/arXiv.2412.15204.
[4] Y. Du et al., “Context length alone hurts LLM performance despite perfect retrieval,” in Findings of the association for computational linguistics: EMNLP 2025, 2025, pp. 23281–23298. doi: 10.18653/v1/2025.findings-emnlp.1264.
[5] C. Packer et al., “MemGPT: Towards LLMs as operating systems,” arXiv preprint arXiv:2310.08560, 2023, doi: 10.48550/arXiv.2310.08560.
[6] T. Mason, “The missing memory hierarchy: Demand paging for LLM context windows,” arXiv preprint arXiv:2603.09023, 2026, doi: 10.48550/arXiv.2603.09023.
[7] L. Chen and Q. Liu, “Neural paging: Learning context management policies for turing-complete agents,” arXiv preprint arXiv:2603.02228, 2026, doi: 10.48550/arXiv.2603.02228.
[8] M. Rafique and L. Bindschaedler, “ClawVM: Harness-managed virtual memory for stateful tool-using LLM agents,” in Proceedings of the sixth european workshop on machine learning and systems (EuroMLSys ’26), 2026, pp. 1–12. doi: 10.1145/3805621.3807648.
[9] Q. Zhu, S. Chen, R. Yu, Z. Wu, and B. Wang, “From lossy to verified: A provenance-aware tiered memory for agents,” arXiv preprint arXiv:2602.17913, 2026, doi: 10.48550/arXiv.2602.17913.
[10] Z. Jin, B. Wang, J. Li, R. Xu, and M. Zhang, “Mitigating provenance-role collapse in long-term agents via typed memory representation,” arXiv preprint arXiv:2605.25869, 2026, doi: 10.48550/arXiv.2605.25869.
[11] C. Ouyang and R. Hou, “MemLineage: Lineage-guided enforcement for LLM agent memory,” arXiv preprint arXiv:2605.14421, 2026, doi: 10.48550/arXiv.2605.14421.
[12] N. Tomczak, “RAMPART: Registry-based agentic memory with priority-aware runtime transformation,” arXiv preprint arXiv:2606.04628, 2026, doi: 10.48550/arXiv.2606.04628.
[13] S. Yu et al., “Pythia: Toward predictability-driven agent-native LLM serving,” arXiv preprint arXiv:2604.25899, 2026, doi: 10.48550/arXiv.2604.25899.
[14] H. Lin, H. Pao, S. Zhan, and H.-T. Zheng, “Model-native computing architecture: Envisioning future system architecture through the lens of computer architecture,” arXiv preprint arXiv:2606.00288, 2026, doi: 10.48550/arXiv.2606.00288.
[15] P. Lewis et al., “Retrieval-augmented generation for knowledge-intensive NLP tasks,” in Advances in neural information processing systems, 2020, pp. 9459–9474.
[16] Z. Jiang et al., “Active retrieval augmented generation,” arXiv preprint arXiv:2305.06983, 2023, doi: 10.48550/arXiv.2305.06983.
[17] A. Asai, Z. Wu, Y. Wang, A. Sil, and H. Hajishirzi, “Self-RAG: Learning to retrieve, generate, and critique through self-reflection,” arXiv preprint arXiv:2310.11511, 2023, doi: 10.48550/arXiv.2310.11511.
[18] H. Trivedi, N. Balasubramanian, T. Khot, and A. Sabharwal, “Interleaving retrieval with chain-of-thought reasoning for knowledge-intensive multi-step questions,” arXiv preprint arXiv:2212.10509, 2022, doi: 10.48550/arXiv.2212.10509.
[19] W. Zhang and S. Pei, “Predictive prefetching for retrieval-augmented generation,” arXiv preprint arXiv:2605.17989, 2026, doi: 10.48550/arXiv.2605.17989.
[20] J. S. Park, J. C. O’Brien, C. J. Cai, M. R. Morris, P. Liang, and M. S. Bernstein, “Generative agents: Interactive simulacra of human behavior,” arXiv preprint arXiv:2304.03442, 2023, doi: 10.48550/arXiv.2304.03442.
[21] J. Kang, M. Ji, Z. Zhao, and T. Bai, “Memory OS of AI agent,” arXiv preprint arXiv:2506.06326, 2025, doi: 10.48550/arXiv.2506.06326.
[22] Z. Li et al., “MemOS: A memory OS for AI system,” arXiv preprint arXiv:2507.03724, 2025, doi: 10.48550/arXiv.2507.03724.
[23] P. Chhikara, D. Khant, S. Aryan, T. Singh, and D. Yadav, “Mem0: Building production-ready AI agents with scalable long-term memory,” arXiv preprint arXiv:2504.19413, 2025, doi: 10.48550/arXiv.2504.19413.
[24] W. Xu, Z. Liang, K. Mei, H. Gao, J. Tan, and Y. Zhang, “A-MEM: Agentic memory for LLM agents,” arXiv preprint arXiv:2502.12110, 2025, doi: 10.48550/arXiv.2502.12110.
[25] J. Liu et al., “SimpleMem: Efficient lifelong memory for LLM agents,” arXiv preprint arXiv:2601.02553, 2026, doi: 10.48550/arXiv.2601.02553.
[26] Y. Yu et al., “Agentic memory: Learning unified long-term and short-term memory management for large language model agents,” arXiv preprint arXiv:2601.01885, 2026, doi: 10.48550/arXiv.2601.01885.
[27] M. Hu, T. Chen, Q. Chen, Y. Mu, W. Shao, and P. Luo, “HiAgent: Hierarchical working memory management for solving long-horizon agent tasks with large language model,” arXiv preprint arXiv:2408.09559, 2024, doi: 10.48550/arXiv.2408.09559.
[28] H. Yu et al., “MemAgent: Reshaping long-context LLM with multi-conv RL-based memory agent,” arXiv preprint arXiv:2507.02259, 2025, doi: 10.48550/arXiv.2507.02259.
[29] A. Nguyen et al., “ByteRover: Agent-native memory through LLM-curated hierarchical context,” arXiv preprint arXiv:2604.01599, 2026, doi: 10.48550/arXiv.2604.01599.
[30] C. Santoni, “Contextual memory virtualisation: DAG-based state management and structurally lossless trimming for LLM agents,” arXiv preprint arXiv:2602.22402, 2026, doi: 10.48550/arXiv.2602.22402.
[31] L. Zhang and M. Agrawala, “View-oriented conversation compiler for agent trace analysis,” arXiv preprint arXiv:2603.29678, 2026, doi: 10.48550/arXiv.2603.29678.
[32] S. Wang et al., “MemMachine: A ground-truth-preserving memory system for personalized AI agents,” arXiv preprint arXiv:2604.04853, 2026, doi: 10.48550/arXiv.2604.04853.
[33] S. K. Ravindran, “Portable agent memory: A protocol for provenance-verified memory transfer across heterogeneous LLM agents,” arXiv preprint arXiv:2605.11032, 2026, doi: 10.48550/arXiv.2605.11032.
[34] D. Patel and S. Patel, “ENGRAM: Effective, lightweight memory orchestration for conversational agents,” arXiv preprint arXiv:2511.12960, 2025, doi: 10.48550/arXiv.2511.12960.
[35] M. Stabile and E. Zimuel, “DMF: A deterministic memory framework for conversational AI agents,” arXiv preprint arXiv:2606.03463, 2026, doi: 10.48550/arXiv.2606.03463.
[36] Y. Hu et al., “Memory in the age of AI agents,” arXiv preprint arXiv:2512.13564, 2025, doi: 10.48550/arXiv.2512.13564.
[37] N. Vispute, “Reasoning provenance for autonomous AI agents: Structured behavioral analytics beyond state checkpoints and execution traces,” arXiv preprint arXiv:2603.21692, 2026, doi: 10.48550/arXiv.2603.21692.
[38] H. Xu, “Mesh memory protocol: Semantic infrastructure for multi-agent LLM systems,” arXiv preprint arXiv:2604.19540, 2026, doi: 10.48550/arXiv.2604.19540.
[39] H. Jiang, Q. Wu, C.-Y. Lin, Y. Yang, and L. Qiu, “LLMLingua: Compressing prompts for accelerated inference of large language models,” in Proceedings of the 2023 conference on empirical methods in natural language processing, 2023, pp. 13358–13376. doi: 10.18653/v1/2023.emnlp-main.825.
[40] H. Jiang et al., “LongLLMLingua: Accelerating and enhancing LLMs in long context scenarios via prompt compression,” arXiv preprint arXiv:2310.06839, 2023, doi: 10.48550/arXiv.2310.06839.
[41] J. Mu, X. L. Li, and N. Goodman, “Learning to compress prompts with gist tokens,” arXiv preprint arXiv:2304.08467, 2023, doi: 10.48550/arXiv.2304.08467.
[42] F. Xu, W. Shi, and E. Choi, “RECOMP: Improving retrieval-augmented LMs with compression and selective augmentation,” in The twelfth international conference on learning representations, 2024. doi: 10.48550/arXiv.2310.04408.
[43] N. Verma, “Active context compression: Autonomous memory management in LLM agents,” arXiv preprint arXiv:2601.07190, 2026, doi: 10.48550/arXiv.2601.07190.
[44] W. Kwon et al., “Efficient memory management for large language model serving with PagedAttention,” in Proceedings of the 29th ACM symposium on operating systems principles, 2023, pp. 611–626. doi: 10.1145/3600006.3613165.
[45] R. Prabhu, A. Nayak, J. Mohan, R. Ramjee, and A. Panwar, “vAttention: Dynamic memory management for serving LLMs without PagedAttention,” arXiv preprint arXiv:2405.04437, 2024, doi: 10.48550/arXiv.2405.04437.
[46] L. Zheng et al., “SGLang: Efficient execution of structured language model programs,” in Advances in neural information processing systems, 2024. doi: 10.48550/arXiv.2312.07104.
[47] Z. Pan et al., “KVFlow: Efficient prefix caching for accelerating LLM-based multi-agent workflows,” in Advances in neural information processing systems, 2025. doi: 10.48550/arXiv.2507.07400.
[48] Z. Zhang et al., “H2O: Heavy-hitter oracle for efficient generative inference of large language models,” arXiv preprint arXiv:2306.14048, 2023, doi: 10.48550/arXiv.2306.14048.
[49] G. Xiao, Y. Tian, B. Chen, S. Han, and M. Lewis, “Efficient streaming language models with attention sinks,” arXiv preprint arXiv:2309.17453, 2023, doi: 10.48550/arXiv.2309.17453.
[50] J. Xu et al., “SpeContext: Enabling efficient long-context reasoning with speculative context sparsity in LLMs,” arXiv preprint arXiv:2512.00722, 2025, doi: 10.48550/arXiv.2512.00722.
[51] H. Zheng et al., “Efficient serving for dynamic agent workflows with prediction-based KV-cache management,” arXiv preprint arXiv:2605.06472, 2026, doi: 10.48550/arXiv.2605.06472.
[52] Z. Bian, F. Wu, Z. Li, T. Ma, and Y. Zhuo, “TokenCake: A KV-cache-centric serving framework for LLM-based multi-agent applications,” arXiv preprint arXiv:2510.18586, 2025, doi: 10.48550/arXiv.2510.18586.
[53] B. Ma, J. Eitzinger, and H. Köstler, “Leyline: KV cache directives for agentic inference,” arXiv preprint arXiv:2606.01065, 2026, doi: 10.48550/arXiv.2606.01065.
[54] L. Stepanek, “Fail-closed lowering of resident KV claims onto LLM serving runtimes,” arXiv preprint arXiv:2606.01387, 2026, doi: 10.48550/arXiv.2606.01387.
[55] S. Dong et al., “Memory injection attacks on LLM agents via query-only interaction,” arXiv preprint arXiv:2503.03704, 2025, doi: 10.48550/arXiv.2503.03704.
[56] S. S. Srivastava and H. He, “MemoryGraft: Persistent compromise of LLM agents via poisoned experience retrieval,” arXiv preprint arXiv:2512.16962, 2025, doi: 10.48550/arXiv.2512.16962.
[57] Z. Xu, X. Zhu, Y. Yao, M. Xue, and Y. Song, “From storage to steering: Memory control flow attacks on LLM agents,” arXiv preprint arXiv:2603.15125, 2026, doi: 10.48550/arXiv.2603.15125.
[58] B. D. Sunil, I. Sinha, P. Maheshwari, S. Todmal, S. Malik, and S. Mishra, “Memory poisoning attack and defense on memory based LLM-agents,” arXiv preprint arXiv:2601.05504, 2026, doi: 10.48550/arXiv.2601.05504.
[59] Z. Lin et al., “A survey on long-term memory security in LLM agents: Attacks, defenses, and governance across the memory lifecycle,” arXiv preprint arXiv:2604.16548, 2026, doi: 10.48550/arXiv.2604.16548.
[60] J. Zhang et al., “Beyond similarity: Trustworthy memory search for personal AI agents,” arXiv preprint arXiv:2606.06054, 2026, doi: 10.48550/arXiv.2606.06054.
[61] Y. Hu et al., “OP-bench: Benchmarking over-personalization for memory-augmented personalized conversational agents,” arXiv preprint arXiv:2601.13722, 2026, doi: 10.48550/arXiv.2601.13722.
[62] H. Chao, Y. Bai, R. Sheng, T. Li, and Y. Sun, “STALE: Can LLM agents know when their memories are no longer valid?” arXiv preprint arXiv:2605.06527, 2026, doi: 10.48550/arXiv.2605.06527.
[63] Y. Chen, J. Zhao, B. Tang, H. Wang, F. Xiong, and Z. Li, “MemPrivacy: Privacy-preserving personalized memory management for edge-cloud agents,” arXiv preprint arXiv:2605.09530, 2026, doi: 10.48550/arXiv.2605.09530.
[64] Z. Chen and Q. Cheng, “Learning what to remember: A cognitively grounded multi-factor value model for agentic memory,” arXiv preprint arXiv:2606.12945, 2026, doi: 10.48550/arXiv.2606.12945.
[65] Q. Kang, M. Liu, S. Kai, K. Liang, T. Zhong, and M. Yuan, “Learning what to remember: Observability-safe memory retention via constrained optimization for long-horizon language agents,” arXiv preprint arXiv:2606.10616, 2026, doi: 10.48550/arXiv.2606.10616.
[66] P. J. Denning, “The working set model for program behavior,” Communications of the ACM, vol. 11, no. 5, pp. 323–333, 1968, doi: 10.1145/363095.363141.
[67] L. A. Bélády, “A study of replacement algorithms for a virtual-storage computer,” IBM Systems Journal, vol. 5, no. 2, pp. 78–101, 1966, doi: 10.1147/sj.52.0078.
[68] Z. Huang et al., “M3Exam: Benchmarking multimodal memory for realistic user-agent interactions,” arXiv preprint arXiv:2606.07402, 2026, doi: 10.48550/arXiv.2606.07402.
[69] L. Lamport, “Time, clocks, and the ordering of events in a distributed system,” Communications of the ACM, vol. 21, no. 7, pp. 558–565, 1978, doi: 10.1145/359545.359563.
[70] J. H. Saltzer and M. D. Schroeder, “The protection of information in computer systems,” Proceedings of the IEEE, vol. 63, no. 9, pp. 1278–1308, 1975, doi: 10.1109/PROC.1975.9939.
[71] D. Wu, H. Wang, W. Yu, Y. Zhang, K.-W. Chang, and D. Yu, “LongMemEval: Benchmarking chat assistants on long-term interactive memory,” in The thirteenth international conference on learning representations, 2025. doi: 10.48550/arXiv.2410.10813.
[72] A. Maharana, D.-H. Lee, S. Tulyakov, M. Bansal, F. Barbieri, and Y. Fang, “Evaluating very long-term conversational memory of LLM agents,” in Proceedings of the 62nd annual meeting of the association for computational linguistics, 2024, pp. 13851–13870. doi: 10.18653/v1/2024.acl-long.747.
[73] Y. Hu, Y. Wang, and J. McAuley, “Evaluating memory in LLM agents via incremental multi-turn interactions,” arXiv preprint arXiv:2507.05257, 2025, doi: 10.48550/arXiv.2507.05257.
[74] Z. He et al., “MemoryArena: Benchmarking agent memory in interdependent multi-session agentic tasks,” arXiv preprint arXiv:2602.16313, 2026, doi: 10.48550/arXiv.2602.16313.
[75] H. Tan, Z. Zhang, C. Ma, X. Chen, Q. Dai, and Z. Dong, “MemBench: Towards more comprehensive evaluation on the memory of LLM-based agents,” arXiv preprint arXiv:2506.21605, 2025, doi: 10.48550/arXiv.2506.21605.
[76] W. Xu et al., “MemGym: A long-horizon memory environment for LLM agents,” arXiv preprint arXiv:2605.20833, 2026, doi: 10.48550/arXiv.2605.20833.
[77] S. Min et al., “FActScore: Fine-grained atomic evaluation of factual precision in long form text generation,” in Proceedings of the 2023 conference on empirical methods in natural language processing, 2023, pp. 12076–12100. doi: 10.18653/v1/2023.emnlp-main.741.
[78] S. Es, J. James, L. Espinosa-Anke, and S. Schockaert, “RAGAS: Automated evaluation of retrieval augmented generation,” arXiv preprint arXiv:2309.15217, 2023, doi: 10.48550/arXiv.2309.15217.
