...
|---|---|
| Source ID | `uat` |
| Source class | `author_review_protocol_family` |
| Library class | `technical_whitepaper` |
| Manuscript date | 2026-07-31 |
| Inventory updated | 2026-07-31 |
| Exact published-source SHA-256 | `8b1be068633829b1caa64ed77b705ef5cd01fb2251ad5792e36c2f19ff52e634` |
| Exact published-source bytes | 40,830 |
| Exact source text | [Download/view the tracked Markdown source](source/uat.md) |
| Book's source note | [Read the bounded mining note](https://github.com/corbensorenson/asi-stack-book/blob/main/sources/source_notes/uat.md) |
...
[Evidence States and Claim Discipline](../chapters/evidence-states-and-claim-discipline.html), [Moral Uncertainty, Value Conflict, and Contestable Governance](../chapters/moral-uncertainty-and-value-conflict.html), [Claim Ledgers and Belief Revision](../chapters/claim-ledgers-and-belief-revision.html), [Proof-Carrying Claims and Adversarial Review](../chapters/spinoza-verification-and-proof-carrying-claims.html), [Benchmark Ratchets and Anti-Goodhart Evidence](../chapters/benchmark-ratchets-and-anti-goodhart-evidence.html)
