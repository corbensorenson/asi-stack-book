...
| Exact published-source SHA-256 | `ccfbb66eec294648738bc7b1e8d575b882b9a56c65a48b2ef8b781a48d346213` |
| Exact published-source bytes | 112,425 |
| Exact source text | [Download/view the tracked Markdown source](source/cognitive_compilation.md) |
| Book's source note | [Read the bounded mining note](https://github.com/corbensorenson/asi-stack-book/blob/main/sources/source_notes/cognitive_compilation.md) |
...
[Human Intent as a Formal Input](../chapters/human-intent-as-a-formal-input.html), [Command Contracts: From Intent to Executable Work](../chapters/intent-to-execution-contracts.html), [Planning as a Control Layer: DAGs and Intelligence Arbitrage](../chapters/planning-as-a-control-layer.html), [Governed World Models and Reality Grounding](../chapters/governed-world-models-and-reality-grounding.html), [Cognitive Compilation and Semantic IR](../chapters/cognitive-compilation-and-semantic-ir.html), [Artifact Graphs, Audit Logs, and Replay](../chapters/artifact-graphs-audit-logs-and-replay.html), [Compact Generative Systems: Generate, Verify, Repair, and Residual Honesty](../chapters/compact-generative-systems-and-residual-honesty.html), [Mathematical and Search Substrates](../chapters/mathematical-and-search-substrates.html)
