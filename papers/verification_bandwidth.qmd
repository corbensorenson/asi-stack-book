...
| Exact published-source SHA-256 | `9f32fbc2517c5260dc7ac8d07cef4a7c0946b62063b0d245925d305744f5dbb0` |
| Exact published-source bytes | 10,913 |
| Exact source text | [Download/view the tracked Markdown source](source/verification_bandwidth.md) |
| Book's source note | [Read the bounded mining note](https://github.com/corbensorenson/asi-stack-book/blob/main/sources/source_notes/verification_bandwidth.md) |
...
[Evidence States and Claim Discipline](../chapters/evidence-states-and-claim-discipline.html), [Scalable Oversight and Adversarial AI Control](../chapters/scalable-oversight-and-adversarial-ai-control.html), [The Virtual Context ABI: Typed Pages, Cells, and Certificates](../chapters/virtual-context-abi.html), [Verification Bandwidth and Context Adequacy](../chapters/verification-bandwidth-and-context-adequacy.html), [Proof-Carrying Claims and Adversarial Review](../chapters/spinoza-verification-and-proof-carrying-claims.html), [Compact Generative Systems: Generate, Verify, Repair, and Residual Honesty](../chapters/compact-generative-systems-and-residual-honesty.html), [Fast Generation Architectures](../chapters/fast-generation-architectures.html), [Governed Deliberation and Test-Time Scaling](../chapters/governed-deliberation-and-test-time-scaling.html), [Policy Optimization and Learning from Feedback](../chapters/policy-optimization-and-learning-from-feedback.html), [Open Research Agenda and Bibliography Plan](../chapters/open-research-agenda-and-bibliography-plan.html)
