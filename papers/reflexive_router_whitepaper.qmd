...
| Exact published-source SHA-256 | `003a693741c40ca96ec3aece5b76ee90ec95a1d6c27ec81a970cff175f509068` |
| Exact published-source bytes | 163,605 |
| Exact source text | [Download/view the tracked Markdown source](source/reflexive_router_whitepaper.md) |
| Book's source note | [Read the bounded mining note](https://github.com/corbensorenson/asi-stack-book/blob/main/sources/source_notes/reflexive_router_whitepaper.md) |
...
[Stable Capability Fields](../chapters/stable-capability-fields.html), [Command Contracts: From Intent to Executable Work](../chapters/intent-to-execution-contracts.html), [Planning as a Control Layer: DAGs and Intelligence Arbitrage](../chapters/planning-as-a-control-layer.html), [The Virtual Context ABI: Typed Pages, Cells, and Certificates](../chapters/virtual-context-abi.html), [Context Transactions, Snapshots, Mounts, and Taint](../chapters/context-transactions-snapshots-mounts-and-taint.html), [Claim Ledgers and Belief Revision](../chapters/claim-ledgers-and-belief-revision.html), [Runtime Adapters, Tool Permissions, and Human Approval](../chapters/runtime-adapters-tool-permissions-and-human-approval.html), [Procedural Memory and Cognitive Loop Closure](../chapters/procedural-memory-and-cognitive-loop-closure.html), [Routing Heads and Specialist Cores](../chapters/routing-heads-and-specialist-cores.html), [Resource Economics and Token Budgets](../chapters/resource-economics-and-token-budgets.html), [Benchmark Ratchets and Anti-Goodhart Evidence](../chapters/benchmark-ratchets-and-anti-goodhart-evidence.html), [Integrated Reference Architecture](../chapters/integrated-reference-architecture.html)
...
**Standalone Architecture White Paper**<br>
