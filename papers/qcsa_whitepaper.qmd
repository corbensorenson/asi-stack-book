...
| Manuscript date | 2026-07-12 |
| Inventory updated | 2026-07-12 |
| Exact published-source SHA-256 | `d9e594d40dfd62c899ab25e9d395d34c702dac12e8afd75eed133392f78c0c8c` |
| Exact published-source bytes | 94,943 |
| Exact source text | [Download/view the tracked Markdown source](source/qcsa_whitepaper.md) |
| Book's source note | [Read the bounded mining note](https://github.com/corbensorenson/asi-stack-book/blob/main/sources/source_notes/qcsa_whitepaper.md) |
...
**HTML presentation note.** The HTML page normalizes line endings and trailing whitespace, preserves explicit Markdown hard breaks, and demotes manuscript headings beneath the page title. The manuscript YAML front matter is represented by the provenance panel rather than repeated in the body. 3 referenced figure assets were absent from the supplied source package and are marked in place. The digest above applies to the linked exact source text, not to this presentation wrapper.

## Where this paper enters the living book

[Governed World Models and Reality Grounding](../chapters/governed-world-models-and-reality-grounding.html), [Cognitive Compilation and Semantic IR](../chapters/cognitive-compilation-and-semantic-ir.html), [The Virtual Context ABI: Typed Pages, Cells, and Certificates](../chapters/virtual-context-abi.html), [Durable Semantic Memory and Knowledge Lattices](../chapters/durable-semantic-memory-and-knowledge-lattices.html), [Claim Ledgers and Belief Revision](../chapters/claim-ledgers-and-belief-revision.html), [Runtime Adapters, Tool Permissions, and Human Approval](../chapters/runtime-adapters-tool-permissions-and-human-approval.html), [Inter-Stack Protocols, Identity, and Economic Exchange](../chapters/inter-stack-protocols-identity-and-economic-exchange.html), [Routing Heads and Specialist Cores](../chapters/routing-heads-and-specialist-cores.html), [Compact Generative Systems: Generate, Verify, Repair, and Residual Honesty](../chapters/compact-generative-systems-and-residual-honesty.html), [White-Box Evidence, Interpretability, and Activation Governance](../chapters/white-box-evidence-interpretability-and-activation-governance.html), [Data Engines, Continual Learning, and Unlearning](../chapters/data-engines-continual-learning-and-unlearning.html), [Integrated Reference Architecture](../chapters/integrated-reference-architecture.html)
...
**Corben Sorenson**<br>
Technical Whitepaper, Version 1.0<br>
July 12, 2026
...
**Figure 1. QCSA reference architecture.**<br>
The original manuscript references `assets/figure_1_reference_architecture.png`, but that asset was not present in the publication source package. The reference is preserved here rather than replaced with a reconstructed image.
:::
...
::: {.callout-note title="Figure asset unavailable in the supplied source package"}
**Figure 2. Stable identity, plural semantic virtual addresses, and compiled physical routes.**<br>
The original manuscript references `assets/figure_2_identity_address_route.png`, but that asset was not present in the publication source package. The reference is preserved here rather than replaced with a reconstructed image.
:::
...
::: {.callout-note title="Figure asset unavailable in the supplied source package"}
**Figure 3. Address-guided active navigation under uncertainty.**<br>
The original manuscript references `assets/figure_3_question_navigation.png`, but that asset was not present in the publication source package. The reference is preserved here rather than replaced with a reconstructed image.
:::
