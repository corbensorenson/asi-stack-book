---
title: "Context Engineer / Manhattan Protocol"
...
| Exact published-source SHA-256 | `7fb934628b283102a69935abcdb45649667f67ddf55e4c7192a4c5c5915d11b2` |
| Exact published-source bytes | 18,556 |
| Exact source text | [Download/view the tracked Markdown source](source/context_engineer.md) |
| Book's source note | [Read the bounded mining note](https://github.com/corbensorenson/asi-stack-book/blob/main/sources/source_notes/context_engineer.md) |
...
[Security Kernel and Digital SCIFs](../chapters/security-kernel-and-digital-scifs.html), [The Virtual Context ABI: Typed Pages, Cells, and Certificates](../chapters/virtual-context-abi.html), [Context Transactions, Snapshots, Mounts, and Taint](../chapters/context-transactions-snapshots-mounts-and-taint.html)
