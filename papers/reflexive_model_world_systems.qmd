---
title: "Reflexive Model-World Systems: When Representations Become Causes"
...
| Exact published-source SHA-256 | `6b30990f2d22d409b1f0e5823f7aef41b5de6040a5c63bb74b5ca6e39c7a95e9` |
| Exact published-source bytes | 99,480 |
| Exact source text | [Download/view the tracked Markdown source](source/reflexive_model_world_systems.md) |
| Book's source note | [Read the bounded mining note](https://github.com/corbensorenson/asi-stack-book/blob/main/sources/source_notes/reflexive_model_world_systems.md) |
...
**Current publication boundary.** August 2026 author preprint with six scoped propositions and a supplied reproducibility package for three deterministic toy campaigns. Intake reviewed the exact code, data, summaries, figures, and checksums but did not rerun the simulations because scikit-learn was unavailable; no local synthetic-test promotion, real-deployment effect, independent reproduction, novelty result, support transition, SOTA, AGI, or ASI is inferred.
...
[Reflexive Model-World Systems](../chapters/reflexive-model-world-systems.html)
...
![Figure 1. Reflexive closure in a model lineage.](assets/reflexive_model_world_systems/figures/figure_1_reflexive_closure.png)
...
**Proposition 1 (World state alone need not be Markov).**<br>
...
**Proposition 2 (Local stability).**<br>
...
**Proposition 3 (Naive retraining targets the wrong risk).**<br>
...
**Proposition 5 (A single deterministic deployment history does not identify reflexive strength in general).**<br>
...
**Proposition 6 (Withdrawal does not imply restoration).**<br>
...
![Figure 2. Appearance diversity under four norm-feedback regimes.](assets/reflexive_model_world_systems/figures/figure_2_beauty_diversity.png)
...
![Figure 3. Preference diversity under four norm-feedback regimes.](assets/reflexive_model_world_systems/figures/figure_3_preference_diversity.png)
...
![Figure 4. Baseline-risk error after self-negating deployment.](assets/reflexive_model_world_systems/figures/figure_4_counterfactual_label_mismatch.png)
...
![Figure 5. Mean predicted baseline risk under naive and causal-aware retraining.](assets/reflexive_model_world_systems/figures/figure_5_baseline_risk_underestimation.png)
...
![Figure 6. Distributional drift by evidence ancestry.](assets/reflexive_model_world_systems/figures/figure_6_evidence_ancestry_js.png)
...
![Figure 7. Tail preservation by evidence ancestry.](assets/reflexive_model_world_systems/figures/figure_7_evidence_ancestry_tail.png)
