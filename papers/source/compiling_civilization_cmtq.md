...
![Figure 1. Qualification, assurance, and authority are independent dimensions. A strongly enforced method can be invalid, and a well-supported method does not thereby acquire permission to act.](figures/figure_1_three_axes.png){width=94%}
...
![Figure 2. CMTQ inheritance, execution, and evolution loops. Civilizational methods enter as evidence-bearing source records; qualified protocols govern execution; outcomes update both world beliefs and beliefs about method performance.](figures/figure_2_three_loop_architecture.png){width=96%}
...
![Figure 3. The model remains the flexible reasoner inside a control envelope whose other components own mechanics, evidence state, verification, and authority.](figures/figure_3_control_envelope.png){width=96%}
...
![Figure 4. QCP lifecycle. Protocols pass identity, sandbox, evidence, promotion, rollout, and monitoring gates; failed or stale versions can be quarantined, rolled back, or revoked.](figures/figure_4_protocol_lifecycle.png){width=97%}
