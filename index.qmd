...
**4 of 84** currently linked visual abstracts (canonical positions 19, 20, 22, 24) are embedded in their canonical chapters for integrated review. They remain unlisted staging previews, not a completed or published-current visual edition. Every preview includes an adjacent descriptive transcript, and the observed platform caption and thumbnail states remain recorded in the binding ledger.

::: {.asi-visual-preview-roster}
19. [Capability Replacement and Rollback](chapters/capability-replacement-and-rollback.qmd#visual-abstract)
20. [Security Kernel and Digital SCIFs](chapters/security-kernel-and-digital-scifs.qmd#visual-abstract)
22. [Privacy, Data Rights, and Information-Flow Governance](chapters/privacy-data-rights-and-information-flow-governance.qmd#visual-abstract)
24. [Model-Weight Custody and Hardware Roots of Trust](chapters/model-weight-custody-and-hardware-roots-of-trust.qmd#visual-abstract)
:::
