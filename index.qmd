...
**What is currently evidenced.** All 44 chapter core claims remain at `argument`. Four narrow non-core transitions are accepted in [`docs/non_core_evidence_ledger.md`](https://github.com/corbensorenson/asi-stack-book/blob/main/docs/non_core_evidence_ledger.md): the Phase 5 harness registry runner, the costed-route/resource-budget slice, and the Compact GVR receipt slice are `synthetic-test-backed`, and one bounded Circle rope receipt replay is `prototype-backed`. Each v1.x safety-critical Lean module now has at least one derived/decomposed finite-record theorem, but those modules remain shallow formal envelopes rather than deployed safety proofs. All 44 chapters now have source-noted external positioning records with 0 explicit external-baseline exceptions; that is a credibility and routing surface, not exhaustive literature synthesis or support-state promotion. Circle has a public ASI consumer-gate fixture checked by digest and negative controls in [`docs/circle_public_replay_consumer_gate.md`](https://github.com/corbensorenson/asi-stack-book/blob/main/docs/circle_public_replay_consumer_gate.md), and Project Theseus has public-safe static architecture-gate and generation-mode imports plus a local support replay probe checked by digest; these are implementation-reference and receipt-use guards, not chapter-core promotions. Independent external human review is requested in [GitHub issue #1](https://github.com/corbensorenson/asi-stack-book/issues/1) and tracked in [`docs/external_review_status.md`](https://github.com/corbensorenson/asi-stack-book/blob/main/docs/external_review_status.md), but no review has been accepted as evidence.
