...
All three products derive from one canonical source tree; their density, navigation, artifact, and review boundaries are defined in [`docs/product_contracts.md`](docs/product_contracts.md), with executable projection details in [`docs/product_projection_artifacts.md`](docs/product_projection_artifacts.md). The v2, v2.1, and post-v2.1 programs are complete. Current implementation work is governed by the [`Post-v2.2 Implementation and Book Completion Roadmap`](docs/post_v2_2_implementation_completion_roadmap.md) and its machine [`status record`](roadmap_records/post_v2_2_implementation_completion_status.json); QCSA is the first vertical implementation slice.
...
**Fast audit path.** Start with the machine-readable [`canonical public status`](status/canonical-public-status.json), the active [`Post-v2.2 Implementation and Book Completion Roadmap`](docs/post_v2_2_implementation_completion_roadmap.md), its machine [`status record`](roadmap_records/post_v2_2_implementation_completion_status.json), the [`v2.2.0 completion declaration`](docs/v2_2_completion_declaration.md), the completed [`Post-v2.1 Residual and Transfer Roadmap`](docs/post_v2_1_residual_and_transfer_roadmap.md), the historical [`v1.x technical backlog`](docs/v1_x_beyond_sota_roadmap.md), [`docs/v1_0_candidate_status.md`](docs/v1_0_candidate_status.md), [`docs/core_claim_disposition_ledger.md`](docs/core_claim_disposition_ledger.md), [`docs/non_core_evidence_ledger.md`](docs/non_core_evidence_ledger.md), Appendix C, Appendix G, and Appendix H. All 54 chapter-core claims remain at `argument`. CI rejects contradictory active counts, release or roadmap identity drift, manifest/rendered navigation drift, duplicate chapter links or titles, missing chapter pages, and multiple-H1 chapter pages.
...
`v2.2.0` is the latest completed immutable live/research HTML release for the completed Post-v2.1 Residual and Transfer Roadmap. It is bound to source commit `e3d5348993cc5083604c85bd699bb0e36eb00de1` and archive SHA-256 `037563bc62792ecd968cf923b94e3082b02597f1b97f81b63fa59c6d083ee2db`. It carries three bounded empirical programs, fourteen conservative core-claim `no_change` decisions, six bounded transitions, eleven residual dispositions, six modern external-source routes, and the QCSA design synthesis while all 54 chapter-core claims remain at `argument`. The root site and `/latest/` are mutable publication channels. EPUB, DOCX, PDF, audio, and a curated-reader edition remain outside the v2.2.0 release scope unless a later exact release record approves them.
