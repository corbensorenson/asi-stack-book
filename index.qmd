...
All three products derive from one canonical source tree; their density, navigation, artifact, and review boundaries are defined in [`docs/product_contracts.md`](docs/product_contracts.md), with executable projection details in [`docs/product_projection_artifacts.md`](docs/product_projection_artifacts.md). The canonical finish line and execution order are in the [`ASI Stack Completion Roadmap`](docs/asi_stack_completion_roadmap.md).
...
**Fast audit path.** Start with the machine-readable [`canonical public status`](status/canonical-public-status.json), the [`canonical completion roadmap`](docs/asi_stack_completion_roadmap.md), the subordinate [`v1.x technical backlog`](docs/v1_x_beyond_sota_roadmap.md), [`docs/v1_0_candidate_status.md`](docs/v1_0_candidate_status.md), [`docs/core_claim_disposition_ledger.md`](docs/core_claim_disposition_ledger.md), [`docs/non_core_evidence_ledger.md`](docs/non_core_evidence_ledger.md), [`docs/contribution_novelty_ledger.md`](docs/contribution_novelty_ledger.md), Appendix C, Appendix G, Appendix H, and [`docs/reader_continuity_audit.md`](docs/reader_continuity_audit.md). The status record is generated from the tested source tree, and CI rejects contradictory active counts, manifest/rendered navigation drift, duplicate chapter links or titles, missing chapter pages, and multiple-H1 chapter pages.
