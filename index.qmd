...
|---|---|---|
| Narrative book | A 22-unit thesis-to-method route over the complete 86-chapter reference, with live research scaffolding hidden. | [Open the narrative route](products/narrative-book/index.html) |
| Architecture reference | Interfaces, invariants, failure routes, protocols, tests, proofs, and implementation horizons across all 86 working-manifest chapters. | [Open the architecture index](products/architecture-reference/index.html) |
...
This live site is the canonical current **86-chapter** book. Use
[Human view](index.html?view=human) for the reader-facing projection or the
[86-chapter architecture index](products/architecture-reference/index.html)
for direct technical lookup. The generated reader pipeline currently derives
all 86 chapters and passes the reader-spine contract. Older downloadable
...
<span>486 public-safe records; 86/86 chapters externally positioned</span>
</div>
<div>
<strong>Claims</strong>
<span>86 chapter core claims remain argument-level</span>
</div>
<div>
<strong>Tests</strong>
...
Breadth does not mean that all 86 chapters make equally central or equally
...
| Load-bearing reference | 56 | Owns an interface, invariant, artifact, or failure family needed to implement or audit the thesis. |
...
surfaces and contain all 86 manifest chapters. Versioned tags and GitHub
