...
<span>160 inventoried records; Appendix G/H split by ownership</span>
</div>
<div>
...
This release is a tagged v1.0.0 living-book baseline, not a finished v1.x evidence-and-reader release. The chapters are written end to end, and the repo validates scaffold, source-note, proof-readiness, schema, fixture, Lean, reading-mode, and render health locally. Most chapter-core claims, external-grounding upgrades, chapter-level tests, stronger safety-critical proof semantics, clean Project Theseus replay, stronger Circle replay or vendored contract-pack lanes, and human-reader curation work remain active roadmap items until their artifacts are added and recorded.
