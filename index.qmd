...
All three products derive from one canonical source tree; their density, navigation, artifact, and review boundaries are defined in [`docs/product_contracts.md`](docs/product_contracts.md), with executable projection details in [`docs/product_projection_artifacts.md`](docs/product_projection_artifacts.md). The v2, v2.1, post-v2.1, and [`Post-v2.2 Implementation and Book Completion Roadmap`](docs/post_v2_2_implementation_completion_roadmap.md) programs are complete. Its machine [`status record`](roadmap_records/post_v2_2_implementation_completion_status.json) binds P0–P5 and M0–M7 to immutable `v2.3.0`; no successor roadmap is active.
...
**Fast audit path.** Start with the machine-readable [`canonical public status`](status/canonical-public-status.json), the completed [`Post-v2.2 Implementation and Book Completion Roadmap`](docs/post_v2_2_implementation_completion_roadmap.md), its machine [`status record`](roadmap_records/post_v2_2_implementation_completion_status.json), the [`v2.3.0 completion declaration`](docs/v2_3_completion_declaration.md), the [`exact release record`](release_records/2026-07-13-v2.3.0-qcsa-e2766116.json), the [`QCSA implementation/evidence reconciliation`](docs/qcsa_implementation_evidence_reconciliation.md), the [`exact evaluation report`](docs/qcsa_reference_evaluation_report.md), the [`governed vertical report`](docs/qcsa_governed_vertical_reference_report.md), the completed [`Post-v2.1 Residual and Transfer Roadmap`](docs/post_v2_1_residual_and_transfer_roadmap.md), the historical [`v1.x technical backlog`](docs/v1_x_beyond_sota_roadmap.md), [`docs/v1_0_candidate_status.md`](docs/v1_0_candidate_status.md), [`docs/core_claim_disposition_ledger.md`](docs/core_claim_disposition_ledger.md), [`docs/non_core_evidence_ledger.md`](docs/non_core_evidence_ledger.md), Appendix C, Appendix G, and Appendix H. All 54 chapter-core claims remain at `argument`. CI rejects contradictory active counts, release or roadmap identity drift, manifest/rendered navigation drift, duplicate chapter links or titles, missing chapter pages, and multiple-H1 chapter pages.
...
`v2.3.0` is the latest completed immutable live/research HTML release, bound to source commit `e27661166e9105f37cb36d63b15795f80715ca24`, build/deploy runs `29234323320` and `29234640734`, and archive SHA-256 `ebb3cccb0841a15a49d7d20ee8d5c7f7dce97dac562ca05068025951274ee28c`. It contains the twelve-lane QCSA package, 2,340-prediction held-out evaluation, 13-stage governed vertical trace, and nine-owner reconciliation. QCSA did not earn matched task advantage, used `1.913386` times the selected baseline operations, and showed no active-question value on the exact corpus; all 54 chapter-core claims remain at `argument`. The roadmap is complete and no successor is active. Historical `v2.2.0` remains immutable. The root site and `/latest/` are mutable; EPUB, DOCX, PDF, audio, and a curated-reader edition remain outside scope.
