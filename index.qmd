...
All three products derive from one canonical source tree; their density, navigation, artifact, and review boundaries are defined in [`docs/product_contracts.md`](docs/product_contracts.md), with executable projection details in [`docs/product_projection_artifacts.md`](docs/product_projection_artifacts.md). The completed v2 and v2.1 programs remain historical records; current work is governed by the [`Post-v2.1 Residual and Transfer Roadmap`](docs/post_v2_1_residual_and_transfer_roadmap.md).
...
<span>v2.1.0 is the latest immutable evidence release; post-v2.1 residual and transfer work is active</span>
</div>
<div>
<strong>Sources</strong>
<span>279 public-safe records; 54/54 chapters externally positioned</span>
</div>
<div>
...
**Fast audit path.** Start with the machine-readable [`canonical public status`](status/canonical-public-status.json), the active [`Post-v2.1 Residual and Transfer Roadmap`](docs/post_v2_1_residual_and_transfer_roadmap.md), its machine [`status record`](roadmap_records/post_v2_1_residual_and_transfer_status.json), the [`v2.1.0 completion declaration`](docs/v2_1_completion_declaration.md), the completed [`Post-v2 Evidence Roadmap`](docs/post_v2_evidence_roadmap.md), the historical [`v2 completion roadmap`](docs/asi_stack_completion_roadmap.md), the historical [`v1.x technical backlog`](docs/v1_x_beyond_sota_roadmap.md), [`docs/v1_0_candidate_status.md`](docs/v1_0_candidate_status.md), [`docs/core_claim_disposition_ledger.md`](docs/core_claim_disposition_ledger.md), [`docs/non_core_evidence_ledger.md`](docs/non_core_evidence_ledger.md), [`docs/contribution_novelty_ledger.md`](docs/contribution_novelty_ledger.md), Appendix C, Appendix G, Appendix H, and [`docs/reader_continuity_audit.md`](docs/reader_continuity_audit.md). The status record is generated from the tested source tree, and CI rejects contradictory active counts, release or roadmap identity drift, manifest/rendered navigation drift, duplicate chapter links or titles, missing chapter pages, and multiple-H1 chapter pages.
...
`v2.1.0` is the latest immutable evidence release, bound to tag `v2.1.0`, source commit `cb3b86051c3f4bd82e8b3128c0fdf180e8a7cfa5`, its exact release record, tag-bound rights snapshot, and immutable rendered-site archive. The root site and `/latest/` are mutable publication channels and must not be cited as immutable artifacts. The completed v2.1 cycle preserved nine chapter-core `no_change` decisions, three non-core `blocks_promotion` transitions, and fourteen residual lanes; all 54 chapter-core claims remain at `argument`. Current work follows the Post-v2.1 Residual and Transfer Roadmap. EPUB, DOCX, PDF, audio, and a curated-reader edition remain outside the v2.1.0 release scope unless a later exact release record approves them.
