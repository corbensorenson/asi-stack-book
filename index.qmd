...
All three products derive from one canonical source tree; their density, navigation, artifact, and review boundaries are defined in [`docs/product_contracts.md`](docs/product_contracts.md), with executable projection details in [`docs/product_projection_artifacts.md`](docs/product_projection_artifacts.md). The v2, v2.1, and post-v2.1 programs are complete. The [`Post-v2.2 Implementation and Book Completion Roadmap`](docs/post_v2_2_implementation_completion_roadmap.md) and machine [`status record`](roadmap_records/post_v2_2_implementation_completion_status.json) now record QCSA implementation, frozen evaluation, the governed vertical path, and nine-chapter reconciliation complete; P5 is the active v2.3.0 release/deploy/attestation transaction.
...
<span>v2.2.0 is the latest completed immutable HTML release</span>
</div>
<div>
...
**Fast audit path.** Start with the machine-readable [`canonical public status`](status/canonical-public-status.json), the active [`Post-v2.2 Implementation and Book Completion Roadmap`](docs/post_v2_2_implementation_completion_roadmap.md), its machine [`status record`](roadmap_records/post_v2_2_implementation_completion_status.json), the [`QCSA implementation/evidence reconciliation`](docs/qcsa_implementation_evidence_reconciliation.md), the [`exact evaluation report`](docs/qcsa_reference_evaluation_report.md), the [`governed vertical report`](docs/qcsa_governed_vertical_reference_report.md), the [`v2.2.0 completion declaration`](docs/v2_2_completion_declaration.md), the completed [`Post-v2.1 Residual and Transfer Roadmap`](docs/post_v2_1_residual_and_transfer_roadmap.md), the historical [`v1.x technical backlog`](docs/v1_x_beyond_sota_roadmap.md), [`docs/v1_0_candidate_status.md`](docs/v1_0_candidate_status.md), [`docs/core_claim_disposition_ledger.md`](docs/core_claim_disposition_ledger.md), [`docs/non_core_evidence_ledger.md`](docs/non_core_evidence_ledger.md), Appendix C, Appendix G, and Appendix H. All 54 chapter-core claims remain at `argument`. CI rejects contradictory active counts, release or roadmap identity drift, manifest/rendered navigation drift, duplicate chapter links or titles, missing chapter pages, and multiple-H1 chapter pages.
...
`v2.2.0` remains the latest completed immutable live/research HTML release, bound to source commit `e3d5348993cc5083604c85bd699bb0e36eb00de1` and archive SHA-256 `037563bc62792ecd968cf923b94e3082b02597f1b97f81b63fa59c6d083ee2db`. The current mutable book has since completed the twelve-lane QCSA package, 2,340-prediction held-out evaluation, 13-stage governed vertical trace, and nine-owner reconciliation. QCSA did not earn matched task advantage, used `1.913386` times the selected baseline operations, and showed no active-question value on the exact corpus; all 54 chapter-core claims remain at `argument`. Canonical HTML-only `v2.3.0` is selected but not immutable until its clean build, deploy, tag, archive, public redownload, and attestation transaction completes. The root site and `/latest/` are mutable; EPUB, DOCX, PDF, audio, and a curated-reader edition remain outside scope.
