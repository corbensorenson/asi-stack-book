...
|---|---|---|
| Narrative book | A 22-unit thesis-to-method route over the complete 85-chapter reference, with live research scaffolding hidden. | [Open the narrative route](products/narrative-book/index.html) |
| Architecture reference | Interfaces, invariants, failure routes, protocols, tests, proofs, and implementation horizons across all 85 working-manifest chapters. | [Open the architecture index](products/architecture-reference/index.html) |
...
This live site is the canonical current **85-chapter** book. Use
[Human view](index.html?view=human) for the reader-facing projection or the
[85-chapter architecture index](products/architecture-reference/index.html)
for direct technical lookup. The generated reader pipeline currently derives
all 85 chapters and passes the reader-spine contract. Older downloadable
...
<span>479 public-safe records; 85/85 chapters externally positioned</span>
</div>
<div>
<strong>Claims</strong>
<span>85 chapter core claims remain argument-level</span>
</div>
<div>
<strong>Tests</strong>
...
**4 of 85** currently linked visual abstracts (canonical positions 19, 20, 22, 24) are embedded in their canonical chapters for integrated review. They remain unlisted staging previews, not a completed or published-current visual edition. Every preview includes an adjacent descriptive transcript, and the observed platform caption and thumbnail states remain recorded in the binding ledger.
...
Breadth does not mean that all 85 chapters make equally central or equally
...
| Load-bearing reference | 55 | Owns an interface, invariant, artifact, or failure family needed to implement or audit the thesis. |
...
surfaces and contain all 85 manifest chapters. Versioned tags and GitHub
