...
|---|---|---|
| Narrative book | A 22-unit thesis-to-method route over the complete 87-chapter reference, with live research scaffolding hidden. | [Open the narrative route](products/narrative-book/index.html) |
| Architecture reference | Interfaces, invariants, failure routes, protocols, tests, proofs, and implementation horizons across all 87 working-manifest chapters. | [Open the architecture index](products/architecture-reference/index.html) |
...
This live site is the canonical current **87-chapter** book. Use
[Human view](index.html?view=human) for the reader-facing projection or the
[87-chapter architecture index](products/architecture-reference/index.html)
for direct technical lookup. The generated reader pipeline currently derives
all 87 chapters and passes the reader-spine contract. Older downloadable
...
<span>490 public-safe records; 87/87 chapters externally positioned</span>
</div>
<div>
<strong>Claims</strong>
<span>87 chapter core claims remain argument-level</span>
</div>
<div>
<strong>Tests</strong>
...
Breadth does not mean that all 87 chapters make equally central or equally
...
surfaces and contain all 87 manifest chapters. Versioned tags and GitHub
