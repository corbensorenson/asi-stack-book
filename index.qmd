...
All three products derive from one canonical source tree; their density, navigation, artifact, and review boundaries are defined in [`docs/product_contracts.md`](docs/product_contracts.md), with executable projection details in [`docs/product_projection_artifacts.md`](docs/product_projection_artifacts.md). The v2, v2.1, and post-v2.1 programs are complete; the latest cycle is summarized by the [`v2.2.0 completion declaration`](docs/v2_2_completion_declaration.md) and its completed [`Post-v2.1 Residual and Transfer Roadmap`](docs/post_v2_1_residual_and_transfer_roadmap.md).
...
**Fast audit path.** Start with the machine-readable [`canonical public status`](status/canonical-public-status.json), the [`v2.2.0 completion declaration`](docs/v2_2_completion_declaration.md), the completed [`Post-v2.1 Residual and Transfer Roadmap`](docs/post_v2_1_residual_and_transfer_roadmap.md), its machine [`status record`](roadmap_records/post_v2_1_residual_and_transfer_status.json), the [`v2.1.0 completion declaration`](docs/v2_1_completion_declaration.md), the completed [`Post-v2 Evidence Roadmap`](docs/post_v2_evidence_roadmap.md), the historical [`v1.x technical backlog`](docs/v1_x_beyond_sota_roadmap.md), [`docs/v1_0_candidate_status.md`](docs/v1_0_candidate_status.md), [`docs/core_claim_disposition_ledger.md`](docs/core_claim_disposition_ledger.md), [`docs/non_core_evidence_ledger.md`](docs/non_core_evidence_ledger.md), Appendix C, Appendix G, and Appendix H. The status record is generated from the tested source tree, and CI rejects contradictory active counts, release or roadmap identity drift, manifest/rendered navigation drift, duplicate chapter links or titles, missing chapter pages, and multiple-H1 chapter pages.
