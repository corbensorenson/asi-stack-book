...
def validate(
    ...
    if editorial.get("state") != "em4_public_html_deployed_no_support_effect":
        errors.append("editorial migration state does not record completed EM4 HTML deployment")
    expected_packages = [
        {
