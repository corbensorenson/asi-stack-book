...
def main() -> None:
    ...
    contract = {
        ...
        "negative_controls": "validator_owned_support_parent_and_route_mutations",
        "negative_control_cases": ["support promotion", "owner reroute", "parent erasure"],
