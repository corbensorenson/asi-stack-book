...
def main() -> None:
    ...
    contract = {
        ...
        "input_contract": "The canonical 87-owner graph, reviewed 54+2/18/7/5/1 publication disposition, exact 26-unit owner route, seven completed EM2 composition packages, and the exact-commit EM4 Human Reader HTML deployment receipt.",
        "input_artifacts": ARTIFACTS,
        "output_contract": "Require disjoint owner roles, exact parents and legacy routes, local claim ownership, one Human Reader route per owner, a canonical deployed preview, exact EM4 HTML custody, and no support inheritance or major-version package release.",
        "output_assertions": [
            "87 canonical technical owners",
            "54 primary architecture owners",
            "2 implementation/method owners",
            "16 publication nests",
            "2 method-detail nests",
            "0 open semantic-merge candidates",
            "7 deployment profiles",
            "5 dossier owners",
            "1 back-matter owner",
            "26 Human Reader units",
            "exact-commit EM4 HTML deployment",
            "16 semantic mutations reject",
            "support effect none",
        ],
        "claim_scope": "Publication classification, legacy identity preservation, Human Reader routing, seven evidence-preserving EM2 composition packages, and the exact EM4 public HTML cutover.",
        "negative_controls": "validator_owned_support_parent_route_and_composition_mutations",
        "negative_control_cases": ["support promotion", "owner reroute", "parent erasure", "method-detail composition-boundary erasure", "security-custody composition-boundary erasure", "white-box composition-boundary erasure", "human-control/communication boundary erasure", "constitution/moral-conflict boundary erasure", "institution/resilience boundary erasure", "intent/command boundary erasure", "context static/dynamic boundary erasure", "work-surface/organization boundary erasure", "protocol/population boundary erasure", "recursive/open-ended boundary erasure", "living-book/stewardship boundary erasure", "theseus/roadmap boundary erasure"],
        "prohibited_inference": "Composition and HTML deployment do not transfer technical ownership or support, erase the rejected semantic-merge boundary, approve major-version packages or accessibility conformance, or establish safety, readiness, AGI, or ASI.",
        "contract_precision": "exact_high_impact",
        "semantic_review_state": "checked_seven_composition_packages_and_em4_html_cutover",
    }
