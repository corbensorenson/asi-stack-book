...
def main() -> None:
    ...
    contract = {
        ...
        "input_contract": "The canonical 87-owner graph, reviewed 54+2/18/7/5/1 publication disposition, exact 26-unit owner route, and the seven completed no-cutover EM2 composition packages.",
        ...
        "claim_scope": "Publication classification, legacy identity preservation, Human Reader routing, and seven evidence-preserving EM2 composition packages without public cutover.",
        ...
        "prohibited_inference": "Composition does not transfer technical ownership or support, erase the rejected semantic-merge boundary, authorize public cutover or release, or establish safety, readiness, AGI, or ASI.",
        "contract_precision": "exact_high_impact",
        "semantic_review_state": "checked_seven_no_cutover_composition_packages",
    }
