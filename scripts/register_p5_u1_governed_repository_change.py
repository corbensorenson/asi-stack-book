    ...
    registry["units"].append(
        {
            ...
            "output_contract": "Replay the 3x4 route/path matrix in a fresh workspace, compute matched governance rent against both simpler routes, and reject route loss, authority laundering, false state checks, false compensation, proxy-as-human-time laundering, rent laundering, prospective-task laundering, or support movement.",
            "output_assertions": [
                ...
                "matched governance rent reports overhead and prevented or closed failures together",
                "nine record mutations reject",
            ...
            "negative_control_cases": [
                ...
                "operator-step proxy relabeled as observed human time",
                "governance-rent benefit laundering",
            ],
