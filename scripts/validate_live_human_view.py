...
def validate(site_dir: Path) -> dict[str, object]:
    ...
    for page in book_pages(structure):
        ...
        for needle in (
            ...
            "data-asi-human-toc-link",
            "data-asi-ai-toc-link",
            "const coreClaimMarkerPattern",
