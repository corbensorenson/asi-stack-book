...
It does **not** quote or publish raw private source passages. It also does **not** promote any support state. A passing audit means the source-note and claim-mapping layer is internally traceable and explicitly bounded; it does not prove that mapped source notes have undergone passage-level review.
