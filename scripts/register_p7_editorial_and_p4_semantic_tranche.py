...
UNITS = [
    ...
    },
    {
        ...
        "input_contract": "Maintained safety/assurance/oversight cluster of four modules and twenty-nine current public targets after two Governance Rights targets migrated to their chapter-owned model, with exact propositions, modeled state, assumptions, countermodels, consumers, mutation evidence, and maximum inference.",
        ...
        "output_assertions": ["4 modules", "29 public targets", "4 adequate bounded dispositions", "5 consumers pass", "9 mutations reject", "support effect none"],
