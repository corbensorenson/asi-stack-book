...
def artifact_errors(data: dict[str, Any]) -> list[str]:
    ...
    expected_reconciliation = {
        ...
        "current_prose_candidate_count": 3871,
        "unchanged_prose_candidate_count": 3190,
        "retired_inherited_prose_candidate_count": 254,
        "added_domain_specific_prose_candidate_count": 681,
