...
def artifact_errors(data: dict[str, Any]) -> list[str]:
    ...
    expected_reconciliation = {
        ...
        "current_prose_candidate_count": 3895,
        "unchanged_prose_candidate_count": 3158,
        "retired_inherited_prose_candidate_count": 286,
        "added_domain_specific_prose_candidate_count": 737,
