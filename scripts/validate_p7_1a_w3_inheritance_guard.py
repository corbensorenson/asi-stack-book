...
def artifact_errors(data: dict[str, Any]) -> list[str]:
    ...
    expected_reconciliation = {
        ...
        "current_prose_candidate_count": 3888,
        "unchanged_prose_candidate_count": 3174,
        "retired_inherited_prose_candidate_count": 270,
        "added_domain_specific_prose_candidate_count": 714,
        "baseline_structured_atom_count": 4067,
        "current_structured_atom_count": 4062,
