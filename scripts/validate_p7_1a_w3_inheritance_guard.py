...
def artifact_errors(data: dict[str, Any]) -> list[str]:
    ...
    expected_reconciliation = {
        ...
        "current_prose_candidate_count": 3538,
        "unchanged_prose_candidate_count": 3197,
        "retired_inherited_prose_candidate_count": 247,
        "added_domain_specific_prose_candidate_count": 341,
