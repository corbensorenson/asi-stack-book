...
def artifact_errors(data: dict[str, Any]) -> list[str]:
    ...
    expected_reconciliation = {
        ...
        "current_prose_candidate_count": 3876,
        "unchanged_prose_candidate_count": 3182,
        "retired_inherited_prose_candidate_count": 262,
        "added_domain_specific_prose_candidate_count": 694,
