...
def artifact_errors(data: dict[str, Any]) -> list[str]:
    ...
    expected_reconciliation = {
        ...
        "current_prose_candidate_count": 3814,
        "unchanged_prose_candidate_count": 3196,
        "retired_inherited_prose_candidate_count": 248,
        "added_domain_specific_prose_candidate_count": 618,
