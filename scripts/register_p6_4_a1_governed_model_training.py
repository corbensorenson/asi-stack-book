...
UNITS = [
    {
        ...
        "output_contract": "Require topology/batch reconciliation, full attempted-run denominator, complete consistent durable checkpoint state, resume-accounting fields, validation-only checkpoint-family selection, independent unopened qualification, 21 transaction mutations, seven weight-only collisions, and nine complete-encoding mutations.",
        "output_assertions": ["10 state classes", "7 sources", "8 non-authorities", "5 prospective arms", "13 fault families", "12 competence gates", "21 transaction mutations reject", "7 weight-only collisions", "9 complete-encoding mutations reject", "no training/support/release effect"],
    ...
    },
    {
        ...
        "input_contract": "Terminal A1 decision, seven-source four-role packet, one argument chapter, three implemented targets, twenty theorem declarations, one authored contract, one unopened natural protocol, and reconciled reader/status surfaces.",
        ...
        "output_assertions": ["1 terminal A1 chapter", "7 source notes", "4 source roles", "3 implemented targets", "20 theorems", "84 chapters", "terminal no-queue custody", "9 integration mutations reject", "support effect none"],
