...
def main() -> None:
    ...
    expected_fragments = [
        ...
        "the reader release has a tracked semantic overlay manifest, generated reader delta report path, and embedded live Human-view overlay payload for major-version human-edition deltas",
