...
def main() -> None:
    ...
    expected_fragments = [
        ...
        "| Test harnesses | Twenty-three synthetic or deterministic harnesses are wired into book validation; twenty-two are wired into the Phase 5 registry and one chapter-specific artifact graph replay harness is book-gate-only:",
