...
def main() -> None:
    ...
    if old_harness_start in expected_fragments and non_infra_start in expected_fragments:
        ...
        current_harness_fragments = [
            "| Test harnesses | Forty-five synthetic, deterministic, measured, local replay, local external-project receipt, local artifact-import, or publication-governance checks are wired into book validation; twenty-two are wired into the Phase 5 registry and twenty-three chapter-specific/support checks are book-gate-only:",
