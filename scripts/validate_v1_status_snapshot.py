...
def main() -> None:
    ...
    expected_fragments = [
        ...
        "| Test harnesses | Eight synthetic or deterministic harnesses are wired into book validation and the Phase 5 registry:",
