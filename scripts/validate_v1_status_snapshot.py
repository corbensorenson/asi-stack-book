...
def main() -> None:
    ...
    expected_fragments = [
        ...
        "| Source appendix ownership | Appendix G is Corben's sources and local projects; Appendix H is a separate external-source appendix for records by other authors marked `external_literature` |",
        ...
        "browser smoke validation can exercise every manifest chapter across desktop and mobile viewports with `--all-chapters --all-viewports` when Playwright/Chrome is available",
