...
def main() -> None:
    ...
    expected_fragments = [
        ...
        "| Test harnesses | Twenty-six synthetic or deterministic harnesses are wired into book validation; twenty-two are wired into the Phase 5 registry and four chapter-specific harnesses are book-gate-only: the artifact graph replay harness, the procedural memory loop harness, the routing decision lease harness, and the cyclic memory contract harness;",
