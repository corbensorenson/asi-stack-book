...
def main() -> None:
    ...
    expected_fragments = [
        ...
        "The synced chapter review matrix records 54 reader-review rows with 22 `spot_checked`, 32 `not_started`, 20 active-overlay chapters, 3 companion-note candidates, 1 curated-manuscript candidate, and release blockers on every row until full chapter review, release record, and artifact review exist.",
