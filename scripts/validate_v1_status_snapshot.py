...
def main() -> None:
    ...
    expected_fragments = [
        ...
        "| External SOTA positioning | Phase 6 placement is machine-tracked and closed for the v1.0 placement gate: 48 of 54 chapters have `ext_*` positioning before the Source crosswalk, 6 chapters have explicit external-baseline exceptions, 0 chapters need source-target placement, and 0 chapters need an exception or added source-noted baseline |",
