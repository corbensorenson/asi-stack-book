...
def main() -> None:
    ...
    expected_fragments = [
        ...
        "`docs/curated_reader_format_artifact_probe.md` records the current curated-reader HTML/EPUB/DOCX/PDF structural probe with 49 HTML files, 52 EPUB XHTML entries, 61 DOCX PNG media entries, 0 SVG conversion warnings, and a 525-page PDF sample-page render while preserving release blockers",
    ...
    if old_harness_start in expected_fragments and non_infra_start in expected_fragments:
        ...
        current_harness_fragments = [
            ...
            "The Human oversight degradation fixture checks `experiments/human_oversight_degradation/results/2026-07-03-local.json`, 3 valid records, 7 expected-invalid controls, approval fatigue, rubber-stamping, alarm fatigue, automation bias, missing reviewer qualification, accepted no-promotion decision `evidence_transitions/v1_x_measured/human_oversight_degradation_no_change.json`, no approval-service quality claim, no reviewer-correctness claim, no alert-quality claim, no deployed human-factors result, no runtime-adapter-safety claim, no chapter-core promotion, and no support-state promotion.",
