...
def main() -> None:
    ...
    expected_fragments = [
        ...
        "`docs/reader_continuity_review.md` records first manual decisions for the three medium-priority reader-audit rows, and `docs/reader_part_i_review_pass.md` records eight first-pass Part I decisions including one canonical prose cleanup, without treating either note as release approval.",
        "The synced chapter review matrix records 54 reader-review rows with 30 `spot_checked`, 24 `not_started`, 20 active-overlay chapters, 11 no-immediate-action decisions, 3 companion-note candidates, 1 curated-manuscript candidate, and release blockers on every row until full chapter review, release record, and artifact review exist.",
