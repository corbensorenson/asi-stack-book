...
def main() -> None:
    ...
    if old_harness_start in expected_fragments and non_infra_start in expected_fragments:
        ...
        current_harness_fragments = [
            "| Test harnesses | Forty synthetic, deterministic, measured, local replay, local external-project receipt, or local artifact-import checks are wired into book validation; twenty-two are wired into the Phase 5 registry and eighteen chapter-specific/support checks are book-gate-only:",
