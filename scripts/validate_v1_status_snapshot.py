...
def main() -> None:
    ...
    expected_fragments = [
        ...
        "`docs/reader_continuity_review.md` records first manual decisions for the three medium-priority reader-audit rows, `docs/reader_part_i_review_pass.md` records eight first-pass Part I decisions including one canonical prose cleanup, `docs/reader_part_ii_review_pass.md` records eleven first-pass Part II decisions including three canonical prose cleanups, and `docs/reader_part_iii_review_pass.md` records eight first-pass Part III decisions including three canonical prose cleanups, without treating those notes as release approval.",
        "The synced chapter review matrix records 54 reader-review rows with 49 `spot_checked`, 5 `not_started`, 20 active-overlay chapters, 30 no-immediate-action decisions, 3 companion-note candidates, 1 curated-manuscript candidate, and release blockers on every row until full chapter review, release record, and artifact review exist.",
