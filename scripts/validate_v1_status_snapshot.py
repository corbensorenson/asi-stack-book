...
def main() -> None:
    ...
    expected_fragments = [
        ...
        "`docs/curated_reader_format_artifact_probe.md` records the current curated-reader HTML/EPUB/DOCX/PDF structural probe with 49 HTML files, 52 EPUB XHTML entries, 61 DOCX PNG media entries, 0 SVG conversion warnings, and a 526-page PDF sample-page render while preserving release blockers",
