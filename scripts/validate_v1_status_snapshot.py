...
def main() -> None:
    ...
    expected_fragments = [
        ...
        "| Source appendix ownership | Appendix G and Appendix H are independent top-level appendices: G contains Corben-authored, Corben-supplied, and local-project source records; H contains external records by other authors marked `external_literature` |",
