...
def main() -> None:
    ...
    expected_fragments = [
        ...
        "| Test harnesses | Twenty-five synthetic or deterministic harnesses are wired into book validation; twenty-two are wired into the Phase 5 registry and three chapter-specific harnesses are book-gate-only: the artifact graph replay harness, the procedural memory loop harness, and the routing decision lease harness;",
