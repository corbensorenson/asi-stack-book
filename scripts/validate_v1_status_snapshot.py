...
def main() -> None:
    ...
    expected_fragments = [
        ...
        "| Test harnesses | Twenty-four synthetic or deterministic harnesses are wired into book validation; twenty-two are wired into the Phase 5 registry and two chapter-specific harnesses are book-gate-only: the artifact graph replay harness and the procedural memory loop harness;",
