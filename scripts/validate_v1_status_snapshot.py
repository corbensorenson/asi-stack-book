...
def main() -> None:
    ...
    expected_fragments = [
        ...
        "| Source appendix ownership | Appendix G is reserved for Corben's source corpus; Appendix H is reserved for external source records marked `external_literature` |",
