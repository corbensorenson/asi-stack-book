...
def main() -> None:
    ...
    expected_fragments = [
        ...
        "`docs/reader_opening_full_review_pass.md` records the first full generated-reader chapter-text review for the opening three chapters; `docs/reader_continuity_review.md` records first manual decisions for the three medium-priority reader-audit rows; `docs/reader_part_i_review_pass.md` records eight first-pass Part I decisions including one canonical prose cleanup; `docs/reader_part_ii_review_pass.md` records eleven first-pass Part II decisions including three canonical prose cleanups; `docs/reader_part_iii_review_pass.md` records eight first-pass Part III decisions including three canonical prose cleanups; and `docs/reader_part_iv_review_pass.md` records five first-pass Part IV decisions plus one reader-generator capitalization cleanup, without treating those notes as release approval.",
        "The synced chapter review matrix records 54 reader-review rows with 3 `reviewed`, 51 `spot_checked`, 0 `not_started`, 20 active-overlay chapters, 38 no-immediate-action decisions, 3 companion-note candidates, 1 curated-manuscript candidate, and release blockers on every row until reader release records and artifact review exist; the remaining 51 spot-checked rows also retain full-chapter-review blockers.",
