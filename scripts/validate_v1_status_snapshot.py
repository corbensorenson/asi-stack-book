...
def main() -> None:
    ...
    expected_fragments = [
        ...
        f"must be at least 140 words excluding the source-only heading, with the current minimum at {human_min_words} words",
    ]
    ...
    if human_min_words < 140:
        errors.append(f"Human Reading Path prose minimum is {human_min_words}, below 140.")
