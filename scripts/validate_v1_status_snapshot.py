...
def main() -> None:
    ...
    expected_fragments = [
        ...
        "`docs/reader_pdf_probe_manifest.md` records the current 614-page, 8,672,117-byte PDF probe, expected title/evidence-boundary text, refreshed sampled pages, and the unresolved PDF source-appendix table-collision blocker",
