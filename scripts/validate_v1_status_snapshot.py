...
def main() -> None:
    ...
    expected_fragments = [
        ...
        "the reader release has a tracked semantic overlay manifest as the editable delta source, generated reader delta report path as review output, and embedded live Human-view overlay payload for major-version human-edition deltas",
