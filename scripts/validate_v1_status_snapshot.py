...
def main() -> None:
    ...
    expected_fragments = [
        ...
        f"| Support states | {evidence_counts.get('argument', 0)} chapter core claims at `argument`; the v1.0 claim-state coverage gate records {accepted_core_transitions} accepted no-change transition records plus {accepted_no_promotion} accepted explicit no-promotion decisions, and the separate measured/replayed set records three bounded `synthetic-test-backed` transitions for `living-book-methodology.phase5_harness_registry_runner`, `resource-economics.costed_route_budget_slice`, and `compact-generative-systems.compact_gvr_receipt_slice` plus one bounded `prototype-backed` imported Circle receipt transition for `circle-calculus.external_rope_receipt_replay`; no chapter core claim support-state promotion |",
        ...
        "| Test harnesses | Thirty-four synthetic, deterministic, measured, or local replay harnesses are wired into book validation; twenty-two are wired into the Phase 5 registry and twelve chapter-specific/support harnesses are book-gate-only: the artifact graph replay harness, the procedural memory loop harness, the routing decision lease harness, the cyclic memory contract harness, the context transaction memory-store harness, the simulation transfer boundary harness, the resource workflow trace harness, the resource live probe harness, the resource workload-quality probe, the Theseus support replay probe, the Compact GVR synthetic slice, and the hive admission harness;",
        ...
        "the resource workload-quality probe checks 3 measured local route records",
        ...
        f"| Proof envelope | {proof_targets} proof targets, all implemented as narrow finite-record Lean predicates; current proof adequacy review classifies 9 targets as adequate only for narrow finite-record claims, 55 useful-but-too-narrow, 21 needing richer state or review semantics, 35 needing executable tests first, 13 needing empirical or baseline tests first, and 6 remaining research-agenda until artifact import; follow-through increments add a stack-boundary trace and layer-contract admission envelope, an efficiency route/residual negative-case and claim-admission lifecycle route envelope, a compact-generation/GVR/semantic negative-case, compact-admission-route, and Compact GVR fixture-bridge envelope, an artifact-compression negative-case and admission-lifecycle route envelope, a circle proof-contract receipt/consumer negative-case envelope, a coil-attention memory negative-case envelope plus synthetic cyclic-memory harness, a cyclic-mixer adoption-boundary negative-case envelope, a living-book release-boundary negative-case envelope, a project-theseus report-boundary negative-case envelope, a readiness lifecycle negative-case envelope, a proof-envelope artifact authority negative-case envelope, a proof-carrying claim negative-case envelope, a tribunal review negative-case and lifecycle-route envelope, a corrigibility agency-correction lifecycle-route envelope, a governance-right lifecycle-route envelope, a value-conflict lifecycle-admission route envelope, a constitutional lifecycle-admission route envelope, a personal-compute hive approval/lease negative-case envelope, a finite hive-work admission lifecycle route envelope, a runtime-adapter permission, authority-ceiling, confused-deputy, sandbox-escape, and dispatch-route envelope plus synthetic permission harness, a procedural-memory generated-tool/regression lifecycle-route and synthetic-fixture bridge envelope plus synthetic loop harness, a routing/MoECOT source-boundary negative-case envelope, a finite routing-decision lifecycle route envelope, a synthetic route-lease harness, a record-aware allow/deny/escalate authority decision and lifecycle admission envelope, a failure incident-route and recurrence-escalation envelope, a finite intent-resolution route envelope, an execution dispatch-route envelope, a command-contract missing-field/hidden-override negative-case envelope, a bibliography source-record/chapter-assignment negative-case envelope, a resource/simulation budget-fidelity negative-case envelope, a semantic-lowering route envelope, a context-admission route envelope, a certificate-lifecycle route envelope, a context-transaction snapshot/branch/mount/taint/deletion/replay route envelope, a verification-adequacy route envelope, a job-execution route envelope, a stable-capability lifecycle-route envelope, a replacement transaction-route envelope, a security-kernel authority-use route envelope, a self-improvement transition-route envelope, a record-aware planning control and dispatch-route envelope, evidence-state terminal/downgrade and transition-lifecycle envelopes, a benchmark-ratchet decision envelope, an artifact-steward lifecycle/contribution/federation route envelope, finite claim-ledger record/lifecycle-route and proof-carrying-claim record envelopes, an artifact-graph provenance/replay/link route envelope and synthetic replay harness, deterministic generation-mode/resource-budget accounting coverage, a finite fast-generation acceptance-accounting negative-case, admission-lifecycle route, and Theseus import fixture bridge envelopes, a finite policy-optimization promotion-boundary and promotion-route negative-case envelope, a deterministic resource-budget ledger harness, a finite costed-route fixture and selector-state trace bridge, a finite resource-workflow trace-property bridge, a reference-trace harness and route envelope, a prototype-roadmap phase-route envelope, and a capacity-smoothing toy harness without promoting ASI Is a Stack, the Efficient ASI Hypothesis, Compact Generative Systems, Mathematical/Search Substrates, Circle Contracts, Coil Attention, CoilRA/MultiCoil/cyclic mixers, Living Book Methodology, Project Theseus, Readiness Gates, Proof Envelope, System Boundaries, Failure Modes, Human Intent, Command Contracts, Cognitive Compilation, Virtual Context ABI, Verification Bandwidth, Labor OS, Artifact Graphs, Procedural Memory, Routing Heads, Personal Compute Hives, RankFold, Stable Capability Fields, Capability Replacement, Security Kernel, Recursive Self-Improvement, Planning, Evidence States, Benchmark Ratchets, Artifact Steward Agents, Claim Ledgers, Spinoza, Runtime Adapters, Integrated Reference Architecture, Fast Generation, Policy Optimization, Prototype Roadmap, or Resource Economics above `argument` |",
