...
def main() -> None:
    ...
    expected_fragments = [
        ...
        "the reader release has a tracked semantic overlay manifest as the editable delta source, generated reader delta report path as review output with a zero-active-operation note or operation digests and before/after excerpts, embedded live Human-view overlay payload for major-version human-edition deltas, and a generated reader-continuity audit with 15 high-priority heuristic review rows",
        "The current v1.0 reader-overlay set carries 10 active operations: 2 opening-chapter operations, 4 Personal Compute Hives table-to-prose operations, 2 Policy Optimization table-to-prose operations, and 2 Artifact Steward Agents table-to-prose operations for Human view and generated reader editions only",
