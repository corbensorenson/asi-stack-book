...
CURRENT_IMPLEMENTED_TARGET_COUNT = 315
CURRENT_PLANNED_TARGET_COUNT = 9
...
CURRENT_EXPECTED_CLASSES = {
    "adequate finite-record invariant": 79,
    "useful but too narrow": 160,
    "needs richer state-machine or review semantics": 25,
