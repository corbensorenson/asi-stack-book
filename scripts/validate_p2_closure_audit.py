...
CURRENT_IMPLEMENTED_TARGET_COUNT = 316
CURRENT_PLANNED_TARGET_COUNT = 8
...
CURRENT_EXPECTED_CLASSES = {
    "adequate finite-record invariant": 80,
    "useful but too narrow": 160,
    "needs richer state-machine or review semantics": 24,
