...
EXPECTED_SOURCES = ["scf", "deterministic_capability_compilation", "theseus_operator_os", "viea", "talos", "platonic_world_model", "regret_engine", "ext_nist_ai_rmf_1_0_2023", "ext_nist_deployed_ai_monitoring_2026", "ext_nist_incident_response_2025"]
...
def errors(data: dict[str, Any]) -> list[str]:
    ...
    if set(source_ids) != set(EXPECTED_SOURCES) or audit["source_crosswalk"].get("assigned_source_count") != 10:
...
def main() -> None:
    ...
    mutations = [
        ...
        ("premature A3 activation", lambda v: v["status"]["execution_readiness"].__setitem__("immediate_book_packet", "P6.4-A3-perception-sensor-fusion-and-observation-trust-adjudication")),
    ]
