...
def errors(data: dict[str, Any]) -> list[str]:
    ...
    if status["execution_readiness"].get("immediate_book_packet") != "P6.4-A1-governed-model-training-distributed-optimization-and-scaling-adjudication":
        out.append("execution board did not advance to second-tranche A1")
