...
UNITS = [
    {
        ...
        "output_assertions": ["1 authored safe-hold case", "5 authority dimensions narrow", "11 packet state classes", "14 campaign state classes", "5 campaign arms", "40 heldout tasks unopened", "9 competence gates", "13 Lean declarations", "33 mutations reject", "support/release/publication none"],
    ...
    },
    {
        ...
        "output_assertions": ["4 first-tranche chapters terminal", "9 source mappings", "2 implemented targets", "13 Lean declarations", "authored case not flagship T4", "5 arms and 40 protected tasks frozen", "0 natural incidents", "13 integration mutations reject", "support effect none"],
