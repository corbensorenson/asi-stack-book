...
UNITS = [
    ...
    },
    {
        ...
        "input_contract": "The admitted Operations chapter, ten exact source mappings, three implemented targets, two Lean modules with twenty-six declarations, one authored safe-hold case, one prospectively frozen five-arm/forty-task campaign with protected outcomes closed, and adjacent reader surfaces.",
        ...
        "output_assertions": ["4 first-tranche chapters terminal", "10 source mappings", "3 implemented targets", "26 Lean declarations", "8 lifecycle stages", "44 lifecycle mutations reject", "authored case not flagship T4", "5 arms and 40 protected tasks frozen", "0 natural incidents", "13 integration mutations reject", "support effect none"],
