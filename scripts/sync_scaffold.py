...
| Project Theseus generation-mode import validation | `python3 scripts/validate_theseus_generation_mode_import.py` | Checks a public-safe static Project Theseus generation-mode gate import with 18 modes, 13 comparisons, zero hard gaps, zero promotable comparisons, pinned source/report/tool digests, and expected-invalid controls for private-payload copying, support-promotion overclaim, raw-speed promotion, and useful-speed overclaim. | Passing this check proves only the imported report-boundary discipline and negative promotion decision; it does not rerun Theseus, prove generation speed, prove useful-solution-per-second improvement, prove model quality, or promote chapter support states. |
