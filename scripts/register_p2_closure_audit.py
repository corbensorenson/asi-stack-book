    ...
    value["units"].append(
        {
            ...
            "output_assertions": [
                ...
                "324 current targets comprise 304 implemented and 20 planned, including the consumer-owned Failure Modes, Governed Operations, Learned Objective Integrity, Observation Trust, Search Substrate, Artifact Steward, and Human-AI Organizations refinements",
