    ...
    value["units"].append(
        {
            ...
            "output_assertions": [
                ...
                "323 current targets comprise 298 implemented and 25 planned, including the consumer-owned Failure Modes, Governed Operations, and Learned Objective Integrity lifecycle refinements",
