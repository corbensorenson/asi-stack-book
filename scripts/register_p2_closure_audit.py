    ...
    value["units"].append(
        {
            ...
            "output_assertions": [
                ...
                "324 current targets comprise 313 implemented and 11 planned, including the consumer-owned Failure Modes, Governed Operations, Learned Objective Integrity, Observation Trust, Search Substrate, Artifact Steward, Human-AI Organizations, Multi-Agent Dynamics, Embodied Physical Safety, Dangerous Capability Review, Military Interaction Review, Open-Weight Release Review, Communication Influence Review, Objective Lease Governance, Adversarial Model Security, and Protected Computation Review refinements",
