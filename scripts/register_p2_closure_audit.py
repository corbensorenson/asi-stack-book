    ...
    value["units"].append(
        {
            ...
            "output_assertions": [
                ...
                "324 current targets comprise 300 implemented and 24 planned, including the consumer-owned Failure Modes, Governed Operations, Learned Objective Integrity, and Observation Trust refinements",
