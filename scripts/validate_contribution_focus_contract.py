...
def main() -> None:
    ...
    if len(ids) != 59 or len(set(ids)) != 59:
        errors.append("chapter focus map must contain 59 unique manifest chapters")
    ...
    expected_summary = {
        ...
        "supporting_or_integration_count": 48,
    ...
    for phrase in (
        ...
        "all 59 manifest chapters",
        "Eleven are primary owners",
        "other 48 are supporting or integration chapters",
        "not novelty proof",
    ):
    ...
    fail(errors)
    print("Contribution focus validation passed: 3 contributions, 59 unique chapter assignments, 11 primary owners, 48 supporting/integration roles, 0 independent chapter flagships.")
