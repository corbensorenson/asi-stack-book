...
def main() -> None:
    ...
    if len(ids) != 55 or len(set(ids)) != 55:
        errors.append("chapter focus map must contain 55 unique manifest chapters")
    ...
    expected_summary = {
        ...
        "supporting_or_integration_count": 44,
    ...
    for phrase in (
        ...
        "other 44 are supporting or integration chapters",
        "not novelty proof",
    ):
    ...
    fail(errors)
    print("Contribution focus validation passed: 3 contributions, 55 unique chapter assignments, 11 primary owners, 44 supporting/integration roles, 0 independent chapter flagships.")
