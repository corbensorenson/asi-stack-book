...
def main() -> None:
    ...
    spec = {
        ...
        "input_contract": "One clean local-authority Project Theseus main snapshot, seven exact file digests, historical 123-artifact T0 package currentness comparison, explicit T0/T0A/T1 states, two fail-closed observation receipts, public-safety filter, and no outcome/support/release effect.",
        "input_artifacts": ARTIFACTS,
        "output_contract": "Reject source-authority drift, remote-divergence erasure, historical-package denominator shrinkage, stale-package currentness laundering, premature T0A/T1 progression, replay-failure erasure, protected-outcome invention, private copying, support promotion, or release promotion.",
        "output_assertions": [
            "clean d5b99128 local main authority",
            "53 commits ahead of origin/main disclosed",
            "T0 complete",
            "T0A active",
            "T1 blocked by T0A",
            "104 of 123 historical package artifacts unchanged",
            "19 changed and zero missing",
        ...
        "negative_control_cases": [
            ...
            "T0A marked complete",
            "T1 unblocked",
            "independent-replay failure erasure",
