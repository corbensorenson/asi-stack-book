...
def main() -> None:
    ...
    spec = {
        ...
        "input_contract": "One clean published Project Theseus main snapshot, nineteen exact file digests including the calibrated contract owner and rejecting tests, historical 123-artifact T0 package currentness comparison, explicit T0/T0A/T1 states, seven CPU/governance replay receipts, the fourteen-receipt accelerator denominator, one preserved exact guarded live-memory-reserve calibration stop, one latest exact no-child preflight stop at the corrected launch floor, one GREEN registry receipt, public-safety filter, and no outcome/support/release effect.",
        "input_artifacts": ARTIFACTS,
        "output_contract": "Reject source-authority drift, origin-main publication erasure, historical-package denominator shrinkage, stale-package currentness laundering, premature T0A/T1 progression, CPU or accelerator denominator drift, failed-shard erasure, prior calibration child-start erasure, latest preflight child-start or available-memory invention, prospective launch-floor regression, failed-receipt authority elevation, protected-outcome invention, private copying, support promotion, or release promotion.",
        "output_assertions": [
            "clean 9e545cf1 main authority published on origin/main",
            ...
            "the prior optimizer-matched attempt started and stopped below its declared live-memory reserve with zero swapout growth, and remains calibration-only evidence",
            "the latest exact guard observed 3874.8 MiB below the corrected 6144 MiB launch floor, so the child did not start and produced no result",
            "the preserved calibration binds the prospective 6144 MiB launch floor",
            "zero protected outcomes/support/release movement",
            "twenty rejecting mutations",
        ],
        ...
        "negative_control_cases": [
            ...
            "prior accelerator child-start erasure",
            "latest accelerator child-start invention",
            "latest available-memory invention",
