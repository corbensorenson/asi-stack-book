...
def main() -> None:
    ...
    spec = {
        ...
        "output_contract": "Reject source-authority drift, origin-main publication erasure, historical-package denominator shrinkage, stale-package currentness laundering, premature T0A/T1 progression, CPU or accelerator denominator drift, failed-shard erasure, child-start erasure, protected-outcome invention, private copying, support promotion, or release promotion.",
        "output_assertions": [
            "clean 24955417 main authority published on origin/main",
