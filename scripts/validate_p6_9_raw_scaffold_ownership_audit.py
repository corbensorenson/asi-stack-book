...
def errors(value: dict[str, Any]) -> list[str]:
    ...
    if (
        binding.get("raw_repeated_12_gram_count") != 925
        or binding.get("raw_maximum_chapter_spread") != 64
    ...
    for row in records:
        ...
        if (
            row.get("chapter_spread") != 64
            or len(chapter_ids) != 64
...
def main() -> None:
    ...
    mutations: list[tuple[str, Callable[[dict[str, Any]], None]]] = [
        ...
        ("raw spread", lambda item: item["w3_binding"].__setitem__("raw_maximum_chapter_spread", 63)),
