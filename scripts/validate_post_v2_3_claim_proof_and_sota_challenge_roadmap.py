...
def errors(data: dict) -> list[str]:
    ...
    expected_claim_ledger_contract = {
        "current_missing_or_changed_theorem_count":469,
        "current_missing_or_changed_target_count":249,
    ...
    expected_hive={"hive_model_path":"lean/AsiStackProofs/HiveLifecycleRefinement.lean","hive_dossier_path":HIVE_DOSSIER,"hive_consumer_path":HIVE_RECEIPT,"hive_result_path":HIVE_RESULT,"hive_state":"validated_finite_authored_policy_closure_lifecycle_not_distributed_useful_or_deployed","hive_admission_valid_count":2,"hive_admission_invalid_count":8,"hive_partition_valid_count":3,"hive_partition_invalid_count":6,"hive_reachable_stage_count":7,"hive_lean_theorem_count":31,"hive_trace_event_count":6,"hive_trace_composition_split_count":7,"hive_identity_field_count":13,"hive_identity_preservation_check_count":7,"hive_non_authority_preservation_check_count":7,"hive_terminal_rejection_count":6,"hive_route_case_count":47,"hive_mutation_rejection_count":144,"hive_retired_baseline_declaration_count":5,"hive_retained_legacy_theorem_count":21,"hive_dispatch_count":1,"hive_useful_outcome_count":1,"hive_recovery_count":1,"hive_support_state_effect":"none"}
    ...
    for key,value in {"lean_theorem_count":31,"reachable_stage_count":7,"trace_event_count":6,"trace_composition_split_count":7,"identity_field_count":13,"identity_preservation_check_count":7,"non_authority_preservation_check_count":7,"terminal_rejection_count":6,"route_case_count":47,"mutation_count":144,"mutation_rejection_count":144,"support_state_effect":"none"}.items():
    ...
    for key,value in {"stage_count":8,"lean_theorem_count":27,"trace_event_count":7,"trace_composition_split_count":8,"identity_field_count":9,"identity_preservation_check_count":8,"non_authority_preservation_check_count":8,"fallback_monotonicity_check_count":7,"terminal_rejection_count":8,"route_count":53,"reached_route_count":53,"route_case_count":53,"rejected_mutation_count":143,"fallback_route_reached":True,"exact_use_route_reached":True,"support_assignment_count":0,"external_effect_count":0}.items():
    ...
    for phrase in ["exact 27-theorem", "eight reachable stages", "eight prefix/suffix", "53 routes", "143/143", "22-field", "Support-state and external-effect authority remain exactly `none`"]:
