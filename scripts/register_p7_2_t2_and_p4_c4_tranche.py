...
UNITS = [
    ...
    },
    {
        ...
        "input_contract": "A frozen four-module data/update/weight/context cluster with 31 public targets and 62 theorem declarations.",
        ...
        "output_assertions": ["4 adequate modules", "31 public targets", "62 theorem declarations", "7 unlearning claim axes separated", "4 consumers pass", "12 mutations reject", "support effect none"],
