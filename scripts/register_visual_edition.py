...
BASE_ARTIFACTS = [
    ...
    "visual_edition/chapter_binding_revalidation.json",
    ...
    "scripts/reconcile_visual_chapter_bindings.py",
...
def main() -> None:
    ...
    registry["units"].append({
        ...
        "output_assertions": [
            ...
            "exact owner-authorized unlisted preview projection distinct from published-current state",
    ...
    registry["units"].append({
        ...
        "execution_tier": "pr",
        "validation_class": "publication_gate",
        "input_contract": "Current visual-edition manifest and chapter packets; owner-authorized YouTube preview bindings; canonical QMD chapters and landing page; publication, preview, and Quarto-embed lifecycle states.",
        "input_artifacts": [
            "visual_edition/manifest.json",
            "scripts/sync_visual_edition_embeds.py",
        ],
        "output_contract": "Reject a missing or stale managed YouTube embed/transcript block for published_current packets, a missing or stale explicitly labeled unlisted-preview block or landing-page roster for owner-authorized preview bindings, a managed block outside either state, or any unmanaged YouTube embed.",
        "output_assertions": [
            "no placeholder player before publication",
            "published player uses youtube-nocookie.com",
            "unlisted preview player is visibly labeled and never counted as published-current",
            "landing page lists every current preview in canonical order",
