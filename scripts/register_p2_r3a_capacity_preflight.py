...
ARTIFACTS = [
    ...
    "docs/p2_r3a_capacity_and_docker_preflight_2026_07_28.md",
    ...
    registry["units"].append(
        {
            ...
            "output_assertions": [
                ...
                "thirty mutations reject across three immutable receipts",
            ],
            ...
            "negative_controls": "three_receipt_validator_owned_floor_shortfall_entry_materialization_content_inference_support_command_queue_and_docker_knowledge_mutations",
