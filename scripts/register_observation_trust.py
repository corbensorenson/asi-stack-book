...
ARTIFACTS = [
    ...
    "tests/fixtures/proof_models/observation_trust.json",
...
def main() -> None:
    ...
    registry["units"].append({
        ...
        "input_contract": "The bounded pair-classification model, canonical lifecycle/common-cause fixture, seven-stage observation lifecycle, exact 32-theorem chapter proof boundary, generated proof manifest, and reviewed triage record.",
