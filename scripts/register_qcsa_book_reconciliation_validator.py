...
def main() -> None:
    ...
    unit.update({
        ...
        "input_contract": "The exact QCSA implementation/evaluation/vertical outcomes, ten non-core dispositions, nine core no-change decisions, nine existing chapter owners, source-versus-repository boundary, Appendix C overlay, evidence-plan overlay, non-aggregating quality vectors, eight residuals, changelog transaction, preserved 54-chapter/298-target historical baseline, current manifest/proof truth, and executed semantic-rationalization target migrations.",
        "input_artifacts": ARTIFACTS,
        "output_contract": "Validate that all nine existing owners expose the bounded mixed result and argument-state boundary; exact matched/resource/active-question negatives remain visible; five promote recommendations remain review inputs rather than automatic transitions; all vectors preserve internal validity and unestablished transfer; eight residuals remain; current proof status permits only later manifest admissions or explicitly ledger-authorized semantic-rationalization migrations; no QCSA chapter or core promotion exists; reject eighteen cross-surface mutations.",
        "output_assertions": ["nine existing chapter owners", "five bounded review candidates", "two narrowed claims", "two exact refutations", "one no-change transfer boundary", "eight explicit residuals", "84 core claims at argument", "only authorized proof-target migrations", "no automatic transition", "no new chapter", "eighteen rejecting mutations"],
