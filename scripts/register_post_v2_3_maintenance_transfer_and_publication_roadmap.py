...
def main() -> None:
    ...
    registry["units"].append({
        ...
        "input_contract": "Completed claim-proof predecessor; exact no-release terminal record; active unfinished-work successor; 3,745 canonical atoms; all 117 transition files and 115 accepted transitions; complete 25-direct/90-indirect claim identity graph; retrospective N0-N5 rehabilitation of all 90 accepted negative/no-change results; prospective P2 selection, natural development-corpus custody, fixed-denominator gold diagnosis, frozen replacement policy and resource ceiling, and deterministic metadata-only replacement queue; current proof-depth receipt; N0-N5 experiment-competence contract; stale main attestation boundary; X derivative disposition; and four public truth surfaces.",
        ...
        "negative_controls": "validator_owned_thirty_one_competence_identity_rehabilitation_surface_p2_gold_replacement_queue_resource_attestation_mutations",
        "negative_control_cases": ["false publication", "support laundering", "hosted-chat dependency", "private-review gate", "authority widening", "claim mapping erasure", "unresolved mapping regression", "natural empirical invention", "exploration promotion", "rehabilitation reopening", "broad-refutation weakening", "N3 invention", "broad-negative inference laundering", "surface language regression", "P2 selected-claim drift", "P2 premature heldout opening", "P2 development-final laundering", "P2 gold denominator shrink", "P2 N0 mechanism laundering", "P2 outcome-aware replacement", "P2 replacement queue state erased", "P2 replacement queue content leak", "P2 replacement queue repository reuse", "P2 resource premature pass", "P2 resource claim laundering", "false clean attestation", "branch permission", "N5 deletion", "false-negative rule deletion", "missing successor continuity", "stale predecessor"],
