...
def main() -> None:
    ...
    registry["units"].append({
        ...
        "output_assertions": ["P0 authority wait, P1/M1 complete, active P2/M2", "115 accepted transitions with 25 direct and 90 indirect identities resolved and zero unmapped", "90 accepted negative/no-change transitions classified as 1 N0, 15 N1, 74 N2, and 0 N3-N5", "81 current surfaces including 61 chapters reconciled", "zero broad or chapter-core negative inference", "P2 prospectively selected from five candidates", "1117-task post-snapshot corpus universe and 12-task development pool", "fixed P2 gold denominator fully dispositioned as 8 qualified and 4 N0 replacements", "62 verified arm logs and 8 attempts", "replacement policy and monitored resource ceiling frozen before draw", "metadata-only queue contains 30 unique repositories while candidate content remains unopened", "construct and resource gates pending with heldout closed", "Round 16 freezes new chapter admission behind P2 plus atom, current-reader, W3, White-Box, and governed optimizer-landscape integration gates", "all six semantic proof clusters terminal at bounded adequate scope", "N0-N5 competence contract", "current proof snapshot", "main-only stale attestation truth", "v2.3.0 latest public release", "X source current and historical platform draft stale", "no support or release effect", "seventy-three mutations reject"],
        ...
        "negative_controls": "validator_owned_seventy_three_competence_identity_rehabilitation_surface_p2_editorial_semantic_proof_optimizer_and_attestation_mutations",
