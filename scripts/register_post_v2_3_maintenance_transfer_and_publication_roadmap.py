...
ARTIFACTS = [
    ...
    "scripts/validate_governed_operations_control_contract.py",
...
def main() -> None:
    ...
    registry["units"].append({
        ...
        "input_contract": "Completed claim-proof predecessor; exact no-release terminal record; active unfinished-work successor; the current 87-chapter manifest and exact role partition; the adjudicated Pro full-book review and C0-C8 convergence amendment; exact concept-first exit receipt with eight packets, 26 prose/product anchors, and zero current roadmap-only remainder; the terminal six-chapter/thirty-atom R16-A organization packet; canonical atoms and all accepted transitions with complete direct/indirect claim identity; N0-N5 negative-result rehabilitation and experiment competence; prospective P2 and ASI-THESEUS-FLAGSHIP-01 natural-evidence custody; two bounded P5 reference slices, one retrospective natural happy path, one retrospective P5-U1 natural-defect route comparison, one prospectively frozen five-arm/forty-task P5 natural-service campaign with protected outcomes closed, and its exact authored implementation/instrument qualification with natural content still closed; current reader, proof, attestation, derivative, and public-truth surfaces.",
        ...
        "output_assertions": ["P0 authority wait, P1/M1 complete, active P2/M2", "R16-A terminal with six chapter reviews, thirty atoms, fourteen local mutations, Appendix C projection, and zero support movement", "W3 active over the current 87-chapter corpus", "115 accepted transitions with 25 direct and 90 indirect identities resolved against 4,112 canonical atoms and zero unmapped", "90 accepted negative/no-change transitions classified as 1 N0, 15 N1, 74 N2, and 0 N3-N5", "current chapter roles remain exactly reconciled", "C0-C8 convergence program and 26-unit narrative target", "concept-first exit receipt reconciles eight packets through 26 exact prose or product anchors with zero current roadmap-only remainder", "Phase 2 resumes through smallest consumed conclusions and natural evidence rather than proof volume", "three defended contribution families and one existing natural flagship", "twelve-property Governed Transition Calculus, eleven-stage developmental loop, eleven-component minimum trusted kernel, bounded liveness, and P0-P6 semantic proof depth", "no external-human prepublication gate", "zero broad or chapter-core negative inference", "P2 prospectively selected from five candidates", "1117-task post-snapshot corpus universe and 12-task development pool", "fixed P2 gold denominator fully dispositioned as 8 qualified and 4 N0 replacements", "62 verified arm logs and 8 attempts", "replacement policy and monitored resource ceiling frozen before draw", "metadata-only queue contains 30 unique repositories while candidate content remains unopened", "construct and resource gates pending with heldout closed", "all six semantic proof clusters terminal at bounded adequate scope", "P5 status binds two bounded slices, one retrospective natural happy path, one 12-case retrospective P5-U1 natural-defect replay, one prospectively frozen five-arm/forty-task natural-service campaign, and a 60-trial/213-process authored implementation qualification while all natural and protected content remains closed", "N0-N5 competence contract", "current proof snapshot", "main-only build-deploy-crawl attestation truth", "v2.3.0 latest public release", "X source current and historical platform draft stale", "no support or release effect"],
