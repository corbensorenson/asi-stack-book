...
def main() -> None:
    ...
    registry["units"].append({
        ...
        "negative_controls": "validator_owned_one_hundred_thirty_four_competence_identity_rehabilitation_surface_p2_p5_convergence_concept_first_role_editorial_semantic_proof_optimizer_and_attestation_mutations",
