...
def main() -> None:
    ...
    contract = {
        ...
        "output_assertions": ["26 Human Reader units", "87 owners routed once", "Units 1 and 2 plus Units 4 through 26 within their declared word targets", "independent maintained prose", "3 mutations reject", "support and release effects none"],
        "claim_scope": "Independent Human Reader manuscript structure and Units 1 and 2 plus Units 4 through 26 drafting completeness only.",
