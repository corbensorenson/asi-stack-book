...
DECISION_REVIEW_REQUIRED_FRAGMENTS = (
    "Current-state note, 2026-07-01",
    "the named retired public slugs have static historical HTML stubs",
...
ROADMAP_REQUIRED_FRAGMENTS = (
    "Keep the 44-chapter spine stable.",
    "The consolidation problem is mostly executed",
    "ten retired public slugs have historical HTML stubs",
    "Retired URL preservation is now an operating guard",
    "Milestone 6.5 is dormant",
    "one flagship measured lane",
