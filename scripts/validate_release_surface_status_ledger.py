...
def collect_metrics() -> tuple[dict[str, Any], list[str]]:
    ...
    expected_audio_metadata = {
        ...
        "source_audio_script_sha256": "cd7c39c3a8d6a775db3876e7c81beec3923651ca9fbdcdddb2eb764ff2c6354d",
        "script_files_checked": 49,
        "chapter_scripts_checked": 44,
        "chapter_marker_rows": 49,
    ...
    expected_audio_metadata_fields = {
        ...
        "script_digest": "cd7c39c3a8d6a775db3876e7c81beec3923651ca9fbdcdddb2eb764ff2c6354d",
    }
