# Model-adequacy dossier: readiness refinement

## Decision

Adequate for one finite authored candidate-to-terminal readiness lifecycle and typed failure routes. Inadequate for evaluator adequacy, gate calibration, natural usefulness, effect-complete rollback, production quarantine, or transfer.
...
The model trusts authored identifiers, booleans, digests, evaluator and outcome records, quarantine propagation, revocation closure, and acknowledgments. It does not prove that evidence is true, evaluators are independent or competent, thresholds are calibrated, rollback reverses effects, quarantine propagates in a live graph, terminal closure is externally complete, or any substrate is useful or safe. Support-state effect: exactly `none`.
