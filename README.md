...
Fast audit path: [docs/v1_0_candidate_status.md](docs/v1_0_candidate_status.md), [docs/non_core_evidence_ledger.md](docs/non_core_evidence_ledger.md), [docs/contribution_novelty_ledger.md](docs/contribution_novelty_ledger.md), Appendix C, Appendix G, Appendix H, [docs/reader_continuity_audit.md](docs/reader_continuity_audit.md), and [docs/v1_x_beyond_sota_roadmap.md](docs/v1_x_beyond_sota_roadmap.md). The landing-page and README trust contract is guarded by `scripts/validate_trust_surface.py`.
