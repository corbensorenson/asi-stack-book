...
The three projections share one source of truth but have different density and review contracts; see [docs/product_contracts.md](docs/product_contracts.md) and [docs/product_projection_artifacts.md](docs/product_projection_artifacts.md). The completed v2 program is preserved in the [ASI Stack Completion Roadmap](docs/asi_stack_completion_roadmap.md); current work is governed by the [Post-v2 Evidence Roadmap](docs/post_v2_evidence_roadmap.md).
...
Fast audit path: [the Post-v2 Evidence Roadmap](docs/post_v2_evidence_roadmap.md), [the v2.0.0 completion declaration](docs/v2_0_completion_declaration.md), [the completed v2 roadmap](docs/asi_stack_completion_roadmap.md), [the completion evidence ledger](docs/asi_stack_completion_ledger.md), [docs/core_claim_disposition_ledger.md](docs/core_claim_disposition_ledger.md), [docs/evidence_quality_vectors.md](docs/evidence_quality_vectors.md), [docs/non_core_evidence_ledger.md](docs/non_core_evidence_ledger.md), [docs/contribution_novelty_ledger.md](docs/contribution_novelty_ledger.md), Appendix C, Appendix G, Appendix H, and [docs/reader_continuity_audit.md](docs/reader_continuity_audit.md). The landing-page and README trust contract is guarded by `scripts/validate_trust_surface.py`.

## Current Status

`v2.0.0` is the completed canonical live/research HTML release. Annotated tag `v2.0.0`, source commit `52e54b71681f3d04644a4142875718d7b55f6dbd`, the clean CI-tested bundle, deployed site, immutable site archive, public SHA-256, release record, citation metadata, and tag-bound rights snapshot identify the same release state. The historical `v1.0.0` source release remains intact and truthfully has no backfilled rendered-site archive. EPUB/DOCX/PDF/audio and the divergent historical curated-reader workspace are explicitly outside the v2.0.0 format scope. No chapter-core support state is promoted.
