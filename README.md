...
Fast audit path: [the active Post-v2.2 Implementation and Book Completion Roadmap](docs/post_v2_2_implementation_completion_roadmap.md), its machine [status record](roadmap_records/post_v2_2_implementation_completion_status.json), [the v2.2.0 completion declaration](docs/v2_2_completion_declaration.md), [the completed Post-v2.1 Residual and Transfer Roadmap](docs/post_v2_1_residual_and_transfer_roadmap.md), [docs/core_claim_disposition_ledger.md](docs/core_claim_disposition_ledger.md), [docs/evidence_quality_vectors.md](docs/evidence_quality_vectors.md), [docs/non_core_evidence_ledger.md](docs/non_core_evidence_ledger.md), Appendix C, Appendix G, and Appendix H. The landing-page and README trust contract is guarded by `scripts/validate_trust_surface.py`.

## Current Status

`v2.2.0` is the latest completed immutable canonical live/research HTML release, bound to tag `v2.2.0`, source commit `e3d5348993cc5083604c85bd699bb0e36eb00de1`, and archive SHA-256 `037563bc62792ecd968cf923b94e3082b02597f1b97f81b63fa59c6d083ee2db`. The active post-v2.2 cycle is implementation work, not a later immutable release: it begins with twelve bounded QCSA artifact lanes and a governed vertical reference path. At activation all 54 chapter-core claims remain at `argument`; no new chapter, optional format, implementation result, or support promotion is claimed. Historical `v1.0.0`, `v2.0.0`, and `v2.1.0` releases remain intact. The root site and `/latest/` are mutable. EPUB/DOCX/PDF/audio and the divergent historical curated-reader workspace remain outside scope.
