...
| [docs/non_core_evidence_ledger.md](docs/non_core_evidence_ledger.md) | Public ledger for 20 accepted non-core upward evidence transitions, 57 accepted `blocks_promotion` no-promotion side-lane decisions, two exact QCSA refutations, one historical count-surface narrowing record, and their no-chapter-core-promotion boundary. |
