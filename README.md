...
| [docs/non_core_evidence_ledger.md](docs/non_core_evidence_ledger.md) | Public ledger for the six accepted non-core upward evidence transitions, 29 accepted `blocks_promotion` no-promotion side-lane decisions, one count-surface narrowing record, and their no-chapter-core-promotion boundary. |
