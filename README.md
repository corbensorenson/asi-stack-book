...
- `scripts/validate_source_appendices.py` checks that Appendix G is only the Corben-authored, Corben-supplied, and local project source corpus, while Appendix H is a separate external-source appendix generated from `sources/source_inventory.json`.
