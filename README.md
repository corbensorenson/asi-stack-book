...
The three projections share one source of truth but have different density and review contracts; see [docs/product_contracts.md](docs/product_contracts.md) and [docs/product_projection_artifacts.md](docs/product_projection_artifacts.md). The canonical finish line and execution order are in the [ASI Stack Completion Roadmap](docs/asi_stack_completion_roadmap.md).
...
Fast audit path: [the v2.0.0 completion declaration](docs/v2_0_completion_declaration.md), [the canonical completion roadmap](docs/asi_stack_completion_roadmap.md), [the completion evidence ledger](docs/asi_stack_completion_ledger.md), [docs/core_claim_disposition_ledger.md](docs/core_claim_disposition_ledger.md), [docs/evidence_quality_vectors.md](docs/evidence_quality_vectors.md), [docs/non_core_evidence_ledger.md](docs/non_core_evidence_ledger.md), [docs/contribution_novelty_ledger.md](docs/contribution_novelty_ledger.md), Appendix C, Appendix G, Appendix H, and [docs/reader_continuity_audit.md](docs/reader_continuity_audit.md). The landing-page and README trust contract is guarded by `scripts/validate_trust_surface.py`.
