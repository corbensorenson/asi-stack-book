...
| [docs/evidence_laundering_prevention_case_studies.md](docs/evidence_laundering_prevention_case_studies.md) | No-promotion case studies for evidence-laundering prevention; records the remaining live demotion/refutation gap. |
