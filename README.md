...
The three projections share one source of truth but have different density and review contracts; see [docs/product_contracts.md](docs/product_contracts.md) and [docs/product_projection_artifacts.md](docs/product_projection_artifacts.md). The v2, v2.1, post-v2.1, [Post-v2.2 Implementation and Book Completion Roadmap](docs/post_v2_2_implementation_completion_roadmap.md), and [Post-v2.3 Quality Floor and Reader Completion Roadmap](docs/post_v2_3_quality_floor_and_reader_completion_roadmap.md) programs are complete. The post-v2.2 terminal state remains at [roadmap_records/post_v2_2_implementation_completion_status.json](roadmap_records/post_v2_2_implementation_completion_status.json). The post-v2.3 machine [status record](roadmap_records/post_v2_3_quality_floor_and_reader_completion_status.json) closes P0–P5 and M0–M9 after ten chapter-depth packets, owned formal coverage, a released exact local 54-chapter reader successor, complete evidence adjudication, two preserved protocol-failure campaigns, and an honest [no-public-release decision](release_records/2026-07-13-post-v2-3-quality-reader-cycle-no-public-release.json). The [Post-v2.3 Clean Handoff, Reader Formats, and Evidence Renewal Roadmap](docs/post_v2_3_handoff_reader_formats_and_evidence_renewal_roadmap.md) is the active canonical successor roadmap, with machine state in [roadmap_records/post_v2_3_handoff_reader_formats_and_evidence_renewal_status.json](roadmap_records/post_v2_3_handoff_reader_formats_and_evidence_renewal_status.json), and all 54 chapter-core claims remain at `argument`.
...
| [docs/non_core_evidence_ledger.md](docs/non_core_evidence_ledger.md) | Public ledger for 19 accepted non-core upward evidence transitions, 56 accepted `blocks_promotion` no-promotion side-lane decisions, two exact QCSA refutations, one historical count-surface narrowing record, and their no-chapter-core-promotion boundary. |
