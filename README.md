...
- `scripts/validate_support_state_transitions.py`, `scripts/validate_authority_transitions.py`, `scripts/validate_plan_execution_contracts.py`, and `scripts/validate_context_admission_adequacy.py` run synthetic gate harnesses for support-state conservatism, authority non-escalation, plan/contract/job consistency, and context admission/adequacy consistency; they are executable behavior checks over fixtures, not claim promotions or deployed-runtime evidence.
