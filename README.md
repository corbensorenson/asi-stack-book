...
Fast audit path: [the canonical completion roadmap](docs/asi_stack_completion_roadmap.md), [docs/v1_0_candidate_status.md](docs/v1_0_candidate_status.md), [docs/core_claim_disposition_ledger.md](docs/core_claim_disposition_ledger.md), [docs/evidence_quality_vectors.md](docs/evidence_quality_vectors.md), [docs/non_core_evidence_ledger.md](docs/non_core_evidence_ledger.md), [docs/contribution_novelty_ledger.md](docs/contribution_novelty_ledger.md), Appendix C, Appendix G, Appendix H, and [docs/reader_continuity_audit.md](docs/reader_continuity_audit.md). The landing-page and README trust contract is guarded by `scripts/validate_trust_surface.py`.
