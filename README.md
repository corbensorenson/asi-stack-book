...
The three projections share one source of truth but have different density and review contracts; see [docs/product_contracts.md](docs/product_contracts.md) and [docs/product_projection_artifacts.md](docs/product_projection_artifacts.md). The v2, v2.1, post-v2.1, and [Post-v2.2 Implementation and Book Completion Roadmap](docs/post_v2_2_implementation_completion_roadmap.md) programs are complete. Its machine [status record](roadmap_records/post_v2_2_implementation_completion_status.json) binds P0–P5 and M0–M7 to immutable `v2.3.0`; there is no active successor roadmap. The `v2.2.0` predecessor remains immutable history.
...
Fast audit path: [the completed Post-v2.2 Implementation and Book Completion Roadmap](docs/post_v2_2_implementation_completion_roadmap.md), its machine [status record](roadmap_records/post_v2_2_implementation_completion_status.json), [the v2.3.0 completion declaration](docs/v2_3_completion_declaration.md), [the exact release record](release_records/2026-07-13-v2.3.0-qcsa-e2766116.json), [the QCSA implementation/evidence reconciliation](docs/qcsa_implementation_evidence_reconciliation.md), [the exact evaluation report](docs/qcsa_reference_evaluation_report.md), [the governed vertical report](docs/qcsa_governed_vertical_reference_report.md), [the completed Post-v2.1 Residual and Transfer Roadmap](docs/post_v2_1_residual_and_transfer_roadmap.md), [docs/core_claim_disposition_ledger.md](docs/core_claim_disposition_ledger.md), [docs/evidence_quality_vectors.md](docs/evidence_quality_vectors.md), [docs/non_core_evidence_ledger.md](docs/non_core_evidence_ledger.md), Appendix C, Appendix G, and Appendix H. The landing-page and README trust contract is guarded by `scripts/validate_trust_surface.py`.

## Current Status

`v2.3.0` is the latest completed immutable canonical live/research HTML release, bound to tag `v2.3.0`, source commit `e27661166e9105f37cb36d63b15795f80715ca24`, hosted build/deploy runs `29234323320` and `29234640734`, and archive SHA-256 `ebb3cccb0841a15a49d7d20ee8d5c7f7dce97dac562ca05068025951274ee28c`. Its exact QCSA result is mixed: matched task advantage and resource gates failed, active-question value was refuted on the frozen corpus, five mechanism findings await ordinary bounded evidence-transition review, and all 54 chapter-core claims remain at `argument`. P5 and M7 are complete; no new chapter, optional format, or successor roadmap is approved. Historical `v1.0.0`, `v2.0.0`, `v2.1.0`, and `v2.2.0` releases remain intact. The root site and `/latest/` are mutable.
