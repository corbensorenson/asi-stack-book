...
Fast audit path: [the active Post-v2.2 Implementation and Book Completion Roadmap](docs/post_v2_2_implementation_completion_roadmap.md), its machine [status record](roadmap_records/post_v2_2_implementation_completion_status.json), [the QCSA implementation/evidence reconciliation](docs/qcsa_implementation_evidence_reconciliation.md), [the exact evaluation report](docs/qcsa_reference_evaluation_report.md), [the governed vertical report](docs/qcsa_governed_vertical_reference_report.md), [the v2.2.0 completion declaration](docs/v2_2_completion_declaration.md), [the completed Post-v2.1 Residual and Transfer Roadmap](docs/post_v2_1_residual_and_transfer_roadmap.md), [docs/core_claim_disposition_ledger.md](docs/core_claim_disposition_ledger.md), [docs/evidence_quality_vectors.md](docs/evidence_quality_vectors.md), [docs/non_core_evidence_ledger.md](docs/non_core_evidence_ledger.md), Appendix C, Appendix G, and Appendix H. The landing-page and README trust contract is guarded by `scripts/validate_trust_surface.py`.

## Current Status

`v2.2.0` is the latest completed immutable canonical live/research HTML release, bound to tag `v2.2.0`, source commit `e3d5348993cc5083604c85bd699bb0e36eb00de1`, and archive SHA-256 `037563bc62792ecd968cf923b94e3082b02597f1b97f81b63fa59c6d083ee2db`. The active post-v2.2 cycle has completed implementation, evaluation, the 13-stage governed vertical path, and book/evidence reconciliation. Its exact result is mixed: matched task advantage and resource gates failed, active-question value was refuted on the frozen corpus, five mechanism findings await ordinary bounded evidence-transition review, and all 54 chapter-core claims remain at `argument`. P5 is selecting canonical HTML-only `v2.3.0`; until that transaction finishes, it is a candidate rather than an immutable release. No new chapter or optional format is approved. Historical `v1.0.0`, `v2.0.0`, and `v2.1.0` releases remain intact. The root site and `/latest/` are mutable.
