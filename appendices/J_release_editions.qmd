...
| `evidence_matrices` | Appendices, source notes, schemas, release records, proof manifest, test specs, the Corben source corpus, external literature, implementation horizons, changelog, and lineage. | Retain for live/research releases; include selected human-useful appendices in reader releases. |
...
It keeps the main argument, diagrams, problem statements, mechanisms, interfaces, invariants, failure modes, minimal implementation discussion, summaries, glossary, Corben source-corpus path, and separate external-literature path. The result should read as a book while still preserving uncertainty in the prose itself.
