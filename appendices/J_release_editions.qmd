...
| `curated_reader_blocked_candidate` | `release_records/2026-07-04-v1-curated-reader-blocked-5dc1cd46.json` and `scripts/validate_curated_reader_blocked_release_record.py`. | Records exact current curated-reader local HTML, EPUB, DOCX, PDF, e-reader, and audio blockers as a partial candidate; it does not approve or publish artifacts. |
