...
| `curated_reader_blocked_candidate` | `release_records/2026-07-05-v1-curated-reader-blocked-d81d505a.json` and `scripts/validate_curated_reader_blocked_release_record.py`. | Records exact current curated-reader local HTML, EPUB, DOCX, PDF, e-reader, and audio blockers as a partial candidate; it does not approve or publish artifacts. |
...
horizons, 5 table treatment notes, 50 Mermaid diagram notes, 11 image notes,
and all MP3/M4B/audio-embedded EPUB targets still marked
