...
This record turns future-source and missing-evidence management into a reviewable backlog item. It records triage state, access state, chapter action policy, boundary-decision rationale, source-note state, claim mapping, passage-level review state, external literature work, proof/test backlog, evidence-transition preconditions, insertion decision, source refs, support-state effect, residuals, next action, and non-claims.
