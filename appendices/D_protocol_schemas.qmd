...
This record separates cyclic adapter, RoPE, phase-bank, and mixer structural facts from quality, runtime, memory, context-length, and deployment claims, while requiring workload target, receipt refs, hardware refusal path, baseline symmetry, negative controls, resource costs, metrics status, tradeoff packet refs, consumer policy, and adoption rationale before adoption.
