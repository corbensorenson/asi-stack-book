...
This record gives each stack layer a bounded lifecycle state, owner, responsibility, input/output surface, authority ceiling, handoff protocol, contract refs, change policy, invariant set, failure model, evidence gate, downstream interface, source refs, support-state effect, and explicit non-claims.
