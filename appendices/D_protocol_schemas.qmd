...
This record describes a compact generative core without hiding the work it exports to generation, correction, verification, governance, fallback, human review, residual correction, authority review, promotion decisions, or retirement.
...
This record makes support-state movement reviewable. It names the claim, prior and candidate support states, transition effect, scope boundary, evidence roles, required artifacts, verifier command/result, negative results, downgrade triggers, promotion burden, limitations, reviewer independence, changelog ref, non-claims, and review state before a claim can move.
