...
This record separates a durable semantic capability boundary from replaceable implementations, while keeping field version, owner, authority, qualification lease, evaluator policy, evaluator independence, route validity, route permission effect, consumer policy, readiness gates, source refs, support-state effect, evidence, incidents, review triggers, regression, migration, rollback obligations, and non-claims visible.
