...
This record makes support-state movement reviewable. It names the claim, claim surface refs, prior and candidate support states, transition effect, scope boundary, evidence roles, required artifacts, artifact refs, evidence packets, source mappings, verifier command/result, negative results, negative evidence refs, downgrade triggers, promotion burden, limitations, reviewer independence, changelog ref, support-state effect, non-claims, and review state before a claim can move.
