...
This record is the stable ABI between planning, durable memory, context compilation, execution, and audit. It distinguishes request validity, resolution validity, materialization validity, admission, adequacy, support boundary, lease expiry, residuals, and typed faults.
...
This record is the small unit of cognitive compilation: one preserved intent fragment with source-plan refs, obligation refs, inputs, outputs, constraints, dependencies, assumptions, authority requirements, validator status, target artifact, lowering receipt, bounded repair target, residuals, and non-claims.
