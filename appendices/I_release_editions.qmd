...
The generated reader workspace includes `reader_manifest.json` with the source profile, target formats, content-layer policy, stripped-heading policy, removed section counts, review requirement, and non-claims. It does not imply that EPUB, PDF, DOCX, or HTML artifacts have been rendered.
...
The generated audio workspace includes `audio_manifest.json` with the source reader generation summary, audio profile, content-layer policy, script files, pronunciation glossary, review status, and non-claims.
