...
The live-site `Human view` uses the same strip-heading list at render time. `scripts/validate_reading_mode_toggle.py` checks that the toggle asset and generated Quarto config stay aligned with `reader_release.strip_headings`.
