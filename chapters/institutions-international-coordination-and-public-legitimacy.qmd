...
Institutions can authorize and coordinate rules, but they do not make society
robust to actors that evade them. **Societal Resilience and Misuse Defense**
follows by receiving jurisdiction, standing, public mandate, independent-
access rules, enforcement gaps, cross-border commitments, affected
populations, and remedy obligations. It must build prevention, detection,
response, recovery, and adaptation around those constraints without inheriting
a claim that the institution is legitimate, the commitment is effective, or
the exposed population is protected.
