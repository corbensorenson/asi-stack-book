...
The first half of Part I builds the safety frame. This chapter begins the operational path from human purpose into the stack. It asks how a request becomes a contract without letting ambiguity become permission.

The human point is that intent is not merely text. It includes requirements, constraints, assumptions, stop conditions, approvals, and unresolved questions. A governed system should preserve those pieces before planning or execution tries to be helpful, because the first loss of alignment often happens when a useful interpretation quietly becomes the authorized one.
:::
...
The operational contract is that human intent enters as a structured agreement, not a prompt-shaped wish: goals, constraints, authority, artifacts, evidence requirements, ambiguities, and stop conditions travel together. A mature implementation would make that contract visible through:
