...
The first half of Part I builds the safety frame. This chapter begins the operational path from a human purpose into the stack. It asks how a request becomes a contract without letting ambiguity become permission.

The human point is that intent is not merely text. It includes requirements, constraints, assumptions, stop conditions, approvals, and unresolved questions. A governed system should preserve those pieces before planning or execution tries to be helpful.
:::
