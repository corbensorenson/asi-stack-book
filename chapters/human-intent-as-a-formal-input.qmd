...
open_evidence_gaps:
  - "The core claim now has exact source-note mappings for all assigned sources in Appendix C; natural-language parsing and end-to-end lowering evidence remain incomplete."
...
The claim remains at `argument` support. VIEA supplies the intent-to-execution contract spine; Software Magic Grimoire, PlanForge, Cognitive Compilation, and Talos supply command, plan, semantic-IR, and job-lowering vocabulary. None of that source context authorizes hidden execution or proves natural-language intent parsing is solved.

### Claim-source mapping status

Appendix C now maps this core intent claim to all assigned source notes. The mappings support the contract boundary for intent, not a solved parser or autonomous execution permission.
...
The crosswalk names the source family for intent contracts. It does not promote any claim until exact source mappings, parser tests, or proof artifacts exist.
