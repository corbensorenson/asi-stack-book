...
open_evidence_gaps:
  ...
  - "The intent_contract fixture validates schema/example consistency only; ambiguity parsing, authority extraction, and stop-condition preservation tests remain unimplemented."
...
| Test state | `intent_contract.valid.json` passes protocol fixture validation; ambiguity parsing, authority extraction, and stop-condition preservation tests remain planned. |
...
These proof targets remain planned. The current executable surface is the intent contract schema and fixture; compiling intent into jobs still needs tests or formal predicates.
