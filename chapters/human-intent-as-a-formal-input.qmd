...
| Test state | `intent_contract.valid.json` passes protocol fixture validation; `AsiStackProofs.IntentContracts` implements finite preservation, missing-authority, and intent-resolution route predicates; ambiguity parsing, authority extraction, and end-to-end stop-condition preservation tests remain planned. |
