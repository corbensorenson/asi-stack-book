...
This is the stack's narrow waist for action. A plan can be brilliant and a job can be well typed, but external effect still needs an authority envelope, approval scope, effect lease, pre/post state, incident path, and residual record.
:::
