...
| Exact accepted transitions in this chapter | `v1_0_pilot.runtime_adapters.no_change` |
...
- **Failure or non-promotion case:** 77 atoms
...
|---|---:|---|---|
| Core: `runtime-adapters-tool-permissions-and-human-approval.core` | 1 | `source-synthesis` | `blocked_after_full_attempt`; missing or unproved: `causal`, `empirical`, `executable`, `formal`, `normative`, `transfer`. |
| blocked after full attempt | 77 | `source-synthesis` | Missing or unproved lanes across this set: `causal`, `empirical`, `executable`, `formal`, `normative`, `transfer`. These are residual proof obligations, not false claims. |
