...
This lease-bound action surface remains a target architecture, not a current-result claim. Support should stay at `argument` until adapter harnesses, sandbox checks, approval workflows, secret-handle tests, rollback records, and effect-receipt validation show that the stack can use tools without giving cognition ambient power over the world.
