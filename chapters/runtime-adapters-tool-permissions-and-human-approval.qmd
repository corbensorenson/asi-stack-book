...
open_evidence_gaps:
  ...
  - "Protocol schema/fixture validation, finite Lean permission, approval, effect-lease, rollback-obligation, authority-ceiling, confused-deputy, sandbox-escape, effect-receipt, dispatch-route, effect-replay, adversarial-boundary, revocation-route, and human-oversight degradation predicates, Runtime Adapters negative-case theorems, a synthetic runtime-adapter permission harness, a public-safe Runtime adapter effect replay probe, a deterministic Runtime adapter adversarial boundary probe, and a deterministic Human oversight degradation fixture are implemented; the effect probe performs one generated temp-file write, the adversarial probe covers two valid synthetic adapter boundary reviews plus twelve expected-invalid controls, and the oversight fixture covers three valid finite records plus seven expected-invalid controls for approval fatigue, rubber-stamping, alarm fatigue, automation bias, missing reviewer qualification, support-state promotion, and non-claim boundaries. No deployed adapter execution, real sandbox, approval service, secret-handle mediation, revocation propagation, policy-enforcement correctness, rollback service, reviewer-correctness result, deployed human-factors result, or security review has been run for this chapter."
...
The source set anchors the effects boundary: authority handles, approval gates, tool permissions, operator-visible control surfaces, and human oversight degradation. Five Google Docs raw-cache sources, two local public-project sources, and four external human-factors comparators now have passage-reviewed Appendix C mappings. `moecot` remains connector/source-note mapped until runtime artifacts, approval traces, sandbox records, benchmark/replay logs, or external corroboration are imported and inspected. The crosswalk does not claim safe tool execution, reviewer correctness, or deployed approval-service behavior has been demonstrated here.
