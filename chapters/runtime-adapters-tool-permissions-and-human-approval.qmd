...
The `qcsa_whitepaper` supplies the contract and attack vocabulary, not runtime
enforcement evidence. It does not establish permission correctness, human
approval quality, effect safety, rollback, or recovery, and the conservative
evidence disposition remains unchanged.
