...
open_evidence_gaps:
  ...
  - "Protocol schema/fixture validation, finite Lean permission, approval, effect-lease, rollback-obligation, authority-ceiling, confused-deputy, sandbox-escape, effect-receipt, dispatch-route, and effect-replay predicates, Runtime Adapters negative-case theorems, a synthetic runtime-adapter permission harness, and a public-safe Runtime adapter effect replay probe are implemented; the effect probe performs one generated temp-file write, records pre/post/rollback hashes, checks rollback-exact restoration, and denies missing-permission plus expired-approval no-mutation controls. No deployed adapter execution, real sandbox, approval service, secret-handle mediation, revocation propagation, policy-enforcement correctness, rollback service, or security review has been run for this chapter."
...
Fixture-shape validation, twenty-four bounded Lean theorem declarations over finite permission, approval, effect-lease, rollback-obligation, authority-ceiling, confused-deputy, sandbox-escape, effect-receipt, dispatch-route, and effect-replay predicates, the synthetic runtime-adapter permission harness, and one public-safe temp-file Runtime adapter effect replay probe are implemented. The remaining tests require a deployed adapter harness, real sandbox isolation, parent job permission lookup against real jobs, high-impact classification against policy, live approval decisions, live effect receipts, rollback execution in target services, deployed revocation propagation, and secret-handle safety checks.
