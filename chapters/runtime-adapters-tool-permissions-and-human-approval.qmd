...
open_evidence_gaps:
  ...
  - "Protocol schema/fixture validation, finite Lean permission, approval, effect-lease, rollback-obligation, authority-ceiling, confused-deputy, sandbox-escape, effect-receipt, and dispatch-route predicates, Runtime Adapters negative-case theorems, and a synthetic runtime-adapter permission harness are implemented; the fixture now records invocation state, impact class, risk tier, approval scope/expiry, effect lease, pre/post state refs, external side effects, verification refs, irreversible residuals, incident/audit refs, support-state effect, and non-claims. No deployed adapter execution, sandbox, approval-service, rollback execution, or secret-handle safety test has been run for this chapter."
...
| Test state | Runtime adapter fixture validation now includes invocation state, impact class, risk tier, approval scope/expiry, effect lease, pre/post state refs, external side effects, verification refs, irreversible residuals, incident/audit refs, support-state effect, and non-claims; finite permission, approval, effect-lease, rollback-obligation, authority-ceiling, confused-deputy, sandbox-escape, effect-receipt, and dispatch-route predicates plus negative-case theorems are implemented in `AsiStackProofs.RuntimeAdapters` for missing parent-job permission, high-impact unapproved adapter calls that try to remain unrejected, missing scoped approval, mismatched effect leases, expired leases, unsandboxed leases, over-ceiling requested authority, confused-deputy attempts, sandbox-escape attempts, high-impact rollback-required calls without rollback handles, and missing effect receipts; `python3 scripts/validate_runtime_adapter_permissions.py` checks synthetic typed-job, adapter-invocation, and authority-use-receipt consistency for permissions, approval gates, expiry markers, receipts, rollback handles, irreversible residuals, and authority receipt alignment. Deployed adapter execution, sandbox isolation, approval-service behavior, rollback execution, and secret-handle safety remain untested. |

## Drafting guardrail

This chapter treats runtime adapters as effect-boundary records, not as proof that tools were safely executed. The repo validates an adapter-invocation fixture and now proves finite permission, approval, effect-lease, rollback-obligation, authority-ceiling, confused-deputy, sandbox-escape, effect-receipt, and dispatch-route predicates with negative cases for missing parent permission, high-impact approval bypass, missing scoped approval, mismatched leases, expired leases, unsandboxed leases, over-ceiling requested authority, confused-deputy attempts, sandbox-escape attempts, missing rollback handles, and missing effect receipts. Seven assigned source mappings have passage-reviewed refs, while `moecot` remains connector/source-note mapped. The fixture does not call a tool, inject a secret, enforce a live approval service, enforce a sandbox, or produce a real rollback handle.
...
The runtime-adapter fixture checks the invocation envelope. `AsiStackProofs.RuntimeAdapters` adds bounded permission and approval predicates showing that a valid invocation requires the parent job permission list to include the adapter capability and that a high-impact unapproved invocation is rejected. It now also models effect leases, rollback obligations, and a finite adapter route: a leased invocation must use an active lease scoped to the requested capability and marked sandboxed; mismatched, expired, or unsandboxed leases cannot validate the invocation; over-ceiling requested authority is denied; confused-deputy and sandbox-escape attempts are rejected; high-impact rollback-required invocations without recorded rollback handles request rollback evidence; missing receipt/audit/non-claim records block dispatch; and a complete low-impact reviewed invocation routes to dispatch. The synthetic runtime-adapter permission harness adds cross-record checks over typed jobs, adapter invocations, and authority-use receipts: valid fixtures cover low-impact local write and high-impact approved preview-deployment records, while expected-invalid fixtures reject missing permissions, high-impact approval bypass, expired approval, missing effect receipts, and irreversible effects without rollback or residual records. This is still fixture behavior, not tool execution, sandbox isolation, human approval workflow, secret-handle safety, effect receipt validity in a live adapter, or rollback execution.
...
Fixture-shape validation, seventeen bounded Lean theorem declarations over finite permission, approval, effect-lease, rollback-obligation, authority-ceiling, confused-deputy, sandbox-escape, effect-receipt, and dispatch-route predicates, and the synthetic runtime-adapter permission harness are implemented. The remaining tests require a deployed adapter harness, real sandbox isolation, parent job permission lookup against real jobs, high-impact classification against policy, live approval decisions, live effect receipts, rollback execution, and secret-handle safety checks.
