...
| Primary source records | `talos`, `viea`, `ladon_manhattan`, `software_magic_grimoire`, `genesiscode`, `moecot`, `field_of_god_ai_constitution`, `theseus_operator_os`, `ext_cap_theorem_gilbert_lynch_2002` |
| Claim label | Design rationale |
| Evidence level | argument |
| Source queue | primary: `talos`, `viea`; supporting: `ladon_manhattan`, `software_magic_grimoire`, `genesiscode`, `field_of_god_ai_constitution`, `theseus_operator_os`; external comparator: `ext_cap_theorem_gilbert_lynch_2002`; connector/recovery: `moecot` |
...
| Human oversight degradation fixture | Check three valid finite records and seven expected-invalid controls for approval fatigue, rubber-stamping, alarm fatigue, automation bias, reviewer qualification, support-state promotion, and non-claim boundaries. | implemented in `python3 scripts/validate_human_oversight_degradation.py`; deterministic synthetic record gate only |
