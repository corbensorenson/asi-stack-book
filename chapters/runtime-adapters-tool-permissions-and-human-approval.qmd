...
The rule is that real-world effects require explicit authority. Planning may propose action; only an authorized adapter may perform it. This pass tightened the evidence crosswalk but did not run an adapter. Once real effect traces accumulate, the system can ask which recurring patterns deserve to become procedural memory.
