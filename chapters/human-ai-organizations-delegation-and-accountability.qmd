...
`lean:human_ai_org.accountability_requires_authority` will reject an
accountability assignment when the authored organizational record lacks
information, competence, time, or intervention authority. It cannot establish
that those fields are true, complete, legitimate, lawful, or effective.
