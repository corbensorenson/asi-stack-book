...
open_evidence_gaps:
  - "The roadmap now distinguishes completed historical T0 from active successor T0A and keeps T1 blocked until a guarded replacement replay, current content-addressed freeze, and 84-chapter readiness rerun exist; the dependency correction is not phase completion or training evidence."
