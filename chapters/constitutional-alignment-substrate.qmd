...
open_evidence_gaps:
  ...
  - "Synthetic constitutional-alignment and agency-rights harnesses plus finite-record Lean theorems remain bounded record checks; runtime policy behavior, material rights usability under pressure, manipulation resistance, approval-service quality, and red-team evidence remain open."
...
The consolidated proof boundary preserves the limitation boundary from both source manuscripts. These Lean modules prove small finite-record properties and rejection
cases for declared records. Direct/projection hooks remain projection-only traceability unless the theorem reasons over an explicit transition, negative case, residual path, authority ceiling, or support-state boundary. They do not prove moral correctness, deployed
