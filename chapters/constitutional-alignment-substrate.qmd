...
open_evidence_gaps:
  ...
  - "Synthetic constitutional-alignment and agency-rights harnesses plus finite-record Lean theorems and agency-correction route checks remain bounded record checks; runtime policy behavior, material rights usability under pressure, manipulation resistance, approval-service quality, rollback/shutdown execution, and red-team evidence remain open."
...
synthetic harnesses, finite-record Lean theorems, and a bounded
agency-correction lifecycle route make the idea more inspectable, but they do
not prove deployed constitutional alignment, human dignity preservation, runtime
corrigibility, consent quality, reviewer independence, moral correctness, or
...
support-state boundary. The Corrigibility module now also checks a finite
agency-correction lifecycle route for missing affected-party records, material
