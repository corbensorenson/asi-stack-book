...
| `ext_recurrent_transformer_2026` | Current comparator for layerwise recurrent KV memory, exact tiling, effective depth, cache pressure, and standard autoregressive decoding cost. | source note available; small-model and asymptotic results not reproduced |
