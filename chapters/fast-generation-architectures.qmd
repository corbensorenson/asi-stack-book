...
| Primary source records | 34 assigned records: ten local architecture sources; eleven decoding, serving, recurrent, state-space, and diffusion comparators; and thirteen heterogeneous-memory comparators spanning layer streaming, planned placement, memory mapping, flash-aware loading, sparse placement, KV allocation and prediction, speculative offload, and tensor scheduling |
