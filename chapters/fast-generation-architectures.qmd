...
| Exact accepted transitions in this chapter | `v1_0_pilot.fast_generation.no_change` |
...
|---|---:|---|---|
| Core: `fast-generation-architectures.core` | 1 | `causal`, `empirical`, `executable`, `formal`, `source-synthesis` | `blocked_after_full_attempt`; missing or unproved: `normative`, `transfer`. |
| blocked after full attempt | 76 | `causal`, `empirical`, `executable`, `formal`, `source-synthesis` | Missing or unproved lanes across this set: `normative`, `transfer`. These are residual proof obligations, not false claims. |
