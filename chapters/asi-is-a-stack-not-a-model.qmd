...
A layer contract is the mechanism that makes that rule concrete. The artifact is a Layer Boundary Record, and a chapter is mature only when it can answer the same recurring questions: what responsibility does the layer own, what artifact does it emit, what authority does it have and lack, what invariant must survive implementation changes, and what evidence would justify promotion, replacement, or rollback.
