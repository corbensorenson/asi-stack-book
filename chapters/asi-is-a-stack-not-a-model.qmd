...
The operational contract is simple: efficient ASI is a governed stack of cooperating layers, not one undifferentiated model. In the target stack doctrine, that contract is visible in:
