...
The stack frame gives the whole argument a practical test. A powerful part must remain inspectable from outside itself. When a later mechanism cannot name its responsibility, artifact, authority ceiling, evidence state, and failure mode, the right response is not enthusiasm. It is to treat the mechanism as unfinished architecture until its boundary is visible.
:::
