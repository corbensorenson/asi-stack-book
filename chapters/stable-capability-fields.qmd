...
| Exact accepted transitions in this chapter | `v1_0_pilot.stable_capability_fields.no_change` |
...
- **Failure or non-promotion case:** 53 atoms
...
|---|---:|---|---|
| Core: `stable-capability-fields.core` | 1 | `executable`, `formal`, `source-synthesis` | `narrowed_after_full_attempt`; missing or unproved: `causal`, `empirical`, `normative`, `transfer`. |
| narrowed after full attempt | 1 | `executable`, `formal`, `source-synthesis` | The exact accepted transition lineage is preserved: `v1_0_pilot.stable_capability_fields.no_change`. The claim is not widened. |
| blocked after full attempt | 53 | `executable`, `formal`, `source-synthesis` | Missing or unproved lanes across this set: `causal`, `empirical`, `executable`, `formal`, `normative`, `transfer`. These are residual proof obligations, not false claims. |
