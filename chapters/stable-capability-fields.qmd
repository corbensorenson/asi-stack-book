...
| Primary source records | `scf`, `viea`, `talos`, `ladon_manhattan`, `moecot`, `ext_capability_based_computer_systems_1984`, `ext_semver_2_0_0`, `ext_slsa_v1_0` |
...
| Source loading state | all eight source notes reviewed and manifest-mapped; local raw passages reviewed for `scf`, `viea`, `talos`, and `ladon_manhattan`; `moecot` mapped from its durable source note; three external specifications/texts mapped through reviewed source notes |
