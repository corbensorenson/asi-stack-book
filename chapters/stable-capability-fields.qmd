...
open_evidence_gaps:
  ...
  - "The implemented `StableCapabilityFields` Lean module contains 15 theorem declarations over finite replacement, lifecycle-review, and lifecycle-transition records grouped under four manifest targets. The independent lifecycle consumer remains separate from Lean; three copied summary mirrors are retired. It does not prove full behavioral refinement, safe composition, evaluator independence, production enforcement, effect-complete rollback, or field-level support."
...
| Test state | public SCF harness: 3 valid / 6 expected-invalid synthetic records; readiness/residual harness: selected route and rollback prerequisites; lifecycle probe: 2 valid traces / 6 expected-invalid controls; Lean: 15 theorem declarations under 4 manifest targets, with three copied lifecycle-summary mirrors retired. No real candidate comparison, full behavioral-refinement evaluator, provenance verification, state migration, effect-complete rollback, or deployed enforcement has run. |
...
- 15 theorem declarations in `AsiStackProofs.StableCapabilityFields`, grouped under four manifest proof targets, plus the separately validated executable lifecycle trace.
...
The module contains 15 theorem declarations grouped under these four manifest targets. They are implemented only over finite replacement, lifecycle-review, and lifecycle-transition records. They derive explicit rejection or nondefault routes for field-identity mismatch, unauthorized authority expansion, missing or stale evidence, evaluator capture, open incidents, retired restart, and five default-promotion failures. Seven direct conjunction projections and three copied lifecycle-summary mirrors were retired rather than used to support broader field-preservation, forward-path, canary, qualification, deprecation-notice, retirement-receipt, trace-count, or no-promotion claims. The executable lifecycle consumer remains a separate evidence surface. The module does not prove the richer behavioral-refinement contract, deployed route validity, evaluator independence, provenance, real regression preservation, migration or composition safety, effect-complete rollback, terminal governance, or lifecycle enforcement.
