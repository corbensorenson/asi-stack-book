...
| Test state | public SCF harness: 3 valid / 6 expected-invalid synthetic records; readiness/residual harness: selected route and rollback prerequisites; lifecycle probe: 2 valid traces / 6 expected-invalid controls; Lean: 18 theorem declarations under 4 manifest targets. No real candidate comparison, full behavioral-refinement evaluator, provenance verification, state migration, effect-complete rollback, or deployed enforcement has run. |
...
- 18 theorem declarations in `AsiStackProofs.StableCapabilityFields`, grouped under four manifest proof targets.
...
The module contains 18 theorem declarations grouped under these four manifest targets. They are implemented only over finite replacement, lifecycle-review, lifecycle-transition, and trace-summary records. They derive explicit rejection or nondefault routes for field-identity mismatch, unauthorized authority expansion, missing or stale evidence, evaluator capture, open incidents, retired restart, and five default-promotion failures, plus the synthetic probe's counts and non-promotion boundary. Seven direct conjunction projections were retired rather than used to support broader field-preservation, forward-path, canary, qualification, deprecation-notice, or retirement-receipt claims. The module does not prove the richer behavioral-refinement contract, deployed route validity, evaluator independence, provenance, real regression preservation, migration or composition safety, effect-complete rollback, terminal governance, or lifecycle enforcement.
