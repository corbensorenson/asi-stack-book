...
The argument then zooms back out to the integrated architecture. Stewardship is one governance surface inside the larger trace from intent to plan, context, claim, job, artifact, evidence, release, and bounded improvement.
