...
In that final product, artifact stewardship would make projects more understandable and less dependent on hidden memory. It would preserve human agency by keeping maps, contracts, release notes, decisions, evidence, finances, and appeals readable without asking the steward for permission. This remains a target architecture. The support state should not rise until a steward workflow, treasury boundary, event-taint pipeline, governance runner, release gate, sunset protocol, and behavioral tests exist and pass review.
