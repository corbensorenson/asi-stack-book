...
**Diagram reading note:** The steward is bounded by its charter before it handles intake, plans work, assigns contracts, or routes outcomes. Verification gates, contribution ledgers, release decisions, lifecycle memory, and governance approvals remain explicit so stewardship does not become unilateral project control.
