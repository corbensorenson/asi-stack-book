...
The mature version is less like tuning a single model and more like approving a behavior-change lease. The lease names what may change, what must not change, how regressions are detected, and who can roll it back.

Feedback becomes governance-compatible when improvement remains reversible and evidence-scoped.

The learning loop should update behavior without rewriting the system's authority.
:::
