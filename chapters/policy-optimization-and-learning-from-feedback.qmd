...
fixture-only rollback dry run. Nineteen Lean declarations are record
projections, finite implications, route reductions, or fixed-fixture
assertions. The adjacent anti-Goodhart harness belongs to Benchmark Ratchets.
No optimizer, model, live router, natural workload, preference dataset, reward
model, real canary, deployed rollback, causal improvement, independent
reproduction, or transfer ran. The core-claim support effect is exactly zero.
...
These Lean hooks are implemented as finite-record predicates over policy-update reviews, reward/governance promotion reviews, promotion-evidence reviews, reward-proxy reviews, authority-expansion reviews, policy-promotion route reviews, and the synthetic lease-probe summary. They prove only record-level gates: an admitted policy update exposes reward, evaluation, governance, and rollback fields; an update with unverified reward or missing governance gate cannot be promoted; promotion evidence cannot omit holdouts or contamination checks; a reward proxy cannot stand alone for target evaluation; authority-expanding updates require governance approval and rollback records; route-level promotion checks cannot pass through inadmissible feedback, missing target evaluation, missing reward-hacking probes, governance or authority gaps, missing rollback, or regression/residual gaps without rejection, review, rollback, or residual routing; and the lease-probe fixture summary contains the expected sample counts, rejection flags, rollback-dry-run flag, no-support-effect flag, and non-claim boundary. They do not prove reward quality, RL convergence, benchmark improvement, policy safety, route quality, context-selection quality, reward-hacking resistance, hidden-holdout adequacy, contamination-detection quality, approval quality, rollback execution, live rollback behavior, or runtime policy-update behavior.

### Formal adequacy audit

All nineteen declarations are finite. Eight are projections or implication
checks over hand-authored records, seven reduce the hand-authored promotion
route, three normalize a fixed synthetic lease summary, and one reduces a
finite evaluation-integrity gate. None models gradient estimation, optimizer
convergence, learning dynamics, reward correctness, evaluator error, causal
target improvement, catastrophic forgetting, full-state recovery, runtime
enforcement, institutional independence, or transfer. No declaration is a
direct empirical projection. Their authority ends at record and route
semantics.
