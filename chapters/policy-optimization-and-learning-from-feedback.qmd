...
open_evidence_gaps:
  ...
  - "The policy_optimization_record fixture validates schema/example consistency; AsiStackProofs.PolicyOptimization implements finite record predicates plus bounded negative cases for missing holdout/contamination checks, reward-proxy promotion without target evaluation, authority-expanding policy updates without approval or rollback, and policy-promotion routes with inadmissible feedback, missing target evaluation, missing reward-hacking probes, governance or authority gaps, missing rollback, or regression/residual gaps; and the benchmark anti-Goodhart harness validates synthetic feedback admissibility, reward-boundary, reward-hacking-probe, evidence-packet, governance-gate, blocked-ratchet, and promotion-gate behavior. None of these artifacts proves reward quality, optimizer convergence, benchmark improvement, policy safety, reward-hacking resistance, or policy-update runtime behavior."
---
...
| Test state | `policy_optimization_record.valid.json` passes repository-level protocol fixture validation; `AsiStackProofs.PolicyOptimization` implements finite policy-update record and reward/governance promotion gates plus bounded negative cases for missing holdout or contamination checks, reward-proxy promotion without target evaluation, authority-expanding policy updates without approval or rollback, and policy-promotion route failures for inadmissible feedback, missing target evaluation, missing reward-hacking probes, governance or authority gaps, missing rollback, and regression/residual gaps; `python3 scripts/validate_benchmark_antigoodhart.py` validates synthetic feedback admissibility, reward-boundary, reward-hacking-probe, evidence-packet, governance-gate, blocked-ratchet, and promotion-gate behavior. No policy optimization experiment has been run. |
...
These Lean hooks are implemented as finite-record predicates over policy-update reviews, reward/governance promotion reviews, promotion-evidence reviews, reward-proxy reviews, authority-expansion reviews, and policy-promotion route reviews. They prove only record-level gates: an admitted policy update exposes reward, evaluation, governance, and rollback fields; an update with unverified reward or missing governance gate cannot be promoted; promotion evidence cannot omit holdouts or contamination checks; a reward proxy cannot stand alone for target evaluation; authority-expanding updates require governance approval and rollback records; and route-level promotion checks cannot pass through inadmissible feedback, missing target evaluation, missing reward-hacking probes, governance or authority gaps, missing rollback, or regression/residual gaps without rejection, review, rollback, or residual routing. They do not prove reward quality, RL convergence, benchmark improvement, policy safety, route quality, context-selection quality, reward-hacking resistance, hidden-holdout adequacy, contamination-detection quality, approval quality, rollback execution, or runtime policy-update behavior.
