...
A better policy is useful only when its new habits remain bounded by older duties. Learning pressure belongs inside the same contract as deployment authority. Deployment still sets boundaries.
:::
