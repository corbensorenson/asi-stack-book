...
**Diagram reading note:** Feedback does not update behavior until admissibility, target policy, reward boundary, drift bound, rollback, holdouts, regressions, and reward-hacking probes are visible. Promotion is a governance decision, while failed updates route to quarantine, rollback, or residuals.
...
Governed learning improves behavior inside a field, but durable artifacts also need continuity across people, agents, budgets, releases, governance decisions, and eventual sunset. Artifact Steward Agents and Living Project Governance extends the same evidence discipline to project life. It asks how an artifact can preserve mission, memory, treasury limits, contributor ledgers, work contracts, and tainted event intake without granting an AI ownership.
