...
open_evidence_gaps:
  ...
  - "The policy_optimization_record fixture validates schema/example consistency; AsiStackProofs.PolicyOptimization implements finite record predicates plus bounded negative cases for missing holdout/contamination checks, reward-proxy promotion without target evaluation, authority-expanding policy updates without approval or rollback, policy-promotion routes with inadmissible feedback, missing target evaluation, missing reward-hacking probes, governance or authority gaps, missing rollback, or regression/residual gaps, and a deterministic policy-update lease fixture bridge; the benchmark anti-Goodhart harness validates synthetic feedback admissibility, reward-boundary, reward-hacking-probe, evidence-packet, governance-gate, blocked-ratchet, and promotion-gate behavior; and the Policy update lease probe validates six synthetic router-policy samples, five candidate policies, expected-invalid controls, and a dry-run rollback record. None of these artifacts proves reward quality, optimizer convergence, benchmark improvement, policy safety, reward-hacking resistance, route quality, or policy-update runtime behavior."
---
...
|---|---|---|
| `ext_trpo_2015` | Metadata-first comparator: Trust Region Policy Optimization. Primary external source for trust-region policy-gradient updates and bounded update-size discipline. | No passage-level source claim, local implementation, reproduction, safety, performance, deployment, support-state, or ASI result is established by this reconciliation row. |
| `ext_ppo_2017` | Metadata-first comparator: Proximal Policy Optimization Algorithms. Primary external source for PPO-style online policy-gradient updates and proximal surrogate objectives. | No passage-level source claim, local implementation, reproduction, safety, performance, deployment, support-state, or ASI result is established by this reconciliation row. |
| `ext_remax_2023` | Metadata-first comparator: ReMax: A Simple, Effective, and Efficient Reinforcement Learning Method for Aligning Large Language Models. Primary external source for simpler RLHF-oriented policy-gradient updates relative to PPO-style machinery. | No passage-level source claim, local implementation, reproduction, safety, performance, deployment, support-state, or ASI result is established by this reconciliation row. |
| `ext_dpo_2023` | Metadata-first comparator: Direct Preference Optimization: Your Language Model is Secretly a Reward Model. Primary external source for DPO-style offline preference optimization without a separate online RL loop. | No passage-level source claim, local implementation, reproduction, safety, performance, deployment, support-state, or ASI result is established by this reconciliation row. |
| `ext_ipo_preference_2023` | Metadata-first comparator: A General Theoretical Paradigm to Understand Learning from Human Preferences. External source for theoretical comparison of preference-learning objectives, including IPO/DPO-style framing. | No passage-level source claim, local implementation, reproduction, safety, performance, deployment, support-state, or ASI result is established by this reconciliation row. |
| `ext_orpo_2024` | Metadata-first comparator: ORPO: Monolithic Preference Optimization without Reference Model. External source for reference-model-free monolithic preference optimization. | No passage-level source claim, local implementation, reproduction, safety, performance, deployment, support-state, or ASI result is established by this reconciliation row. |
| `ext_kto_2024` | Metadata-first comparator: KTO: Model Alignment as Prospect Theoretic Optimization. External source for prospect-theoretic model alignment and human-aware loss framing. | No passage-level source claim, local implementation, reproduction, safety, performance, deployment, support-state, or ASI result is established by this reconciliation row. |
| `ext_simpo_2024` | Metadata-first comparator: SimPO: Simple Preference Optimization with a Reference-Free Reward. External source for simple reference-free preference optimization using sequence-level reward framing. | No passage-level source claim, local implementation, reproduction, safety, performance, deployment, support-state, or ASI result is established by this reconciliation row. |
| `ext_reinforce_style_rlhf_2024` | Metadata-first comparator: Back to Basics: Revisiting REINFORCE Style Optimization for Learning from Human Feedback in LLMs. External source for revisiting simpler REINFORCE-style optimization as an RLHF baseline. | No passage-level source claim, local implementation, reproduction, safety, performance, deployment, support-state, or ASI result is established by this reconciliation row. |
| `ext_deepseek_r1_2025` | Metadata-first comparator: DeepSeek-R1: Incentivizing Reasoning Capability in LLMs via Reinforcement Learning. External source for reinforcement-learning pressure on reasoning behavior in large language models. | No passage-level source claim, local implementation, reproduction, safety, performance, deployment, support-state, or ASI result is established by this reconciliation row. |
| `ext_dapo_2025` | Metadata-first comparator: DAPO: An Open-Source LLM Reinforcement Learning System at Scale. External source for open-source large-scale LLM RL system details and DAPO-style update design. | No passage-level source claim, local implementation, reproduction, safety, performance, deployment, support-state, or ASI result is established by this reconciliation row. |
| `ext_gspo_2025` | Metadata-first comparator: Group Sequence Policy Optimization. External source for sequence-level group policy optimization in LLM reinforcement learning. | No passage-level source claim, local implementation, reproduction, safety, performance, deployment, support-state, or ASI result is established by this reconciliation row. |
| `ext_s_grpo_2025` | Metadata-first comparator: S-GRPO: Early Exit via Reinforcement Learning in Reasoning Models. External source for early-exit reinforcement learning and overthinking control in reasoning models. | No passage-level source claim, local implementation, reproduction, safety, performance, deployment, support-state, or ASI result is established by this reconciliation row. |
| `ext_longrlvr_2026` | Metadata-first comparator: LongRLVR: Long-Context Reinforcement Learning Requires Verifiable Context Rewards. External source for long-context RLVR and verifiable context-grounding rewards. | No passage-level source claim, local implementation, reproduction, safety, performance, deployment, support-state, or ASI result is established by this reconciliation row. |
| `ext_rlhf_limitations_2023` | Metadata-first comparator: Open Problems and Fundamental Limitations of Reinforcement Learning from Human Feedback. External survey source for RLHF limitations, reward hacking, evaluator limits, and complementary safeguards. | No passage-level source claim, local implementation, reproduction, safety, performance, deployment, support-state, or ASI result is established by this reconciliation row. |
