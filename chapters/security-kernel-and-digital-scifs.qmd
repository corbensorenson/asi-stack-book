...
open_evidence_gaps:
  ...
  - "Current evidence is exactly 3 valid and 8 expected-invalid synthetic Authority Use Receipts, 2 valid and 6 expected-invalid SCIF commit-probe routes, one security-overhead-laundering negative fixture inside the 6-valid/7-invalid Resource Budget corpus, and 56 finite Lean theorem declarations under four targets. The 35-theorem transaction lifecycle has exact committed and revoked witnesses, twelve state-preserving rejecting controls, eight revoked-state event-kind checks, six canonical descendant-inventory permutations, and a count-only revocation impossibility result; none establishes a non-bypassable monitor, real secret custody, real descendant discovery, isolation, declassification quality, effect-complete runtime revocation, side-channel safety, privacy, or production security."
...
| `AsiStackProofs.SecurityKernel` | 56 theorem declarations under four manifest targets, including a 35-theorem versioned authority-use transaction | Runtime refinement, open-world information flow, cryptography, isolation, side-channel control, or security |
