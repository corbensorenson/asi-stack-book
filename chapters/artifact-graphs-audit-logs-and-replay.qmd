...
| Test state | Artifact graph fixture validation now includes context transaction refs, semantic certificate refs, replay grade, evidence gate, residuals, and non-claims; finite provenance predicates plus route, replay-packet bridge, record-reality sequence bridge, receipt-faithfulness bridge, receipt repository audit bridge, receipt repository challenge bridge, epistemic-TCB bridge, and negative-case theorems are implemented in `AsiStackProofs.ArtifactGraph` for produced artifacts, missing trace refs, insufficient replay grade, missing claim/test links, missing audit/replay/evidence/non-claim fields, stale certificates, blocked promotion, byte-exact missing observation, partial-replay promotion blocking, support-review transaction validation, record-reality restoration after a block, receipt/reality mismatch, trap-receipt failure, independent cross-check, tracked digest mismatch, failed command replay, deterministic challenge mismatch, missing non-claim boundaries, attestation limits, trust-base root refs, delegation, recursion stops, outside-TCB residuals, and complete admission; `python3 scripts/validate_artifact_graph_replay.py` checks synthetic parentage, replay metadata, audit reconstruction, stale-certificate, and promotion-blocking cases; `python3 scripts/validate_artifact_graph_record_reality_sequence.py` checks 1 valid stale/partial/fresh replay sequence and 4 expected-invalid controls; `python3 scripts/validate_receipt_faithfulness.py` checks 3 valid bounded receipt records and 6 expected-invalid controls; `python3 scripts/validate_receipt_repository_audit.py` checks 4 selected repository receipt records, 55 tracked digest checks, external receipt fingerprints, and 5 expected-invalid controls; `python3 scripts/validate_receipt_repository_challenge.py` checks 4 deterministic challenge responses over the repository audit and 5 expected-invalid controls; `python3 scripts/validate_epistemic_trusted_computing_base.py` checks 3 valid bounded trust-base records and 6 expected-invalid controls; deployed replay, audit-reconstruction, produced-artifact completeness, attestation, epistemic trusted computing base, and open-world receipt-faithfulness services remain planned. |
...
Fixture-shape validation, bounded Lean theorem declarations over finite provenance, replay-grade, artifact-admission, replay-packet route predicates, receipt-faithfulness fixture predicates, receipt repository audit/challenge predicates, and epistemic-TCB fixture predicates, plus synthetic cross-record replay, receipt-faithfulness, repository challenge, and trust-base harnesses are implemented. The remaining tests require produced artifacts, audit logs, replay attempts, attestation checks, trust-base checks, and receipt-faithfulness audits from a deployed or imported artifact graph service.
