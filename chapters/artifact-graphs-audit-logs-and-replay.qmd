...
open_evidence_gaps:
  ...
  - "Protocol schema/fixture validation, finite Lean provenance, route predicates, replay-packet bridge predicates, the receipt-faithfulness fixture bridge, and `python3 scripts/validate_artifact_graph_replay.py` are implemented; the harness checks synthetic parentage, context transaction, semantic certificate, replay metadata, audit reconstruction, stale-certificate, and promotion-blocking cases, while `python3 scripts/validate_receipt_faithfulness.py` rejects shape-valid but reality-false receipts, ignored trap-receipt failures, missing independent cross-check routes, same-component self-check laundering, unbounded attestation, and support promotion from receipt shape. No deployed artifact-graph replay service, audit reconstruction service, produced-artifact completeness service, attestation service, or open-world receipt-faithfulness system has been run."
...
| Test state | Artifact graph fixture validation now includes context transaction refs, semantic certificate refs, replay grade, evidence gate, residuals, and non-claims; finite provenance predicates plus route, replay-packet bridge, receipt-faithfulness bridge, and negative-case theorems are implemented in `AsiStackProofs.ArtifactGraph` for produced artifacts, missing trace refs, insufficient replay grade, missing claim/test links, missing audit/replay/evidence/non-claim fields, stale certificates, blocked promotion, byte-exact missing observation, partial-replay promotion blocking, support-review transaction validation, receipt/reality mismatch, trap-receipt failure, independent cross-check, attestation limits, and complete admission; `python3 scripts/validate_artifact_graph_replay.py` checks synthetic parentage, replay metadata, audit reconstruction, stale-certificate, and promotion-blocking cases; `python3 scripts/validate_receipt_faithfulness.py` checks 3 valid bounded receipt records and 6 expected-invalid controls; deployed replay, audit-reconstruction, produced-artifact completeness, attestation, and open-world receipt-faithfulness services remain planned. |

## Drafting guardrail

Artifacts are provenance-bearing work products, not automatic evidence. Six local-cache source mappings have been passage-reviewed for the architecture surface; `moecot` remains connector/source-note mapped. The repo validates an artifact-graph fixture, proves finite Lean predicates over provenance, artifact-admission routes, replay-packet bridge routes, and receipt-faithfulness fixture routes, and runs synthetic harnesses over parentage, context transaction, semantic certificate, replay metadata, audit reconstruction, stale-certificate, promotion-blocking, and adversarial receipt/reality mismatch cases. It has not run a deployed replay engine, audit reconstruction service, produced-artifact checker, attestation service, or provenance completeness service for this layer.
...
Fixture-shape validation, 34 bounded Lean theorem declarations over finite provenance, replay-grade, artifact-admission, replay-packet route predicates, and receipt-faithfulness fixture predicates, plus synthetic cross-record replay and receipt-faithfulness harnesses are implemented. The remaining tests require produced artifacts, audit logs, replay attempts, attestation checks, and receipt-faithfulness audits from a deployed or imported artifact graph service.
...
These proof hooks are implemented as finite-record predicates plus route, replay-packet bridge, receipt-faithfulness fixture, and negative-case theorems over modeled artifact records. They cover parent/source/context refs, replay-grade sufficiency, claim/test links, audit and replay metadata, replay limits, evidence gates, stale certificates, promotion permission, cross-record replay-packet alignment, byte-exact observation requirements, support-review transaction validation, partial-replay promotion blocking, receipt/reality mismatch rejection, trap-receipt failure rejection, independent cross-check requirements, attestation-limit recording, non-claim boundaries, and complete modeled admission. They do not prove replayability, audit reconstruction, artifact-type-specific completeness, provenance completeness in a deployed service, open-world receipt faithfulness, deployed attestation behavior, deployed audit behavior, or source interpretation adequacy.
