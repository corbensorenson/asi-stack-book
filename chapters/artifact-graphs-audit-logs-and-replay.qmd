...
| Test state | Artifact graph fixture validation now includes context transaction refs, semantic certificate refs, replay grade, evidence gate, residuals, and non-claims; finite provenance predicates plus route, replay-packet bridge, receipt-faithfulness bridge, receipt repository audit bridge, epistemic-TCB bridge, and negative-case theorems are implemented in `AsiStackProofs.ArtifactGraph` for produced artifacts, missing trace refs, insufficient replay grade, missing claim/test links, missing audit/replay/evidence/non-claim fields, stale certificates, blocked promotion, byte-exact missing observation, partial-replay promotion blocking, support-review transaction validation, receipt/reality mismatch, trap-receipt failure, independent cross-check, tracked digest mismatch, failed command replay, missing non-claim boundaries, attestation limits, trust-base root refs, delegation, recursion stops, outside-TCB residuals, and complete admission; `python3 scripts/validate_artifact_graph_replay.py` checks synthetic parentage, replay metadata, audit reconstruction, stale-certificate, and promotion-blocking cases; `python3 scripts/validate_receipt_faithfulness.py` checks 3 valid bounded receipt records and 6 expected-invalid controls; `python3 scripts/validate_receipt_repository_audit.py` checks 4 selected repository receipt records, 55 tracked digest checks, external receipt fingerprints, and 5 expected-invalid controls; `python3 scripts/validate_epistemic_trusted_computing_base.py` checks 3 valid bounded trust-base records and 6 expected-invalid controls; deployed replay, audit-reconstruction, produced-artifact completeness, attestation, epistemic trusted computing base, and open-world receipt-faithfulness services remain planned. |
...
These proof hooks are implemented as finite-record predicates plus route, replay-packet bridge, receipt-faithfulness fixture, receipt repository audit fixture, epistemic-TCB fixture, and negative-case theorems over modeled artifact records. They cover parent/source/context refs, replay-grade sufficiency, claim/test links, audit and replay metadata, replay limits, evidence gates, stale certificates, promotion permission, cross-record replay-packet alignment, byte-exact observation requirements, support-review transaction validation, partial-replay promotion blocking, receipt/reality mismatch rejection, trap-receipt failure rejection, independent cross-check requirements, repository receipt tracked digest checks, command replay boundaries, external receipt fingerprints, missing non-claim rejection, attestation-limit recording, root-of-trust recording, delegation bounds, recursion-stop requirements, outside-TCB residuals, verifier-trust laundering rejection, non-claim boundaries, and complete modeled admission. They do not prove replayability, audit reconstruction, artifact-type-specific completeness, provenance completeness in a deployed service, open-world receipt faithfulness, deployed attestation behavior, deployed audit behavior, verifier correctness, deployed epistemic trusted-computing-base behavior, external project truth, or source interpretation adequacy.
