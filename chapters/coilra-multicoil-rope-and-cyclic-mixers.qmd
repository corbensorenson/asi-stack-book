...
atom `coilra-multicoil-rope-and-cyclic-mixers.core` remains at `argument` with terminal
disposition `blocked_after_full_attempt`. The authoritative per-atom rows
are the `coilra-multicoil-rope-and-cyclic-mixers` slice of
...
|---|---:|---|---|
| Core: `coilra-multicoil-rope-and-cyclic-mixers.core` | 1 | `causal`, `empirical`, `executable`, `formal`, `source-synthesis` | `blocked_after_full_attempt`; missing or unproved: `normative`, `transfer`. |
