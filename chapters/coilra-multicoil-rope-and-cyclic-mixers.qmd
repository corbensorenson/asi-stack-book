...
The fixture proves only that the adoption boundary can be represented. It does not turn structural facts into performance claims or show that a mixer should be routed into a workload.
