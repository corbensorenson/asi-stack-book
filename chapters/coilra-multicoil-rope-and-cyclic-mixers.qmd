...
The smallest useful implementation is a cyclic mixer evaluation schema and fixture. It records structural invariant, proof or receipt boundary, alias and load diagnostics, parameter accounting, hardware notes, baselines, required metrics, adoption state, non-claims, and evidence references.
