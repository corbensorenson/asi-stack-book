...
The insufficiency is cross-ledger spending. A substrate wins a structural ledger entry, then spends that win as if it were a quality result, runtime result, memory result, or hardware result. Each ledger should have to earn its own evidence.
