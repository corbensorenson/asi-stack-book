...
Until then, elegance remains a candidate, not a license to skip ordinary baselines.

The comparison record decides whether the mechanism becomes architecture or ornament. Position schemes need receipts as much as they need elegance.
:::
...
Another failure is alias blindness, where position collisions are treated as harmless because average metrics still look acceptable.
