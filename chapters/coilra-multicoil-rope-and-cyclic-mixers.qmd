...
Baseline symmetry keeps cyclic evaluation honest. A cyclic candidate and its ordinary baselines should face the same workload, metric, data condition, hardware notes, and fallback policy before a tradeoff is called favorable.
