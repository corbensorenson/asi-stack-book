...
open_evidence_gaps:
  ...
  - "Pinned Circle project references support structural-contract, receipt, theorem-id, baseline, and non-claim discussion, and the separate public-safe Circle receipt lane now gives the CoilRA chapter one concrete RoPE receipt boundary for diagnostic structural use; this ASI Stack repo still did not rerun Circle commands, import generated contract packs, replay receipts from source, validate external Circle Lean proofs locally, or produce a quality/context-length/runtime result."
