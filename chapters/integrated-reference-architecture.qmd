...
supported old address or fails explicitly and rolls back. The
`qcsa_whitepaper` makes these contracts precise and proposes artifacts and
falsification tests, but it does not implement this reference trace or promote
