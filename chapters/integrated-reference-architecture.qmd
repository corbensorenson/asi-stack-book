...
open_evidence_gaps:
  - "Exact source-note mappings now cover all assigned sources for this core claim; support remains argument until passage review, integrated trace artifacts, tests, or accepted evidence transitions justify promotion."
  - "The reference_trace_record fixture validates schema/example consistency only; no end-to-end runtime trace harness, authority stop-condition checker, or artifact continuity audit has been run."
