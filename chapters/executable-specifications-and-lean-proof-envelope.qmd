...
open_evidence_gaps:
  ...
  - "The frozen activation-baseline rationalization contains 298 targets and 1,151 declarations; the live surface contains 324 targets and 1,354 declarations. Neither denominator establishes semantic adequacy, implementation binding, independent reproduction, transfer, or system behavior."
...
The claim remains at `argument` support. The current generated proof manifest contains 305 implemented narrow formal obligations and nineteen planned targets without a claimed theorem; the activation audit separately preserves its historical 298-target baseline. Current proof-depth snapshot: 324 proof targets, 113 Lean modules, 1354 theorem declarations, 879 derived/decomposed, 185 direct/projection, 290 unknown/mixed, and 1/1 safety-critical chapter classifications present. That coverage does not prove broad chapter claims, source interpretation, deployed enforcement, model quality, semantic adequacy, or benchmark performance.
...
generated 324-target proof manifest with 305 implemented and 19 planned
targets; a 113-module Lean workspace with 1,354 theorem declarations classified
as 879 derived/decomposed, 185 direct/projection, and 290 unknown/mixed; one proof-readiness classification;
