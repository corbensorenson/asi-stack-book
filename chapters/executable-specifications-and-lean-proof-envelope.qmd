...
open_evidence_gaps:
  ...
  - "The frozen activation-baseline rationalization contains 298 targets and 1,151 declarations; the live surface contains 324 targets and 1,460 declarations. Neither denominator establishes semantic adequacy, implementation binding, independent reproduction, transfer, or system behavior."
...
The claim remains at `argument` support. The current generated proof manifest contains 310 implemented narrow formal obligations and fourteen planned targets without a claimed theorem; the activation audit separately preserves its historical 298-target baseline. Current proof-depth snapshot: 324 proof targets, 117 Lean modules, 1460 theorem declarations, 954 derived/decomposed, 198 direct/projection, 308 unknown/mixed, and 1/1 safety-critical chapter classifications present. That coverage does not prove broad chapter claims, source interpretation, deployed enforcement, model quality, semantic adequacy, or benchmark performance.
...
generated 324-target proof manifest with 310 implemented and 14 planned
targets; a 117-module Lean workspace with 1,460 theorem declarations classified
as 954 derived/decomposed, 198 direct/projection, and 308 unknown/mixed; one proof-readiness classification;
