...
open_evidence_gaps:
  ...
  - "The frozen activation-baseline rationalization contains 298 targets and 1,151 declarations; the live surface contains 324 targets and 1,515 declarations. Neither denominator establishes semantic adequacy, implementation binding, independent reproduction, transfer, or system behavior."
...
The claim remains at `argument` support. The current generated proof manifest contains 312 implemented narrow formal obligations and twelve planned targets without a claimed theorem; the activation audit separately preserves its historical 298-target baseline. Current proof-depth snapshot: 324 proof targets, 119 Lean modules, 1515 theorem declarations, 976 derived/decomposed, 223 direct/projection, 316 unknown/mixed, and 1/1 safety-critical chapter classifications present. That coverage does not prove broad chapter claims, source interpretation, deployed enforcement, model quality, semantic adequacy, or benchmark performance.
...
generated 324-target proof manifest with 312 implemented and 12 planned
targets; a 119-module Lean workspace with 1,515 theorem declarations classified
as 976 derived/decomposed, 223 direct/projection, and 316 unknown/mixed; one proof-readiness classification;
