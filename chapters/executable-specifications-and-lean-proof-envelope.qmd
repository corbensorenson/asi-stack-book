...
open_evidence_gaps:
  ...
  - "The frozen activation-baseline rationalization contains 298 targets and 1,151 declarations; the live surface contains 324 targets and 1,420 declarations. Neither denominator establishes semantic adequacy, implementation binding, independent reproduction, transfer, or system behavior."
...
The claim remains at `argument` support. The current generated proof manifest contains 308 implemented narrow formal obligations and sixteen planned targets without a claimed theorem; the activation audit separately preserves its historical 298-target baseline. Current proof-depth snapshot: 324 proof targets, 115 Lean modules, 1420 theorem declarations, 932 derived/decomposed, 188 direct/projection, 300 unknown/mixed, and 1/1 safety-critical chapter classifications present. That coverage does not prove broad chapter claims, source interpretation, deployed enforcement, model quality, semantic adequacy, or benchmark performance.
...
generated 324-target proof manifest with 308 implemented and 16 planned
targets; a 115-module Lean workspace with 1,420 theorem declarations classified
as 932 derived/decomposed, 188 direct/projection, and 300 unknown/mixed; one proof-readiness classification;
