...
open_evidence_gaps:
  ...
  - "The frozen activation-baseline rationalization contains 298 targets and 1,151 declarations; the live surface contains 324 targets and 1,546 declarations. Neither denominator establishes semantic adequacy, implementation binding, independent reproduction, transfer, or system behavior."
...
The claim remains at `argument` support. The current generated proof manifest contains 313 implemented narrow formal obligations and eleven planned targets without a claimed theorem; the activation audit separately preserves its historical 298-target baseline. Current proof-depth snapshot: 324 proof targets, 120 Lean modules, 1546 theorem declarations, 990 derived/decomposed, 236 direct/projection, 320 unknown/mixed, and 1/1 safety-critical chapter classifications present. That coverage does not prove broad chapter claims, source interpretation, deployed enforcement, model quality, semantic adequacy, or benchmark performance.
...
generated 324-target proof manifest with 313 implemented and 11 planned
targets; a 120-module Lean workspace with 1,546 theorem declarations classified
as 990 derived/decomposed, 236 direct/projection, and 320 unknown/mixed; one proof-readiness classification;
