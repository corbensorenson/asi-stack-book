...
open_evidence_gaps:
  ...
  - "The frozen activation-baseline rationalization contains 298 targets and 1,151 declarations; the live surface contains 324 targets and 1,376 declarations. Neither denominator establishes semantic adequacy, implementation binding, independent reproduction, transfer, or system behavior."
...
The claim remains at `argument` support. The current generated proof manifest contains 306 implemented narrow formal obligations and eighteen planned targets without a claimed theorem; the activation audit separately preserves its historical 298-target baseline. Current proof-depth snapshot: 324 proof targets, 113 Lean modules, 1376 theorem declarations, 898 derived/decomposed, 186 direct/projection, 292 unknown/mixed, and 1/1 safety-critical chapter classifications present. That coverage does not prove broad chapter claims, source interpretation, deployed enforcement, model quality, semantic adequacy, or benchmark performance.
...
generated 324-target proof manifest with 306 implemented and 18 planned
targets; a 113-module Lean workspace with 1,376 theorem declarations classified
as 898 derived/decomposed, 186 direct/projection, and 292 unknown/mixed; one proof-readiness classification;
