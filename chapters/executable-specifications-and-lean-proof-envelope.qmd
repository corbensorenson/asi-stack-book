...
open_evidence_gaps:
  ...
  - "The frozen activation-baseline rationalization contains 298 targets and 1,151 declarations; the live surface contains 324 targets and 1,439 declarations. Neither denominator establishes semantic adequacy, implementation binding, independent reproduction, transfer, or system behavior."
...
The claim remains at `argument` support. The current generated proof manifest contains 309 implemented narrow formal obligations and fifteen planned targets without a claimed theorem; the activation audit separately preserves its historical 298-target baseline. Current proof-depth snapshot: 324 proof targets, 116 Lean modules, 1439 theorem declarations, 942 derived/decomposed, 193 direct/projection, 304 unknown/mixed, and 1/1 safety-critical chapter classifications present. That coverage does not prove broad chapter claims, source interpretation, deployed enforcement, model quality, semantic adequacy, or benchmark performance.
...
generated 324-target proof manifest with 309 implemented and 15 planned
targets; a 116-module Lean workspace with 1,439 theorem declarations classified
as 942 derived/decomposed, 193 direct/projection, and 304 unknown/mixed; one proof-readiness classification;
