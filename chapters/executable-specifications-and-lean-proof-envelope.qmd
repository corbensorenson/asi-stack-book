...
open_evidence_gaps:
  ...
  - "The frozen activation-baseline rationalization contains 298 targets and 1,151 declarations; the live surface contains 324 targets and 1,396 declarations. Neither denominator establishes semantic adequacy, implementation binding, independent reproduction, transfer, or system behavior."
...
The claim remains at `argument` support. The current generated proof manifest contains 307 implemented narrow formal obligations and seventeen planned targets without a claimed theorem; the activation audit separately preserves its historical 298-target baseline. Current proof-depth snapshot: 324 proof targets, 114 Lean modules, 1396 theorem declarations, 913 derived/decomposed, 187 direct/projection, 296 unknown/mixed, and 1/1 safety-critical chapter classifications present. That coverage does not prove broad chapter claims, source interpretation, deployed enforcement, model quality, semantic adequacy, or benchmark performance.
...
generated 324-target proof manifest with 307 implemented and 17 planned
targets; a 114-module Lean workspace with 1,396 theorem declarations classified
as 913 derived/decomposed, 187 direct/projection, and 296 unknown/mixed; one proof-readiness classification;
