...
open_evidence_gaps:
  - "The 2026-07-27 T0/T0A currentness import records clean local-authority Theseus `main` at `d5b99128`, discloses 53 commits ahead of `origin/main`, separates completed historical T0 from active successor T0A, and finds 19 changed artifacts in the historical 123-artifact freeze. It does not establish that the local commits are publicly pushed, that a current replacement replay passed, or that T1 training is authorized."
...
immutable control, but 19 of its 123 bound artifacts differ from the current
clean Theseus `main` tree at `d5b99128`; it therefore supplies no authority
for the successor campaign. The current implementation records a GREEN factorized
selection and acceleration selector, while `T1` remains blocked until a
guarded independent replay publishes a replacement content-addressed freeze
