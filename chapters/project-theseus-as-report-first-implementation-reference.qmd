...
open_evidence_gaps:
  - "The 2026-07-27 T0/T0A currentness import records clean published Theseus `main` at `24955417`, separates completed historical T0 from active successor T0A, finds 21 changed artifacts in the historical 123-artifact freeze, records 7/7 current CPU/governance replays and 13/14 valid accelerator receipts, and preserves the final optimizer-matched shard's guarded live-memory-reserve stop. It does not establish a current replacement freeze, training readiness, or T1 authority."
...
immutable control, but 21 of its 123 bound artifacts differ from the current
clean, published Theseus `main` tree at `24955417`; it therefore supplies no
...
remaining optimizer-matched accelerator shard passed its 5,120 MiB launch
...
or architecture result and not completion. `T1` remains blocked until that
unchanged guarded shard passes, a replacement
