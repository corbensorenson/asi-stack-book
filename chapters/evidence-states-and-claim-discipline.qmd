...
The support-state harness exercises synthetic no-change, upward, downward, and terminal refutation transitions, including invalid controls for unreviewed promotion, failed verification, reasonless demotion, and unsupported refutation. The evidence-bundle probe adds the next accountability surface: two valid synthetic evidence bundles for no-change and blocked promotion, plus seven expected-invalid controls for missing claim IDs, artifact/result refs, commands, changelog refs, limitations, non-claims, stale changelogs, and fixture overclaiming. The Lean module proves narrow support-state invariants in this repository, including that terminal states are not promotion targets and that a finite transition-lifecycle route sends missing claim records, scope boundaries, support-state effects, effect mismatches, missing review, missing required evidence, missing negative evidence, missing downgrade triggers, wrong terminal effects, missing changelog refs, and missing non-claim boundaries to explicit modeled outcomes. These artifacts leave chapter claims unchanged unless claim-specific evidence and accepted review exist.
...
These evidence-state hooks are implemented in the local Lean workspace. The module models `deprecated` and `refuted` as terminal support states, proves narrow terminal/downgrade guard theorems over finite records, includes a finite transition-lifecycle route envelope, and now carries a fixture bridge for the evidence-bundle completeness probe. Their scope is narrow: they check transition discipline and fixture alignment, not the truth of any source-derived or benchmark-backed claim, not reviewer quality, and not the correctness of any live promotion, demotion, deprecation, or refutation decision.
