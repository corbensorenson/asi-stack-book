...
open_evidence_gaps:
  ...
  - "The claim_record and evidence_transition_record fixtures and evidence-state Lean proofs validate narrow transition surfaces only; the fixtures now record source mapping status, source mapping refs, evidence readiness state, required next evidence, claim surface refs, claim record refs, transition validity state, evidence packet refs, source mapping refs, negative evidence refs, downgrade triggers, promotion burden, reviewer refs, acceptance blockers, reviewer independence, changelog ref, support-state effect, and non-claims. The support-state harness now includes synthetic downward demotion and terminal refutation cases, but no live claim is demoted or refuted. Claim-ledger completeness, evidence bundle completeness, accepted transition review, and changelog audits remain unimplemented."
...
The minimal evidence-control surface is `schemas/claim_record.schema.json`, `schemas/evidence_transition_record.schema.json`, Appendix C, one valid claim fixture, one valid transition fixture, the support-state transition harness, and the Lean evidence-state proof module. Schema validation checks claim shape, source-mapping status, evidence-readiness state, required next evidence, transition shape, claim surface refs, claim-record refs, transition validity state, scope boundary, evidence roles, evidence packet refs, source mapping refs, negative evidence refs, downgrade triggers, promotion burden, reviewer refs, acceptance blockers, reviewer independence, changelog linkage, support-state effect, and non-claims. The support-state harness now exercises synthetic no-change, upward, downward, and terminal refutation transitions, including invalid controls for unreviewed promotion, failed verification, reasonless demotion, and unsupported refutation. The Lean module proves the narrow support-state invariant in this repository, including that terminal states are not promotion targets. Neither artifact promotes, demotes, deprecates, or refutes any chapter claim without claim-specific evidence and accepted review.
...
These two evidence-state hooks are implemented in the local Lean workspace. The module also now models `deprecated` and `refuted` as terminal support states and proves narrow terminal/downgrade guard theorems over finite records. Their scope is narrow: they check transition discipline, not the truth of any source-derived or benchmark-backed claim and not the correctness of any live demotion/refutation decision.
