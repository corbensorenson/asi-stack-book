...
| Exact accepted transitions in this chapter | `v1_0_pilot.evidence_states.no_change` |
...
- **Failure or non-promotion case:** 39 atoms
...
|---|---:|---|---|
| Core: `evidence-states-and-claim-discipline.core` | 1 | `executable`, `formal`, `source-synthesis` | `blocked_after_full_attempt`; missing or unproved: `causal`, `empirical`, `normative`, `transfer`. |
| retained after full attempt | 7 | `executable`, `formal`, `source-synthesis` | All atom-required local routes were present at the frozen audit boundary, but no accepted upward transition was inferred. |
| blocked after full attempt | 39 | `executable`, `formal`, `source-synthesis` | Missing or unproved lanes across this set: `causal`, `empirical`, `executable`, `formal`, `normative`, `transfer`. These are residual proof obligations, not false claims. |
