...
The smallest useful implementation is a substrate adoption schema and fixture. It records the candidate, intended use, advantage, baselines, negative controls, proof boundary, experiment requirements, falsification condition, adoption state, residuals, and evidence references.
