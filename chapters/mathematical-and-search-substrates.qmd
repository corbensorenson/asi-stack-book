...
open_evidence_gaps:
  ...
  - "The substrate_adoption_record fixture validates schema/example consistency for baseline obligations, consumer gate/policy, axis ledger, routing-permission effect, fallback substrate, retirement/supersession path, support-state effect, and non-claims only; no substrate A/B run, representation-efficiency benchmark, CoilMoECOT benchmark, Mamba comparison, Circle substrate sidecar run, or Theseus transfer consumer run has been executed from this repo. The separate Circle external rope receipt slice does not validate substrate adoption."
