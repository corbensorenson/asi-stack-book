...
open_evidence_gaps:
  - "Appendix C now maps this mathematical/search substrate claim to all assigned source notes; support remains argument until substrate A/B runs, representation-efficiency benchmarks, CoilMoECOT benchmarks, or local Circle builds exist."
...
Appendix C now maps this mathematical/search substrate claim to all assigned source notes. The mappings support optional substrate candidates, proof boundaries, manifests, A/B discipline, semantic IR, graph substrates, cyclic contracts, transfer boundaries, and adoption gates, not a promoted core substrate.
