...
Negative-control memory keeps substrate adoption honest. The ordinary baseline, simple ablation, and embarrassing control remain attached to the substrate record after a favorable result. Promotion without the controls is not promotion; it is wishful selection.
