...
A substrate-adoption trace should be the next minimum: exploratory registration, structural-only proof receipt, consumer rejection, canary benchmark plan, failed negative control, narrowed adoption state, and residual reason. That would make optionality executable before any substrate becomes load-bearing.
