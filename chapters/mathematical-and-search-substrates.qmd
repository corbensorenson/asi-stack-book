...
open_evidence_gaps:
  ...
  - "The substrate_adoption_record fixture validates schema/example consistency for baseline obligations, consumer gate/policy, axis ledger, routing-permission effect, fallback substrate, retirement/supersession path, support-state effect, and non-claims only; AsiStackProofs.SearchSubstrates implements finite-record adoption-field and promotion gates plus bounded negative cases for missing required fields, unproven qualified states, qualified states without passing evidence, unmeasured or blocked consumer-axis reliance, and incomplete canary evidence packets; no substrate A/B run, representation-efficiency benchmark, CoilMoECOT benchmark, Mamba comparison, Circle substrate sidecar run, or Theseus transfer consumer run has been executed from this repo. The separate Circle external rope receipt slice does not validate substrate adoption."
...
| Test state | `substrate_adoption_record.valid.json` passes repository-level protocol fixture validation for baseline obligations, consumer gate/policy, axis ledger, routing-permission effect, fallback substrate, retirement/supersession path, support-state effect, and non-claims; `AsiStackProofs.SearchSubstrates` implements finite adoption-field and promotion gates plus negative cases for missing required fields, unproven qualified states, qualified states without passing evidence, unmeasured or blocked consumer-axis reliance, and incomplete canary evidence packets; baseline comparison, representation-efficiency, sequence-substrate A/B, and falsification tests remain planned. |
