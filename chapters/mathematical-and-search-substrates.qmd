...
open_evidence_gaps:
  ...
  - "The substrate_adoption_record fixture validates schema/example consistency for adoption state, consumer gate, axis ledger, and non-claims only; no substrate A/B run, representation-efficiency benchmark, CoilMoECOT benchmark, Mamba comparison, local Circle build, Circle sidecar run, or Theseus transfer consumer run has been executed from this repo."
...
| Test state | `substrate_adoption_record.valid.json` passes repository-level protocol fixture validation for record shape, consumer gate, axis ledger, and non-claims; baseline comparison, representation-efficiency, sequence-substrate A/B, and falsification tests remain planned. |
...
- Consumer gate and allowed uses.
...
The smallest useful implementation is a substrate adoption schema and fixture. The current fixture records the candidate, intended use, advantage, baselines, negative controls, proof boundary, experiment requirements, consumer gate, axis ledger, falsification condition, adoption state, residuals, evidence references, and non-claims.
