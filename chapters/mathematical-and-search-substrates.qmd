...
`unproven_qualified_substrate_rejected`,
...
The module now contains six theorem declarations. Five are derived finite
negative cases over missing fields, unproven qualification,
qualified-without-evidence, unsupported consumer axes, and incomplete canary
packets. One proves that a hand-authored trace-summary fixture satisfies the
predicate whose values were authored into that fixture. The seventh C6
