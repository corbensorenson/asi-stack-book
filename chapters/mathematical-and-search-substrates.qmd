...
|---|---:|---|---|
| Core: `mathematical-and-search-substrates.core` | 1 | `causal`, `empirical`, `executable`, `formal`, `source-synthesis` | `blocked_after_full_attempt`; missing or unproved: `normative`, `transfer`. |
