...
At that end state, the chapter's claim becomes an operational contract: Coils, calculi, and geometric search belong in the stack as optional specialist substrates until tests show where they improve search, routing, or compression. The mature surface would include:
