...
The human reading rule is simple: a substrate enters through an interface, not through fascination. It needs a task boundary, baseline, negative control, evidence packet, failure mode, and reason why it improves the governed system rather than merely adding a beautiful internal story.
:::
...
The operational contract is that mathematical substrates remain optional specialists until baseline-symmetric workloads show where they improve search, routing, compression, or representation without hiding tradeoffs. A mature implementation would make that contract visible through:
