...
open_evidence_gaps:
  - "Appendix C now records exact passage-reviewed mappings for all eleven assigned mathematical/search-substrate sources; support remains at argument until substrate A/B runs, representation-efficiency benchmarks, CoilMoECOT benchmarks, Circle substrate-sidecar evidence, Mamba comparisons, or accepted chapter-core evidence transitions exist."
  - "The substrate_adoption_record fixture validates schema/example consistency for baseline obligations, consumer gate/policy, axis ledger, routing-permission effect, fallback substrate, retirement/supersession path, support-state effect, and non-claims only; the Substrate adoption trace validates four synthetic adoption states and eight expected-invalid controls for missing baseline, missing falsification condition, theorem spillover, unmeasured-axis routing, failed-control promotion, missing fallback, support-promotion overclaim, and missing non-claim boundary; AsiStackProofs.SearchSubstrates implements finite-record adoption-field and promotion gates plus bounded negative cases and a trace-summary bridge; no substrate A/B run, representation-efficiency benchmark, CoilMoECOT benchmark, Mamba comparison, Circle substrate sidecar run, or Theseus transfer consumer run has been executed from this repo. The separate Circle external rope receipt slice does not validate substrate adoption."
