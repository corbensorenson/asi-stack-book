...
| `circle_ai_contract_suite` | Theorem-linked contract families and consumer fields for KV-cache freshness, sparse attention, recurrence schedules, cyclic memory residue/winding, multicoil phase, and explicit non-claims. | A separate external Circle rope receipt slice is recorded in `docs/circle_external_receipt_slice.md`, but no generated contract pack, cyclic-memory contract command, receipt check, fingerprint check, or ASI Stack consumer gate was run from this repo. |
