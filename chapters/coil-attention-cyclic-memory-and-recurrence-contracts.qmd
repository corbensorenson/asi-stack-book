...
open_evidence_gaps:
  ...
  - "The exact current minimum includes a 34-declaration finite Lean lifecycle and an independent consumer covering incomplete-address collisions, complete-address round trips, arbitrary-run custody and budget invariants, recurrence monotonicity, freshness-stage coherence, stale-path containment, absorbing closure, trace composition, and rejection noninterference; it establishes no deployed memory or recurrence benefit or chapter-core transition."
...
### Worked stale-cache trace: the fluent answer that must be rejected
...
strided fanout with explicit no-promotion boundaries, and a 34-declaration Lean
...
The module contains 34 theorem declarations: four retained negative cases and
thirty address/lifecycle results. The two former assumption-restating
