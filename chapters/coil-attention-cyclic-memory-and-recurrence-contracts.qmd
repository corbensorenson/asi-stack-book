...
| Test state | `cyclic_memory_contract.valid.json` passes repository-level protocol fixture validation; alias, sparse-coverage, recurrence-exit, and freshness tests remain planned. |
...
These Lean hooks remain planned. The schema can require alias and freshness fields, but it does not prove a memory system retrieves useful content. A first proof should stay structural: reused cyclic slots must carry winding/provenance or visible alias residuals.
