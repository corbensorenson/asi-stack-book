...
open_evidence_gaps:
  ...
  - "The cyclic_memory_contract fixture validates schema/example consistency and `AsiStackProofs.CoilAttentionMemory` implements local finite-record alias and promotion gates only; no Circle sidecar, contract generator, KV-cache certifier, sparse-attention certifier, recurrence certifier, learned-model experiment, retrieval-quality test, long-context test, or Theseus transfer command has been run from this repo."
