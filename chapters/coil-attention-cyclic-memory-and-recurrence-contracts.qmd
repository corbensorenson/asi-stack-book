...
External baseline exception: Coil Attention is currently grounded in local Circle/Coil and VCM/Verification Bandwidth lineage. External sequence-model, recurrence, state-space, retrieval-memory, or long-context baselines have not been assigned with source notes for this layer, so v1.0 records a source gap rather than making an unreviewed literature comparison.
