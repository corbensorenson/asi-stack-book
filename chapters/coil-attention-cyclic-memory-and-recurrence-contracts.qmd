...
The smallest useful implementation is a cyclic memory contract schema and fixture. It records slot count, residue and winding policies, freshness window, coverage claim, recurrence schedule, loop exit, fallback, non-claims, and evidence references.
