...
| Test state | Correlated-evidence and observation-custody model formalized in Lean; claim-bearing sensor campaign remains unexecuted. |
...
| Observation lifecycle | The canonical six-transition path reaches invalidation with one handoff, one invalidation, and zero support or authority assignments. | proved in Lean and independently replayed |
