...
| Primary source records | `viea`, `talos`, `software_magic_grimoire`, `genesiscode`, `moecot`, `cognitive_compilation`, `ext_camel_prompt_injection_2025`, `cca_project`, `moecot_manifest_project`, `beastbrain_project`, `bugbrain_project`, `corbens_best_model_possible_project` |
| Claim label | Design rationale |
| Evidence level | argument |
| Source queue | primary: `viea`, `software_magic_grimoire`; supporting: `talos`, `genesiscode`, `cognitive_compilation`, `cca_project`, `moecot_manifest_project`, `beastbrain_project`, `bugbrain_project`, `corbens_best_model_possible_project`; comparator: `ext_camel_prompt_injection_2025`; connector/recovery: `moecot` |
...
transfer. The current scaffold does not meet that bar.
