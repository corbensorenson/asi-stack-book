...
The P4-C3 semantic audit classifies `IntentExecutionRefinement` as adequate only
for exact root/parent preservation, non-widening authority, approval/dispatch
custody, one observed local effect, artifact binding, verification, delivery,
and the encoded rejection routes. Its 89-event independent replay and 30
mutations do not establish intent fidelity, authentic authority or receipts,
effect completeness, verifier independence, useful delivery, or deployment.
