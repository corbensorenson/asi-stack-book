...
open_evidence_gaps:
  ...
  - "Source notes, schemas, fixtures, a synthetic plan-execution harness, and finite Lean predicates support record discipline only; they do not prove parser correctness, semantic extraction quality, prompt-injection resistance, approval enforcement, runtime dispatcher behavior, tool-effect control, or deployed execution safety."
...
traceability predicates. They do not prove parser completeness, prompt-injection
resistance, deployed command dispatch, approval-service correctness, runtime
execution correctness, model behavior, or source interpretation.
