...
open_evidence_gaps:
  ...
  - "Source notes, schemas, fixtures, a synthetic plan-execution harness, the Intent-to-execution handoff probe, and finite Lean predicates including a dispatch-route envelope, a handoff-probe bridge, and command-contract negative cases support record discipline only; they do not prove parser correctness, semantic extraction quality, prompt-injection resistance, approval enforcement, runtime dispatcher behavior, tool-effect control, artifact satisfaction, or deployed execution safety."
