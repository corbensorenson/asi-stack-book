...
| Exact accepted transitions in this chapter | `v1_0_pilot.intent_to_execution_contracts.no_change` |
...
|---|---:|---|---|
| Core: `intent-to-execution-contracts.core` | 1 | `source-synthesis` | `blocked_after_full_attempt`; missing or unproved: `causal`, `empirical`, `executable`, `formal`, `normative`, `transfer`. |
