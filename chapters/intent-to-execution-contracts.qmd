...
| Test state | `intent_contract.valid.json`, `command_contract.valid.json`, and `intent_execution_trace.valid.json` pass protocol fixture validation; `python3 scripts/validate_plan_execution_contracts.py` passes 3 valid and 10 expected-invalid synthetic plan-execution contract checks, including unresolved-ambiguity dispatch blocking, unrejected-hidden-override blocking, intent-authority-ceiling preservation, inferred-field dispatch blocking, a valid blocked inferred-authority residual path, and inferred-authority dispatch blocking; `python3 scripts/validate_intent_execution_handoff_probe.py` passes two valid synthetic handoff traces and seven expected-invalid controls, producing `experiments/intent_execution_handoff/results/2026-07-02-local.json`; `python3 scripts/validate_intent_governed_replacement_bridge.py` passes two valid synthetic bridge traces and six expected-invalid controls, producing `experiments/intent_governed_replacement_bridge/results/2026-07-02-local.json`; `AsiStackProofs.IntentToExecution`, `AsiStackProofs.CommandContracts`, and the downstream `AsiStackProofs.Replacement` bridge implement finite record predicates including a dispatch-route envelope, a handoff-probe bridge, replacement-admission bridge, missing-field negative case, hidden-override precedence negative case, and field-confidence route. Behavioral parser, dispatcher, approval-enforcement, tool-effect, prompt-injection, authority-extraction, replacement-execution, artifact-satisfaction, and runtime execution tests remain planned. |
