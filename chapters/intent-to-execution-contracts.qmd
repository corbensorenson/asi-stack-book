...
reasoning/action-trace baseline and `ext_dafny_2010` as an adjacent
specification-and-verification-condition baseline. The comparison is about
interfaces and evidence boundaries, not a claim that the ASI Stack has
implemented ReAct behavior, Dafny-style verification, parser completeness,
dispatcher correctness, or functional correctness.
