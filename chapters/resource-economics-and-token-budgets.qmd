...
These Lean hooks are implemented as finite-record predicates over required gates, risk class, verification-budget sufficiency, and budget decision fields. They prove only the record-level gates: required safety and verification gates cannot be disabled, and high-risk work with insufficient verification budget must route to escalation, deferral, scope reduction, rejection, or residual accounting rather than ordinary dispatch. Together with the deterministic generation-mode/resource-budget alignment harness, they are useful but too narrow for the chapter boundary. They do not prove load stability, economic optimality, welfare effects, scheduler quality, KV-cache performance, or TokenMana performance.
