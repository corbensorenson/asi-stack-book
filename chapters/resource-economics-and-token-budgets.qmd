...
| Primary source records | 32 assigned records with 17 exact mappings and 15 metadata-first reconciliation records across resource, simulation, serving, heterogeneous memory, recurrent compute, verification, routing economics, relational compute, and harness concerns |
...
| Source loading state | 17 exact passage-reviewed mappings cover the preexisting core; 15 assigned records add metadata-first relational, training-benchmark, and heterogeneous-memory context. Local and external results remain source-scoped unless a named repository artifact independently supports them. |
