...
The previous chapters offer cheaper routes, smaller artifacts, faster generation, and richer representations. This chapter asks whether those moves actually saved anything after verification, repair, fallback, memory pressure, human review, and risk are counted.
...
The operational contract is that cognition has a budget, but the budget cannot delete verification tax, protected overhead, review capacity, rollback cost, security cost, or residual burden. A mature implementation would make that contract visible through:
