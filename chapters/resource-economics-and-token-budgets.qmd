...
| Primary source records | all 16 manifest-assigned resource, simulation, serving, memory, recurrent-compute, verification, and harness comparators |
| Claim label | Design rationale |
| Evidence level | argument |
| Source queue | primary: `tokenmana`, `planforge`; supporting: the local resource/simulation lineage; external comparators: PagedAttention, Reluplex, Mem0, Recurrent Transformer, Dynamic Compute, and Claw-SWE-Bench |
| Source loading state | exact passage-reviewed mappings exist for all 16 assigned sources; local and external results remain source-scoped unless a named repository artifact independently supports them. |
