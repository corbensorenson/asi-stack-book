...
| Resource budget ledger harness | Check deterministic Resource Budget Record decisions for dispatch, high-risk escalation, protected overhead, displaced-cost residualization, evidence refs, and no-promotion boundaries. | implemented; passing via `python3 scripts/validate_resource_budget_ledgers.py` |
