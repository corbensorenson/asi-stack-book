...
The efficiency thesis depends on this accounting. A route is not efficient because it looks cheap at the model boundary. It is efficient only when full system cost, protected overhead, displaced work, and remaining residual burden are visible.
...
The budget should reveal tradeoffs before they become hidden policy. It should say which latency target is flexible, which review cost is mandatory, which cache is safe, and which shortcut would spend authority the task lacks. Budgets govern. Efficiency is credible after protected costs are paid.
:::
