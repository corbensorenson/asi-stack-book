...
| Source loading state | the preexisting passage-reviewed mappings retain their exact boundaries; the assigned cache records add primary papers and official documentation inspected 2026-07-23. Local and external results remain source-scoped unless a named repository artifact independently supports them. |
