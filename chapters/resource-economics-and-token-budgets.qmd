...
open_evidence_gaps:
  - "Appendix C now maps this resource-economics claim to all assigned source notes; support remains argument until TokenMana simulations, PlanForge scheduler benchmarks, welfare/load studies, or cost-quality experiments exist."
...
Appendix C now maps this resource-economics claim to all assigned source notes. The mappings support budget records, regenerative capacity, planner scheduling, physical feasibility, value/accounting metaphors, execution-spine resource discipline, report-first implementation pressure, and parameter accounting, not measured economic or scheduler performance.
