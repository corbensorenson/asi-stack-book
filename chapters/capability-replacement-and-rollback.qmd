...
| Test state | synthetic: 5/9 transaction records, selected readiness/residual gates, six-step 2-valid/3-invalid transaction trace plus 4 sequence controls, 2-valid/6-invalid intent bridge; formal: 37 theorem declarations under 6 targets; bounded outcomes: 15/15 exact local 24-surface rollback with no eligible utility gain, 32/36 attack-control rollback with 2/36 useful release, and 12/12 nine-surface harness probes with all model calls failing before candidate creation. No general, semantic, external-effect, or production recovery claim. |
