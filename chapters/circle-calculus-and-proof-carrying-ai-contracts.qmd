...
These Lean hooks are implemented as local finite-record predicates. They prove the ASI Stack boundary rule over receipt and consumer-gate records, but they do not prove Circle contracts, resolve external theorem IDs, replay receipts from source, vendor Circle packs, or evaluate downstream model behavior.
