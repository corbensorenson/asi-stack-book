...
The current book has not demonstrated that transport service. `argument` remains the right support state until receipt records, theorem-resolution checks, replay status, consumer-gate tests, stale-proof failure behavior, and downstream promotion reviews show that proof-carrying claims are usable without overstating what the proof stack established.
