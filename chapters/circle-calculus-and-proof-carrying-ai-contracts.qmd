...
| Exact accepted transitions in this chapter | `post_v2_3.p5.circle_named_target_receipt.promote` |
...
|---|---:|---|---|
| Core: `circle-calculus-and-proof-carrying-ai-contracts.core` | 1 | `causal`, `empirical`, `executable`, `formal`, `source-synthesis` | `blocked_after_full_attempt`; missing or unproved: `normative`, `transfer`. |
| promoted at bounded scope | 1 | `causal`, `empirical`, `executable`, `formal`, `source-synthesis` | Only the already accepted exact transitions are preserved: `post_v2_3.p5.circle_named_target_receipt.promote`. No chapter-core movement follows. |
