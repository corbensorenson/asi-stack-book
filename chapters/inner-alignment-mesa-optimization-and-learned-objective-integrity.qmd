...
| `lean:inner_alignment.hypothesis_review_lifecycle` | Seven accepted transitions reach one bounded handoff and one descendant invalidation; 59 independently encoded mutations reject without changing state. | implemented |
