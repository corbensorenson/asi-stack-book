...
| Source loading state | source notes: `ext_learned_optimization_risks_2019`, `ext_goal_misgeneralization_2022`, `ext_sleeper_agents_2024`, `ext_emergent_misalignment_reward_hacking_2025`, `ext_optimal_policies_power_2019`, `alignment_field`; raw cache: `alignment_field` |
...
**Concrete lens.** More random training examples may break this one correlation but cannot prove objective identity; a competent evaluation must state which hypotheses its intervention separates and which remain compatible.
