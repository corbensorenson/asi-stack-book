...
`lean:inner_alignment.behavior_does_not_identify_objective` will encode only a
finite non-identification boundary: compliant observations cannot select one
learned-objective hypothesis without separating evidence. It will not identify
an actual model objective or prove alignment, safety, or deception absence.
