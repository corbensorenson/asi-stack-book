...
open_evidence_gaps:
  ...
  - "Protocol schema/fixture validation, finite Lean gates, and the synthetic procedural-memory loop harness are implemented; no deployed loop detector, tool synthesizer, generated-tool correctness check, routing monitor, regression-quality benchmark, or retirement automation exists."
...
Fixture-shape validation, finite Lean gates, and the synthetic procedure-qualification harness are implemented. Remaining tests need deployed repeated-trace mining, synthesized tool candidates, generated-tool correctness checks, regression-quality benchmarks, routing monitors, and retirement automation.
