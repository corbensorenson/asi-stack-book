...
The candidate tool-card fixture checks only record shape. Repeated trace existence, invariant abstraction correctness, tool behavior, and regression success remain open until a harness records them.
