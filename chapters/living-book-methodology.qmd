...
open_evidence_gaps:
  ...
  - "The living_book_release_record fixture and AsiStackProofs.LivingBook finite-record predicates validate release-record shape, audience scope, derived-artifact boundaries, support-state effect, manifest linkage, structural-update sync predicates, and bounded negative cases for missing drafting artifacts, unsynced structural updates, release readiness without validation/changelog/residuals, and derived artifacts missing source/review/support-state boundaries only; they do not prove manuscript quality, source interpretation quality, editorial completeness, reader artifact production, audio artifact production, or GitHub Pages availability."
...
A change-packet record should be the methodology's next executable object: one chapter edit with source IDs, one outline-only change, one proof-manifest shift, one reader-edition generation record, and one blocked release with residuals. The record would make the living process auditable while leaving final manuscript quality unclaimed.
...
These Lean hooks are implemented as finite-record predicates over chapter-manifest and structural-update reviews. They prove only the record-level gates: a manifest chapter has outline proof targets and generated claim placeholders, and a structural update marked valid requires regenerated scaffold and proof manifest. The module also now proves bounded negative cases named `manifest_chapter_missing_outline_targets_or_claim_placeholders_rejected`, `structural_update_marked_valid_without_sync_artifacts_rejected`, `release_ready_without_validation_changelog_or_residuals_rejected`, and `derived_artifact_without_source_review_or_support_boundary_rejected`. These cases reject malformed maintenance/release records; they do not prove manuscript quality, source-to-claim completeness, editorial judgment, GitHub Pages availability, reader artifact approval, or audio artifact approval.
