...
| Exact accepted transitions in this chapter | `v1_0_pilot.living_book_methodology.no_change` |
...
|---|---:|---|---|
| Core: `living-book-methodology.core` | 1 | `causal`, `empirical`, `executable`, `formal`, `source-synthesis` | `blocked_after_full_attempt`; missing or unproved: `normative`, `transfer`. |
