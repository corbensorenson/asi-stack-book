...
Four proof targets are implemented by nineteen Lean declarations over hand-authored finite manifest, structural-update, release, derivative, change-packet, and reader-route records. They reject missing drafting artifacts, unsynced changes, incomplete release records, boundaryless derivatives, missing change receipts, equal-authority derivatives, unsupported promotion, and reader approval despite accessibility, audio, approval, or non-claim blockers. The current blocked reader candidate is a hand-authored finite route fixture, not a reader-quality result.
