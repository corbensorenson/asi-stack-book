...
open_evidence_gaps:
  ...
  - "The living_book_release_record fixture, living_book_change_packet schema/harness, and AsiStackProofs.LivingBook finite-record predicates validate release-record shape, audience scope, derived-artifact boundaries, support-state effect, manifest linkage, structural-update sync predicates, change-packet receipt discipline, and bounded negative cases for missing drafting artifacts, unsynced structural updates, release readiness without validation/changelog/residuals, derived artifacts missing source/review/support-state boundaries, change packets missing validation/changelog/non-claims, equal-authority reader derivatives, and support promotion without evidence-transition refs only; they do not prove manuscript quality, source interpretation quality, editorial completeness, reader artifact production, audio artifact production, or GitHub Pages availability."
...
| Test state | Quarto render, manifest/proof sync, changelog updates, protocol fixture validation, public release-record validation, `python3 scripts/validate_living_book_change_packets.py`, and `AsiStackProofs.LivingBook` finite manifest/drafting-artifact, structural-update, and change-packet predicates run in the current publication gate; `AsiStackProofs.LivingBook` also implements negative cases for missing drafting artifacts, unsynced structural updates, release readiness without validation/changelog/residuals, derived artifacts missing source/review/support-state boundaries, missing change-packet receipts, equal-authority reader derivatives, and support promotion without evidence-transition refs; claim-quality review remains human/editorial and no reader/audio artifact is implied. |
...
These Lean hooks are implemented as finite-record predicates over chapter-manifest, structural-update, release-readiness, derived-artifact, and change-packet reviews. They prove only the record-level gates: a manifest chapter has outline proof targets and generated claim placeholders, a structural update marked valid requires regenerated scaffold and proof manifest, a release-ready record needs validation/changelog/residuals, a derived artifact needs source/review/support boundaries, and a public-surface change packet needs validation, changelog, support-state, non-claim, derivative-boundary, and evidence-transition discipline. The module proves bounded negative cases named `manifest_chapter_missing_outline_targets_or_claim_placeholders_rejected`, `structural_update_marked_valid_without_sync_artifacts_rejected`, `release_ready_without_validation_changelog_or_residuals_rejected`, `derived_artifact_without_source_review_or_support_boundary_rejected`, `change_packet_without_validation_changelog_support_or_nonclaims_rejected`, `derived_artifact_equal_authority_change_packet_rejected`, and `support_promotion_without_evidence_transition_rejected`. These cases reject malformed maintenance/release records; they do not prove manuscript quality, source-to-claim completeness, editorial judgment, GitHub Pages availability, reader artifact approval, audio artifact approval, future-agent correctness, or support-state promotion.
