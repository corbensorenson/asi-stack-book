...
Benchmark ratchets create pressure, but the observation itself may be sensitive to evaluation, monitor, or selection context. Adversarial Evaluation, Sandbagging, and Training-Time Deception owns that integrity boundary before any signal becomes a learning input or capability conclusion. It records cross-context discrepancies, monitor interference, sandbagging risk, and residual uncertainty so an anti-Goodhart control is not mistaken for proof that the evaluator saw the whole capability surface.
