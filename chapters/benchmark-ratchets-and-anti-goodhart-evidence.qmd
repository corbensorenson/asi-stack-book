...
A toy ratchet ledger is the smallest concrete extension: one passing run record, one failed neighboring case, one saturated benchmark moved to regression, and one blocked promotion. Such a ledger would demonstrate support-state restraint without claiming empirical capability.
