...
**Diagram reading note:** The ratchet converts benchmark work into an evidence-state decision, not a celebration of a score. Residuals, regressions, holdouts, transfer checks, mutation, contamination, and negative results all gate whether readiness or a claim can move.
...
Benchmark ratchets create pressure, but pressure becomes system change only through an update mechanism. Policy Optimization and Learning from Feedback defines that learning actuator. It records target layer, reward boundary, feedback admissibility, verifier refs, holdouts, drift limits, rollback, monitor windows, governance gates, and residuals so reward, preference, benchmark, or verifier signals cannot become authority by training side effect.
