...
| Test state | `benchmark_ratchet_record.valid.json` passes repository-level protocol fixture validation; saturation, transfer, and regression-preservation tests remain planned. |
