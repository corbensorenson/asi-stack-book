...
These targets are implemented as finite record predicates. The current Lean envelope now includes negative-case theorems for missing bound approval on high-risk execution and missing lease-boundary fields on external hive access. It still does not prove a distributed scheduler, network boundary, rented-node sandbox, family-governance policy, privacy guarantee, approval-service behavior, or live federation behavior.
