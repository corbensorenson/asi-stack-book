...
That shifts the focus from where work can run to how work and artifacts can become smaller. A hive can create pressure for compact generation, but compression is useful only when residual burden, verification cost, and fallback remain visible.
