...
| Source loading state | All 23 assigned sources have exact reviewed mappings. Internal and tracked-project passages support bounded architectural components; official tooling sources and the CAP paper supply adjacent substrate and failure-pressure comparators only. None is implementation or safety evidence for this hive. |
...
|---|---:|---|---|
| Core: `personal-compute-hives-and-federated-edge-intelligence.core` | 1 | `causal`, `empirical`, `executable`, `formal`, `source-synthesis` | `blocked_after_full_attempt`; missing or unproved: `normative`, `transfer`. |
| blocked after full attempt | 77 | `causal`, `empirical`, `executable`, `formal`, `source-synthesis` | Missing or unproved lanes across this set: `normative`, `transfer`. These are residual proof obligations, not false claims. |
