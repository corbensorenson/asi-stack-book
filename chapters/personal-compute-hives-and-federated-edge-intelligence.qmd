...
The operational contract is that owned and rented devices form a policy-bounded compute fabric only when scheduling respects capability, locality, trust, cost, energy, data class, physical risk, and authority. A mature implementation would make that contract visible through:
