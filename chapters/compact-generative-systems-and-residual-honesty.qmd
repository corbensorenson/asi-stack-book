...
Compression and representation baselines make residual accounting non-optional. Deep Compression (`ext_deep_compression_2015`) names pruning, quantization, and coding; knowledge distillation (`ext_knowledge_distillation_2015`) names teacher/student behavior transfer; DreamCoder (`ext_dreamcoder_2020`) frames reusable abstraction learning; Information Bottleneck (`ext_information_bottleneck_2000`) separates relevance from compression; and MDL (`ext_mdl_tutorial_2004`) makes model/data tradeoffs explicit. Compact generative systems use those baselines to require residual and verifier accounting, not to claim a local compression ratio or utility result.
