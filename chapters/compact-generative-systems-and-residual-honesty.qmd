...
open_evidence_gaps:
  ...
  - "Only the compact_generative_record fixture and narrow finite Lean residual/exactness predicates have been implemented; the fixture validates correction mechanism, verifier independence, authority boundary, use envelope, burden ledger, cost accounting, promotion state, retirement condition, support-state effect, and non-claims only. No CGS benchmark, utility test, generator, fallback harness, downstream behavior test, BugBrain build, simulation benchmark, or Theseus report rerun has been executed from this repository."
...
| Test state | `compact_generative_record.valid.json` passes repository-level protocol fixture validation for correction mechanism, verifier independence, authority boundary, use envelope, burden ledger, cost accounting, promotion state, retirement condition, support-state effect, and non-claims; finite residual/exactness predicates implemented in `AsiStackProofs.CompactGenerativeSystems`; chapter-specific CGS utility, fallback, and downstream tests remain planned. |
...
A Compact Generative Record names what is compact, what is generated, how it is corrected, how it is verified, which verifier separation is required, what residuals remain, what use envelope is allowed, which burdens and costs are being counted, and who is allowed to use, promote, retire, or fall back from it. It treats compactness as a claim with costs, not as an aesthetic preference.
...
The smallest useful implementation is a compact generative record and fixture. It does not prove that a compact core works. It makes the burden visible: target, seed, rules, memory, residuals, correction mechanism, verification, verifier independence, governance, authority boundary, use envelope, burden ledger, cost accounting, leverage, hidden complexity, fallback, promotion state, retirement condition, support-state effect, evidence references, and non-claims.
...
| Test | Purpose | Status |
|---|---|---|
| Compact generative record fixture validation | Validate that the public record contract includes target, seed, rules, memory, residuals, correction mechanism, verification, verifier independence, governance, authority boundary, use envelope, burden ledger, cost accounting, fallback, promotion state, retirement condition, support-state effect, evidence references, and non-claims. | implemented; passing via `python3 scripts/validate_protocol_examples.py` |
