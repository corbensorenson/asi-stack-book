...
open_evidence_gaps:
  ...
  - "The compact_generative_record fixture validates schema/example consistency only; CGS utility, residual burden, fallback behavior, and downstream tests remain unimplemented."
...
| Test state | `compact_generative_record.valid.json` passes repository-level protocol fixture validation; chapter-specific CGS utility and residual-burden tests remain planned. |
...
These Lean hooks are still planned. The validated JSON fixture is a protocol contract, not a mechanized proof that compact representations preserve utility or block promotion under all conditions. The first proof candidate should be limited to a finite record predicate such as "unresolved obligations imply a nonempty residual field."
