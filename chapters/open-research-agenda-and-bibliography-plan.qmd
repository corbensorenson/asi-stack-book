...
| Exact accepted transitions in this chapter | `v1_0_pilot.research_agenda.no_change` |
...
|---|---:|---|---|
| Core: `open-research-agenda-and-bibliography-plan.core` | 1 | `causal`, `empirical`, `executable`, `formal`, `source-synthesis` | `blocked_after_full_attempt`; missing or unproved: `normative`, `transfer`. |
