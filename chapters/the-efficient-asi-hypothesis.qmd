...
The stack is now defined. The next question is why that stack is not only a governance diagram. A good architecture should spend high-cost cognition where the contract demands it, reuse prior work when it remains valid, and preserve enough evidence that cheap shortcuts do not become hidden errors.
