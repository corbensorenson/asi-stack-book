...
open_evidence_gaps:
  ...
  - "The costed_route_record fixture validates schema/example consistency only. `AsiStackProofs.Efficiency` now supplies an executable finite selector and proofs of listed-candidate membership, eligibility, and minimum complete seven-class modeled cost, plus cost algebra, absence completeness, a reachable witness, and cheaper unauthorized and failed-quality countermodels. The independent synthetic route-search probe agrees with that selector on two finite traces and retains six expected-invalid controls. The stronger `AsiStackProofs.ResourceEconomicsRefinement` lifecycle owns request-through-closure governance. Route-search completeness, cost-estimate accuracy, quality calibration, measured efficiency, benchmark performance, model quality, deployment, and downstream compression utility remain unimplemented."
...
`AsiStackProofs.Efficiency` owns complete seven-class cost addition and
monotonicity, an executable finite selector, universal membership, eligibility,
and minimum-cost consequences, concrete nonvacuity witnesses, and the residual
promotion rejection. Its modeled minimum is conditional on the authored
candidate set and declarations. The previous theorem-per-Boolean admission
