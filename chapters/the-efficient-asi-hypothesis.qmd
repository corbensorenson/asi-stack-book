...
open_evidence_gaps:
  ...
  - "The costed_route_record fixture validates schema/example consistency only; minimum-viable routing, residual burden, and utility-preserving compression tests remain unimplemented."
...
| Test state | `costed_route_record.valid.json` passes protocol fixture validation; minimum viable route, residual burden, and utility-preserving compression tests remain planned. |
...
The proof targets remain planned. The near-term executable surface is the route record schema; a later Lean target should formalize "minimum viable" only after route ordering, authority, and quality predicates are precise.
