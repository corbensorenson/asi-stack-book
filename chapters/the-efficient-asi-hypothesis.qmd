...
open_evidence_gaps:
  ...
  - "The costed_route_record fixture validates schema/example consistency only; the fixture now records route state, task contract ref, outcome state, cost classes, hidden-cost checks, support-state effect, and non-claims. `AsiStackProofs.Efficiency` adds finite negative cases for a lower-cost authorized quality-preserving candidate and open-obligation promotion without residual records only; route-search completeness, cost-estimate accuracy, residual-burden measurement, and utility-preserving compression tests remain unimplemented."
...
| Test state | `costed_route_record.valid.json` passes protocol fixture validation for route state, task contract ref, outcome state, cost classes, hidden-cost checks, support-state effect, and non-claims; `AsiStackProofs.Efficiency` implements finite route-comparison and residual-promotion predicates plus negative cases for lower-cost authorized quality-preserving candidates and open-obligation promotion without residual records; route-search, cost-estimate accuracy, residual-burden, and utility-preserving compression tests remain planned. |
...
These Lean hooks are implemented as finite-record predicates plus negative-case theorems over route-comparison reviews and residual-promotion reviews. They prove only the record-level gates: a route marked minimum viable excludes listed lower-cost authorized candidates that satisfy the declared quality predicate, a listed lower-cost authorized quality-preserving candidate rejects the minimum-viable predicate, a promoted result with open obligations requires a residual record, and open-obligation promotion without a residual record rejects the residual-promotion predicate. They do not prove route-search completeness, cost-estimate accuracy, quality evaluation, measured efficiency, residual-burden measurement, or compression utility.
