...
open_evidence_gaps:
  - "The core claim has exact source-note mappings for all assigned sources in Appendix C; nine carry local raw-cache passage review and the complete authenticated `moecot` connector text is passage-reviewed, while runtime artifacts remain unimported."
...
| Source loading state | source notes: `viea`, `rmi`, `cgs`, `rankfold_neuralfold`, `bbvca_v9`, `simulation_scaling`, `beastbrain`, `beastbrain_timeless`, `aletheia`, `moecot`; passage-reviewed local raw cache: `viea`, `rmi`, `cgs`, `rankfold_neuralfold`, `bbvca_v9`, `simulation_scaling`, `beastbrain`, `beastbrain_timeless`, `aletheia`; authenticated connector text passage-reviewed: `moecot` |
