...
These Lean hooks are implemented as finite-record predicates plus negative-case, route theorems, and a finite probe-summary bridge over route-comparison, residual-promotion, efficiency-claim admission, and synthetic route-search reviews. The public minimum-route and residual targets now bind to derived negative cases rather than premise projections: a listed lower-cost authorized quality-preserving candidate rejects the minimum-viable predicate, and open-obligation promotion without a residual record rejects the residual-promotion predicate. The admission route sends missing contract, quality, route, candidate, cost, verification, residual, fallback, hidden-cost, benchmark-or-trace, negative-control, evidence-transition, and non-claim-boundary records to explicit outcomes before admitting the finite record, while the synthetic route-search probe summary preserves its count and no-promotion boundary.

The module contains twenty-four declarations after retiring the two
assumption-restating projections. None proves route-search completeness,
cost-estimate accuracy, quality evaluation, measured efficiency,
residual-burden measurement, benchmark performance, support-state promotion,
model quality, or compression utility.
