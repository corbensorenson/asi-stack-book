...
open_evidence_gaps:
  ...
  - "The authority transition harness validates synthetic authority-transition gate semantics for scoped allow, over-ceiling denial, approval escalation, missing receipts, permission-class collapse, and confused-deputy shortcuts. The executed grant-to-effect refinement now binds six authority fixtures, one local effect and exact rollback, two pre-effect denials, five revocation entries, and nine governed repository scenarios, and rejects 38 semantic mutations. Deployed authorization enforcement, authentic identity and receipts, concurrent revocation, complete observation, live runtime adapters, and tool-wrapper security remain unimplemented."
  - "`AsiStackProofs.AuthorityEffectRefinement` now owns the first two proof targets with a reachable grant, approval, dispatch, effect, observation, revocation, one-shot use, and rollback model. `AsiStackProofs.Authority` retains finite ceiling and lifecycle route lemmas; one projection-only declaration was physically retired. Neither module proves deployed authorization enforcement or production security."
  - "No support-state promotion is implied by this drafting pass."
---

<!-- BEGIN MANAGED VISUAL ABSTRACT:system-boundaries-and-authority -->
...
<strong>Visual-edition preview — 3 of 84.</strong>
...
<iframe
  src="https://www.youtube-nocookie.com/embed/lT2ftLM4erY"
  title="Visual abstract: System Boundaries and Authority"
  aria-label="Play the visual abstract for System Boundaries and Authority"
  loading="lazy"
...
<p class="asi-visual-preview-links"><a href="https://www.youtube.com/watch?v=lT2ftLM4erY">Open this unlisted preview on YouTube</a></p>

<details class="asi-visual-transcript">
<summary>Read the descriptive transcript</summary>

<p>Canonical live chapter: <a
href="https://corbensorenson.github.io/asi-stack-book/chapters/system-boundaries-and-authority.html">https://corbensorenson.github.io/asi-stack-book/chapters/system-boundaries-and-authority.html</a></p>
<p>Video ID: <code>asi-video-system-boundaries-and-authority</code></p>
...
<h3 class="asi-visual-transcript-heading" id="00000033--problem-and-shortcut">00:00–00:33 — Problem and
shortcut</h3>
...
it.</p>
<p><strong>Narration.</strong> This chapter asks a specific question: To
test whether cross-layer effects are authorized, the stack needs
explicit identities for the principal, execution domain, operation,
target, permission class, ceiling, grant lifecycle, delegation, and
receipt. The tempting shortcut is insufficient: Role labels, prompts,
and ambient process identity do not by themselves distinguish read,
transform, disclose, write, execute, and approve authority or enforce
delegation, expiry, revocation, and cross-domain approval.</p>
<h3 class="asi-visual-transcript-heading" id="00330112--operating-mechanism">00:33–01:12 — Operating
mechanism</h3>
...
External-effect authority should be represented as a versioned,
revocable tuple binding principal, execution domain, operation, target,
permission class, scope, ceiling, grant state, delegation, expiry or
revocation epoch, and receipt obligations; capability, context access,
route quality, or ambient process power alone confers none of it. Define
principals, authorities, ceilings, grants, revocations, and handoff
contracts. Separate knowledge access from action authority. Represent
missing authority as a detectable failure rather than implicit
permission.</p>
<h3 class="asi-visual-transcript-heading" id="01120159--concrete-state-transition">01:12–01:59 — Concrete
state transition</h3>
...
proposal testable. An authority-transition schema plus a unified
authority-tuple lifecycle that binds execution-domain ownership, scope,
budget, trace, replay, grant, revocation, cross-domain approval,
receipts, and protocol-versus-hardware-root boundaries. Separate
knowledge access from action authority. Represent missing authority as a
detectable failure rather than implicit permission. Bind principal,
execution domain, operation, target, permission class, scope, budget
account, trace, replay identity, grant, policy version, revocation
epoch, and expiry in one authority tuple. Throughout the trace, one
invariant remains visible: Authority never expands silently.</p>
<h3 class="asi-visual-transcript-heading" id="01590220--failure-boundary">01:59–02:20 — Failure boundary</h3>
<p><strong>Visual description.</strong> Four failure cards meet a red
fail-closed boundary labeled RECORD THE RESIDUAL.</p>
<p><strong>Narration.</strong> The design can still fail. Authority
creep. Confused-deputy tool calls. Memory access treated as action
approval. Authority identity forks across budget, trace, replay, or
revocation. The correct response is to stop, narrow, quarantine,
compensate, or retain an owned residual rather than narrate uncertainty
away.</p>
<h3 class="asi-visual-transcript-heading" id="02200308--evidence-state">02:20–03:08 — Evidence state</h3>
...
rather than pretending they are already closed. Every accepted issuance,
dispatch, and effect in the finite reachable grant model remains within
the caller ceiling and exactly binds grant ID, principal, operation,
target, epoch, expiry, remaining uses, approval, dispatch, and effect
custody. The reachable model and independent consumer reject authority
widening, confused-deputy substitution, stale or expired grants, missing
approval/dispatch/effect receipts, post-revocation dispatch, effect
without dispatch, and consumed one-shot reuse.</p>
<h3 class="asi-visual-transcript-heading" id="03080336--non-claims">03:08–03:36 — Non-claims</h3>
...
<h3 class="asi-visual-transcript-heading" id="03360405--handoff">03:36–04:05 — Handoff</h3>
...
next chapter is Failure Modes of Ungoverned Intelligence. It takes
responsibility for Governance, reliability, and self-improvement claims
cannot be tested unless their failure conditions, observable boundary
events, evidence records, and owners are declared prospectively.</p>
...
:::
<!-- END MANAGED VISUAL ABSTRACT:system-boundaries-and-authority -->
## Chapter status
...
| Test state | `authority_transition_record.valid.json` passes protocol fixture validation; `AsiStackProofs.Authority` and `AsiStackProofs.AuthorityEffectRefinement` build locally; and `python3 scripts/validate_authority_effect_refinement.py` passes over 6 authority fixtures, a 6-event reachable witness, 1 executed local effect, 1 independent observation, 1 exact rollback, 2 pre-effect denials, 5 revocation entries, 9 governed repository scenarios, and 38 of 38 rejected mutations. Earlier authority, runtime-adapter, and revocation validators remain passing. Deployed permission enforcement, authentic identity and receipts, concurrent revocation, complete observation, production security, and transfer remain planned. |
...
This record is the authority-specific projection of the shared Governed
Transition Calculus defined by Executable Specifications. Its source and target
identities become the principal, source layer, and target boundary; its
authority field becomes the ceiling, grant, delegation, expiry, and revocation
state; and its obligations, evidence, residuals, consumers, and closure become
the required checks, receipts, denials, downstream acknowledgements, and
rollback or retirement path. The projection is intentionally asymmetric:
System Boundaries may add stricter authority fields, but neither a generic
transition record nor a complete authority tuple may claim that a real effect
was enforced without an independently grounded effect receipt.
...
The stronger bounded owner is now the executed grant-to-effect refinement. `AsiStackProofs.AuthorityEffectRefinement` models exact grant identity, principal, operation, target, ceiling, epoch, expiry, remaining uses, approval, dispatch, effect, independent observation, revocation, and exact rollback as reachable state rather than unrelated true fields. `python3 scripts/validate_authority_effect_refinement.py` independently consumes the existing authority, runtime-effect, revocation, and governed-repository artifacts. It records 6 fixtures, a 6-event witness, 1 local material effect, 1 independent observation, 1 exact rollback, 2 no-mutation denials, 5 revocation entries, 9 governed scenarios, and 38 of 38 rejected mutations. This is stronger finite and executable evidence, but its numeric identities and receipts are trusted inputs and its effect is local and public-safe.
...
| Executed Authority grant-to-effect refinement | Check reachable exact grant binding, caller-ceiling preservation, epoch and expiry freshness, approval and dispatch custody, local effect observation, revocation, one-shot use, exact rollback, and source-sensitive failures. | implemented by `python3 scripts/validate_authority_effect_refinement.py`; 6 authority fixtures, 6 reachable events, 1 executed effect, 1 independent observation, 1 exact rollback, 2 pre-effect denials, 5 revocation entries, 9 governed scenarios, and 38/38 rejected mutations; support-state effect `none`; no authentic identity/receipt, deployed enforcement, concurrent revocation, production security, reproduction, or transfer claim |
...
|---|---|---|---|
| `lean:authority.ceiling.operational_invariant` | `AsiStackProofs.AuthorityEffectRefinement` | Every accepted issuance, dispatch, and effect in the finite reachable grant model remains within the caller ceiling and exactly binds grant ID, principal, operation, target, epoch, expiry, remaining uses, approval, dispatch, and effect custody. | implemented |
| `lean:authority.ceiling.failure_blocks_promotion` | `AsiStackProofs.AuthorityEffectRefinement` | The reachable model and independent consumer reject authority widening, confused-deputy substitution, stale or expired grants, missing approval/dispatch/effect receipts, post-revocation dispatch, effect without dispatch, and consumed one-shot reuse. | implemented |
...
The first two targets are now implemented by the reachable model in `AsiStackProofs.AuthorityEffectRefinement`; the lifecycle route and historical revocation-surface bridge remain in `AsiStackProofs.Authority`. The stronger model proves exact finite transition consequences for issuance, approval, dispatch, effect, observation, revocation, one-shot use, and rollback, and its independent Python consumer refines the model against existing executed local records plus 38 source/model mutations. The older general ceiling lemmas and lifecycle negative cases remain useful at their exact local scope. The projection-only declaration that merely extracted audit and non-claim fields from an assumed-valid record was physically retired. This finite proof packet does not prove natural-language authority extraction, real identity or receipt authenticity, wise issuance, complete observation, concurrent or distributed revocation, tool-wrapper enforcement, deployed approval services, production security, reproduction, transfer, or chapter-core support.

The P4-C3 semantic audit therefore classifies `AuthorityEffectRefinement` as
adequate only for its bounded reachable grant-to-local-effect semantics. The
six-event witness and 38 rejected mutations show exact routing consequences;
they do not establish that any identity, approval, receipt, observation, or
rollback claim is authentic, complete, concurrently enforced, or safe.
...
per-atom rows are the `system-boundaries-and-authority` slice of
...
Across 35 atoms, the terminal ledger records 26 `blocked_after_full_attempt`; 8 `retained_after_full_attempt`; 1 `promoted_at_bounded_scope`.
:::
