...
This boundary is what keeps the efficient stack from becoming a permission leak. Routing can choose a worker, planning can request a handoff, memory can expose context, and GenesisCode-like systems can propose effects, but authority moves only through typed transitions that can be audited, revoked, tested, and later formalized. Without those transitions, context boundaries, evaluator boundaries, and residual records, the stack fails in predictable ways.
