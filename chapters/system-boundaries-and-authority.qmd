...
| Exact accepted transitions in this chapter | `post_v2_3.p5.authority_no_silent_expansion.promote`, `v1_0_pilot.system_boundaries.no_change` |
...
- **Failure or non-promotion case:** 26 atoms
...
|---|---:|---|---|
| Core: `system-boundaries-and-authority.core` | 1 | `executable`, `formal`, `source-synthesis` | `blocked_after_full_attempt`; missing or unproved: `causal`, `empirical`, `normative`, `transfer`. |
| promoted at bounded scope | 1 | `executable`, `formal`, `source-synthesis` | Only the already accepted exact transitions are preserved: `post_v2_3.p5.authority_no_silent_expansion.promote`. No chapter-core movement follows. |
| retained after full attempt | 8 | `executable`, `formal`, `source-synthesis` | All atom-required local routes were present at the frozen audit boundary, but no accepted upward transition was inferred. |
| blocked after full attempt | 26 | `executable`, `formal`, `source-synthesis` | Missing or unproved lanes across this set: `causal`, `empirical`, `executable`, `formal`, `normative`, `transfer`. These are residual proof obligations, not false claims. |
