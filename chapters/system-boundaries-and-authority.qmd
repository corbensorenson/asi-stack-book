...
This authority type system is still an architectural target. Authority support remains at `argument` until missing-grant denials, ceiling-preservation checks, read/write separation fixtures, confused-deputy scenarios, and tool-call traces show that authority cannot expand silently by implication.
