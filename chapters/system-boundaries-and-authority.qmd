...
Authority is therefore a first-class artifact: something granted, scoped, recorded, revoked, and reviewed instead of inferred from capability. The practical payoff is a system that can say no even when it knows how.
:::
