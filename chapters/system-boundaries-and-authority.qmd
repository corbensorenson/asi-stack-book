...
open_evidence_gaps:
  - "The core claim has exact source-note mappings for all assigned sources in Appendix C, including six public-safe historical-project notes treated as one related lineage; five original mappings carry local raw-cache passage review and the complete authenticated `moecot` connector text is passage-reviewed."
