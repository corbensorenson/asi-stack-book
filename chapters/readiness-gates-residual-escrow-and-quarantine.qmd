...
open_evidence_gaps:
  ...
  - "Protocol schema/fixture validation, narrow Lean gate/quarantine predicates, and the readiness/residual gate harness's synthetic transition, residual-escrow, quarantine, expired-rerun, fallback, and rollback-readiness checks are implemented; no readiness engine, residual-ledger storage, benchmark harness, live quarantine routing, or MoECOT replay has been run for this chapter."
