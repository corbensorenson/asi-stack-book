...
open_evidence_gaps:
  ...
  - "Protocol schema/fixture validation, narrow Lean routing/readiness predicates with negative cases, a finite routing-decision lifecycle route envelope, MoECOT runtime source-boundary predicates with negative cases, the readiness/residual gate harness's synthetic authority-bounded/fallback route checks, and the synthetic routing decision lease harness are implemented; no specialist-routing benchmark, learned-router harness, runtime route, MoECOT replay, orchestration benchmark, route-quality measurement, or deployed authority-enforcement test has been run for this chapter."
