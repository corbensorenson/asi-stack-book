...
Fixture-shape validation, four bounded Lean predicates, the readiness/residual harness's synthetic route authority/fallback/readiness-mapping checks, and the synthetic routing decision lease harness are implemented. Routing accuracy and MoECOT runtime claims still require real routing tasks, candidate specialists, readiness states, learned-router or policy-router code, imported runtime packets, concrete replay refs, benchmark records, and logged route outcomes.
