...
Fixture-shape validation, twenty bounded Lean theorem declarations across routing and MoECOT runtime record predicates, the readiness/residual harness's synthetic route authority/fallback/readiness-mapping checks, and the synthetic routing decision lease harness are implemented. The route-lease harness now includes one expected-invalid authority-widening grant that keeps task-local authority inside the selected specialist registry envelope. Routing accuracy and MoECOT runtime claims still require real routing tasks, candidate specialists, readiness states, learned-router or policy-router code, imported runtime packets, concrete replay refs, benchmark records, and logged route outcomes.
