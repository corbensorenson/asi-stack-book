...
- **Failure or non-promotion case:** 24 atoms
...
|---|---:|---|---|
| Core: `failure-modes-of-ungoverned-intelligence.core` | 1 | `executable`, `formal`, `source-synthesis` | `blocked_after_full_attempt`; missing or unproved: `causal`, `empirical`, `normative`, `transfer`. |
...
| blocked after full attempt | 24 | `executable`, `formal`, `source-synthesis` | Missing or unproved lanes across this set: `causal`, `empirical`, `executable`, `formal`, `normative`, `transfer`. These are residual proof obligations, not false claims. |
