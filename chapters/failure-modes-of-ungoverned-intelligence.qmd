...
open_evidence_gaps:
  - "The core claim now has exact source-note mappings for all assigned sources in Appendix C; scenario coverage and failure-detector evidence remain incomplete."
...
Appendix C now maps this core failure claim to every assigned source note. The mappings support the obligation map for failure boundaries, not a claim that the stack already detects or prevents the failures.
