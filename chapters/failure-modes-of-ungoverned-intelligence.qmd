...
attainable options. The result is important and conditional. It does not prove
that every capable system will seek power or that every increase in options is
harmful.

The stack should therefore govern **option expansion as a transition**, not
...
Prospective failure obligations create claims about detectors, controls,
containment, and recovery; those claims can fail just as the underlying system
can. **Evidence States and Claim Discipline** follows by separating taxonomy,
mechanism evidence, observed incidents, mitigation results, and broader safety
inference. The handoff prevents a seeded detector pass or a polished
postmortem from becoming an unsupported claim that the failure has been solved.
