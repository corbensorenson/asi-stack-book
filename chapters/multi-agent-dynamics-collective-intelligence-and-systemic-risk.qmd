...
Within the consolidated reference, population dynamics remain a distinct route
beneath [Inter-Stack Protocols, Identity,
and Economic Exchange](inter-stack-protocols-identity-and-economic-exchange.qmd).
The parent owns typed identity, authority, semantic exchange, settlement,
receipt, dispute, revocation, and closure between stacks. This route continues
to own effective diversity, multiplex interactions, strategic adaptation,
cooperation and conflict, collusion, externalities, learning dynamics,
emergent objectives, concentration, cascades, common-mode failures, human
influence, and displaced intervention effects.

That placement does not turn protocol conformance into a claim about the
population. This route retains its claims, source queue, proof targets, tests,
fixtures, failure modes, evidence exit, non-claims, support ceiling, identity,
and legacy URL. The parent does not inherit collective intelligence,
non-collusion, systemic stability, welfare, fair allocation, or human agency;
this route does not inherit identity correctness, valid authority, semantic
equivalence, settlement, dispute closure, or permission to intervene. The nest
creates no cooperation, market outcome, social benefit, systemic safety,
support movement, deployment, release, AGI, or ASI result.
