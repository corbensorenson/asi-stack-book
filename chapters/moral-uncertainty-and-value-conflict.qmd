...
synthetic harnesses, finite-record Lean theorems, and a bounded governance-right
lifecycle route make the idea more inspectable, but they do not prove moral
correctness, legal rights, institutional adequacy, reviewer independence, real
export usability, safe fork execution, redaction quality, SCF replacement
behavior, or deployed governance enforcement.
...
ceiling, or support-state boundary. The Governance Rights module now also checks
a finite lifecycle route for missing governance records, audit material,
redaction appeal gaps, exit/export gaps, unsafe forks, missing fork obligations,
