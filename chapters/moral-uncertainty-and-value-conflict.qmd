...
open_evidence_gaps:
  ...
  - "Synthetic value-conflict and governance-rights harnesses plus finite-record Lean theorems remain bounded record checks; real review quality, runtime contestability, actual exit/fork usability, and SCF replacement behavior remain open."
...
cases for declared records. Direct/projection hooks remain projection-only traceability unless the theorem reasons over an explicit transition, negative case, residual path, authority ceiling, or support-state boundary. They do not prove moral correctness, automatic
