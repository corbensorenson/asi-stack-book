...
- Publisher: Anthropic
- Public source: <https://www.anthropic.com/responsible-scaling-policy>
- Version/date: 3.4, 2026-07-08
- Reviewed: 2026-07-24

## Thesis

The policy binds named capability thresholds to required safeguards, risk
reports, governance procedures, and public disclosures. The current policy
...
- threat-model-specific evaluation;
- external review provisions for risk reports;
...
thresholds and governance procedures change. It is not independent evidence
...
- policy revision weakening an earlier commitment;
