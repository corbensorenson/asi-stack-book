...
- Public source: <https://digital-strategy.ec.europa.eu/en/library/guidelines-transparency-obligations-providers-and-deployers-ai-systems>
- Published: 2026-07-20
- Reviewed: 2026-07-24

## Thesis

The guidance explains the scope and application of Article 50 transparency
obligations for specified AI interactions and AI-generated or manipulated
content. The Commission states that these obligations apply from 2 August
...
- disclosure for deepfakes and certain public-interest text;
- distinction between provider and deployer duties;
...
compliant, or that disclosure prevents deception. The underlying law,
...
- assuming one actor owns both provider and deployer obligations;
- failing to preserve evidence through downstream transformation;
